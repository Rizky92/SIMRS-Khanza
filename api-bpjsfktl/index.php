                                                        ...
                                                        if($sudahdaftar>0){
                                                            ...
                                                            if($interval<0){
                                                                ...
                                                                if ($sisakuota < $jadwal['kuota']) {
                                                                    ...
                                                                    $queryregistrasi = false;
                                                                    for ($percobaan = 0; $percobaan < 5 && !$queryregistrasi; $percobaan++) {
                                                                        if ($percobaan > 0) {
                                                                            $noReg     = noRegPoliSmc($kdpoli, $kddokter, validTeks4($decode['tanggalperiksa'], 20));
                                                                            $max       = norawatSmc(validTeks4($decode['tanggalperiksa'], 20));
                                                                            $no_rawat  = str_replace("-", "/", validTeks4($decode['tanggalperiksa'], 20)."/").sprintf("%06s", $max);
                                                                        ...
                                                                        $queryregistrasi = simpanTransaksiSmc([
                                                                            sprintf("insert into reg_periksa values('%s', '%s', '%s', '%s', '%s', '%s', '%s',
                                                                            ...
                                                                            sprintf("insert into referensi_mobilejkn_bpjs values('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s',

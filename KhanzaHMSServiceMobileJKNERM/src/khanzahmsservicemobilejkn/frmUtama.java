                    ...
                    try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                if(task3.equals("")){
                                    datajam=Sequel.cariIsi("select referensi_mobilejkn_bpjs.validasi from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat=? and referensi_mobilejkn_bpjs.status != 'Batal'",rs.getString("no_rawat"));
                                    if(!datajam.equals("")){

                            ...
                            while(rs.next()){
                                ...
                                if(task99.equals("")){
                                    ...
                                    if(task3.equals("Sudah") && task4.equals("")){
                                        ...
                                        if(datajam.equals("")){
                                            datajam=Sequel.cariIsi("select concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? and pemeriksaan_ralan.nip = (select reg_periksa.kd_dokter from reg_periksa where reg_periksa.no_rawat = pemeriksaan_ralan.no_rawat)",rs.getString("no_rawat"));
                                        }
                                        if(!datajam.equals("")){
                                ...
                                try {
                                    ...
                                    if(rs2.next()){
                                        ...
                                        if (task99.equals("")) {
                                            ...
                                            if(task3.equals("")){
                                                datajam = Sequel.cariIsiSmc("select if(dikirim = '0000-00-00 00:00:00.000', '', dikirim) from mutasi_berkas where no_rawat = ?", rs.getString("no_rawat"));
                                                if (datajam.isBlank()) {

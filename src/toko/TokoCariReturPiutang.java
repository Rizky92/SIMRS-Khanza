        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ReturPiutangToko.html", "Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ReturPiutangToko.wps", "Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ReturPiutangToko.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ReturPiutangToko.xlsx", tbDokter);
                        break;

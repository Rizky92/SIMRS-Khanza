            ...
            case 0:
                if(tabMode.getRowCount()==0){
                    ...
                    try {
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("PenjualanToko.html", "Transaksi Penjualan Barang Toko", tbDokter);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("PenjualanToko.wps", "Transaksi Penjualan Barang Toko", tbDokter);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("PenjualanToko.csv", tbDokter);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("PenjualanToko.xlsx", tbDokter);
                                break;

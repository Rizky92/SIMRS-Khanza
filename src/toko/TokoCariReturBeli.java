        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ReturBeliToko.html", "Transaksi Retur Ke Suplier Barang Toko / Minimarket / Koperasi", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ReturBeliToko.wps", "Transaksi Retur Ke Suplier Barang Toko / Minimarket / Koperasi", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ReturBeliToko.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ReturBeliToko.xlsx", tbDokter);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MemberToko.html", "Data Member Toko", tbPetugas);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MemberToko.wps", "Data Member Toko", tbPetugas);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MemberToko.csv", tbPetugas);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MemberToko.xlsx", tbPetugas);
                        break;

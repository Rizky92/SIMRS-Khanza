        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ReturJualToko.html", "Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ReturJualToko.wps", "Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ReturJualToko.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ReturJualToko.xlsx", tbDokter);
                        break;

...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    private void isSimpan() {
        ...
        if(sukses==true){
            jur.clear();
            if (sukses) sukses = jur.tampung(Piutang_Toko, "PIUTANG TOKO", (tagihan-uangmuka), 0);
            if (sukses) sukses = jur.tampung(Kontra_Piutang_Toko, "Persediaan Barang Toko", 0, (tagihan-uangmuka));
            if (sukses) sukses = jur.simpanJurnalSMC(NoNota.getText(),"U","PIUTANG TOKO / MINIMARKET / KOPERASI, OLEH "+akses.getkode());
         }
    }

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPemesananToko.html", "Data Surat Pemesanan Barang Toko / Minimarket / Koperasi", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPemesananToko.wps", "Data Surat Pemesanan Barang Toko / Minimarket / Koperasi", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPemesananToko.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPemesananToko.xlsx", tbDokter);
                        break;

           ...
           try {
              ...
              if(rs.next()){
                  ...
                  if(sukses==true){
                        ...
                        jur.clear();
                        if (sukses) sukses = jur.tampung(Piutang_Toko, "PIUTANG", 0, ttlpiutang);
                        if (sukses) sukses = jur.tampung(Kontra_Piutang_Toko, "Persediaan Barang Toko", ttlpiutang, 0);
                        if (sukses) sukses = jur.simpanJurnalSMC(rs.getString("nota_piutang"),"U","BATAL PIUTANG BARANG TOKO / MINIMARKET / KOPERASI, OLEH "+akses.getkode());
                  }

            ...
            case 0:
                if(tabMode.getRowCount()==0){
                    ...
                    "Laporan 1 (HTML)", "Laporan 2 (WPS)", "Laporan 3 (CSV)", "Laporan 4 (XLSX)", "Laporan 5 (Jasper)"
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("PiutangToko.html", "Transaksi Piutang Barang Toko", tbDokter);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("PiutangToko.wps", "Transaksi Piutang Barang Toko", tbDokter);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("PiutangToko.csv", tbDokter);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("PiutangToko.xlsx", tbDokter);
                                break;

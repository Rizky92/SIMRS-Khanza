...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    public DlgUpdateUser(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {"P", "Pilihan Hak Akses Menu di SIMKES", "Status", "nama_akses"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Update Hak Akses User ]::",
    ...
    */
        ...
        try{    
            ...
            for(i=0;i<tbUser.getRowCount();i++){
                if(tbUser.getValueAt(i,0).toString().equals("true")){
                    ...
                    menuakses[jml] = tbUser.getValueAt(i, 3).toString();
                    jml++;
                }
            }
            ...
            for(i=0;i<jml;i++){
                tabMode.addRow(new Object[] {
                    pilih[i],menu[i],akses[i],menuakses[i]
                });
            }
    ...
    private void setTampilA() {
        if("[A]Jadwal Praktek".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Jadwal Praktek",jadwal_praktek,"jadwal_praktek"});
        }

        if("[A]Registrasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Registrasi",registrasi,"registrasi"});
        }

        if("[A]Tindakan Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Tindakan Ralan",tindakan_ralan,"tindakan_ralan"});
        }

        if("[A]Rawat Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Rawat Inap",kamar_inap,"kamar_inap"});
        }

        if("[A]Tindakan Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Tindakan Ranap",tindakan_ranap,"tindakan_ranap"});
        }

        if("[A]Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Operasi",operasi,"operasi"});
        }

        if("[A]Rujukan Keluar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Rujukan Keluar",rujukan_keluar,"rujukan_keluar"});
        }

        if("[A]Rujukan Masuk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Rujukan Masuk",rujukan_masuk,"rujukan_masuk"});
        }

        if("[A]Beri Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Beri Obat, Alkes & BHP",beri_obat,"beri_obat"});
        }

        if("[A]Resep Pulang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Resep Pulang",resep_pulang,"resep_pulang"});
        }

        if("[A]Diet Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Diet Pasien",diet_pasien,"diet_pasien"});
        }

        if("[A]Periksa Lab PK".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Periksa Lab PK",periksa_lab,"periksa_lab"});
        }

        if("[A]Periksa Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Periksa Radiologi",periksa_radiologi,"periksa_radiologi"});
        }

        if("[A]Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Rawat Jalan",kasir_ralan,"kasir_ralan"});
        }

        if("[A]Informasi Kamar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Informasi Kamar",informasi_kamar,"informasi_kamar"});
        }

        if("[A]No.Resep".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]No.Resep",resep_obat,"resep_obat"});
        }

        if("[A]Billing Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Billing Ralan",billing_ralan,"billing_ralan"});
        }

        if("[A]Billing Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Billing Ranap",billing_ranap,"billing_ranap"});
        }

        if("[A]IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]IGD",igd,"igd"});
        }

        if("[A]DPJP Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]DPJP Ranap",dpjp_ranap,"dpjp_ranap"});
        }

        if("[A]Edit Registrasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Edit Registrasi",edit_registrasi,"edit_registrasi"});
        }

        if("[A]Rujukan Poli Internal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Rujukan Poli Internal",rujukan_poli_internal,"rujukan_poli_internal"});
        }

        if("[A]Billing Parsial".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Billing Parsial",billing_parsial,"billing_parsial"});
        }

        if("[A]Akses Depo Obat/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Akses Depo Obat/BHP",akses_depo_obat,"akses_depo_obat"});
        }

        if("[A]Jadwal Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Jadwal Operasi",booking_operasi,"booking_operasi"});
        }

        if("[A]Booking Registrasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Booking Registrasi",booking_registrasi,"booking_registrasi"});
        }

        if("[A]Permintaan Lab".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Permintaan Lab",permintaan_lab,"permintaan_lab"});
        }

        if("[A]Permintaan Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Permintaan Radiologi",permintaan_radiologi,"permintaan_radiologi"});
        }

        if("[A]Catatan Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Catatan Dokter",catatan_perawatan,"catatan_perawatan"});
        }

        if("[A]Asesmen Awal Rawat Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Asesmen Awal Rawat Inap",pengkajian_askep,"pengkajian_askep"});
        }

        if("[A]Skrining Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Skrining Rawat Jalan",sekrining_rawat_jalan,"sekrining_rawat_jalan"});
        }

        if("[A]Perkiraan Biaya Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Perkiraan Biaya Ranap",perkiraan_biaya_ranap,"perkiraan_biaya_ranap"});
        }

        if("[A]Permintaan Diet".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Permintaan Diet",permintaan_diet,"permintaan_diet"});
        }

        if("[A]Deteksi Dini Corona".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Deteksi Dini Corona",deteksi_corona,"deteksi_corona"});
        }

        if("[A]Booking Periksa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Booking Periksa",booking_periksa,"booking_periksa"});
        }

        if("[A]Periksa Lab PA".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Periksa Lab PA",pemeriksaan_lab_pa,"pemeriksaan_lab_pa"});
        }

        if("[A]Permintaan Rawat Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Permintaan Rawat Inap",permintaan_ranap,"permintaan_ranap"});
        }

        if("[A]Ubah Petugas Lab PK".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Ubah Petugas Lab PK",ubah_petugas_lab_pk,"ubah_petugas_lab_pk"});
        }

        if("[A]Ubah Petugas Lab PA".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Ubah Petugas Lab PA",ubah_petugas_lab_pa,"ubah_petugas_lab_pa"});
        }

        if("[A]Ubah Petugas Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Ubah Petugas Radiologi",ubah_petugas_radiologi,"ubah_petugas_radiologi"});
        }

        if("[A]Gabung Nomor Rawat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Gabung Nomor Rawat",gabung_norawat,"gabung_norawat"});
        }

        if("[A]Periksa Lab MB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Periksa Lab MB",pemeriksaan_lab_mb,"pemeriksaan_lab_mb"});
        }

        if("[A]Ubah Petugas Lab MB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Ubah Petugas Lab MB",ubah_petugas_lab_mb,"ubah_petugas_lab_mb"});
        }
        
        if("[A]Akses Ke Dokter Lain Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Akses Ke Dokter Lain Rawat Jalan",akses_dokter_lain_rawat_jalan,"akses_dokter_lain_rawat_jalan"});
        }
    }

    private void setTampilB() {
        if("[B]Barcode Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[B]Barcode Ralan",barcoderalan,"barcoderalan"});
        }

        if("[B]Barcode Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[B]Barcode Ranap",barcoderanap,"barcoderanap"});
        }
    }

    private void setTampilC() {
        if("[C]Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Dokter",dokter,"dokter"});
        }

        if("[C]Petugas".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Petugas",petugas,"petugas"});
        }

        if("[C]Barcode Presensi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Barcode Presensi",barcode,"barcode"});
        }

        if("[C]Presensi Harian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Presensi Harian",presensi_harian,"presensi_harian"});
        }

        if("[C]Presensi Bulanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Presensi Bulanan",presensi_bulanan,"presensi_bulanan"});
        }

        if("[C]Pegawai Admin".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Pegawai Admin",pegawai_admin,"pegawai_admin"});
        }

        if("[C]Pegawai User".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Pegawai User",pegawai_user,"pegawai_user"});
        }

        if("[C]SMS Gateway".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]SMS Gateway",sms,"sms"});
        }

        if("[C]Sidik Jari".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Sidik Jari",sidikjari,"sidikjari"});
        }

        if("[C]Jam Presensi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jam Presensi",jam_masuk,"jam_masuk"});
        }

        if("[C]Jadwal Pegawai".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jadwal Pegawai",jadwal_pegawai,"jadwal_pegawai"});
        }

        if("[C]Temporary Presensi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Temporary Presensi",temporary_presensi,"temporary_presensi"});
        }

        if("[C]Master Berkas Pegawai".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Master Berkas Pegawai",master_berkas_pegawai,"master_berkas_pegawai"});
        }

        if("[C]Berkas Kepegawaian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Berkas Kepegawaian",berkas_kepegawaian,"berkas_kepegawaian"});
        }

        if("[C]Riwayat Jabatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Riwayat Jabatan",riwayat_jabatan,"riwayat_jabatan"});
        }

        if("[C]Riwayat Pendidikan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Riwayat Pendidikan",riwayat_pendidikan,"riwayat_pendidikan"});
        }

        if("[C]Riwayat Naik Gaji".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Riwayat Naik Gaji",riwayat_naik_gaji,"riwayat_naik_gaji"});
        }

        if("[C]Kegiatan Ilmiah & Pelatihan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Kegiatan Ilmiah & Pelatihan",kegiatan_ilmiah,"kegiatan_ilmiah"});
        }

        if("[C]Riwayat Penghargaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Riwayat Penghargaan",riwayat_penghargaan,"riwayat_penghargaan"});
        }

        if("[C]Riwayat Penelitian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Riwayat Penelitian",riwayat_penelitian,"riwayat_penelitian"});
        }

        if("[C]Jenis Cidera K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jenis Cidera K3",jenis_cidera_k3rs,"jenis_cidera_k3rs"});
        }

        if("[C]Penyebab Kecelakaan K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Penyebab Kecelakaan K3",penyebab_k3rs,"penyebab_k3rs"});
        }

        if("[C]Jenis Luka K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jenis Luka K3",jenis_luka_k3rs,"jenis_luka_k3rs"});
        }

        if("[C]Lokasi Kejadian K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Lokasi Kejadian K3",lokasi_kejadian_k3rs,"lokasi_kejadian_k3rs"});
        }

        if("[C]Dampak Cidera K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Dampak Cidera K3",dampak_cidera_k3rs,"dampak_cidera_k3rs"});
        }

        if("[C]Jenis Pekerjaan K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jenis Pekerjaan K3",jenis_pekerjaan_k3rs,"jenis_pekerjaan_k3rs"});
        }

        if("[C]Bagian Tubuh K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Bagian Tubuh K3",bagian_tubuh_k3rs,"bagian_tubuh_k3rs"});
        }

        if("[C]Peristiwa K3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Peristiwa K3",peristiwa_k3rs,"peristiwa_k3rs"});
        }

        if("[C]Jenis Cidera K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jenis Cidera K3 Per Tahun",jenis_cidera_k3rstahun,"jenis_cidera_k3rstahun"});
        }

        if("[C]Penyebab Kecelakaan K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Penyebab Kecelakaan K3 Per Tahun",penyebab_k3rstahun,"penyebab_k3rstahun"});
        }

        if("[C]Jenis Luka K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jenis Luka K3 Per Tahun",jenis_luka_k3rstahun,"jenis_luka_k3rstahun"});
        }

        if("[C]Lokasi Kejadian K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Lokasi Kejadian K3 Per Tahun",lokasi_kejadian_k3rstahun,"lokasi_kejadian_k3rstahun"});
        }

        if("[C]Dampak Cidera K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Dampak Cidera K3 Per Tahun",dampak_cidera_k3rstahun,"dampak_cidera_k3rstahun"});
        }

        if("[C]Jenis Pekerjaan K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Jenis Pekerjaan K3 Per Tahun",jenis_pekerjaan_k3rstahun,"jenis_pekerjaan_k3rstahun"});
        }

        if("[C]Bagian Tubuh K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Bagian Tubuh K3 Per Tahun",bagian_tubuh_k3rstahun,"bagian_tubuh_k3rstahun"});
        }

        if("[C]Pengajuan Cuti".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Pengajuan Cuti",pengajuan_cuti,"pengajuan_cuti"});
        }

        if("[C]Audit Kepatuhan APD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Kepatuhan APD",audit_kepatuhan_apd,"audit_kepatuhan_apd"});
        }

        if("[C]Audit Cuci Tangan Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Cuci Tangan Medis",audit_cuci_tangan_medis,"audit_cuci_tangan_medis"});
        }

        if("[C]Audit Pembuangan Limbah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Pembuangan Limbah",audit_pembuangan_limbah,"audit_pembuangan_limbah"});
        }

        if("[C]Ruang/Unit Audit Kepatuhan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Ruang/Unit Audit Kepatuhan",ruang_audit_kepatuhan,"ruang_audit_kepatuhan"});
        }

        if("[C]Audit Pembuangan Benda Tajam & Jarum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Pembuangan Benda Tajam & Jarum",audit_pembuangan_benda_tajam,"audit_pembuangan_benda_tajam"});
        }

        if("[C]Audit Penanganan Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Penanganan Darah",audit_penanganan_darah,"audit_penanganan_darah"});
        }

        if("[C]Audit Pengelolaan Linen Kotor".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Pengelolaan Linen Kotor",audit_pengelolaan_linen_kotor,"audit_pengelolaan_linen_kotor"});
        }

        if("[C]Audit Penempatan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Penempatan Pasien",audit_penempatan_pasien,"audit_penempatan_pasien"});
        }

        if("[C]Audit Kamar Jenazah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Kamar Jenazah",audit_kamar_jenazah,"audit_kamar_jenazah"});
        }

        if("[C]Audit Bundle IADP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Bundle IADP",audit_bundle_iadp,"audit_bundle_iadp"});
        }

        if("[C]Audit Bundle IDO".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Bundle IDO",audit_bundle_ido,"audit_bundle_ido"});
        }

        if("[C]Audit Fasilitas Kebersihan Tangan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Fasilitas Kebersihan Tangan",audit_fasilitas_kebersihan_tangan,"audit_fasilitas_kebersihan_tangan"});
        }

        if("[C]Audit Fasilitas APD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Fasilitas APD",audit_fasilitas_apd,"audit_fasilitas_apd"});
        }

        if("[C]Audit Pembuangan Limbah Cair Infeksius".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Pembuangan Limbah Cair Infeksius",audit_pembuangan_limbah_cair_infeksius,"audit_pembuangan_limbah_cair_infeksius"});
        }

        if("[C]Audit Sterilisasi Alat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Sterilisasi Alat",audit_sterilisasi_alat,"audit_sterilisasi_alat"});
        }

        if("[C]Audit Bundle ISK".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Bundle ISK",audit_bundle_isk,"audit_bundle_isk"});
        }

        if("[C]Audit Bundle PLABSI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Bundle PLABSI",audit_bundle_plabsi,"audit_bundle_plabsi"});
        }

        if("[C]Audit Bundle VAP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Audit Bundle VAP",audit_bundle_vap,"audit_bundle_vap"});
        }
    }

    private void setTampilD() {
        if("[D]Suplier Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Suplier Obat/Alkes/BHP",suplier,"suplier"});
        }

        if("[D]Satuan Barang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Satuan Barang",satuan_barang,"satuan_barang"});
        }

        if("[D]Konversi Satuan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Konversi Satuan",konversi_satuan,"konversi_satuan"});
        }

        if("[D]Jenis Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Jenis Obat/Alkes/BHP",jenis_barang,"jenis_barang"});
        }

        if("[D]Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Obat, Alkes & BHP",obat,"obat"});
        }

        if("[D]Stok Opname Apotek".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Stok Opname Apotek",stok_opname_obat,"stok_opname_obat"});
        }

        if("[D]Stok Obat Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Stok Obat Pasien",stok_obat_pasien,"stok_obat_pasien"});
        }

        if("[D]Pengadaan Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Pengadaan Obat, Alkes & BHP",pengadaan_obat,"pengadaan_obat"});
        }

        if("[D]Penerimaan Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Penerimaan Obat, Alkes & BHP",pemesanan_obat,"pemesanan_obat"});
        }

        if("[D]Penjualan Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Penjualan Obat, Alkes & BHP",penjualan_obat,"penjualan_obat"});
        }

        if("[D]Piutang Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Piutang Obat, Alkes & BHP",piutang_obat,"piutang_obat"});
        }

        if("[D]Retur Ke Suplier".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Retur Ke Suplier",retur_ke_suplier,"retur_ke_suplier"});
        }

        if("[D]Retur Dari Pembeli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Retur Dari Pembeli",retur_dari_pembeli,"retur_dari_pembeli"});
        }

        if("[D]Retur Obat, Alkes & BHP Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Retur Obat, Alkes & BHP Ranap",retur_obat_ranap,"retur_obat_ranap"});
        }

        if("[D]Retur Piutang Pembeli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Retur Piutang Pembeli",retur_piutang_pasien,"retur_piutang_pasien"});
        }

        if("[D]Keuntungan Penjualan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Keuntungan Penjualan",keuntungan_penjualan,"keuntungan_penjualan"});
        }

        if("[D]Keuntungan Beri Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Keuntungan Beri Obat, Alkes & BHP",keuntungan_beri_obat,"keuntungan_beri_obat"});
        }

        if("[D]Sirkulasi Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sirkulasi Obat, Alkes & BHP",sirkulasi_obat,"sirkulasi_obat"});
        }

        if("[D]Mutasi Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Mutasi Obat/Alkes/BHP",mutasi_barang,"mutasi_barang"});
        }

        if("[D]Darurat Stok".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Darurat Stok",darurat_stok,"darurat_stok"});
        }

        if("[D]Sirkulasi Obat, Alkes & BHP 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sirkulasi Obat, Alkes & BHP 2",sirkulasi_obat2,"sirkulasi_obat2"});
        }

        if("[D]Industri Farmasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Industri Farmasi",industrifarmasi,"industrifarmasi"});
        }

        if("[D]Pengambilan BHP UTD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Pengambilan BHP UTD",pengambilan_utd,"pengambilan_utd"});
        }

        if("[D]Keuntungan Beri Obat, Alkes & BHP 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Keuntungan Beri Obat, Alkes & BHP 2",keuntungan_beri_obat_nonpiutang,"keuntungan_beri_obat_nonpiutang"});
        }

        if("[D]Riwayat Obat, Alkes & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Riwayat Obat, Alkes & BHP",riwayat_obat_alkes_bhp,"riwayat_obat_alkes_bhp"});
        }

        if("[D]Resep Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Resep Dokter",resep_dokter,"resep_dokter"});
        }

        if("[D]Kategori Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Kategori Obat/Alkes/BHP",kategori_barang,"kategori_barang"});
        }

        if("[D]Golongan Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Golongan Obat/Alkes/BHP",golongan_barang,"golongan_barang"});
        }

        if("[D]Obat/Alkes/BHP Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Obat/Alkes/BHP Per Tanggal",pemberian_obat_pertanggal,"pemberian_obat_pertanggal"});
        }

        if("[D]Penjualan Bebas Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Penjualan Bebas Per Tanggal",penjualan_obat_pertanggal,"penjualan_obat_pertanggal"});
        }

        if("[D]Permintaan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Permintaan Obat & BHP",permintaan_medis,"permintaan_medis"});
        }

        if("[D]Ringkasan Permintaan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Permintaan Obat & BHP",rekap_permintaan_medis,"rekap_permintaan_medis"});
        }

        if("[D]Surat Pemesanan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Surat Pemesanan Obat & BHP",surat_pemesanan_medis,"surat_pemesanan_medis"});
        }

        if("[D]Stok Keluar Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Stok Keluar Medis",pengeluaran_stok_apotek,"pengeluaran_stok_apotek"});
        }

        if("[D]Metode Racik".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Metode Racik",metode_racik,"metode_racik"});
        }

        if("[D]Pengguna Obat/Alkes/BHP Resep".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Pengguna Obat/Alkes/BHP Resep",pengguna_obat_resep,"pengguna_obat_resep"});
        }

        if("[D]Rekap Penerimaan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Rekap Penerimaan Obat & BHP",rekap_pemesanan,"rekap_pemesanan"});
        }

        if("[D]Riwayat Batch".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Riwayat Batch",riwayat_data_batch,"riwayat_data_batch"});
        }

        if("[D]Kegiatan Farmasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Kegiatan Farmasi",kegiatan_farmasi,"kegiatan_farmasi"});
        }

        if("[D]Sirkulasi Obat, Alkes & BHP 3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sirkulasi Obat, Alkes & BHP 3",sirkulasi_obat3,"sirkulasi_obat3"});
        }

        if("[D]PPN Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]PPN Obat",ppn_obat,"ppn_obat"});
        }

        if("[D]Data Batch".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Data Batch",data_batch,"data_batch"});
        }

        if("[D]Kadaluarsa Batch".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Kadaluarsa Batch",kadaluarsa_batch,"kadaluarsa_batch"});
        }

        if("[D]Sisa Stok".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sisa Stok",sisa_stok,"sisa_stok"});
        }

        if("[D]Obat Per Resep".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Obat Per Resep",obat_per_resep,"obat_per_resep"});
        }

        if("[D]Pengajuan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Pengajuan Obat & BHP",pengajuan_barang_medis,"pengajuan_barang_medis"});
        }

        if("[D]10 Obat Terbanyak Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]10 Obat Terbanyak Poli",sepuluh_obat_terbanyak_poli,"sepuluh_obat_terbanyak_poli"});
        }

        if("[D]Rekap Obat Per Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Rekap Obat Per Poli",rekap_obat_poli,"rekap_obat_poli"});
        }

        if("[D]Rekap Obat Per Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Rekap Obat Per Pasien",rekap_obat_pasien,"rekap_obat_pasien"});
        }

        if("[D]Hibah Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Hibah Obat & BHP",hibah_obat_bhp,"hibah_obat_bhp"});
        }

        if("[D]Sirkulasi Obat, Alkes & BHP 4".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sirkulasi Obat, Alkes & BHP 4",sirkulasi_obat4,"sirkulasi_obat4"});
        }

        if("[D]Sirkulasi Obat, Alkes & BHP 5".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sirkulasi Obat, Alkes & BHP 5",sirkulasi_obat5,"sirkulasi_obat5"});
        }

        if("[D]Permintaan Stok Obat Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Permintaan Stok Obat Pasien",permintaan_stok_obat_pasien,"permintaan_stok_obat_pasien"});
        }

        if("[D]Verifikasi Penerimaan Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Verifikasi Penerimaan Obat/Alkes/BHP",verifikasi_penerimaan_farmasi,"verifikasi_penerimaan_farmasi"});
        }

        if("[D]Ringkasan Pengajuan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Pengajuan Obat & BHP",ringkasan_pengajuan_obat,"ringkasan_pengajuan_obat"});
        }

        if("[D]Ringkasan Pemesanan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Pemesanan Obat & BHP",ringkasan_pemesanan_obat,"ringkasan_pemesanan_obat"});
        }

        if("[D]Ringkasan Pengadaan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Pengadaan Obat & BHP",ringkasan_pengadaan_obat,"ringkasan_pengadaan_obat"});
        }

        if("[D]Ringkasan Penerimaan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Penerimaan Obat & BHP",ringkasan_penerimaan_obat,"ringkasan_penerimaan_obat"});
        }

        if("[D]Ringkasan Hibah Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Hibah Obat & BHP",ringkasan_hibah_obat,"ringkasan_hibah_obat"});
        }

        if("[D]Ringkasan Penjualan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Penjualan Obat & BHP",ringkasan_penjualan_obat,"ringkasan_penjualan_obat"});
        }

        if("[D]Ringkasan Beri Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Beri Obat & BHP",ringkasan_beri_obat,"ringkasan_beri_obat"});
        }

        if("[D]Ringkasan Piutang Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Piutang Obat & BHP",ringkasan_piutang_obat,"ringkasan_piutang_obat"});
        }

        if("[D]Ringkasan Stok Keluar Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Stok Keluar Obat & BHP",ringkasan_stok_keluar_obat,"ringkasan_stok_keluar_obat"});
        }

        if("[D]Ringkasan Retur Suplier Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Retur Suplier Obat & BHP",ringkasan_retur_suplier_obat,"ringkasan_retur_suplier_obat"});
        }

        if("[D]Ringkasan Retur Pembeli Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Retur Pembeli Obat & BHP",ringkasan_retur_pembeli_obat,"ringkasan_retur_pembeli_obat"});
        }

        if("[D]Penggunaan BHP OK/VK".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Penggunaan BHP OK/VK",penggunaan_bhp_ok,"penggunaan_bhp_ok"});
        }

        if("[D]Resep Luar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Resep Luar",resep_luar,"resep_luar"});
        }

        if("[D]Stok Akhir Farmasi Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Stok Akhir Farmasi Per Tanggal",stok_akhir_farmasi_pertanggal,"stok_akhir_farmasi_pertanggal"});
        }

        if("[D]Telaah Resep & Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Telaah Resep & Obat",telaah_resep,"telaah_resep"});
        }

        if("[D]Permintaan Resep Pulang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Permintaan Resep Pulang",permintaan_resep_pulang,"permintaan_resep_pulang"});
        }

        if("[D]Ringkasan Biaya Obat Pasien Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ringkasan Biaya Obat Pasien Per Tanggal",ringkasan_biaya_obat_pasien_pertanggal,"ringkasan_biaya_obat_pasien_pertanggal"});
        }

        if("[D]Nilai Penerimaan Vendor Farmasi Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Nilai Penerimaan Vendor Farmasi Per Bulan",nilai_penerimaan_vendor_farmasi_perbulan,"nilai_penerimaan_vendor_farmasi_perbulan"});
        }

        if("[D]Obat/Alkes/BHP Tidak Bergerak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Obat/Alkes/BHP Tidak Bergerak",obat_bhp_tidakbergerak,"obat_bhp_tidakbergerak"});
        }

        if("[D]Sirkulasi Obat, Alkes & BHP 6".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Sirkulasi Obat, Alkes & BHP 6",sirkulasi_obat6,"sirkulasi_obat6"});
        }

        if("[D]Edit/Hapus Surat Pemesanan Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Edit/Hapus Surat Pemesanan Medis",edit_hapus_spo_medis,"edit_hapus_spo_medis"});
        }
    }

    private void setTampilE() {
        if("[E]Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Barang Non Medis",ipsrs_barang,"ipsrs_barang"});
        }

        if("[E]Pengadaan Barang Nonmedis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Pengadaan Barang Nonmedis",ipsrs_pengadaan_barang,"ipsrs_pengadaan_barang"});
        }

        if("[E]Stok Keluar Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Stok Keluar Non Medis",ipsrs_stok_keluar,"ipsrs_stok_keluar"});
        }

        if("[E]Rekap Pengadaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Rekap Pengadaan Non Medis",ipsrs_rekap_pengadaan,"ipsrs_rekap_pengadaan"});
        }

        if("[E]Rekap Stok Keluar Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Rekap Stok Keluar Non Medis",ipsrs_rekap_stok_keluar,"ipsrs_rekap_stok_keluar"});
        }

        if("[E]Biaya Pengadaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Biaya Pengadaan Non Medis",ipsrs_pengeluaran_harian,"ipsrs_pengeluaran_harian"});
        }

        if("[E]Jenis Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Jenis Barang Non Medis",ipsrs_jenis_barang,"ipsrs_jenis_barang"});
        }

        if("[E]Pengambilan UTD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Pengambilan UTD",pengambilan_penunjang_utd,"pengambilan_penunjang_utd"});
        }

        if("[E]Suplier Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Suplier Non Medis",suplier_penunjang,"suplier_penunjang"});
        }

        if("[E]Pengadaan Non Medis Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Pengadaan Non Medis Per Tanggal",ipsrs_pengadaan_pertanggal,"ipsrs_pengadaan_pertanggal"});
        }

        if("[E]Stok Keluar Non Medis Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Stok Keluar Non Medis Per Tanggal",ipsrs_stokkeluar_pertanggal,"ipsrs_stokkeluar_pertanggal"});
        }

        if("[E]Permintaan Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Permintaan Barang Non Medis",permintaan_non_medis,"permintaan_non_medis"});
        }

        if("[E]Ringkasan Permintaan Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Permintaan Barang Non Medis",rekap_permintaan_non_medis,"rekap_permintaan_non_medis"});
        }

        if("[E]Surat Pemesanan Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Surat Pemesanan Barang Non Medis",surat_pemesanan_non_medis,"surat_pemesanan_non_medis"});
        }

        if("[E]Penerimaan Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Penerimaan Barang Non Medis",penerimaan_non_medis,"penerimaan_non_medis"});
        }

        if("[E]Rekap Penerimaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Rekap Penerimaan Non Medis",rekap_pemesanan_non_medis,"rekap_pemesanan_non_medis"});
        }

        if("[E]Stok Opname Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Stok Opname Non Medis",stok_opname_logistik,"stok_opname_logistik"});
        }

        if("[E]Sirkulasi Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Sirkulasi Non Medis",sirkulasi_non_medis,"sirkulasi_non_medis"});
        }

        if("[E]Pengajuan Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Pengajuan Barang Non Medis",pengajuan_barang_nonmedis,"pengajuan_barang_nonmedis"});
        }

        if("[E]Sirkulasi Non Medis 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Sirkulasi Non Medis 2",sirkulasi_non_medis,"sirkulasi_non_medis"});
        }

        if("[E]Retur Ke Suplier Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Retur Ke Suplier Non Medis",ipsrs_returbeli,"ipsrs_returbeli"});
        }

        if("[E]Riwayat Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Riwayat Barang Non Medis",ipsrs_riwayat_barang,"ipsrs_riwayat_barang"});
        }

        if("[E]Verifikasi Penerimaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Verifikasi Penerimaan Non Medis",verifikasi_penerimaan_logistik,"verifikasi_penerimaan_logistik"});
        }

        if("[E]Ringkasan Pengajuan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Pengajuan Non Medis",ringkasan_pengajuan_nonmedis,"ringkasan_pengajuan_nonmedis"});
        }

        if("[E]Ringkasan Pemesanan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Pemesanan Non Medis",ringkasan_pemesanan_nonmedis,"ringkasan_pemesanan_nonmedis"});
        }

        if("[E]Ringkasan Pengadaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Pengadaan Non Medis",ringkasan_pengadaan_nonmedis,"ringkasan_pengadaan_nonmedis"});
        }

        if("[E]Ringkasan Penerimaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Penerimaan Non Medis",ringkasan_penerimaan_nonmedis,"ringkasan_penerimaan_nonmedis"});
        }

        if("[E]Ringkasan Stok Keluar Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Stok Keluar Non Medis",ringkasan_stokkeluar_nonmedis,"ringkasan_stokkeluar_nonmedis"});
        }

        if("[E]Ringkasan Retur Suplier Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Ringkasan Retur Suplier Non Medis",ringkasan_returbeli_nonmedis,"ringkasan_returbeli_nonmedis"});
        }

        if("[E]Hibah Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Hibah Non Medis",hibah_non_medis,"hibah_non_medis"});
        }

        if("[E]Nilai Penerimaan Vendor Non Medis Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Nilai Penerimaan Vendor Non Medis Per Bulan",nilai_penerimaan_vendor_nonmedis_perbulan,"nilai_penerimaan_vendor_nonmedis_perbulan"});
        }

        if("[E]Edit/Hapus Surat Pemesanan Nonmedis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[E]Edit/Hapus Surat Pemesanan Nonmedis",edit_hapus_spo_nonmedis,"edit_hapus_spo_nonmedis"});
        }
    }

    private void setTampilF() {

        if("[F]Barang Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Barang Dapur",dapur_barang,"dapur_barang"});
        }

        if("[F]Stok Opname Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Stok Opname Dapur",dapur_opname,"dapur_opname"});
        }

        if("[F]Suplier Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Suplier Dapur",dapur_suplier,"dapur_suplier"});
        }

        if("[F]Pengadaan Barang Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Pengadaan Barang Dapur",dapur_pembelian,"dapur_pembelian"});
        }

        if("[F]Stok Keluar Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Stok Keluar Dapur",dapur_stok_keluar,"dapur_stok_keluar"});
        }

        if("[F]Riwayat Barang Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Riwayat Barang Dapur",dapur_riwayat_barang,"dapur_riwayat_barang"});
        }

        if("[F]Permintaan Barang Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Permintaan Barang Dapur",permintaan_dapur,"permintaan_dapur"});
        }

        if("[F]Biaya Pengadaan Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Biaya Pengadaan Dapur",biaya_pengadaan_dapur,"biaya_pengadaan_dapur"});
        }

        if("[F]Rekap Pengadaan Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Rekap Pengadaan Dapur",rekap_pengadaan_dapur,"rekap_pengadaan_dapur"});
        }

        if("[F]Ringkasan Pengadaan Barang Dapur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[F]Ringkasan Pengadaan Barang Dapur",dapur_ringkasan_pembelian,"dapur_ringkasan_pembelian"});
        }
    }

    private void setTampilG() {
        if("[G]Jenis Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Jenis Inventaris",inventaris_jenis,"inventaris_jenis"});
        }

        if("[G]Kategori Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Kategori Inventaris",inventaris_kategori,"inventaris_kategori"});
        }

        if("[G]Merk Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Merk Inventaris",inventaris_merk,"inventaris_merk"});
        }

        if("[G]Ruang Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Ruang Inventaris",inventaris_ruang,"inventaris_ruang"});
        }

        if("[G]Produsen Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Produsen Inventaris",inventaris_produsen,"inventaris_produsen"});
        }

        if("[G]Koleksi Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Koleksi Inventaris",inventaris_koleksi,"inventaris_koleksi"});
        }

        if("[G]Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Inventaris",inventaris_inventaris,"inventaris_inventaris"});
        }

        if("[G]Sirkulasi Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Sirkulasi Inventaris",inventaris_sirkulasi,"inventaris_sirkulasi"});
        }

        if("[G]Barang CSSD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Barang CSSD",barang_cssd,"barang_cssd"});
        }

        if("[G]Pemakaian Air PDAM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pemakaian Air PDAM",pemakaian_air_pdam,"pemakaian_air_pdam"});
        }

        if("[G]Limbah Padat B3 Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Limbah Padat B3 Medis",limbah_b3_medis,"limbah_b3_medis"});
        }

        if("[G]Limbah Padat Domestik".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Limbah Padat Domestik",limbah_domestik,"limbah_domestik"});
        }

        if("[G]Mutu Air Limbah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Mutu Air Limbah",mutu_air_limbah,"mutu_air_limbah"});
        }

        if("[G]Pest Control".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pest Control",pest_control,"pest_control"});
        }

        if("[G]Pengajuan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pengajuan Aset/Inventaris",pengajuan_asetinventaris,"pengajuan_asetinventaris"});
        }

        if("[G]Rekap Pengajuan Aset Departemen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Rekap Pengajuan Aset Departemen",rekap_pengajuan_aset_departemen,"rekap_pengajuan_aset_departemen"});
        }

        if("[G]Permintaan Perbaikan Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Permintaan Perbaikan Inventaris",permintaan_perbaikan_inventaris,"permintaan_perbaikan_inventaris"});
        }

        if("[G]Asal Hibah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Asal Hibah",asal_hibah,"asal_hibah"});
        }

        if("[G]Pemakaian Air Tanah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pemakaian Air Tanah",pemakaian_air_tanah,"pemakaian_air_tanah"});
        }

        if("[G]Perbaikan Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Perbaikan Inventaris",perbaikan_inventaris,"perbaikan_inventaris"});
        }

        if("[G]Pemeliharaan Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pemeliharaan Inventaris",pemeliharaan_inventaris,"pemeliharaan_inventaris"});
        }

        if("[G]Pengadaan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pengadaan Aset/Inventaris",pengadaan_aset_inventaris,"pengadaan_aset_inventaris"});
        }

        if("[G]Suplier Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Suplier Aset/Inventaris",suplier_inventaris,"suplier_inventaris"});
        }

        if("[G]Penerimaan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Penerimaan Aset/Inventaris",penerimaan_aset_inventaris,"penerimaan_aset_inventaris"});
        }

        if("[G]Hibah Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Hibah Aset/Inventaris",hibah_aset_inventaris,"hibah_aset_inventaris"});
        }

        if("[G]Pemeliharaan Gedung".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Pemeliharaan Gedung",pemeliharaan_gedung,"pemeliharaan_gedung"});
        }

        if("[G]Limbah Cair B3 Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[G]Limbah Cair B3 Medis",kesling_limbah_b3medis_cair,"kesling_limbah_b3medis_cair"});
        }
    }

    private void setTampilH() {
        if("[H]Jenis Parkir".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[H]Jenis Parkir",parkir_jenis,"parkir_jenis"});
        }

        if("[H]Parkir Masuk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[H]Parkir Masuk",parkir_in,"parkir_in"});
        }

        if("[H]Parkir Keluar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[H]Parkir Keluar",parkir_out,"parkir_out"});
        }

        if("[H]Rekap Parkir Harian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[H]Rekap Parkir Harian",parkir_rekap_harian,"parkir_rekap_harian"});
        }

        if("[H]Rekap Parkir Bulanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[H]Rekap Parkir Bulanan",parkir_rekap_bulanan,"parkir_rekap_bulanan"});
        }

        if("[H]Barcode Parkir".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[H]Barcode Parkir",parkir_barcode,"parkir_barcode"});
        }
    }

    private void setTampilI() {
        if("[I]Harian Dokter Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian Dokter Poli",harian_tindakan_poli,"harian_tindakan_poli"});
        }

        if("[I]Obat Per Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Obat Per Poli",obat_per_poli,"obat_per_poli"});
        }

        if("[I]Obat Per Kamar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Obat Per Kamar",obat_per_kamar,"obat_per_kamar"});
        }

        if("[I]Obat Per Dokter Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Obat Per Dokter Ralan",obat_per_dokter_ralan,"obat_per_dokter_ralan"});
        }

        if("[I]Obat Per Dokter Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Obat Per Dokter Ranap",obat_per_dokter_ranap,"obat_per_dokter_ranap"});
        }

        if("[I]Harian Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian Dokter",harian_dokter,"harian_dokter"});
        }

        if("[I]Bulanan Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Bulanan Dokter",bulanan_dokter,"bulanan_dokter"});
        }

        if("[I]Harian Paramedis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian Paramedis",harian_paramedis,"harian_paramedis"});
        }

        if("[I]Bulanan Paramedis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Bulanan Paramedis",bulanan_paramedis,"bulanan_paramedis"});
        }

        if("[I]Pembayaran Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Ralan",pembayaran_ralan,"pembayaran_ralan"});
        }

        if("[I]Pembayaran Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Ranap",pembayaran_ranap,"pembayaran_ranap"});
        }

        if("[I]Rekap Pembayaran Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap Pembayaran Ralan",rekap_pembayaran_ralan,"rekap_pembayaran_ralan"});
        }

        if("[I]Rekap Pembayaran Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap Pembayaran Ranap",rekap_pembayaran_ranap,"rekap_pembayaran_ranap"});
        }

        if("[I]Tagihan Masuk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Tagihan Masuk",tagihan_masuk,"tagihan_masuk"});
        }

        if("[I]Tambahan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Tambahan Biaya",tambahan_biaya,"tambahan_biaya"});
        }

        if("[I]Potongan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Potongan Biaya",potongan_biaya,"potongan_biaya"});
        }

        if("[I]Detail JM Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Detail JM Dokter",jm_ranap_dokter,"jm_ranap_dokter"});
        }

        if("[I]Harian Dokter Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian Dokter Ralan",harian_tindakan_dokter,"harian_tindakan_dokter"});
        }

        if("[I]Fee Visit Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Fee Visit Dokter",fee_visit_dokter,"fee_visit_dokter"});
        }

        if("[I]Fee Bacaan EKG".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Fee Bacaan EKG",fee_bacaan_ekg,"fee_bacaan_ekg"});
        }

        if("[I]Fee Rujukan Rontgen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Fee Rujukan Rontgen",fee_rujukan_rontgen,"fee_rujukan_rontgen"});
        }

        if("[I]Fee Rujukan Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Fee Rujukan Ranap",fee_rujukan_ranap,"fee_rujukan_ranap"});
        }

        if("[I]Fee Periksa Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Fee Periksa Ralan",fee_ralan,"fee_ralan"});
        }

        if("[I]Obat Per Dokter Peresep".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Obat Per Dokter Peresep",obat_per_dokter_peresep,"obat_per_dokter_peresep"});
        }

        if("[I]Rekap Per Shift".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap Per Shift",rekap_per_shift,"rekap_per_shift"});
        }

        if("[I]Obat Per Cara Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Obat Per Cara Bayar",obat_per_cara_bayar,"obat_per_cara_bayar"});
        }

        if("[I]Payment Point".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Payment Point",payment_point,"payment_point"});
        }

        if("[I]Harian J.S.".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian J.S.",harian_js,"harian_js"});
        }

        if("[I]Bulanan J.S.".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Bulanan J.S.",bulanan_js,"bulanan_js"});
        }

        if("[I]Harian BHP Medis/Paket Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian BHP Medis/Paket Obat",harian_paket_bhp,"harian_paket_bhp"});
        }

        if("[I]Bulanan BHP Medis/Paket Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Bulanan BHP Medis/Paket Obat",bulanan_paket_bhp,"bulanan_paket_bhp"});
        }

        if("[I]Harian Kamar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian Kamar",harian_kamar,"harian_kamar"});
        }

        if("[I]Harian KSO".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian KSO",harian_kso,"harian_kso"});
        }

        if("[I]Bulanan KSO".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Bulanan KSO",bulanan_kso,"bulanan_kso"});
        }

        if("[I]Harian Menejemen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Harian Menejemen",harian_menejemen,"harian_menejemen"});
        }

        if("[I]Bulanan Menejemen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Bulanan Menejemen",bulanan_menejemen,"bulanan_menejemen"});
        }

        if("[I]Piutang Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Piutang Ralan",piutang_ralan,"piutang_ralan"});
        }

        if("[I]Piutang Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Piutang Ranap",piutang_ranap,"piutang_ranap"});
        }

        if("[I]Detail Tindakan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Detail Tindakan",detail_tindakan,"detail_tindakan"});
        }

        if("[I]Rekap Poli Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap Poli Anak",rekap_poli_anak,"rekap_poli_anak"});
        }

        if("[I]Pembayaran Per Unit".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Per Unit",pembayaran_per_unit,"pembayaran_per_unit"});
        }

        if("[I]Rekap Pembayaran Per Unit".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap Pembayaran Per Unit",rekap_pembayaran_per_unit,"rekap_pembayaran_per_unit"});
        }

        if("[I]Detail VK/OK".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Detail VK/OK",detail_tindakan_okvk,"detail_tindakan_okvk"});
        }

        if("[I]Detail JM Dokter 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Detail JM Dokter 2",detailjmdokter2,"detailjmdokter2"});
        }

        if("[I]Pembayaran Per Akun Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Per Akun Bayar",pembayaran_akun_bayar,"pembayaran_akun_bayar"});
        }

        if("[I]Piutang Per Akun Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Piutang Per Akun Piutang",piutang_akun_piutang,"piutang_akun_piutang"});
        }

        if("[I]Payment Point 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Payment Point 2",payment_point2,"payment_point2"});
        }

        if("[I]Pembayaran Per Akun Bayar 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Per Akun Bayar 2",pembayaran_akun_bayar2,"pembayaran_akun_bayar2"});
        }

        if("[I]Hapus Nota Salah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Hapus Nota Salah",hapus_nota_salah,"hapus_nota_salah"});
        }

        if("[I]Pembayaran Per Akun Bayar 3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Per Akun Bayar 3",pembayaran_akun_bayar3,"pembayaran_akun_bayar3"});
        }

        if("[I]Ringkasan Tindakan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Ringkasan Tindakan",ringkasan_tindakan,"ringkasan_tindakan"});
        }

        if("[I]Pembayaran Per Akun Bayar 4".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Per Akun Bayar 4",pembayaran_akun_bayar4,"pembayaran_akun_bayar4"});
        }

        if("[I]Pembayaran Per Akun Bayar 5".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Pembayaran Per Akun Bayar 5",pembayaran_akun_bayar5,"pembayaran_akun_bayar5"});
        }

        if("[I]Jasa Tindakan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Jasa Tindakan Pasien",jasa_tindakan_pasien,"jasa_tindakan_pasien"});
        }

        if("[I]Rekap JM Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap JM Dokter",rekap_jm_dokter,"rekap_jm_dokter"});
        }

        if("[I]Rekap Biaya Registrasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[I]Rekap Biaya Registrasi",rekap_biaya_registrasi,"rekap_biaya_registrasi"});
        }
    }

    private void setTampilJ() {
        if("[J]ICD 10".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]ICD 10",penyakit,"penyakit"});
        }

        if("[J]Obat Penyakit".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Obat Penyakit",obat_penyakit,"obat_penyakit"});
        }

        if("[J]Frekuensi Penyakit Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Frekuensi Penyakit Ralan",penyakit_ralan,"penyakit_ralan"});
        }

        if("[J]Frekuensi Penyakit Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Frekuensi Penyakit Ranap",penyakit_ranap,"penyakit_ranap"});
        }

        if("[J]Penyakit AFP & PD3I".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Penyakit AFP & PD3I",penyakit_pd3i,"penyakit_pd3i"});
        }

        if("[J]Surveilans AFP & PD3I".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Surveilans AFP & PD3I",surveilans_pd3i,"surveilans_pd3i"});
        }

        if("[J]Surveilans Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Surveilans Ralan",surveilans_ralan,"surveilans_ralan"});
        }

        if("[J]Surveilans Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Surveilans Ranap",surveilans_ranap,"surveilans_ranap"});
        }

        if("[J]Pny.Tdk Menular Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Pny.Tdk Menular Ranap",pny_takmenular_ranap,"pny_takmenular_ranap"});
        }

        if("[J]Pny.Tdk Menular Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Pny.Tdk Menular Ralan",pny_takmenular_ralan,"pny_takmenular_ralan"});
        }

        if("[J]Kunjungan Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kunjungan Ralan",kunjungan_ralan,"kunjungan_ralan"});
        }

        if("[J]RL 3.2 Rawat Darurat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 3.2 Rawat Darurat",rl32,"rl32"});
        }

        if("[J]RL 3.3 Gigi dan Mulut".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 3.3 Gigi dan Mulut",rl33,"rl33"});
        }

        if("[J]RL 3.7 Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 3.7 Radiologi",rl37,"rl37"});
        }

        if("[J]RL 3.8 Laboratorium".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 3.8 Laboratorium",rl38,"rl38"});
        }

        if("[J]RL 3.4 Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 3.4 Kebidanan",rl34,"rl34"});
        }

        if("[J]RL 3.6 Pembedahan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 3.6 Pembedahan",rl36,"rl36"});
        }

        if("[J]Kunjungan Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kunjungan Ranap",kunjungan_ranap,"kunjungan_ranap"});
        }

        if("[J]ICD 9".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]ICD 9",icd9,"icd9"});
        }

        if("[J]Sensus Harian Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Sensus Harian Poli",sensus_harian_poli,"sensus_harian_poli"});
        }

        if("[J]RL 4A Sebab Morbiditas Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 4A Sebab Morbiditas Ranap",rl4a,"rl4a"});
        }

        if("[J]RL 4B Sebab Morbiditas Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 4B Sebab Morbiditas Ralan",rl4b,"rl4b"});
        }

        if("[J]RL 4A Morbiditas Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 4A Morbiditas Ralan",rl4asebab,"rl4asebab"});
        }

        if("[J]RL 4B Morbiditas Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]RL 4B Morbiditas Ralan",rl4bsebab,"rl4bsebab"});
        }

        if("[J]Lama Pelayanan Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Pelayanan Ralan",lama_pelayanan_ralan,"lama_pelayanan_ralan"});
        }

        if("[J]Harian HAIs".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Harian HAIs",harian_HAIs,"harian_HAIs"});
        }

        if("[J]Bulanan HAIs".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Bulanan HAIs",bulanan_HAIs,"bulanan_HAIs"});
        }

        if("[J]HAIs Per Kamar/Bangsal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]HAIs Per Kamar/Bangsal",hais_perbangsal,"hais_perbangsal"});
        }

        if("[J]Hitung BOR".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Hitung BOR",hitung_bor,"hitung_bor"});
        }

        if("[J]Lama Pelayanan Apotek".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Pelayanan Apotek",lama_pelayanan_apotek,"lama_pelayanan_apotek"});
        }

        if("[J]Hitung ALOS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Hitung ALOS",hitung_alos,"hitung_alos"});
        }

        if("[J]Pny Menular Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Pny Menular Ranap",penyakit_menular_ranap,"penyakit_menular_ranap"});
        }

        if("[J]Pny Menular Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Pny Menular Ralan",penyakit_menular_ralan,"penyakit_menular_ralan"});
        }

        if("[J]Pembatalan Periksa Per Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Pembatalan Periksa Per Dokter",pembatalan_periksa_dokter,"pembatalan_periksa_dokter"});
        }

        if("[J]Cek Entry Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Cek Entry Ralan",cek_entry_ralan,"cek_entry_ralan"});
        }

        if("[J]Sensus Harian Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Sensus Harian Ralan",sensus_harian_ralan,"sensus_harian_ralan"});
        }

        if("[J]Insiden Keselamatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Insiden Keselamatan",insiden_keselamatan,"insiden_keselamatan"});
        }

        if("[J]Ranap Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Ranap Per Ruang",ranap_per_ruang,"ranap_per_ruang"});
        }

        if("[J]Penyakit Ranap Per Cara Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Penyakit Ranap Per Cara Bayar",penyakit_ranap_cara_bayar,"penyakit_ranap_cara_bayar"});
        }

        if("[J]Anggota TNI Dirawat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Anggota TNI Dirawat",anggota_militer_dirawat,"anggota_militer_dirawat"});
        }

        if("[J]Lama Pelayanan Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Pelayanan Radiologi",lama_pelayanan_radiologi,"lama_pelayanan_radiologi"});
        }

        if("[J]Lama Pelayanan Lab".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Pelayanan Lab",lama_pelayanan_lab,"lama_pelayanan_lab"});
        }

        if("[J]Rekap Lab Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Lab Per Tahun",rekap_lab_pertahun,"rekap_lab_pertahun"});
        }

        if("[J]Perujuk Lab Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Perujuk Lab Per Tahun",perujuk_lab_pertahun,"perujuk_lab_pertahun"});
        }

        if("[J]Rekap Radiologi Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Radiologi Per Tahun",rekap_radiologi_pertahun,"rekap_radiologi_pertahun"});
        }

        if("[J]Perujuk Radiologi Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Perujuk Radiologi Per Tahun",perujuk_radiologi_pertahun,"perujuk_radiologi_pertahun"});
        }

        if("[J]Rekap Bulanan Porsi Diet".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Bulanan Porsi Diet",jumlah_porsi_diet,"jumlah_porsi_diet"});
        }

        if("[J]Rekap Bulanan Macam Diet".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Bulanan Macam Diet",jumlah_macam_diet,"jumlah_macam_diet"});
        }

        if("[J]Kunjungan Lab Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kunjungan Lab Ralan",kunjungan_permintaan_lab,"kunjungan_permintaan_lab"});
        }

        if("[J]Kunjungan Lab Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kunjungan Lab Ranap",kunjungan_permintaan_lab2,"kunjungan_permintaan_lab2"});
        }

        if("[J]Kunjungan Radiologi Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kunjungan Radiologi Ralan",kunjungan_permintaan_radiologi,"kunjungan_permintaan_radiologi"});
        }

        if("[J]Kunjungan Radiologi Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kunjungan Radiologi Ranap",kunjungan_permintaan_radiologi2,"kunjungan_permintaan_radiologi2"});
        }

        if("[J]Data TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Data TB",kemenkes_sitt,"kemenkes_sitt"});
        }

        if("[J]Rekap Mutasi Berkas".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Mutasi Berkas",rekap_mutasi_berkas,"rekap_mutasi_berkas"});
        }

        if("[J]Skrining Pernapasan Ralan Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Skrining Pernapasan Ralan Per Tahun",skrining_ralan_pernapasan_pertahun,"skrining_ralan_pernapasan_pertahun"});
        }

        if("[J]Masuk Ruang Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Masuk Ruang Per Tahun",kunjungan_bangsal_pertahun,"kunjungan_bangsal_pertahun"});
        }

        if("[J]KIP Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]KIP Pasien Ranap",kip_pasien_ranap,"kip_pasien_ranap"});
        }

        if("[J]KIP Pasien Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]KIP Pasien Ralan",kip_pasien_ralan,"kip_pasien_ralan"});
        }

        if("[J]Rekap Permintaan Diet".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Permintaan Diet",rekap_permintaan_diet,"rekap_permintaan_diet"});
        }

        if("[J]Daftar Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Daftar Pasien Ranap",daftar_pasien_ranap,"daftar_pasien_ranap"});
        }

        if("[J]Daftar Pasien Ranap TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Daftar Pasien Ranap TNI",daftar_pasien_ranaptni,"daftar_pasien_ranaptni"});
        }

        if("[J]Harian HAIs 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Harian HAIs 2",harian_HAIs2,"harian_HAIs2"});
        }

        if("[J]Rekap Kunjungan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Rekap Kunjungan",rekap_kunjungan,"rekap_kunjungan"});
        }

        if("[J]Kedatangan Pasien Per Jam".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Kedatangan Pasien Per Jam",kedatangan_pasien,"kedatangan_pasien"});
        }

        if("[J]Registrasi Poli Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Registrasi Poli Per Tanggal",registrasi_poli_per_tanggal,"registrasi_poli_per_tanggal"});
        }

        if("[J]Lama Pelayanan Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Pelayanan Poli",lama_pelayanan_poli,"lama_pelayanan_poli"});
        }

        if("[J]Laporan Tahunan IRJ".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Laporan Tahunan IRJ",laporan_tahunan_irj,"laporan_tahunan_irj"});
        }

        if("[J]Bulanan Klasifikasi Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Bulanan Klasifikasi Pasien Ranap",bulanan_klasifikasi_pasien_ranap,"bulanan_klasifikasi_pasien_ranap"});
        }

        if("[J]Harian Klasifikasi Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Harian Klasifikasi Pasien Ranap",harian_klasifikasi_pasien_ranap,"harian_klasifikasi_pasien_ranap"});
        }

        if("[J]Klasifikasi Pasien Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Klasifikasi Pasien Per Ruang",klasifikasi_pasien_perbangsal,"klasifikasi_pasien_perbangsal"});
        }

        if("[J]Lama Penyiapan RM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Penyiapan RM",lama_penyiapan_rm,"lama_penyiapan_rm"});
        }

        if("[J]Dosis Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Dosis Radiologi",dosis_radiologi,"dosis_radiologi"});
        }

        if("[J]Demografi Umur Kunjungan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Demografi Umur Kunjungan",demografi_umur_kunjungan,"demografi_umur_kunjungan"});
        }

        if("[J]Lama Pelayanan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Pelayanan Pasien",lama_pelayanan_pasien,"lama_pelayanan_pasien"});
        }

        if("[J]Lama Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Lama Operasi",lama_operasi,"lama_operasi"});
        }

        if("[J]Status Data RM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Status Data RM",status_data_rm,"status_data_rm"});
        }

        if("[J]Laporan Tahunan IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Laporan Tahunan IGD",laporan_tahunan_igd,"laporan_tahunan_igd"});
        }

        if("[J]Anggota POLRI Dirawat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Anggota POLRI Dirawat",anggota_polri_dirawat,"anggota_polri_dirawat"});
        }

        if("[J]Daftar Pasien Ranap POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Daftar Pasien Ranap POLRI",daftar_pasien_ranap_polri,"daftar_pasien_ranap_polri"});
        }

        if("[J]Laporan Penyakit POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Laporan Penyakit POLRI",laporan_penyakit_polri,"laporan_penyakit_polri"});
        }

        if("[J]Jumlah Pengunjung Ralan POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Jumlah Pengunjung Ralan POLRI",jumlah_pengunjung_ralan_polri,"jumlah_pengunjung_ralan_polri"});
        }

        if("[J]Jumlah Pengunjung Ralan TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Jumlah Pengunjung Ralan TNI",jumlah_pengunjung_ralan_tni,"jumlah_pengunjung_ralan_tni"});
        }

        if("[J]Laporan Penyakit TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Laporan Penyakit TNI",laporan_penyakit_tni,"laporan_penyakit_tni"});
        }

        if("[J]Laporan Bulanan IRJ".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Laporan Bulanan IRJ",laporan_bulanan_irj,"laporan_bulanan_irj"});
        }

        if("[J]Operasi Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Operasi Per Bulan",operasi_per_bulan,"operasi_per_bulan"});
        }

        if("[J]Sisa Diet Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Sisa Diet Pasien",sisa_diet_pasien,"sisa_diet_pasien"});
        }

        if("[J]Laporan Tahunan Penolakan Anjuran Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Laporan Tahunan Penolakan Anjuran Medis",laporan_tahunan_penolakan_anjuran_medis,"laporan_tahunan_penolakan_anjuran_medis"});
        }

        if("[J]Pemeriksaan Fisik Ralan Per Penyakit".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[J]Pemeriksaan Fisik Ralan Per Penyakit",pemeriksaan_fisik_ralan_per_penyakit,"pemeriksaan_fisik_ralan_per_penyakit"});
        }
    }

    private void setTampilK() {
        if("[K]Deposit Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Deposit Pasien",deposit_pasien,"deposit_pasien"});
        }

        if("[K]Piutang Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Piutang Pasien",piutang_pasien,"piutang_pasien"});
        }

        if("[K]Kamar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Kamar",kamar,"kamar"});
        }

        if("[K]Tarif Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Tarif Ralan",tarif_ralan,"tarif_ralan"});
        }

        if("[K]Tarif Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Tarif Ranap",tarif_ranap,"tarif_ranap"});
        }

        if("[K]Tarif Lab".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Tarif Lab",tarif_lab,"tarif_lab"});
        }

        if("[K]Tarif Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Tarif Radiologi",tarif_radiologi,"tarif_radiologi"});
        }

        if("[K]Tarif Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Tarif Operasi",tarif_operasi,"tarif_operasi"});
        }

        if("[K]Akun Rekening".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Akun Rekening",akun_rekening,"akun_rekening"});
        }

        if("[K]Rekening Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Rekening Tahun",rekening_tahun,"rekening_tahun"});
        }

        if("[K]Posting Jurnal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Posting Jurnal",posting_jurnal,"posting_jurnal"});
        }

        if("[K]Buku Besar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Buku Besar",buku_besar,"buku_besar"});
        }

        if("[K]Cash Flow".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Cash Flow",cashflow,"cashflow"});
        }

        if("[K]Keuangan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Keuangan",keuangan,"keuangan"});
        }

        if("[K]Pengeluaran Harian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pengeluaran Harian",pengeluaran,"pengeluaran"});
        }

        if("[K]Akun Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Akun Bayar",akun_bayar,"akun_bayar"});
        }

        if("[K]Bayar Pesan Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Bayar Pesan Obat",bayar_pemesanan_obat,"bayar_pemesanan_obat"});
        }

        if("[K]Pemasukkan Lain-Lain".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pemasukkan Lain-Lain",pemasukan_lain,"pemasukan_lain"});
        }

        if("[K]Pengaturan Rekening".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pengaturan Rekening",pengaturan_rekening,"pengaturan_rekening"});
        }

        if("[K]Bayar Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Bayar Piutang",bayar_piutang,"bayar_piutang"});
        }

        if("[K]Jurnal Harian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Jurnal Harian",jurnal_harian,"jurnal_harian"});
        }

        if("[K]Piutang Belum Lunas".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Piutang Belum Lunas",piutang_pasien2,"piutang_pasien2"});
        }

        if("[K]Tarif UTD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Tarif UTD",tarif_utd,"tarif_utd"});
        }

        if("[K]Rincian Piutang Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Rincian Piutang Pasien",rincian_piutang_pasien,"rincian_piutang_pasien"});
        }

        if("[K]Hutang Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Hutang Obat & BHP",hutang_obat,"hutang_obat"});
        }

        if("[K]Akun Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Akun Piutang",akun_piutang,"akun_piutang"});
        }

        if("[K]Piutang Per Cara Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Piutang Per Cara Bayar",detail_piutang_penjab,"detail_piutang_penjab"});
        }

        if("[K]Bayar Pesan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Bayar Pesan Non Medis",bayar_pesan_non_medis,"bayar_pesan_non_medis"});
        }

        if("[K]Bayar Pesan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Bayar Pesan Aset/Inventaris",bayar_pemesanan_iventaris,"bayar_pemesanan_iventaris"});
        }

        if("[K]Hutang Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Hutang Barang Non Medis",hutang_barang_non_medis,"hutang_barang_non_medis"});
        }

        if("[K]Saldo Akun Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Saldo Akun Per Bulan",saldo_akun_perbulan,"saldo_akun_perbulan"});
        }

        if("[K]Penagihan Piutang Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Penagihan Piutang Pasien",penagihan_piutang_pasien,"penagihan_piutang_pasien"});
        }

        if("[K]Akun Penagihan Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Akun Penagihan Piutang",akun_penagihan_piutang,"akun_penagihan_piutang"});
        }

        if("[K]Set Tarif Online".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Set Tarif Online",set_tarif_online,"set_tarif_online"});
        }

        if("[K]Klaim Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Klaim Rawat Jalan",klaim_rawat_jalan,"klaim_rawat_jalan"});
        }

        if("[K]RVP Piutang BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]RVP Piutang BPJS",rvu_bpjs,"rvu_bpjs"});
        }

        if("[K]Penerimaan/Omset/Kas Masuk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Penerimaan/Omset/Kas Masuk",omset_penerimaan,"omset_penerimaan"});
        }

        if("[K]Validasi Penagihan Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Validasi Penagihan Piutang",validasi_penagihan_piutang,"validasi_penagihan_piutang"});
        }

        if("[K]Pendapatan Per Cara Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pendapatan Per Cara Bayar",pendapatan_per_carabayar,"pendapatan_per_carabayar"});
        }

        if("[K]Pembayaran Bank Jateng".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pembayaran Bank Jateng",pembayaran_bank_jateng,"pembayaran_bank_jateng"});
        }

        if("[K]Titip Faktur/Tagihan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Titip Faktur/Tagihan Obat & BHP",tagihan_hutang_obat,"tagihan_hutang_obat"});
        }

        if("[K]Pengembalian Deposit Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pengembalian Deposit Pasien",pengembalian_deposit_pasien,"pengembalian_deposit_pasien"});
        }

        if("[K]Validasi Titip Faktur/Tagihan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Validasi Titip Faktur/Tagihan Obat & BHP",validasi_tagihan_hutang_obat,"validasi_tagihan_hutang_obat"});
        }

        if("[K]Piutang Obat & BHP Belum Lunas".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Piutang Obat & BHP Belum Lunas",piutang_obat_belum_lunas,"piutang_obat_belum_lunas"});
        }

        if("[K]Akun Jenis Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Akun Jenis Aset/Inventaris",akun_aset_inventaris,"akun_aset_inventaris"});
        }

        if("[K]Hutang Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Hutang Aset/Inventaris",hutang_aset_inventaris,"hutang_aset_inventaris"});
        }

        if("[K]Titip Faktur/Tagihan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Titip Faktur/Tagihan Non Medis",titip_faktur_non_medis,"titip_faktur_non_medis"});
        }

        if("[K]Validasi Titip Faktur/Tagihan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Validasi Titip Faktur/Tagihan Non Medis",validasi_tagihan_non_medis,"validasi_tagihan_non_medis"});
        }

        if("[K]Titip Faktur/Tagihan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Titip Faktur/Tagihan Aset/Inventaris",titip_faktur_aset,"titip_faktur_aset"});
        }

        if("[K]Validasi Titip Faktur/Tagihan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Validasi Titip Faktur/Tagihan Aset/Inventaris",validasi_tagihan_aset,"validasi_tagihan_aset"});
        }

        if("[K]Peminjam Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Peminjam Piutang",peminjam_piutang,"peminjam_piutang"});
        }

        if("[K]Piutang Lain-lain".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Piutang Lain-lain",piutang_lainlain,"piutang_lainlain"});
        }

        if("[K]Bayar Piutang Lain-lain".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Bayar Piutang Lain-lain",bayar_piutang_lain,"bayar_piutang_lain"});
        }

        if("[K]Asuransi/Askes/Jenis Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Asuransi/Askes/Jenis Bayar",cara_bayar,"cara_bayar"});
        }

        if("[K]Kategori Pengeluaran Harian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Kategori Pengeluaran Harian",kategori_pengeluaran_harian,"kategori_pengeluaran_harian"});
        }

        if("[K]Kategori Pemasukan Lain-lain".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Kategori Pemasukan Lain-lain",kategori_pemasukan_lain,"kategori_pemasukan_lain"});
        }

        if("[K]Bayar JM Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Bayar JM Dokter",bayar_jm_dokter,"bayar_jm_dokter"});
        }

        if("[K]Pembayaran BRIVA".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pembayaran BRIVA",pembayaran_briva,"pembayaran_briva"});
        }

        if("[K]Akun Bayar Hutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Akun Bayar Hutang",akun_bayar_hutang,"akun_bayar_hutang"});
        }

        if("[K]Ringkasan Hutang Vendor Farmasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Ringkasan Hutang Vendor Farmasi",ringkasan_hutang_vendor_farmasi,"ringkasan_hutang_vendor_farmasi"});
        }

        if("[K]Ringkasan Hutang Vendor Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Ringkasan Hutang Vendor Non Medis",ringkasan_hutang_vendor_nonmedis,"ringkasan_hutang_vendor_nonmedis"});
        }

        if("[K]Pembayaran Bank Papua".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pembayaran Bank Papua",pembayaran_bank_papua,"pembayaran_bank_papua"});
        }

        if("[K]Pembayaran Bank Jabar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pembayaran Bank Jabar",pembayaran_bank_jabar,"pembayaran_bank_jabar"});
        }

        if("[K]Pengajuan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pengajuan Biaya",pengajuan_biaya,"pengajuan_biaya"});
        }

        if("[K]Persetujuan Pengajuan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Persetujuan Pengajuan Biaya",persetujuan_pengajuan_biaya,"persetujuan_pengajuan_biaya"});
        }

        if("[K]Validasi Persetujuan Pengajuan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Validasi Persetujuan Pengajuan Biaya",validasi_persetujuan_pengajuan_biaya,"validasi_persetujuan_pengajuan_biaya"});
        }

        if("[K]Rekap Pengajuan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Rekap Pengajuan Biaya",rekap_pengajuan_biaya,"rekap_pengajuan_biaya"});
        }

        if("[K]Pembayaran Bank Mandiri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[K]Pembayaran Bank Mandiri",pembayaran_bank_mandiri,"pembayaran_bank_mandiri"});
        }
    }

    private void setTampilL() {
        if("[L]Cek NIK".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek NIK",bpjs_cek_nik,"bpjs_cek_nik"});
        }

        if("[L]Cek No.Kartu".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek No.Kartu",bpjs_cek_kartu,"bpjs_cek_kartu"});
        }

        if("[L]Riwayat Rujukan PCare di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Riwayat Rujukan PCare di VClaim",bpjs_cek_riwayat,"bpjs_cek_riwayat"});
        }

        if("[L]Cek No.Rujukan PCare di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek No.Rujukan PCare di VClaim",bpjs_cek_nomor_rujukan,"bpjs_cek_nomor_rujukan"});
        }

        if("[L]Referensi Diagnosa VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Diagnosa VClaim",bpjs_referensi_diagnosa,"bpjs_referensi_diagnosa"});
        }

        if("[L]Referensi Poli VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Poli VClaim",bpjs_referensi_poli,"bpjs_referensi_poli"});
        }

        if("[L]Referensi Faskes VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Faskes VClaim",bpjs_referensi_faskes,"bpjs_referensi_faskes"});
        }

        if("[L]Data Bridging SEP VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Data Bridging SEP VClaim",bpjs_sep,"bpjs_sep"});
        }

        if("[L]Monitoring Verifikasi Klaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Monitoring Verifikasi Klaim",bpjs_monitoring_klaim,"bpjs_monitoring_klaim"});
        }

        if("[L]Reklasifikasi Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Reklasifikasi Ralan",reklasifikasi_ralan,"reklasifikasi_ralan"});
        }

        if("[L]Reklasifikasi Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Reklasifikasi Ranap",reklasifikasi_ranap,"reklasifikasi_ranap"});
        }

        if("[L]Referensi Kamar Aplicare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Kamar Aplicare",aplicare_referensi_kamar,"aplicare_referensi_kamar"});
        }

        if("[L]Ketersediaan Kamar Aplicare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Ketersediaan Kamar Aplicare",aplicare_ketersediaan_kamar,"aplicare_ketersediaan_kamar"});
        }

        if("[L]Klaim Baru Otomatis INACBG".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Klaim Baru Otomatis INACBG",inacbg_klaim_baru_otomatis,"inacbg_klaim_baru_otomatis"});
        }

        if("[L]Klaim Baru Manual INACBG".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Klaim Baru Manual INACBG",inacbg_klaim_baru_manual,"inacbg_klaim_baru_manual"});
        }

        if("[L]Coder NIK INACBG".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Coder NIK INACBG",inacbg_coder_nik,"inacbg_coder_nik"});
        }

        if("[L]Cek Eligibilitas Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek Eligibilitas Inhealth",inhealth_cek_eligibilitas,"inhealth_cek_eligibilitas"});
        }

        if("[L]Referensi Ruang Rawat Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Ruang Rawat Inhealth",inhealth_referensi_jenpel_ruang_rawat,"inhealth_referensi_jenpel_ruang_rawat"});
        }

        if("[L]Referensi Poli Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Poli Inhealth",inhealth_referensi_poli,"inhealth_referensi_poli"});
        }

        if("[L]Referensi Faskes Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Faskes Inhealth",inhealth_referensi_faskes,"inhealth_referensi_faskes"});
        }

        if("[L]Data Bridging SJP Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Data Bridging SJP Inhealth",inhealth_sjp,"inhealth_sjp"});
        }

        if("[L]Referensi Diagnosa Pcare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Diagnosa Pcare",pcare_cek_penyakit,"pcare_cek_penyakit"});
        }

        if("[L]Referensi Kesadaran Pcare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Kesadaran Pcare",pcare_cek_kesadaran,"pcare_cek_kesadaran"});
        }

        if("[L]Cek Rujukan PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek Rujukan PCare",pcare_cek_rujukan,"pcare_cek_rujukan"});
        }

        if("[L]Klaim Baru Manual INACBG 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Klaim Baru Manual INACBG 2",inacbg_klaim_baru_manual2,"inacbg_klaim_baru_manual2"});
        }

        if("[L]Referensi Prosedur VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Prosedur VClaim",bpjs_cek_prosedur,"bpjs_cek_prosedur"});
        }

        if("[L]Referensi Kelas Rawat VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Kelas Rawat VClaim",bpjs_cek_kelas_rawat,"bpjs_cek_kelas_rawat"});
        }

        if("[L]Referensi Dokter VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Dokter VClaim",bpjs_cek_dokter,"bpjs_cek_dokter"});
        }

        if("[L]Referensi Spesialistik VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Spesialistik VClaim",bpjs_cek_spesialistik,"bpjs_cek_spesialistik"});
        }

        if("[L]Referensi Ruang Rawat VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Ruang Rawat VClaim",bpjs_cek_ruangrawat,"bpjs_cek_ruangrawat"});
        }

        if("[L]Referensi Cara Keluar VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Cara Keluar VClaim",bpjs_cek_carakeluar,"bpjs_cek_carakeluar"});
        }

        if("[L]Referensi Pasca Pulang VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Pasca Pulang VClaim",bpjs_cek_pasca_pulang,"bpjs_cek_pasca_pulang"});
        }

        if("[L]Cek No.Rujukan RS di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek No.Rujukan RS di VClaim",bpjs_cek_nomor_rujukan_rs,"bpjs_cek_nomor_rujukan_rs"});
        }

        if("[L]Cek Rujukan Kartu PCare di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek Rujukan Kartu PCare di VClaim",bpjs_cek_rujukan_kartu_pcare,"bpjs_cek_rujukan_kartu_pcare"});
        }

        if("[L]Cek Rujukan Kartu RS di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek Rujukan Kartu RS di VClaim",bpjs_cek_rujukan_kartu_rs,"bpjs_cek_rujukan_kartu_rs"});
        }

        if("[L]Pembuatan Rujukan VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Pembuatan Rujukan VClaim",bpjs_rujukan_keluar,"bpjs_rujukan_keluar"});
        }

        if("[L]Mapping Poli VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Poli VClaim",mapping_poli_bpjs,"mapping_poli_bpjs"});
        }

        if("[L]Referensi Propinsi VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Propinsi VClaim",bpjs_cek_propinsi,"bpjs_cek_propinsi"});
        }

        if("[L]Referensi Kabupaten VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Kabupaten VClaim",bpjs_cek_kabupaten,"bpjs_cek_kabupaten"});
        }

        if("[L]Referensi Kecamatan VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Kecamatan VClaim",bpjs_cek_kecamatan,"bpjs_cek_kecamatan"});
        }

        if("[L]Referensi Dokter DPJP VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Dokter DPJP VClaim",bpjs_cek_dokterdpjp,"bpjs_cek_dokterdpjp"});
        }

        if("[L]Riwayat Rujukan RS di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Riwayat Rujukan RS di VClaim",bpjs_cek_riwayat_rujukanrs,"bpjs_cek_riwayat_rujukanrs"});
        }

        if("[L]Tanggal Rujukan di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tanggal Rujukan di VClaim",bpjs_cek_tanggal_rujukan,"bpjs_cek_tanggal_rujukan"});
        }

        if("[L]Histori Pelayanan BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Histori Pelayanan BPJS",bpjs_histori_pelayanan,"bpjs_histori_pelayanan"});
        }

        if("[L]Referensi Dokter PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Dokter PCare",pcare_cek_dokter,"pcare_cek_dokter"});
        }

        if("[L]Referensi Poli PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Poli PCare",pcare_cek_poli,"pcare_cek_poli"});
        }

        if("[L]Referensi Provider PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Provider PCare",pcare_cek_provider,"pcare_cek_provider"});
        }

        if("[L]Referensi Stts Pulang PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Stts Pulang PCare",pcare_cek_statuspulang,"pcare_cek_statuspulang"});
        }

        if("[L]Referensi Spesialis PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Spesialis PCare",pcare_cek_spesialis,"pcare_cek_spesialis"});
        }

        if("[L]Referensi Subspesialis PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Subspesialis PCare",pcare_cek_subspesialis,"pcare_cek_subspesialis"});
        }

        if("[L]Referensi Sarana PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Sarana PCare",pcare_cek_sarana,"pcare_cek_sarana"});
        }

        if("[L]Referensi Khusus PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Khusus PCare",pcare_cek_khusus,"pcare_cek_khusus"});
        }

        if("[L]Referensi Obat PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Obat PCare",pcare_cek_obat,"pcare_cek_obat"});
        }

        if("[L]Referensi Tindakan PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Tindakan PCare",pcare_cek_tindakan,"pcare_cek_tindakan"});
        }

        if("[L]Faskes Subspesialis PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Faskes Subspesialis PCare",pcare_cek_faskessubspesialis,"pcare_cek_faskessubspesialis"});
        }

        if("[L]Faskes Alih Rawat PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Faskes Alih Rawat PCare",pcare_cek_faskesalihrawat,"pcare_cek_faskesalihrawat"});
        }

        if("[L]Faskes Thalasemia & Hemofili PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Faskes Thalasemia & Hemofili PCare",pcare_cek_faskesthalasemia,"pcare_cek_faskesthalasemia"});
        }

        if("[L]Mapping Obat PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Obat PCare",pcare_mapping_obat,"pcare_mapping_obat"});
        }

        if("[L]Tarif Ralan RS & PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Ralan RS & PCare",pcare_mapping_tindakan,"pcare_mapping_tindakan"});
        }

        if("[L]Club Prolanis PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Club Prolanis PCare",pcare_club_prolanis,"pcare_club_prolanis"});
        }

        if("[L]Mapping Poli PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Poli PCare",pcare_mapping_poli,"pcare_mapping_poli"});
        }

        if("[L]Kegiatan Kelompok PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kegiatan Kelompok PCare",pcare_kegiatan_kelompok,"pcare_kegiatan_kelompok"});
        }

        if("[L]Tarif Ranap RS & PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Ranap RS & PCare",pcare_mapping_tindakan_ranap,"pcare_mapping_tindakan_ranap"});
        }

        if("[L]Peserta Keg Kelompok PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Peserta Keg Kelompok PCare",pcare_peserta_kegiatan_kelompok,"pcare_peserta_kegiatan_kelompok"});
        }

        if("[L]Data Pendafataran PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Data Pendafataran PCare",bridging_pcare_daftar,"bridging_pcare_daftar"});
        }

        if("[L]Mapping Dokter PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Dokter PCare",pcare_mapping_dokter,"pcare_mapping_dokter"});
        }

        if("[L]Cek Nomor SEP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek Nomor SEP",bpjs_cek_sep,"bpjs_cek_sep"});
        }

        if("[L]Referensi Faskes Sisrute".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Faskes Sisrute",sisrute_referensi_faskes,"sisrute_referensi_faskes"});
        }

        if("[L]Referensi Alasan Rujuk Sisrute".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Alasan Rujuk Sisrute",sisrute_referensi_alasanrujuk,"sisrute_referensi_alasanrujuk"});
        }

        if("[L]Referensi Diagnosa Sisrute".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Diagnosa Sisrute",sisrute_referensi_diagnosa,"sisrute_referensi_diagnosa"});
        }

        if("[L]Rujukan Masuk Sisrute".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Rujukan Masuk Sisrute",sisrute_rujukan_masuk,"sisrute_rujukan_masuk"});
        }

        if("[L]Rujukan Keluar Sisrute".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Rujukan Keluar Sisrute",sisrute_rujukan_keluar,"sisrute_rujukan_keluar"});
        }

        if("[L]Cek SKDP VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek SKDP VClaim",bpjs_cek_skdp,"bpjs_cek_skdp"});
        }

        if("[L]Pemberian Obat PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Pemberian Obat PCare",pcare_pemberian_obat,"pcare_pemberian_obat"});
        }

        if("[L]Pemberian Tindakan PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Pemberian Tindakan PCare",pcare_pemberian_tindakan,"pcare_pemberian_tindakan"});
        }

        if("[L]Ketersediaan Kamar SIRANAP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Ketersediaan Kamar SIRANAP",siranap_ketersediaan_kamar,"siranap_ketersediaan_kamar"});
        }

        if("[L]Mapping Dokter DPJP VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Dokter DPJP VClaim",bpjs_mapping_dokterdpjp,"bpjs_mapping_dokterdpjp"});
        }

        if("[L]Mapping Poli Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Poli Inhealth",inhealth_mapping_poli,"inhealth_mapping_poli"});
        }

        if("[L]Mapping Dokter Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Dokter Inhealth",inhealth_mapping_dokter,"inhealth_mapping_dokter"});
        }

        if("[L]Tarif Ralan Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Ralan Inhealth",inhealth_mapping_tindakan_ralan,"inhealth_mapping_tindakan_ralan"});
        }

        if("[L]Tarif Ranap Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Ranap Inhealth",inhealth_mapping_tindakan_ranap,"inhealth_mapping_tindakan_ranap"});
        }

        if("[L]Tarif Radiologi Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Radiologi Inhealth",inhealth_mapping_tindakan_radiologi,"inhealth_mapping_tindakan_radiologi"});
        }

        if("[L]Tarif Laborat Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Laborat Inhealth",inhealth_mapping_tindakan_laborat,"inhealth_mapping_tindakan_laborat"});
        }

        if("[L]Tarif Operasi Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tarif Operasi Inhealth",inhealth_mapping_tindakan_operasi,"inhealth_mapping_tindakan_operasi"});
        }

        if("[L]Tagihan Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Tagihan Inhealth",inhealth_kirim_tagihan,"inhealth_kirim_tagihan"});
        }

        if("[L]Pasien Corona".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Pasien Corona",pasien_corona,"pasien_corona"});
        }

        if("[L]Diagnosa Pasien Corona".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Diagnosa Pasien Corona",diagnosa_pasien_corona,"diagnosa_pasien_corona"});
        }

        if("[L]Perawatan Pasien Corona".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Perawatan Pasien Corona",perawatan_pasien_corona,"perawatan_pasien_corona"});
        }

        if("[L]Cek No.Kartu PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Cek No.Kartu PCare",pcare_cek_kartu,"pcare_cek_kartu"});
        }

        if("[L]Referensi Diagnosa PRB VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Diagnosa PRB VClaim",bpjs_diagnosa_prb,"bpjs_diagnosa_prb"});
        }

        if("[L]Referensi Obat PRB VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Obat PRB VClaim",bpjs_obat_prb,"bpjs_obat_prb"});
        }

        if("[L]Surat Kontrol VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Surat Kontrol VClaim",bpjs_surat_kontrol,"bpjs_surat_kontrol"});
        }

        if("[L]Surat PRI VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Surat PRI VClaim",bpjs_surat_pri,"bpjs_surat_pri"});
        }

        if("[L]Referensi Pendaftaran Mobile JKN".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Pendaftaran Mobile JKN",referensi_mobilejkn_bpjs,"referensi_mobilejkn_bpjs"});
        }

        if("[L]Batal Pendaftaran Mobile JKN".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Batal Pendaftaran Mobile JKN",batal_pendaftaran_mobilejkn_bpjs,"batal_pendaftaran_mobilejkn_bpjs"});
        }

        if("[L]Host To Host Bank Jateng".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Host To Host Bank Jateng",akun_host_to_host_bank_jateng,"akun_host_to_host_bank_jateng"});
        }

        if("[L]Integrasi BRI API".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Integrasi BRI API",integrasi_briapi,"integrasi_briapi"});
        }

        if("[L]Referensi TACC PCare".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi TACC PCare",pcare_alasan_tacc,"pcare_alasan_tacc"});
        }

        if("[L]Referensi Poli HFIS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Poli HFIS",bpjs_referensi_poli_hfis,"bpjs_referensi_poli_hfis"});
        }

        if("[L]Referensi Dokter HFIS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Dokter HFIS",bpjs_referensi_dokter_hfis,"bpjs_referensi_dokter_hfis"});
        }

        if("[L]Referensi Jadwal HFIS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Jadwal HFIS",bpjs_referensi_jadwal_hfis,"bpjs_referensi_jadwal_hfis"});
        }

        if("[L]Program PRB di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Program PRB di VClaim",bpjs_program_prb,"bpjs_program_prb"});
        }

        if("[L]Suplesi Jasa Raharja di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Suplesi Jasa Raharja di VClaim",bpjs_suplesi_jasaraharja,"bpjs_suplesi_jasaraharja"});
        }

        if("[L]Data Induk Kecelakaan VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Data Induk Kecelakaan VClaim",bpjs_data_induk_kecelakaan,"bpjs_data_induk_kecelakaan"});
        }

        if("[L]Data SEP Internal VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Data SEP Internal VClaim",bpjs_sep_internal,"bpjs_sep_internal"});
        }

        if("[L]Klaim Jaminan Jasa Raharja VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Klaim Jaminan Jasa Raharja VClaim",bpjs_klaim_jasa_raharja,"bpjs_klaim_jasa_raharja"});
        }

        if("[L]Pasien Finger Print VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Pasien Finger Print VClaim",bpjs_daftar_finger_print,"bpjs_daftar_finger_print"});
        }

        if("[L]Rujukan Khusus VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Rujukan Khusus VClaim",bpjs_rujukan_khusus,"bpjs_rujukan_khusus"});
        }

        if("[L]Task ID Mobile JKN".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Task ID Mobile JKN",bpjs_task_id,"bpjs_task_id"});
        }

        if("[L]Referensi DPHO Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi DPHO Apotek BPJS",bpjs_referensi_dpho_apotek,"bpjs_referensi_dpho_apotek"});
        }

        if("[L]Referensi Poli Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Poli Apotek BPJS",bpjs_referensi_poli_apotek,"bpjs_referensi_poli_apotek"});
        }

        if("[L]Referensi Faskes Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Faskes Apotek BPJS",bpjs_referensi_faskes_apotek,"bpjs_referensi_faskes_apotek"});
        }

        if("[L]Referensi Spesialistik Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Spesialistik Apotek BPJS",bpjs_referensi_spesialistik_apotek,"bpjs_referensi_spesialistik_apotek"});
        }

        if("[L]Host To Host Bank Papua".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Host To Host Bank Papua",akun_host_to_host_bank_papua,"akun_host_to_host_bank_papua"});
        }

        if("[L]Host To Host Bank Jabar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Host To Host Bank Jabar",akun_host_to_host_bank_jabar,"akun_host_to_host_bank_jabar"});
        }

        if("[L]Referensi Praktisi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Praktisi Satu Sehat",satu_sehat_referensi_dokter,"satu_sehat_referensi_dokter"});
        }

        if("[L]Referensi Pasien Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Pasien Satu Sehat",satu_sehat_referensi_pasien,"satu_sehat_referensi_pasien"});
        }

        if("[L]Mapping Organisasi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Organisasi Satu Sehat",satu_sehat_mapping_departemen,"satu_sehat_mapping_departemen"});
        }

        if("[L]Mapping Lokasi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Lokasi Satu Sehat",satu_sehat_mapping_lokasi,"satu_sehat_mapping_lokasi"});
        }

        if("[L]Mapping Vaksin Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Vaksin Satu Sehat",satu_sehat_mapping_vaksin,"satu_sehat_mapping_vaksin"});
        }

        if("[L]Kirim Encounter Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Encounter Satu Sehat",satu_sehat_kirim_encounter,"satu_sehat_kirim_encounter"});
        }

        if("[L]Kirim Condition Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Condition Satu Sehat",satu_sehat_kirim_condition,"satu_sehat_kirim_condition"});
        }

        if("[L]Kirim Observation-TTV Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Observation-TTV Satu Sehat",satu_sehat_kirim_observationttv,"satu_sehat_kirim_observationttv"});
        }

        if("[L]Kirim Procedure Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Procedure Satu Sehat",satu_sehat_kirim_procedure,"satu_sehat_kirim_procedure"});
        }

        if("[L]Kirim Vaksin Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Vaksin Satu Sehat",satu_sehat_kirim_Immunization,"satu_sehat_kirim_Immunization"});
        }

        if("[L]Kirim Clinical Impression Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Clinical Impression Satu Sehat",satu_sehat_kirim_clinicalimpression,"satu_sehat_kirim_clinicalimpression"});
        }

        if("[L]Antrean Per Tanggal Mobile JKN".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Antrean Per Tanggal Mobile JKN",bpjs_antrean_pertanggal,"bpjs_antrean_pertanggal"});
        }

        if("[L]Riwayat Perawatan ICare BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Riwayat Perawatan ICare BPJS",riwayat_perawatan_icare_bpjs,"riwayat_perawatan_icare_bpjs"});
        }

        if("[L]Host To Host Bank Mandiri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Host To Host Bank Mandiri",akun_host_to_host_bank_mandiri,"akun_host_to_host_bank_mandiri"});
        }

        if("[L]Referensi Setting PPK Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Setting PPK Apotek BPJS",bpjs_referensi_setting_apotek,"bpjs_referensi_setting_apotek"});
        }

        if("[L]Referensi Obat Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Referensi Obat Apotek BPJS",bpjs_referensi_obat_apotek,"bpjs_referensi_obat_apotek"});
        }

        if("[L]Mapping Obat Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Obat Apotek BPJS",bpjs_mapping_obat_apotek,"bpjs_mapping_obat_apotek"});
        }

        if("[L]Obat 23 Hari Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Obat 23 Hari Apotek BPJS",bpjs_obat_23hari_apotek,"bpjs_obat_23hari_apotek"});
        }

        if("[L]Pencarian SEP Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Pencarian SEP Apotek BPJS",bpjs_kunjungan_sep_apotek,"bpjs_kunjungan_sep_apotek"});
        }

        if("[L]Monitoring Klaim Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Monitoring Klaim Apotek BPJS",bpjs_monitoring_klaim_apotek,"bpjs_monitoring_klaim_apotek"});
        }

        if("[L]Daftar Pelayanan Obat Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Daftar Pelayanan Obat Apotek BPJS",bpjs_daftar_pelayanan_obat_apotek,"bpjs_daftar_pelayanan_obat_apotek"});
        }

        if("[L]Hapus/Edit SEP VClaim".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Hapus/Edit SEP VClaim",hapus_edit_sep_bpjs,"hapus_edit_sep_bpjs"});
        }

        if("[L]Kirim Diet Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Diet Satu Sehat",satu_sehat_kirim_diet,"satu_sehat_kirim_diet"});
        }

        if("[L]Mapping Obat/Alkes/BHP Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Obat/Alkes/BHP Satu Sehat",satu_sehat_mapping_obat,"satu_sehat_mapping_obat"});
        }

        if("[L]Kirim Medication Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Medication Satu Sehat",satu_sehat_kirim_medication,"satu_sehat_kirim_medication"});
        }

        if("[L]Kirim Medication Request Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Medication Request Satu Sehat",satu_sehat_kirim_medicationrequest,"satu_sehat_kirim_medicationrequest"});
        }

        if("[L]Kirim Medication Dispense Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Medication Dispense Satu Sehat",satu_sehat_kirim_medicationdispense,"satu_sehat_kirim_medicationdispense"});
        }

        if("[L]Mapping Tindakan Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Tindakan Radiologi Satu Sehat",satu_sehat_mapping_radiologi,"satu_sehat_mapping_radiologi"});
        }

        if("[L]Kirim Service Request Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Service Request Radiologi Satu Sehat",satu_sehat_kirim_servicerequest_radiologi,"satu_sehat_kirim_servicerequest_radiologi"});
        }

        if("[L]Kirim Specimen Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Specimen Radiologi Satu Sehat",satu_sehat_kirim_specimen_radiologi,"satu_sehat_kirim_specimen_radiologi"});
        }

        if("[L]Kirim Observation Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Observation Radiologi Satu Sehat",satu_sehat_kirim_observation_radiologi,"satu_sehat_kirim_observation_radiologi"});
        }

        if("[L]Kirim Diagnostic Report Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Diagnostic Report Radiologi Satu Sehat",satu_sehat_kirim_diagnosticreport_radiologi,"satu_sehat_kirim_diagnosticreport_radiologi"});
        }

        if("[L]Mapping Tindakan Lab PK & MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Mapping Tindakan Lab PK & MB Satu Sehat",satu_sehat_mapping_lab,"satu_sehat_mapping_lab"});
        }

        if("[L]Kirim Service Request Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Service Request Lab PK Satu Sehat",satu_sehat_kirim_servicerequest_lab,"satu_sehat_kirim_servicerequest_lab"});
        }

        if("[L]Kirim Service Request Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Service Request Lab MB Satu Sehat",satu_sehat_kirim_servicerequest_labmb,"satu_sehat_kirim_servicerequest_labmb"});
        }

        if("[L]Kirim Specimen Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Specimen Lab PK Satu Sehat",satu_sehat_kirim_specimen_lab,"satu_sehat_kirim_specimen_lab"});
        }

        if("[L]Kirim Specimen Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Specimen Lab MB Satu Sehat",satu_sehat_kirim_specimen_labmb,"satu_sehat_kirim_specimen_labmb"});
        }

        if("[L]Kirim Observation Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Observation Lab PK Satu Sehat",satu_sehat_kirim_observation_lab,"satu_sehat_kirim_observation_lab"});
        }
        
        if("[L]Kirim Observation Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[L]Kirim Observation Lab MB Satu Sehat",satu_sehat_kirim_observation_labmb,"satu_sehat_kirim_observation_labmb"});
        }
    }

    private void setTampilM() {
        if("[M]Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pasien",pasien,"pasien"});
        }

        if("[M]Pasien Meninggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pasien Meninggal",pasien_meninggal,"pasien_meninggal"});
        }

        if("[M]Kelahiran Bayi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Kelahiran Bayi",kelahiran_bayi,"kelahiran_bayi"});
        }

        if("[M]Peminjaman Berkas RM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Peminjaman Berkas RM",peminjaman_berkas,"peminjaman_berkas"});
        }

        if("[M]Riwayat Perawatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Riwayat Perawatan",resume_pasien,"resume_pasien"});
        }

        if("[M]Diagnosa Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Diagnosa Pasien",diagnosa_pasien,"diagnosa_pasien"});
        }

        if("[M]Retensi Data R.M.".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Retensi Data R.M.",retensi_rm,"retensi_rm"});
        }

        if("[M]Mutasi Berkas RM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Mutasi Berkas RM",mutasi_berkas,"mutasi_berkas"});
        }

        if("[M]Catatan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Pasien",catatan_pasien,"catatan_pasien"});
        }

        if("[M]Data HAIs".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Data HAIs",data_HAIs,"data_HAIs"});
        }

        if("[M]Klasifikasi Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Klasifikasi Pasien Ranap",klasifikasi_pasien_ranap,"klasifikasi_pasien_ranap"});
        }

        if("[M]Instansi/Perusahaan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Instansi/Perusahaan Pasien",perusahaan_pasien,"perusahaan_pasien"});
        }

        if("[M]Berkas Digital Perawatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Berkas Digital Perawatan",berkas_digital_perawatan,"berkas_digital_perawatan"});
        }

        if("[M]Pengaduan/Chat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pengaduan/Chat",pengaduan_pasien,"pengaduan_pasien"});
        }

        if("[M]Insiden Keselamatan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Insiden Keselamatan Pasien",insiden_keselamatan_pasien,"insiden_keselamatan_pasien"});
        }

        if("[M]Suku/Bangsa Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Suku/Bangsa Pasien",suku_bangsa,"suku_bangsa"});
        }

        if("[M]Bahasa Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Bahasa Pasien",bahasa_pasien,"bahasa_pasien"});
        }

        if("[M]Golongan TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Golongan TNI",golongan_tni,"golongan_tni"});
        }

        if("[M]Satuan TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Satuan TNI",satuan_tni,"satuan_tni"});
        }

        if("[M]Jabatan TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Jabatan TNI",jabatan_tni,"jabatan_tni"});
        }

        if("[M]Pangkat TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pangkat TNI",pangkat_tni,"pangkat_tni"});
        }

        if("[M]Golongan POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Golongan POLRI",golongan_polri,"golongan_polri"});
        }

        if("[M]Satuan POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Satuan POLRI",satuan_polri,"satuan_polri"});
        }

        if("[M]Jabatan POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Jabatan POLRI",jabatan_polri,"jabatan_polri"});
        }

        if("[M]Pangkat POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pangkat POLRI",pangkat_polri,"pangkat_polri"});
        }

        if("[M]Cacat Fisik".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Cacat Fisik",cacat_fisik,"cacat_fisik"});
        }

        if("[M]Data Triase".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Data Triase",data_triase_igd,"data_triase_igd"});
        }

        if("[M]Master Triase Skala 1".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Skala 1",master_triase_skala1,"master_triase_skala1"});
        }

        if("[M]Master Triase Skala 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Skala 2",master_triase_skala2,"master_triase_skala2"});
        }

        if("[M]Master Triase Skala 3".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Skala 3",master_triase_skala3,"master_triase_skala3"});
        }

        if("[M]Master Triase Skala 4".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Skala 4",master_triase_skala4,"master_triase_skala4"});
        }

        if("[M]Master Triase Skala 5".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Skala 5",master_triase_skala5,"master_triase_skala5"});
        }

        if("[M]Master Triase Pemeriksaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Pemeriksaan",master_triase_pemeriksaan,"master_triase_pemeriksaan"});
        }

        if("[M]Master Triase Macam Kasus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Triase Macam Kasus",master_triase_macamkasus,"master_triase_macamkasus"});
        }

        if("[M]Resume Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Resume Pasien",data_resume_pasien,"data_resume_pasien"});
        }

        if("[M]Asuhan Gizi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Asuhan Gizi",asuhan_gizi,"asuhan_gizi"});
        }

        if("[M]Monitoring Asuhan Gizi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Monitoring Asuhan Gizi",monitoring_asuhan_gizi,"monitoring_asuhan_gizi"});
        }

        if("[M]Penilaian Awal Keperawatan Ralan Umum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ralan Umum",penilaian_awal_keperawatan_ralan,"penilaian_awal_keperawatan_ralan"});
        }

        if("[M]Master Masalah Keperawatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan",master_masalah_keperawatan,"master_masalah_keperawatan"});
        }

        if("[M]Penilaian Awal Keperawatan Gigi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Gigi",penilaian_awal_keperawatan_gigi,"penilaian_awal_keperawatan_gigi"});
        }

        if("[M]Master Masalah Keperawatan Gigi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan Gigi",master_masalah_keperawatan_gigi,"master_masalah_keperawatan_gigi"});
        }

        if("[M]Penilaian Awal Keperawatan Ralan Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ralan Kebidanan",penilaian_awal_keperawatan_kebidanan,"penilaian_awal_keperawatan_kebidanan"});
        }

        if("[M]Penilaian Awal Keperawatan Ralan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ralan Bayi/Anak",penilaian_awal_keperawatan_anak,"penilaian_awal_keperawatan_anak"});
        }

        if("[M]Master Masalah Keperawatan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan Bayi/Anak",master_masalah_keperawatan_anak,"master_masalah_keperawatan_anak"});
        }

        if("[M]Master Imunisasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Imunisasi",master_imunisasi,"master_imunisasi"});
        }

        if("[M]Hemodialisa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hemodialisa",hemodialisa,"hemodialisa"});
        }

        if("[M]SOAP Perawatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]SOAP Perawatan",soap_perawatan,"soap_perawatan"});
        }

        if("[M]Skrining Gizi Lanjut".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skrining Gizi Lanjut",skrining_gizi,"skrining_gizi"});
        }

        if("[M]Penilaian Awal Keperawatan Ranap Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ranap Kebidanan",penilaian_awal_keperawatan_ranapkebidanan,"penilaian_awal_keperawatan_ranapkebidanan"});
        }

        if("[M]Penilaian Awal Medis Ralan Umum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Umum",penilaian_awal_medis_ralan,"penilaian_awal_medis_ralan"});
        }

        if("[M]Master Masalah Keperawatan Mata".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan Mata",master_masalah_keperawatan_mata,"master_masalah_keperawatan_mata"});
        }

        if("[M]Penilaian Awal Keperawatan Ralan Mata".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ralan Mata",penilaian_awal_keperawatan_mata,"penilaian_awal_keperawatan_mata"});
        }

        if("[M]Penilaian Awal Medis Ranap Umum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ranap Umum",penilaian_awal_medis_ranap,"penilaian_awal_medis_ranap"});
        }

        if("[M]Penilaian Awal Medis Ranap Kandungan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ranap Kandungan",penilaian_awal_medis_ranap_kebidanan,"penilaian_awal_medis_ranap_kebidanan"});
        }

        if("[M]Penilaian Awal Medis Ralan Kandungan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Kandungan",penilaian_awal_medis_ralan_kebidanan,"penilaian_awal_medis_ralan_kebidanan"});
        }

        if("[M]Penilaian Awal Medis IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis IGD",penilaian_awal_medis_igd,"penilaian_awal_medis_igd"});
        }

        if("[M]Penilaian Awal Medis Ralan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Bayi/Anak",penilaian_awal_medis_ralan_anak,"penilaian_awal_medis_ralan_anak"});
        }

        if("[M]Penilaian Awal Fisioterapi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Fisioterapi",penilaian_fisioterapi,"penilaian_fisioterapi"});
        }

        if("[M]Penilaian MCU".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian MCU",penilaian_mcu,"penilaian_mcu"});
        }

        if("[M]Riwayat Kamar Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Riwayat Kamar Pasien",riwayat_kamar_pasien,"riwayat_kamar_pasien"});
        }

        if("[M]Uji Fungsi/Prosedur KFR".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Uji Fungsi/Prosedur KFR",uji_fungsi_kfr,"uji_fungsi_kfr"});
        }

        if("[M]Hapus Berkas Digital Perawatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hapus Berkas Digital Perawatan",hapus_berkas_digital_perawatan,"hapus_berkas_digital_perawatan"});
        }

        if("[M]Gabungkan Data RM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Gabungkan Data RM",gabung_rm,"gabung_rm"});
        }

        if("[M]Master Masalah Keperawatan IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan IGD",master_masalah_keperawatan_igd,"master_masalah_keperawatan_igd"});
        }

        if("[M]Penilaian Awal Keperawatan IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan IGD",penilaian_awal_keperawatan_igd,"penilaian_awal_keperawatan_igd"});
        }

        if("[M]Penilaian Awal Keperawatan Ranap Umum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ranap Umum",penilaian_awal_keperawatan_ranap,"penilaian_awal_keperawatan_ranap"});
        }

        if("[M]Master Rencana Keperawatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan",master_rencana_keperawatan,"master_rencana_keperawatan"});
        }

        if("[M]Master Rencana Keperawatan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan Bayi/Anak",master_rencana_keperawatan_anak,"master_rencana_keperawatan_anak"});
        }

        if("[M]SOAP Ralan Anggota POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]SOAP Ralan Anggota POLRI",soap_ralan_polri,"soap_ralan_polri"});
        }

        if("[M]SOAP Ranap Anggota POLRI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]SOAP Ranap Anggota POLRI",soap_ranap_polri,"soap_ranap_polri"});
        }

        if("[M]Catatan Observasi IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Observasi IGD",catatan_observasi_igd,"catatan_observasi_igd"});
        }

        if("[M]Catatan Observasi Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Observasi Ranap",catatan_observasi_ranap,"catatan_observasi_ranap"});
        }

        if("[M]Catatan Observasi Ranap Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Observasi Ranap Kebidanan",catatan_observasi_ranap_kebidanan,"catatan_observasi_ranap_kebidanan"});
        }

        if("[M]Catatan Observasi Ranap Post Partum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Observasi Ranap Post Partum",catatan_observasi_ranap_postpartum,"catatan_observasi_ranap_postpartum"});
        }

        if("[M]Penilaian Awal Medis Ralan THT".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan THT",penilaian_awal_medis_ralan_tht,"penilaian_awal_medis_ralan_tht"});
        }

        if("[M]Penilaian Psikologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Psikologi",penilaian_psikologi,"penilaian_psikologi"});
        }

        if("[M]Penilaian Awal Medis Ralan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Psikiatri",penilaian_awal_medis_ralan_psikiatri,"penilaian_awal_medis_ralan_psikiatri"});
        }

        if("[M]Penilaian Awal Medis Ralan Penyakit Dalam".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Penyakit Dalam",penilaian_awal_medis_ralan_penyakit_dalam,"penilaian_awal_medis_ralan_penyakit_dalam"});
        }

        if("[M]Penilaian Awal Medis Ralan Mata".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Mata",penilaian_awal_medis_ralan_mata,"penilaian_awal_medis_ralan_mata"});
        }

        if("[M]Penilaian Awal Medis Ralan Neurologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Neurologi",penilaian_awal_medis_ralan_neurologi,"penilaian_awal_medis_ralan_neurologi"});
        }

        if("[M]Penilaian Awal Medis Ralan Orthopedi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Orthopedi",penilaian_awal_medis_ralan_orthopedi,"penilaian_awal_medis_ralan_orthopedi"});
        }

        if("[M]Penilaian Awal Medis Ralan Bedah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Bedah",penilaian_awal_medis_ralan_bedah,"penilaian_awal_medis_ralan_bedah"});
        }

        if("[M]SOAP Ralan Anggota TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]SOAP Ralan Anggota TNI",soap_ralan_tni,"soap_ralan_tni"});
        }

        if("[M]SOAP Ranap Anggota TNI".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]SOAP Ranap Anggota TNI",soap_ranap_tni,"soap_ranap_tni"});
        }

        if("[M]Catatan Keperawatan Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Keperawatan Ranap",catatan_keperawatan_ranap,"catatan_keperawatan_ranap"});
        }

        if("[M]Master Rencana Keperawatan Gigi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan Gigi",master_rencana_keperawatan_gigi,"master_rencana_keperawatan_gigi"});
        }

        if("[M]Master Rencana Keperawatan Mata".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan Mata",master_rencana_keperawatan_mata,"master_rencana_keperawatan_mata"});
        }

        if("[M]Master Rencana Keperawatan IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan IGD",master_rencana_keperawatan_igd,"master_rencana_keperawatan_igd"});
        }

        if("[M]Master Masalah Keperawatan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan Psikiatri",master_masalah_keperawatan_psikiatri,"master_masalah_keperawatan_psikiatri"});
        }

        if("[M]Master Rencana Keperawatan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan Psikiatri",master_rencana_keperawatan_psikiatri,"master_rencana_keperawatan_psikiatri"});
        }

        if("[M]Penilaian Awal Keperawatan Ralan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ralan Psikiatri",penilaian_awal_keperawatan_psikiatri,"penilaian_awal_keperawatan_psikiatri"});
        }

        if("[M]Pemantauan PEWS Pasien Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pemantauan PEWS Pasien Anak",pemantauan_pews_anak,"pemantauan_pews_anak"});
        }

        if("[M]Master Template Hasil Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Template Hasil Radiologi",template_hasil_radiologi,"template_hasil_radiologi"});
        }

        if("[M]Master Template Pemeriksaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Template Pemeriksaan",template_pemeriksaan,"template_pemeriksaan"});
        }

        if("[M]Penilaian Pre Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Pre Operasi",penilaian_pre_operasi,"penilaian_pre_operasi"});
        }

        if("[M]Penilaian Pre Anestesi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Pre Anestesi",penilaian_pre_anestesi,"penilaian_pre_anestesi"});
        }

        if("[M]Perencanaan Pemulangan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Perencanaan Pemulangan",perencanaan_pemulangan,"perencanaan_pemulangan"});
        }

        if("[M]Penilaian Lanjutan Resiko Jatuh Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Resiko Jatuh Dewasa",penilaian_lanjutan_resiko_jatuh_dewasa,"penilaian_lanjutan_resiko_jatuh_dewasa"});
        }

        if("[M]Penilaian Lanjutan Risiko Jatuh Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Risiko Jatuh Anak",penilaian_lanjutan_resiko_jatuh_anak,"penilaian_lanjutan_resiko_jatuh_anak"});
        }

        if("[M]Penilaian Awal Medis Ralan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Geriatri",penilaian_awal_medis_ralan_geriatri,"penilaian_awal_medis_ralan_geriatri"});
        }

        if("[M]Penilaian Tambahan Pasien Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Tambahan Pasien Geriatri",penilaian_tambahan_pasien_geriatri,"penilaian_tambahan_pasien_geriatri"});
        }

        if("[M]Skrining Nutrisi Pasien Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skrining Nutrisi Pasien Dewasa",skrining_nutrisi_dewasa,"skrining_nutrisi_dewasa"});
        }

        if("[M]Skrining Nutrisi Pasien Lansia".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skrining Nutrisi Pasien Lansia",skrining_nutrisi_lansia,"skrining_nutrisi_lansia"});
        }

        if("[M]Hasil USG Kandungan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil USG Kandungan",hasil_pemeriksaan_usg,"hasil_pemeriksaan_usg"});
        }

        if("[M]Skrining Nutrisi Pasien Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skrining Nutrisi Pasien Anak",skrining_nutrisi_anak,"skrining_nutrisi_anak"});
        }

        if("[M]Konseling Farmasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Konseling Farmasi",konseling_farmasi,"konseling_farmasi"});
        }

        if("[M]Pelayanan Informasi Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pelayanan Informasi Obat",pelayanan_informasi_obat,"pelayanan_informasi_obat"});
        }

        if("[M]Jawaban PIO Apoteker".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Jawaban PIO Apoteker",jawaban_pio_apoteker,"jawaban_pio_apoteker"});
        }

        if("[M]Transfer Pasien Antar Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Transfer Pasien Antar Ruang",transfer_pasien_antar_ruang,"transfer_pasien_antar_ruang"});
        }

        if("[M]Catatan Cek GDS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Cek GDS",catatan_cek_gds,"catatan_cek_gds"});
        }

        if("[M]Check List Pre Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Check List Pre Operasi",checklist_pre_operasi,"checklist_pre_operasi"});
        }

        if("[M]Sign-In Sebelum Anestesi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Sign-In Sebelum Anestesi",signin_sebelum_anestesi,"signin_sebelum_anestesi"});
        }

        if("[M]Time-Out Sebelum Insisi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Time-Out Sebelum Insisi",timeout_sebelum_insisi,"timeout_sebelum_insisi"});
        }

        if("[M]Sign-Out Sebelum Menutup Luka".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Sign-Out Sebelum Menutup Luka",signout_sebelum_menutup_luka,"signout_sebelum_menutup_luka"});
        }

        if("[M]Check List Post Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Check List Post Operasi",checklist_post_operasi,"checklist_post_operasi"});
        }

        if("[M]Rekonsiliasi Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Rekonsiliasi Obat",rekonsiliasi_obat,"rekonsiliasi_obat"});
        }

        if("[M]Konfirmasi Rekonsiliasi Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Konfirmasi Rekonsiliasi Obat",konfirmasi_rekonsiliasi_obat,"konfirmasi_rekonsiliasi_obat"});
        }

        if("[M]Penilaian Pasien Terminal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Pasien Terminal",penilaian_pasien_terminal,"penilaian_pasien_terminal"});
        }

        if("[M]Monitoring Reaksi Tranfusi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Monitoring Reaksi Tranfusi",monitoring_reaksi_tranfusi,"monitoring_reaksi_tranfusi"});
        }

        if("[M]Penilaian Korban Kekerasan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Korban Kekerasan",penilaian_korban_kekerasan,"penilaian_korban_kekerasan"});
        }

        if("[M]Penilaian Lanjutan Risiko Jatuh Lansia".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Risiko Jatuh Lansia",penilaian_lanjutan_resiko_jatuh_lansia,"penilaian_lanjutan_resiko_jatuh_lansia"});
        }

        if("[M]Penilaian Pasien Penyakit Menular".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Pasien Penyakit Menular",penilaian_pasien_penyakit_menular,"penilaian_pasien_penyakit_menular"});
        }

        if("[M]Skrining Manajer Pelayanan Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skrining Manajer Pelayanan Pasien",mpp_skrining,"mpp_skrining"});
        }

        if("[M]Edukasi Pasien & Keluarga Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Edukasi Pasien & Keluarga Rawat Jalan",edukasi_pasien_keluarga_rj,"edukasi_pasien_keluarga_rj"});
        }

        if("[M]Pemantauan EWS Pasien Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pemantauan EWS Pasien Dewasa",pemantauan_pews_dewasa,"pemantauan_pews_dewasa"});
        }

        if("[M]Penilaian Tambahan Bunuh Diri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Tambahan Bunuh Diri",penilaian_tambahan_bunuh_diri,"penilaian_tambahan_bunuh_diri"});
        }

        if("[M]Penilaian Tambahan Perilaku Kekerasan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Tambahan Perilaku Kekerasan",penilaian_tambahan_perilaku_kekerasan,"penilaian_tambahan_perilaku_kekerasan"});
        }

        if("[M]Penilaian Tambahan Melarikan Diri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Tambahan Melarikan Diri",penilaian_tambahan_beresiko_melarikan_diri,"penilaian_tambahan_beresiko_melarikan_diri"});
        }

        if("[M]Penilaian Awal Medis Ralan Bedah Mulut".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Bedah Mulut",penilaian_awal_medis_ralan_bedah_mulut,"penilaian_awal_medis_ralan_bedah_mulut"});
        }

        if("[M]Penilaian Pasien Keracunan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Pasien Keracunan",penilaian_pasien_keracunan,"penilaian_pasien_keracunan"});
        }

        if("[M]Pemantauan MEOWS Pasien Obstetri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pemantauan MEOWS Pasien Obstetri",pemantauan_meows_obstetri,"pemantauan_meows_obstetri"});
        }

        if("[M]Catatan ADIME Gizi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan ADIME Gizi",catatan_adime_gizi,"catatan_adime_gizi"});
        }

        if("[M]Penilaian Awal Keperawatan Ralan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ralan Geriatri",penilaian_awal_keperawatan_ralan_geriatri,"penilaian_awal_keperawatan_ralan_geriatri"});
        }

        if("[M]Master Masalah Keperawatan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan Geriatri",master_masalah_keperawatan_geriatri,"master_masalah_keperawatan_geriatri"});
        }

        if("[M]Master Rencana Keperawatan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan Geriatri",master_rencana_keperawatan_geriatri,"master_rencana_keperawatan_geriatri"});
        }

        if("[M]Check List Kriteria Masuk HCU".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Check List Kriteria Masuk HCU",checklist_kriteria_masuk_hcu,"checklist_kriteria_masuk_hcu"});
        }

        if("[M]Check List Kriteria Keluar HCU".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Check List Kriteria Keluar HCU",checklist_kriteria_keluar_hcu,"checklist_kriteria_keluar_hcu"});
        }

        if("[M]Penilaian Risiko Dekubitus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Risiko Dekubitus",penilaian_risiko_dekubitus,"penilaian_risiko_dekubitus"});
        }

        if("[M]Master Template Laporan Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Template Laporan Operasi",template_laporan_operasi,"template_laporan_operasi"});
        }

        if("[M]Dokumentasi Tindakan ESWL".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Dokumentasi Tindakan ESWL",hasil_tindakan_eswl,"hasil_tindakan_eswl"});
        }

        if("[M]Check List Kriteria Masuk ICU".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Check List Kriteria Masuk ICU",checklist_kriteria_masuk_icu,"checklist_kriteria_masuk_icu"});
        }

        if("[M]Check List Kriteria Keluar ICU".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Check List Kriteria Keluar ICU",checklist_kriteria_keluar_icu,"checklist_kriteria_keluar_icu"});
        }

        if("[M]Follow Up DBD".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Follow Up DBD",follow_up_dbd,"follow_up_dbd"});
        }

        if("[M]Penilaian Lanjutan Risiko Jatuh Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Risiko Jatuh Neonatus",penilaian_risiko_jatuh_neonatus,"penilaian_risiko_jatuh_neonatus"});
        }

        if("[M]Penilaian Lanjutan Risiko Jatuh Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Risiko Jatuh Geriatri",penilaian_lanjutan_resiko_jatuh_geriatri,"penilaian_lanjutan_resiko_jatuh_geriatri"});
        }

        if("[M]Pemantauan EWS Pasien Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pemantauan EWS Pasien Neonatus",pemantauan_ews_neonatus,"pemantauan_ews_neonatus"});
        }

        if("[M]Penilaian Awal Medis Ralan Kulit & Kelamin".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Kulit & Kelamin",penilaian_awal_medis_ralan_kulit_kelamin,"penilaian_awal_medis_ralan_kulit_kelamin"});
        }

        if("[M]Penilaian Awal Medis Pasien Hemodialisa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Pasien Hemodialisa",penilaian_medis_hemodialisa,"penilaian_medis_hemodialisa"});
        }

        if("[M]Penilaian Level Kecemasan Ranap Anak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Level Kecemasan Ranap Anak",penilaian_level_kecemasan_ranap_anak,"penilaian_level_kecemasan_ranap_anak"});
        }

        if("[M]Penilaian Lanjutan Risiko Jatuh Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Risiko Jatuh Psikiatri",penilaian_lanjutan_resiko_jatuh_psikiatri,"penilaian_lanjutan_resiko_jatuh_psikiatri"});
        }

        if("[M]Penilaian Lanjutan Skrining Fungsional".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Lanjutan Skrining Fungsional",penilaian_lanjutan_skrining_fungsional,"penilaian_lanjutan_skrining_fungsional"});
        }

        if("[M]Penilaian Awal Medis Ralan Fisik & Rehabilitasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Fisik & Rehabilitasi",penilaian_medis_ralan_rehab_medik,"penilaian_medis_ralan_rehab_medik"});
        }

        if("[M]Laporan Anestesi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Laporan Anestesi",laporan_anestesi,"laporan_anestesi"});
        }

        if("[M]Penilaian Awal Medis IGD Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis IGD Psikiatri",penilaian_medis_ralan_gawat_darurat_psikiatri,"penilaian_medis_ralan_gawat_darurat_psikiatri"});
        }

        if("[M]Penilaian Ulang Nyeri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Ulang Nyeri",penilaian_ulang_nyeri,"penilaian_ulang_nyeri"});
        }

        if("[M]Penilaian Terapi Wicara".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Terapi Wicara",penilaian_terapi_wicara,"penilaian_terapi_wicara"});
        }

        if("[M]Pengkajian Restrain".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Pengkajian Restrain",pengkajian_restrain,"pengkajian_restrain"});
        }

        if("[M]Penilaian Awal Medis Ralan Paru".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Paru",penilaian_awal_medis_ralan_paru,"penilaian_awal_medis_ralan_paru"});
        }

        if("[M]Catatan Keperawatan Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Keperawatan Ralan",catatan_keperawatan_ralan,"catatan_keperawatan_ralan"});
        }

        if("[M]Catatan Persalinan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Catatan Persalinan",catatan_persalinan,"catatan_persalinan"});
        }

        if("[M]Skor Aldrette Pasca Anestesi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skor Aldrette Pasca Anestesi",skor_aldrette_pasca_anestesi,"skor_aldrette_pasca_anestesi"});
        }

        if("[M]Skor Steward Pasca Anestesi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skor Steward Pasca Anestesi",skor_steward_pasca_anestesi,"skor_steward_pasca_anestesi"});
        }

        if("[M]Skor Bromage Pasca Anestesi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Skor Bromage Pasca Anestesi",skor_bromage_pasca_anestesi,"skor_bromage_pasca_anestesi"});
        }

        if("[M]Penilaian Pre Induksi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Pre Induksi",penilaian_pre_induksi,"penilaian_pre_induksi"});
        }

        if("[M]Hasil USG Urologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil USG Urologi",hasil_usg_urologi,"hasil_usg_urologi"});
        }

        if("[M]Hasil USG Gynecologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil USG Gynecologi",hasil_usg_gynecologi,"hasil_usg_gynecologi"});
        }

        if("[M]Hasil USG Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil USG Neonatus",hasil_usg_neonatus,"hasil_usg_neonatus"});
        }

        if("[M]Hasil Pemeriksaan EKG".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil Pemeriksaan EKG",hasil_pemeriksaan_ekg,"hasil_pemeriksaan_ekg"});
        }

        if("[M]Hasil Endoskopi Faring/Laring".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil Endoskopi Faring/Laring",hasil_endoskopi_faring_laring,"hasil_endoskopi_faring_laring"});
        }

        if("[M]Penatalaksanaan Terapi Okupasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penatalaksanaan Terapi Okupasi",penatalaksanaan_terapi_okupasi,"penatalaksanaan_terapi_okupasi"});
        }

        if("[M]Hasil Endoskopi Hidung".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil Endoskopi Hidung",hasil_endoskopi_hidung,"hasil_endoskopi_hidung"});
        }

        if("[M]Master Masalah Keperawatan Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Masalah Keperawatan Neonatus",master_masalah_keperawatan_neonatus,"master_masalah_keperawatan_neonatus"});
        }

        if("[M]Master Rencana Keperawatan Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Master Rencana Keperawatan Neonatus",master_rencana_keperawatan_neonatus,"master_rencana_keperawatan_neonatus"});
        }

        if("[M]Penilaian Awal Keperawatan Ranap Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Keperawatan Ranap Neonatus",penilaian_awal_keperawatan_ranap_neonatus,"penilaian_awal_keperawatan_ranap_neonatus"});
        }

        if("[M]Hasil Endoskopi Telinga".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Hasil Endoskopi Telinga",hasil_endoskopi_telinga,"hasil_endoskopi_telinga"});
        }
    }

    private void setTampilN() {
        if("[N]Pengambilan BHP Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Pengambilan BHP Medis",pengambilan_utd2,"pengambilan_utd2"});
        }

        if("[N]BHP Medis Rusak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]BHP Medis Rusak",utd_medis_rusak,"utd_medis_rusak"});
        }

        if("[N]Pengambilan BHP Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Pengambilan BHP Non Medis",pengambilan_penunjang_utd2,"pengambilan_penunjang_utd2"});
        }

        if("[N]BHP Non Medis Rusak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]BHP Non Medis Rusak",utd_penunjang_rusak,"utd_penunjang_rusak"});
        }

        if("[N]Donor Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Donor Darah",utd_donor,"utd_donor"});
        }

        if("[N]Cekal Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Cekal Darah",utd_cekal_darah,"utd_cekal_darah"});
        }

        if("[N]Komponen Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Komponen Darah",utd_komponen_darah,"utd_komponen_darah"});
        }

        if("[N]Stok Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Stok Darah",utd_stok_darah,"utd_stok_darah"});
        }

        if("[N]Pemisahan Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Pemisahan Darah",utd_pemisahan_darah,"utd_pemisahan_darah"});
        }

        if("[N]Penyerahan Darah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Penyerahan Darah",utd_penyerahan_darah,"utd_penyerahan_darah"});
        }

        if("[N]Data Pendonor".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[N]Data Pendonor",utd_pendonor,"utd_pendonor"});
        }
    }

    private void setTampilO() {
        if("[O]Registrasi Per Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Poli",grafik_kunjungan_poli,"grafik_kunjungan_poli"});
        }

        if("[O]Registrasi Per Dokter".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Dokter",grafik_kunjungan_perdokter,"grafik_kunjungan_perdokter"});
        }

        if("[O]Registrasi Per Pekerjaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Pekerjaan",grafik_kunjungan_perpekerjaan,"grafik_kunjungan_perpekerjaan"});
        }

        if("[O]Registrasi Per Pendidikan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Pendidikan",grafik_kunjungan_perpendidikan,"grafik_kunjungan_perpendidikan"});
        }

        if("[O]Registrasi Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Tahun",grafik_kunjungan_pertahun,"grafik_kunjungan_pertahun"});
        }

        if("[O]Registrasi Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Bulan",grafik_kunjungan_perbulan,"grafik_kunjungan_perbulan"});
        }

        if("[O]Registrasi Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Tanggal",grafik_kunjungan_pertanggal,"grafik_kunjungan_pertanggal"});
        }

        if("[O]Demografi Registrasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Demografi Registrasi",grafik_kunjungan_demografi,"grafik_kunjungan_demografi"});
        }

        if("[O]Reg Lama Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Reg Lama Per Tahun",grafik_kunjungan_statusdaftartahun,"grafik_kunjungan_statusdaftartahun"});
        }

        if("[O]Reg Baru Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Reg Baru Per Tahun",grafik_kunjungan_statusdaftartahun2,"grafik_kunjungan_statusdaftartahun2"});
        }

        if("[O]Reg Lama Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Reg Lama Per Bulan",grafik_kunjungan_statusdaftarbulan,"grafik_kunjungan_statusdaftarbulan"});
        }

        if("[O]Reg Baru Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Reg Baru Per Bulan",grafik_kunjungan_statusdaftarbulan2,"grafik_kunjungan_statusdaftarbulan2"});
        }

        if("[O]Reg Lama Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Reg Lama Per Tanggal",grafik_kunjungan_statusdaftartanggal,"grafik_kunjungan_statusdaftartanggal"});
        }

        if("[O]Reg Baru Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Reg Baru Per Tanggal",grafik_kunjungan_statusdaftartanggal2,"grafik_kunjungan_statusdaftartanggal2"});
        }

        if("[O]Batal Periksa Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Batal Periksa Per Tahun",grafik_kunjungan_statusbataltahun,"grafik_kunjungan_statusbataltahun"});
        }

        if("[O]Batal Periksa Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Batal Periksa Per Bulan",grafik_kunjungan_statusbatalbulan,"grafik_kunjungan_statusbatalbulan"});
        }

        if("[O]Batal Periksa Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Batal Periksa Per Tanggal",grafik_kunjungan_statusbataltanggal,"grafik_kunjungan_statusbataltanggal"});
        }

        if("[O]Registrasi Per Cara Bayar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Cara Bayar",grafik_kunjungan_percarabayar,"grafik_kunjungan_percarabayar"});
        }

        if("[O]Kunjungan Ranap Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Ranap Per Tahun",grafik_kunjungan_ranaptahun,"grafik_kunjungan_ranaptahun"});
        }

        if("[O]Kunjungan Lab Ralan Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Lab Ralan Per Tahun",grafik_lab_ralantahun,"grafik_lab_ralantahun"});
        }

        if("[O]Kunjungan Rad Ralan Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Rad Ralan Per Tahun",grafik_rad_ralantahun,"grafik_rad_ralantahun"});
        }

        if("[O]Registrasi Per Perujuk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Perujuk",grafik_per_perujuk,"grafik_per_perujuk"});
        }

        if("[O]Kunjungan Lab Ralan Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Lab Ralan Per Bulan",grafik_lab_ralanbulan,"grafik_lab_ralanbulan"});
        }

        if("[O]Kunjungan Rad Ralan Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Rad Ralan Per Bulan",grafik_rad_ralanbulan,"grafik_rad_ralanbulan"});
        }

        if("[O]Kunjungan Lab Ralan Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Lab Ralan Per Tanggal",grafik_lab_ralanhari,"grafik_lab_ralanhari"});
        }

        if("[O]Kunjungan Rad Ralan Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Rad Ralan Per Tanggal",grafik_rad_ralanhari,"grafik_rad_ralanhari"});
        }

        if("[O]Kejadian IKP Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kejadian IKP Per Tahun",grafik_ikp_pertahun,"grafik_ikp_pertahun"});
        }

        if("[O]Kejadian IKP Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kejadian IKP Per Bulan",grafik_ikp_perbulan,"grafik_ikp_perbulan"});
        }

        if("[O]Kejadian IKP Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kejadian IKP Per Tanggal",grafik_ikp_pertanggal,"grafik_ikp_pertanggal"});
        }

        if("[O]Kejadian IKP Per Jenis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kejadian IKP Per Jenis",grafik_ikp_jenis,"grafik_ikp_jenis"});
        }

        if("[O]Kejadian IKP Per Dampak".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kejadian IKP Per Dampak",grafik_ikp_dampak,"grafik_ikp_dampak"});
        }

        if("[O]Registrasi Per Agama".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Agama",grafik_kunjungan_per_agama,"grafik_kunjungan_per_agama"});
        }

        if("[O]Registrasi Per Umur".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Umur",grafik_kunjungan_per_umur,"grafik_kunjungan_per_umur"});
        }

        if("[O]Registrasi Per Suku/Bangsa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Suku/Bangsa",grafik_kunjungan_suku,"grafik_kunjungan_suku"});
        }

        if("[O]Registrasi Per Bahasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Bahasa",grafik_kunjungan_bahasa,"grafik_kunjungan_bahasa"});
        }

        if("[O]Registrasi Per Cacat Fisik".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Registrasi Per Cacat Fisik",grafik_kunjungan_per_cacat,"grafik_kunjungan_per_cacat"});
        }

        if("[O]Periode Laporan TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Periode Laporan TB",grafik_tb_periodelaporan,"grafik_tb_periodelaporan"});
        }

        if("[O]Rujukan TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Rujukan TB",grafik_tb_rujukan,"grafik_tb_rujukan"});
        }

        if("[O]Riwayat TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Riwayat TB",grafik_tb_riwayat,"grafik_tb_riwayat"});
        }

        if("[O]Tipe Diagnosis TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Tipe Diagnosis TB",grafik_tb_tipediagnosis,"grafik_tb_tipediagnosis"});
        }

        if("[O]Status HIV TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Status HIV TB",grafik_tb_statushiv,"grafik_tb_statushiv"});
        }

        if("[O]Skoring Anak TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Skoring Anak TB",grafik_tb_skoringanak,"grafik_tb_skoringanak"});
        }

        if("[O]Konfirmasi Skoring 5 TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Konfirmasi Skoring 5 TB",grafik_tb_konfirmasiskoring5,"grafik_tb_konfirmasiskoring5"});
        }

        if("[O]Konfirmasi Skoring 6 TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Konfirmasi Skoring 6 TB",grafik_tb_konfirmasiskoring6,"grafik_tb_konfirmasiskoring6"});
        }

        if("[O]Sumber Obat TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Sumber Obat TB",grafik_tb_sumberobat,"grafik_tb_sumberobat"});
        }

        if("[O]Hasil Akhir Pengobatan TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Hasil Akhir Pengobatan TB",grafik_tb_hasilakhirpengobatan,"grafik_tb_hasilakhirpengobatan"});
        }

        if("[O]Hasil Tes HIV TB".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Hasil Tes HIV TB",grafik_tb_hasilteshiv,"grafik_tb_hasilteshiv"});
        }

        if("[O]Pemakaian Air PDAM Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pemakaian Air PDAM Per Tanggal",grafik_air_pdam_pertanggal,"grafik_air_pdam_pertanggal"});
        }

        if("[O]Pemakaian Air PDAM Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pemakaian Air PDAM Per Bulan",grafik_air_pdam_perbulan,"grafik_air_pdam_perbulan"});
        }

        if("[O]Limbah B3 Padat Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah B3 Padat Per Tanggal",grafik_limbahb3_pertanggal,"grafik_limbahb3_pertanggal"});
        }

        if("[O]Limbah B3 Padat Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah B3 Padat Per Bulan",grafik_limbahb3_perbulan,"grafik_limbahb3_perbulan"});
        }

        if("[O]Limbah Padat Domestik Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah Padat Domestik Per Tanggal",grafik_limbahdomestik_pertanggal,"grafik_limbahdomestik_pertanggal"});
        }

        if("[O]Limbah Padat Domestik Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah Padat Domestik Per Bulan",grafik_limbahdomestik_perbulan,"grafik_limbahdomestik_perbulan"});
        }

        if("[O]K3 Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Tahun",grafik_k3_pertahun,"grafik_k3_pertahun"});
        }

        if("[O]K3 Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Bulan",grafik_k3_perbulan,"grafik_k3_perbulan"});
        }

        if("[O]K3 Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Tanggal",grafik_k3_pertanggal,"grafik_k3_pertanggal"});
        }

        if("[O]K3 Per Jenis Cidera".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Jenis Cidera",grafik_k3_perjeniscidera,"grafik_k3_perjeniscidera"});
        }

        if("[O]K3 Per Penyebab Kecelakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Penyebab Kecelakaan",grafik_k3_perpenyebab,"grafik_k3_perpenyebab"});
        }

        if("[O]K3 Per Jenis Luka".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Jenis Luka",grafik_k3_perjenisluka,"grafik_k3_perjenisluka"});
        }

        if("[O]K3 Per Lokasi Kejadian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Lokasi Kejadian",grafik_k3_lokasikejadian,"grafik_k3_lokasikejadian"});
        }

        if("[O]K3 Per Dampak Cidera".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Dampak Cidera",grafik_k3_dampakcidera,"grafik_k3_dampakcidera"});
        }

        if("[O]K3 Per Jenis Pekerjaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Jenis Pekerjaan",grafik_k3_perjenispekerjaan,"grafik_k3_perjenispekerjaan"});
        }

        if("[O]K3 Per Bagian Tubuh".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]K3 Per Bagian Tubuh",grafik_k3_perbagiantubuh,"grafik_k3_perbagiantubuh"});
        }

        if("[O]Kunjungan Ranap Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Ranap Per Bulan",grafik_kunjungan_ranapbulan,"grafik_kunjungan_ranapbulan"});
        }

        if("[O]Kunjungan Ranap Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Ranap Per Tanggal",grafik_kunjungan_ranaptanggal,"grafik_kunjungan_ranaptanggal"});
        }

        if("[O]Kunjungan Ranap Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Kunjungan Ranap Per Ruang",grafik_kunjungan_ranap_peruang,"grafik_kunjungan_ranap_peruang"});
        }

        if("[O]Pegawai Per Jenjang Jabatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Jenjang Jabatan",grafik_jenjang_jabatanpegawai,"grafik_jenjang_jabatanpegawai"});
        }

        if("[O]Pegawai Per Bidang/Bagian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Bidang/Bagian",grafik_bidangpegawai,"grafik_bidangpegawai"});
        }

        if("[O]Pegawai Per Departemen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Departemen",grafik_departemenpegawai,"grafik_departemenpegawai"});
        }

        if("[O]Pegawai Per Pendidikan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Pendidikan",grafik_pendidikanpegawai,"grafik_pendidikanpegawai"});
        }

        if("[O]Pegawai Per Status WP".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Status WP",grafik_sttswppegawai,"grafik_sttswppegawai"});
        }

        if("[O]Pegawai Per Status Kerja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Status Kerja",grafik_sttskerjapegawai,"grafik_sttskerjapegawai"});
        }

        if("[O]Status Pulang Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Status Pulang Ranap",grafik_sttspulangranap,"grafik_sttspulangranap"});
        }

        if("[O]Item Apotek Per Jenis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Item Apotek Per Jenis",item_apotek_jenis,"item_apotek_jenis"});
        }

        if("[O]Item Apotek Per Kategori".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Item Apotek Per Kategori",item_apotek_kategori,"item_apotek_kategori"});
        }

        if("[O]Item Apotek Per Golongan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Item Apotek Per Golongan",item_apotek_golongan,"item_apotek_golongan"});
        }

        if("[O]Item Apotek Per Industri Farmasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Item Apotek Per Industri Farmasi",item_apotek_industrifarmasi,"item_apotek_industrifarmasi"});
        }

        if("[O]Pengajuan Aset Per Urgensi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pengajuan Aset Per Urgensi",grafik_pengajuan_aset_urgensi,"grafik_pengajuan_aset_urgensi"});
        }

        if("[O]Pengajuan Aset Per Status".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pengajuan Aset Per Status",grafik_pengajuan_aset_status,"grafik_pengajuan_aset_status"});
        }

        if("[O]Pengajuan Aset Per Departemen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pengajuan Aset Per Departemen",grafik_pengajuan_aset_departemen,"grafik_pengajuan_aset_departemen"});
        }

        if("[O]Pegawai Per Kelompok Jabatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Kelompok Jabatan",grafik_kelompok_jabatanpegawai,"grafik_kelompok_jabatanpegawai"});
        }

        if("[O]Pegawai Per Resiko Kerja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Resiko Kerja",grafik_resiko_kerjapegawai,"grafik_resiko_kerjapegawai"});
        }

        if("[O]Pegawai Per Emergency Index".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pegawai Per Emergency Index",grafik_emergency_indexpegawai,"grafik_emergency_indexpegawai"});
        }

        if("[O]Jumlah Inventaris Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Jumlah Inventaris Per Ruang",grafik_inventaris_ruang,"grafik_inventaris_ruang"});
        }

        if("[O]Jumlah Inventaris Per Jenis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Jumlah Inventaris Per Jenis",grafik_inventaris_jenis,"grafik_inventaris_jenis"});
        }

        if("[O]Pasien HAIs Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pasien HAIs Per Ruang",grafik_HAIs_pasienbangsal,"grafik_HAIs_pasienbangsal"});
        }

        if("[O]Pasien HAIs Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pasien HAIs Per Bulan",grafik_HAIs_pasienbulan,"grafik_HAIs_pasienbulan"});
        }

        if("[O]Laju HAIs VAP Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Laju HAIs VAP Per Ruang",grafik_HAIs_laju_vap,"grafik_HAIs_laju_vap"});
        }

        if("[O]Laju HAIs IAD Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Laju HAIs IAD Per Ruang",grafik_HAIs_laju_iad,"grafik_HAIs_laju_iad"});
        }

        if("[O]Laju HAIs Plebitis Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Laju HAIs Plebitis Per Ruang",grafik_HAIs_laju_pleb,"grafik_HAIs_laju_pleb"});
        }

        if("[O]Laju HAIs ISK Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Laju HAIs ISK Per Ruang",grafik_HAIs_laju_isk,"grafik_HAIs_laju_isk"});
        }

        if("[O]Laju HAIs ILO Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Laju HAIs ILO Per Ruang",grafik_HAIs_laju_ilo,"grafik_HAIs_laju_ilo"});
        }

        if("[O]Laju HAIs HAP Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Laju HAIs HAP Per Ruang",grafik_HAIs_laju_hap,"grafik_HAIs_laju_hap"});
        }

        if("[O]Penerimaan Obat, Alkes & BHP Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Penerimaan Obat, Alkes & BHP Per Bulan",penerimaan_obat_perbulan,"penerimaan_obat_perbulan"});
        }

        if("[O]Pemakaian Air Tanah Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pemakaian Air Tanah Per Tanggal",grafik_air_tanah_pertanggal,"grafik_air_tanah_pertanggal"});
        }

        if("[O]Pemakaian Air Tanah Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pemakaian Air Tanah Per Bulan",grafik_air_tanah_perbulan,"grafik_air_tanah_perbulan"});
        }

        if("[O]Hemodialisa Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Hemodialisa Per Tanggal",grafik_harian_hemodialisa,"grafik_harian_hemodialisa"});
        }

        if("[O]Hemodialisa Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Hemodialisa Per Bulan",grafik_bulanan_hemodialisa,"grafik_bulanan_hemodialisa"});
        }

        if("[O]Hemodialisa Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Hemodialisa Per Tahun",grafik_tahunan_hemodialisa,"grafik_tahunan_hemodialisa"});
        }

        if("[O]Pasien Meninggal Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Pasien Meninggal Per Bulan",grafik_bulanan_meninggal,"grafik_bulanan_meninggal"});
        }

        if("[O]Jumlah Inventaris Per Kategori".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Jumlah Inventaris Per Kategori",grafik_inventaris_kategori,"grafik_inventaris_kategori"});
        }

        if("[O]Jumlah Inventaris Per Merk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Jumlah Inventaris Per Merk",grafik_inventaris_merk,"grafik_inventaris_merk"});
        }

        if("[O]Jumlah Inventaris Per Produsen".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Jumlah Inventaris Per Produsen",grafik_inventaris_produsen,"grafik_inventaris_produsen"});
        }

        if("[O]Porsi Diet Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Porsi Diet Per Tanggal",grafik_porsidiet_pertanggal,"grafik_porsidiet_pertanggal"});
        }

        if("[O]Porsi Diet Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Porsi Diet Per Bulan",grafik_porsidiet_perbulan,"grafik_porsidiet_perbulan"});
        }

        if("[O]Porsi Diet Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Porsi Diet Per Tahun",grafik_porsidiet_pertahun,"grafik_porsidiet_pertahun"});
        }

        if("[O]Porsi Diet Per Ruang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Porsi Diet Per Ruang",grafik_porsidiet_perbangsal,"grafik_porsidiet_perbangsal"});
        }

        if("[O]Perbaikan Inventaris Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Perbaikan Inventaris Per Tanggal",grafik_perbaikan_inventaris_pertanggal,"grafik_perbaikan_inventaris_pertanggal"});
        }

        if("[O]Perbaikan Inventaris Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Perbaikan Inventaris Per Bulan",grafik_perbaikan_inventaris_perbulan,"grafik_perbaikan_inventaris_perbulan"});
        }

        if("[O]Perbaikan Inventaris Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Perbaikan Inventaris Per Tahun",grafik_perbaikan_inventaris_pertahun,"grafik_perbaikan_inventaris_pertahun"});
        }

        if("[O]Perbaikan Inventaris Per Pelaksana & Status".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Perbaikan Inventaris Per Pelaksana & Status",grafik_perbaikan_inventaris_perpelaksana_status,"grafik_perbaikan_inventaris_perpelaksana_status"});
        }

        if("[O]Limbah B3 Cair Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah B3 Cair Per Tanggal",grafik_limbahb3cair_pertanggal,"grafik_limbahb3cair_pertanggal"});
        }

        if("[O]Limbah B3 Cair Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah B3 Cair Per Bulan",grafik_limbahb3cair_perbulan,"grafik_limbahb3cair_perbulan"});
        }
    }

    private void setTampilP() {
        if("[P]Indeks Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Indeks Surat",surat_indeks,"surat_indeks"});
        }

        if("[P]Map Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Map Surat",surat_map,"surat_map"});
        }

        if("[P]Almari Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Almari Surat",surat_almari,"surat_almari"});
        }

        if("[P]Rak Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Rak Surat",surat_rak,"surat_rak"});
        }

        if("[P]Ruang Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Ruang Surat",surat_ruang,"surat_ruang"});
        }

        if("[P]Klasifikasi Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Klasifikasi Surat",surat_klasifikasi,"surat_klasifikasi"});
        }

        if("[P]Status Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Status Surat",surat_status,"surat_status"});
        }

        if("[P]Sifat Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Sifat Surat",surat_sifat,"surat_sifat"});
        }

        if("[P]Stts Balas Surat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Stts Balas Surat",surat_balas,"surat_balas"});
        }

        if("[P]Surat Masuk".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Masuk",surat_masuk,"surat_masuk"});
        }

        if("[P]Surat Keluar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keluar",surat_keluar,"surat_keluar"});
        }

        if("[P]Surat Keterangan Sakit".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keterangan Sakit",surat_sakit,"surat_sakit"});
        }

        if("[P]Pengumuman E-Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Pengumuman E-Pasien",pengumuman_epasien,"pengumuman_epasien"});
        }

        if("[P]Surat Hamil".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Hamil",surat_hamil,"surat_hamil"});
        }

        if("[P]Surat Bebas Narkoba".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Bebas Narkoba",surat_bebas_narkoba,"surat_bebas_narkoba"});
        }

        if("[P]Surat Keterangan Covid".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keterangan Covid",surat_keterangan_covid,"surat_keterangan_covid"});
        }

        if("[P]Surat Cuti Hamil".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Cuti Hamil",surat_cuti_hamil,"surat_cuti_hamil"});
        }

        if("[P]Surat Kontrol".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Kontrol",skdp_bpjs,"skdp_bpjs"});
        }

        if("[P]Surat Keterangan Rawat Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keterangan Rawat Inap",surat_keterangan_rawat_inap,"surat_keterangan_rawat_inap"});
        }

        if("[P]Surat Keterangan Sehat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keterangan Sehat",surat_keterangan_sehat,"surat_keterangan_sehat"});
        }

        if("[P]Surat Keterangan Sakit Pihak 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keterangan Sakit Pihak 2",surat_sakit_pihak_2,"surat_sakit_pihak_2"});
        }

        if("[P]Surat Bebas TBC".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Bebas TBC",surat_bebas_tbc,"surat_bebas_tbc"});
        }

        if("[P]Surat Keterangan Buta Warna".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Keterangan Buta Warna",surat_buta_warna,"surat_buta_warna"});
        }

        if("[P]Surat Bebas Tato".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Bebas Tato",surat_bebas_tato,"surat_bebas_tato"});
        }

        if("[P]Surat Kewaspadaan Kesehatan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Surat Kewaspadaan Kesehatan",surat_kewaspadaan_kesehatan,"surat_kewaspadaan_kesehatan"});
        }

        if("[P]Persetujuan/Penolakan Tindakan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Persetujuan/Penolakan Tindakan",persetujuan_penolakan_tindakan,"persetujuan_penolakan_tindakan"});
        }

        if("[P]Pulang Atas Permintaan Sendiri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Pulang Atas Permintaan Sendiri",surat_pulang_atas_permintaan_sendiri,"surat_pulang_atas_permintaan_sendiri"});
        }

        if("[P]Pernyataan Pasien Umum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Pernyataan Pasien Umum",surat_pernyataan_pasien_umum,"surat_pernyataan_pasien_umum"});
        }

        if("[P]Persetujuan Umum".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Persetujuan Umum",surat_persetujuan_umum,"surat_persetujuan_umum"});
        }

        if("[P]Persetujuan Rawat Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Persetujuan Rawat Inap",surat_persetujuan_rawat_inap,"surat_persetujuan_rawat_inap"});
        }

        if("[P]Persetujuan Penundaan Pelayanan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Persetujuan Penundaan Pelayanan",persetujuan_penundaan_pelayanan,"persetujuan_penundaan_pelayanan"});
        }

        if("[P]Master Menolak Anjuran Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Master Menolak Anjuran Medis",master_menolak_anjuran_medis,"master_menolak_anjuran_medis"});
        }

        if("[P]Penolakan Anjuran Medis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Penolakan Anjuran Medis",penolakan_anjuran_medis,"penolakan_anjuran_medis"});
        }

        if("[P]Template Persetujuan Penolakan Tindakan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[P]Template Persetujuan Penolakan Tindakan",template_persetujuan_penolakan_tindakan,"template_persetujuan_penolakan_tindakan"});
        }
    }

    private void setTampilQ() {
        if("[Q]Ruang Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Ruang Perpustakaan",ruang_perpustakaan,"ruang_perpustakaan"});
        }

        if("[Q]Kategori Koleksi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Kategori Koleksi",kategori_perpustakaan,"kategori_perpustakaan"});
        }

        if("[Q]Jenis Koleksi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Jenis Koleksi",jenis_perpustakaan,"jenis_perpustakaan"});
        }

        if("[Q]Pengarang/Penulis".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Pengarang/Penulis",pengarang_perpustakaan,"pengarang_perpustakaan"});
        }

        if("[Q]Penerbit Koleksi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Penerbit Koleksi",penerbit_perpustakaan,"penerbit_perpustakaan"});
        }

        if("[Q]Koleksi Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Koleksi Perpustakaan",koleksi_perpustakaan,"koleksi_perpustakaan"});
        }

        if("[Q]Inventaris Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Inventaris Perpustakaan",inventaris_perpustakaan,"inventaris_perpustakaan"});
        }

        if("[Q]Pengaturan Peminjaman".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Pengaturan Peminjaman",set_peminjaman_perpustakaan,"set_peminjaman_perpustakaan"});
        }

        if("[Q]Denda Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Denda Perpustakaan",denda_perpustakaan,"denda_perpustakaan"});
        }

        if("[Q]Anggota Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Anggota Perpustakaan",anggota_perpustakaan,"anggota_perpustakaan"});
        }

        if("[Q]Peminjaman Koleksi Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Peminjaman Koleksi Perpustakaan",peminjaman_perpustakaan,"peminjaman_perpustakaan"});
        }

        if("[Q]Bayar Denda Perpustakaan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Bayar Denda Perpustakaan",bayar_denda_perpustakaan,"bayar_denda_perpustakaan"});
        }

        if("[Q]Data Koleksi Ebook".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[Q]Data Koleksi Ebook",ebook_perpustakaan,"ebook_perpustakaan"});
        }
    }

    private void setTampilR() {
        if("[R]Suplier Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Suplier Toko",toko_suplier,"toko_suplier"});
        }

        if("[R]Jenis Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Jenis Barang Toko",toko_jenis,"toko_jenis"});
        }

        if("[R]Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Barang Toko",toko_barang,"toko_barang"});
        }

        if("[R]Stok Opname Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Stok Opname Toko",stok_opname_toko,"stok_opname_toko"});
        }

        if("[R]Riwayat Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Riwayat Barang Toko",toko_riwayat_barang,"toko_riwayat_barang"});
        }

        if("[R]Surat Pemesanan Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Surat Pemesanan Toko",toko_surat_pemesanan,"toko_surat_pemesanan"});
        }

        if("[R]Pengajuan Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Pengajuan Barang Toko",toko_pengajuan_barang,"toko_pengajuan_barang"});
        }

        if("[R]Penerimaan Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Penerimaan Barang Toko",toko_penerimaan_barang,"toko_penerimaan_barang"});
        }

        if("[R]Pengadaan Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Pengadaan Barang Toko",toko_pengadaan_barang,"toko_pengadaan_barang"});
        }

        if("[R]Member Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Member Toko",toko_member,"toko_member"});
        }

        if("[R]Penjualan Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Penjualan Toko",toko_penjualan,"toko_penjualan"});
        }

        if("[R]Piutang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Piutang Toko",toko_piutang,"toko_piutang"});
        }

        if("[R]Retur Ke Suplier Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Retur Ke Suplier Toko",toko_retur_beli,"toko_retur_beli"});
        }

        if("[R]Pendapatan Harian Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Pendapatan Harian Toko",toko_pendapatan_harian,"toko_pendapatan_harian"});
        }

        if("[R]Bayar Piutang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Bayar Piutang Toko",toko_bayar_piutang,"toko_bayar_piutang"});
        }

        if("[R]Piutang Harian Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Piutang Harian Toko",toko_piutang_harian,"toko_piutang_harian"});
        }

        if("[R]Penjualan Harian Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Penjualan Harian Toko",toko_penjualan_harian,"toko_penjualan_harian"});
        }

        if("[R]Hutang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Hutang Toko",toko_hutang,"toko_hutang"});
        }

        if("[R]Bayar Pesan Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Bayar Pesan Toko",toko_bayar_pemesanan,"toko_bayar_pemesanan"});
        }

        if("[R]Sirkulasi Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Sirkulasi Barang Toko",toko_sirkulasi,"toko_sirkulasi"});
        }

        if("[R]Retur Jual Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Retur Jual Toko",toko_retur_jual,"toko_retur_jual"});
        }

        if("[R]Retur Jual Piutang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Retur Jual Piutang",toko_retur_piutang,"toko_retur_piutang"});
        }

        if("[R]Sirkulasi Barang Toko 2".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Sirkulasi Barang Toko 2",toko_sirkulasi2,"toko_sirkulasi2"});
        }

        if("[R]Keuntungan Barang Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[R]Keuntungan Barang Toko",toko_keuntungan_barang,"toko_keuntungan_barang"});
        }
    }

    private void setTampilS() {
        if("[S]Ket Pengeluaran Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Ket Pengeluaran Penerima Dankes",zis_pengeluaran_penerima_dankes,"zis_pengeluaran_penerima_dankes"});
        }

        if("[S]Ket Penghasilan Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Ket Penghasilan Penerima Dankes",zis_penghasilan_penerima_dankes,"zis_penghasilan_penerima_dankes"});
        }

        if("[S]Ukuran Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Ukuran Rumah Penerima Dankes",zis_ukuran_rumah_penerima_dankes,"zis_ukuran_rumah_penerima_dankes"});
        }

        if("[S]Dinding Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Dinding Rumah Penerima Dankes",zis_dinding_rumah_penerima_dankes,"zis_dinding_rumah_penerima_dankes"});
        }

        if("[S]Lantai Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Lantai Rumah Penerima Dankes",zis_lantai_rumah_penerima_dankes,"zis_lantai_rumah_penerima_dankes"});
        }

        if("[S]Atap Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Atap Rumah Penerima Dankes",zis_atap_rumah_penerima_dankes,"zis_atap_rumah_penerima_dankes"});
        }

        if("[S]Kepemilikan Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Kepemilikan Rumah Penerima Dankes",zis_kepemilikan_rumah_penerima_dankes,"zis_kepemilikan_rumah_penerima_dankes"});
        }

        if("[S]Kamar Mandi Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Kamar Mandi Penerima Dankes",zis_kamar_mandi_penerima_dankes,"zis_kamar_mandi_penerima_dankes"});
        }

        if("[S]Dapur Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Dapur Rumah Penerima Dankes",zis_dapur_rumah_penerima_dankes,"zis_dapur_rumah_penerima_dankes"});
        }

        if("[S]Kursi Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Kursi Rumah Penerima Dankes",zis_kursi_rumah_penerima_dankes,"zis_kursi_rumah_penerima_dankes"});
        }

        if("[S]Kategori PHBS Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Kategori PHBS Penerima Dankes",zis_kategori_phbs_penerima_dankes,"zis_kategori_phbs_penerima_dankes"});
        }

        if("[S]Elektronik Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Elektronik Penerima Dankes",zis_elektronik_penerima_dankes,"zis_elektronik_penerima_dankes"});
        }

        if("[S]Ternak Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Ternak Penerima Dankes",zis_ternak_penerima_dankes,"zis_ternak_penerima_dankes"});
        }

        if("[S]Jenis Simpanan Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Jenis Simpanan Penerima Dankes",zis_jenis_simpanan_penerima_dankes,"zis_jenis_simpanan_penerima_dankes"});
        }

        if("[S]Kategori Asnaf Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Kategori Asnaf Penerima Dankes",zis_kategori_asnaf_penerima_dankes,"zis_kategori_asnaf_penerima_dankes"});
        }

        if("[S]Patologis Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[S]Patologis Penerima Dankes",zis_patologis_penerima_dankes,"zis_patologis_penerima_dankes"});
        }
    }

    private void setTampilT() {
        if("[T]Set P.J. Unit Penunjang".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set P.J. Unit Penunjang",setup_pjlab,"setup_pjlab"});
        }

        if("[T]Set Oto Lokasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Oto Lokasi",setup_otolokasi,"setup_otolokasi"});
        }

        if("[T]Set Kamar Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Kamar Inap",setup_jam_kamin,"setup_jam_kamin"});
        }

        if("[T]Set Embalase & Tuslah".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Embalase & Tuslah",setup_embalase,"setup_embalase"});
        }

        if("[T]Tracer Login".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Tracer Login",tracer_login,"tracer_login"});
        }

        if("[T]Display Antrian Registrasi & Poli".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Display Antrian Registrasi & Poli",display,"display"});
        }

        if("[T]Set Harga Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Harga Obat",set_harga_obat,"set_harga_obat"});
        }

        if("[T]Set Penggunaan Tarif".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Penggunaan Tarif",set_penggunaan_tarif,"set_penggunaan_tarif"});
        }

        if("[T]Set Oto Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Oto Ralan",set_oto_ralan,"set_oto_ralan"});
        }

        if("[T]Biaya Harian Kamar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Biaya Harian Kamar",biaya_harian,"biaya_harian"});
        }

        if("[T]Biaya Masuk Sekali".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Biaya Masuk Sekali",biaya_masuk_sekali,"biaya_masuk_sekali"});
        }

        if("[T]Set RM".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set RM",set_no_rm,"set_no_rm"});
        }

        if("[T]Set Harga Obat Ralan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Harga Obat Ralan",set_harga_obat_ralan,"set_harga_obat_ralan"});
        }

        if("[T]Set Harga Obat Ranap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Harga Obat Ranap",set_harga_obat_ranap,"set_harga_obat_ranap"});
        }

        if("[T]Set Billing".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Billing",set_nota,"set_nota"});
        }

        if("[T]Closing Kasir".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Closing Kasir",closing_kasir,"closing_kasir"});
        }

        if("[T]Set Keterlambatan Presensi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Keterlambatan Presensi",keterlambatan_presensi,"keterlambatan_presensi"});
        }

        if("[T]Set Harga Kamar".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Harga Kamar",set_harga_kamar,"set_harga_kamar"});
        }

        if("[T]Set Input Parsial".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Input Parsial",set_input_parsial,"set_input_parsial"});
        }

        if("[T]Display Antrian Apotek".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Display Antrian Apotek",display_apotek,"display_apotek"});
        }

        if("[T]Password BPJS".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Password BPJS",password_asuransi,"password_asuransi"});
        }

        if("[T]Set Harga Toko".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Set Harga Toko",toko_set_harga,"toko_set_harga"});
        }

        if("[T]Jam Diet Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Jam Diet Pasien",jam_diet_pasien,"jam_diet_pasien"});
        }

        if("[T]Ruang Operasi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Ruang Operasi",ruang_ok,"ruang_ok"});
        }

        if("[T]Integrasi Khanza Health Services".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[T]Integrasi Khanza Health Services",integrasi_khanza_health_services,"integrasi_khanza_health_services"});
        }
    }
    ...
    private void simpanSmc() {
        for (i = 0; i < tbUser.getRowCount(); i++) {
            if (Boolean.parseBoolean(tbUser.getValueAt(i, 2).toString())) {
                Sequel.mengupdateSmc("user", tbUser.getValueAt(i, 3).toString() + " = ?", "id_user = aes_encrypt(?, 'nur')", tbUser.getValueAt(i, 2).toString(), TKd.getText());
            }
        }
    }
    
    private void Simpan() {
        // fungsi ini hanya digunakan agar perubahan dari upstream tetap bisa masuk ke fungsi ini.
        for(i=0;i<tbUser.getRowCount();i++){
    ...
    private void Simpan2() {
        // fungsi ini hanya digunakan agar perubahan dari upstream tetap bisa masuk
        for(i=0;i<tbUser.getRowCount();i++){ 

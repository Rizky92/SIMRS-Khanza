...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,tindakan_ralan=false,kamar_inap=false,
            ...
            skrining_instrumen_acrs=false,surat_pernyataan_memilih_dpjp=false,antrian_di_registrasi=false,skrining_instrumen_mental_emosional=false,pelanggan_lab_kesehatan_lingkungan=false,kriteria_masuk_nicu=false,kriteria_keluar_nicu=false,
    ...
    private void tampil(String user) {
        ...
        try{
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.skrining_instrumen_acrs,user.surat_pernyataan_memilih_dpjp,user.antrian_di_registrasi,user.skrining_instrumen_mental_emosional,user.pelanggan_lab_kesehatan_lingkungan,user.kriteria_masuk_nicu,"+

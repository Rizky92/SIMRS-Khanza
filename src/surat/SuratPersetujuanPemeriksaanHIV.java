        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataFormulirPersetujuanPemeriksaanHIV.html", "Data Formulir Persetujuan Pemeriksaan HIV", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataFormulirPersetujuanPemeriksaanHIV.wps", "Data Formulir Persetujuan Pemeriksaan HIV", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataFormulirPersetujuanPemeriksaanHIV.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataFormulirPersetujuanPemeriksaanHIV.xlsx", tbObat);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataFormulirPernyataanPasienUmum.html", "Data Formulir Pernyataan Pasien Umum", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataFormulirPernyataanPasienUmum.wps", "Data Formulir Pernyataan Pasien Umum", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataFormulirPernyataanPasienUmum.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataFormulirPernyataanPasienUmum.xlsx", tbObat);
                        break;

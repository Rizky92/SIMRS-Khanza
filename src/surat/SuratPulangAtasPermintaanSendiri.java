        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataFormulirPulangAtasPermintaanSendiri.html", "Data Formulir Pulang Atas Permintaan Sendiri", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataFormulirPulangAtasPermintaanSendiri.wps", "Data Formulir Pulang Atas Permintaan Sendiri", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataFormulirPulangAtasPermintaanSendiri.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataFormulirPulangAtasPermintaanSendiri.xlsx", tbObat);
                        break;

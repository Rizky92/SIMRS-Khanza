        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Resep.html", "Daftar Pemberian Obat Resep", tbResep);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Resep.wps", "Daftar Pemberian Obat Resep", tbResep);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Resep.csv", tbResep);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Resep.xlsx", tbResep);
                        break;

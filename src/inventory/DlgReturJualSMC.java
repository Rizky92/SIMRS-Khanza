...
public class DlgReturJualSMC extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgReturJualSMC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgReturJualSMC dialog = new DlgReturJualSMC(new javax.swing.JFrame(), true);

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ReturPiutang.html", "Transaksi Retur Piutang", tbRetur);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ReturPiutang.wps", "Transaksi Retur Piutang", tbRetur);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ReturPiutang.csv", tbRetur);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ReturPiutang.xlsx", tbRetur);
                        break;

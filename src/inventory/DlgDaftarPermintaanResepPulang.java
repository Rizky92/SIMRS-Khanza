        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DaftarResepPulang.html", "Daftar Permintaan Resep Pulang", tbPemisahan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DaftarResepPulang.wps", "Daftar Permintaan Resep Pulang", tbPemisahan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DaftarResepPulang.csv", tbPemisahan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DaftarResepPulang.xlsx", tbPemisahan);
                        break;

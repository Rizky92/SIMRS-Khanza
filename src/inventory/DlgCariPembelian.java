            ...
            try {
                ...
                try {
                   ...
                   if(rs.next()){
                       ...
                       if(sukses==true){
                            jur.bersihkan();
                            if (sukses) sukses = jur.tampung(akunpengadaan, "PENGADAAN OBAT", 0, rs.getDouble("total2"));
                           if(rs.getDouble("ppn")>0){
                           }
                           if (sukses) sukses = jur.tampung(rs.getString("kd_rek"), "AKUN BAYAR", rs.getDouble("tagihan"), 0);

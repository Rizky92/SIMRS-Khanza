        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                String pilihan = (String) JOptionPane.showInputDialog(null, "Silahkan pilih laporan..!", "Pilihan Cetak", JOptionPane.QUESTION_MESSAGE, null, new Object[] {"Laporan 1 (HTML)", "Laporan 2 (WPS)", "Laporan 3 (CSV)", "Laporan 4 (XLSX)", "Laporan 5 (Jasper)"}, "Laporan 5 (Jasper)");                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ReturJual.html", "Transaksi Retur Jual", tbRetur);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ReturJual.wps", "Transaksi Retur Jual", tbRetur);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ReturJual.csv", tbRetur);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ReturJual.xlsx", tbRetur);
                        break;

        ...
        if(TabRawat1.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("RekapObatPasien.html", "Rekap Penggunaan Obat Per Pasien", tbDokter);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("RekapObatPasien.wps", "Rekap Penggunaan Obat Per Pasien", tbDokter);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("RekapObatPasien.csv", tbDokter);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("RekapObatPasien.xlsx", tbDokter);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("RekapObatPasien.html", "Rekap Penggunaan Obat Per Pasien", tbDokter2);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("RekapObatPasien.wps", "Rekap Penggunaan Obat Per Pasien", tbDokter2);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("RekapObatPasien.csv", tbDokter2);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("RekapObatPasien.xlsx", tbDokter2);
                            break;
                        case "Laporan 5 (Jasper)":
                            Sequel.queryu("delete from temporary where temp37='"+akses.getalamatip()+"'");

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanReturSuplierObat.html", "Laporan Ringkasan Retur Ke Suplier Obat/Alkes/BHP Medis", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanReturSuplierObat.wps", "Laporan Ringkasan Retur Ke Suplier Obat/Alkes/BHP Medis", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanReturSuplierObat.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RingkasanReturSuplierObat.xlsx", tbDokter);
                        break;

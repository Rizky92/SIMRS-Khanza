            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                    ...
                    if(sukses){
                        jur.clear();
                        if(ttljual>0){
                            if (sukses) sukses = jur.tampung(Suspen_Piutang_Obat_Ranap, ttljual, 0);
                            if (sukses) sukses = jur.tampung(Obat_Ranap, 0, ttljual);
                        }
                        if(ttlhpp>0){
                            if (sukses) sukses = jur.tampung(HPP_Obat_Rawat_Inap, ttlhpp, 0);
                            if (sukses) sukses = jur.tampung(Persediaan_Obat_Rawat_Inap, 0, ttlhpp);
                        }

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Sirkulasi.html", "Sirkulasi Barang", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Sirkulasi.wps", "Sirkulasi Barang", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Sirkulasi.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Sirkulasi.xlsx", tbDokter);
                        break;

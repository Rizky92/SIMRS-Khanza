        ...
        if(nmgudang.getText().trim().equals("")||kdgudang.getText().trim().equals("")){
            ...
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("InputStokOpname.html", "Data Persediaan Stok Ruangan", tbDokter);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("InputStokOpname.wps", "Data Persediaan Stok Ruangan", tbDokter);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("InputStokOpname.csv", tbDokter);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("InputStokOpname.xlsx", tbDokter);
                            break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanBiayaObatPasienPertanggal.html", "Ringkasan Biaya Obat Pasien Per Tanggal", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanBiayaObatPasienPertanggal.wps", "Ringkasan Biaya Obat Pasien Per Tanggal", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanBiayaObatPasienPertanggal.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RingkasanBiayaObatPasienPertanggal.xlsx", tbDokter);
                        break;

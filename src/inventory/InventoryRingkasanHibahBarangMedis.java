        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanHibahObat.html", "Laporan Ringkasan Penerimaan Obat/Alkes/BHP Medis", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanHibahObat.wps", "Laporan Ringkasan Penerimaan Obat/Alkes/BHP Medis", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanHibahObat.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RingkasanHibahObat.xlsx", tbDokter);
                        break;

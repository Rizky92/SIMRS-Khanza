        ...
        if(tabModePO.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BrObt.html", "Rekam Data Pemberian Obat (UMUM)", tbPemberianObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BrObt.wps", "Rekam Data Pemberian Obat (UMUM)", tbPemberianObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BrObt.csv", tbPemberianObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BrObt.xlsx", tbPemberianObat);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DaftarResep3.html", "Daftar Permintaan Stok Obat Pasien", tbPemisahan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DaftarResep3.wps", "Daftar Permintaan Stok Obat Pasien", tbPemisahan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DaftarResep3.csv", tbPemisahan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DaftarResep3.xlsx", tbPemisahan);
                        break;

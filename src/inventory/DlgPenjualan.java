                    ...
                    try {
                        ...
                        switch (pilihanetiket) {
                            case "Cetak Aturan Pakai Model 1":
                                ...
                                if(Sequel.cariInteger("select count(*) from detailjual where nota_jual=? and aturan_pakai<>''",NoNota.getText())>0){
                                ...
                                if(Sequel.cariInteger("select count(*) from obat_racikan_jual where nota_jual=? and aturan_pakai<>''",NoNota.getText())>0){
                                    param.put("logo",Sequel.cariGambar("select setting.logo from setting"));

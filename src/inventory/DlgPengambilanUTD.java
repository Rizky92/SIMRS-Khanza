        ...
        if(nmdari.getText().trim().equals("")||kddari.getText().trim().equals("")){
            ...
            if (i == JOptionPane.YES_OPTION) {
                ...
                if(sukses==true){
                    ...
                    if (sukses) sukses = jur.simpanJurnalSMC(Valid.SetTgl(Tanggal.getSelectedItem()+"").replaceAll("-","/"),"U","PENGAMBILAN BHP MEDIS UTD DARI "+nmdari.getText().toUpperCase()+", OLEH "+akses.getkode());
                }

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ResepPulang.html", "Data Resep Pulang", tbResep);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ResepPulang.wps", "Data Resep Pulang", tbResep);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ResepPulang.csv", tbResep);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ResepPulang.xlsx", tbResep);
                        break;

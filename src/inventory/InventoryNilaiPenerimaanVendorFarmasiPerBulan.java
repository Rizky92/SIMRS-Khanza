        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("InventoryNilaiPenerimaanVendorFarmasiPerBulan.html", "Nilai Penerimaan Vendor Farmasi Per Bulan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("InventoryNilaiPenerimaanVendorFarmasiPerBulan.wps", "Nilai Penerimaan Vendor Farmasi Per Bulan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("InventoryNilaiPenerimaanVendorFarmasiPerBulan.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("InventoryNilaiPenerimaanVendorFarmasiPerBulan.xlsx", tbDokter);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PenerbitPerpustakaan.html", "Data Penerbit Perpustakaan", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PenerbitPerpustakaan.wps", "Data Penerbit Perpustakaan", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PenerbitPerpustakaan.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PenerbitPerpustakaan.xlsx", tbJnsPerawatan);
                        break;

...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,cuti_dokter=false,petugas=false,pasien=false,registrasi=false,
            ...
            try(
                ...
                try(
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.cuti_dokter=rs2.getBoolean("cuti_dokter");
    ...
    public static boolean getcuti_dokter(){return akses.cuti_dokter;}

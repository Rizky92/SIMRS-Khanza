        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("JadwalPegawai.html", "Jadwal Masuk Tambahan Pegawai", tbJadwal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("JadwalPegawai.wps", "Jadwal Masuk Tambahan Pegawai", tbJadwal);
                        break;
                    case "Laporan 3 (CSV)":

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("AuditPembuanganLimbahCairInfeksius.html", "Data Audit Pembuangan Limbah Cair Infeksius", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("AuditPembuanganLimbahCairInfeksius.wps", "Data Audit Pembuangan Limbah Cair Infeksius", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("AuditPembuanganLimbahCairInfeksius.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("AuditPembuanganLimbahCairInfeksius.xlsx", tbObat);
                        break;

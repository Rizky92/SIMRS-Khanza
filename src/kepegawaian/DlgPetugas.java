        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Petugas.html", "Data Petugas", tbPetugas);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Petugas.wps", "Data Petugas", tbPetugas);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Petugas.csv", tbPetugas);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Petugas.xlsx", tbPetugas);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("TemporaryPresensi.html", "Temporary Presensi", tbTemporary);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("TemporaryPresensi.wps", "Temporary Presensi", tbTemporary);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("TemporaryPresensi.csv", tbTemporary);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("TemporaryPresensi.xlsx", tbTemporary);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("AuditFasilitasKebersihanTangan.html", "Data Audit Fasilitas Kebersihan Tangan", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("AuditFasilitasKebersihanTangan.wps", "Data Audit Fasilitas Kebersihan Tangan", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("AuditFasilitasKebersihanTangan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("AuditFasilitasKebersihanTangan.xlsx", tbObat);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("InsidenKeselamatan.html", "Master Insiden Kecelakaan", tbPenyakit);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("InsidenKeselamatan.wps", "Master Insiden Kecelakaan", tbPenyakit);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("InsidenKeselamatan.csv", tbPenyakit);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("InsidenKeselamatan.xlsx", tbPenyakit);
                        break;

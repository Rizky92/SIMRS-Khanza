        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Pengaduan.html", "Data Pengaduan", tbPengaduan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Pengaduan.wps", "Data Pengaduan", tbPengaduan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Pengaduan.csv", tbPengaduan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Pengaduan.xlsx", tbPengaduan);
                        break;

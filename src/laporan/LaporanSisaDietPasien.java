        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("SisaDiet.html", "Data Pemberian Diet", tbDataDiet);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("SisaDiet.wps", "Data Pemberian Diet", tbDataDiet);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("SisaDiet.csv", tbDataDiet);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("SisaDiet.xlsx", tbDataDiet);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("AnggotaMiliterDirawat.html", "Laporan Anggota Militer/PNS & Keluarga Yang Dirawat", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("AnggotaMiliterDirawat.wps", "Laporan Anggota Militer/PNS & Keluarga Yang Dirawat", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("AnggotaMiliterDirawat.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("AnggotaMiliterDirawat.xlsx", tbBangsal);
                        break;

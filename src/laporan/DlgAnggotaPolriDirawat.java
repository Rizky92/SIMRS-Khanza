        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("AnggotaPolriDirawat.html", "Laporan Anggota Polri/PNS & Keluarga Yang Dirawat", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("AnggotaPolriDirawat.wps", "Laporan Anggota Polri/PNS & Keluarga Yang Dirawat", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("AnggotaPolriDirawat.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("AnggotaPolriDirawat.xlsx", tbBangsal);
                        break;

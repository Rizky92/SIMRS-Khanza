        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ICD9.html", "Data Prosedur", tbPenyakit);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ICD9.wps", "Data Prosedur", tbPenyakit);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ICD9.csv", tbPenyakit);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ICD9.xlsx", tbPenyakit);
                        break;

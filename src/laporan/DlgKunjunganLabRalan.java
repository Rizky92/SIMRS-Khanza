        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KunjunganLabRalan.html", "Laporan Kunjungan Laboratorium Rawat Jalan", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KunjunganLabRalan.wps", "Laporan Kunjungan Laboratorium Rawat Jalan", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KunjunganLabRalan.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KunjunganLabRalan.xlsx", tbBangsal);
                        break;

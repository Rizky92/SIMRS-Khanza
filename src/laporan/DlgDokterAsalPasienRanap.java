        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DokterAsalPasienRanap.html", "Laporan Dokter Asal Pasien Ranap", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DokterAsalPasienRanap.wps", "Laporan Dokter Asal Pasien Ranap", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DokterAsalPasienRanap.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DokterAsalPasienRanap.xlsx", tbBangsal);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DaftarPasienRanapPolri.html", "Laporan Daftar Nama Pasien Ranap POLRI", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DaftarPasienRanapPolri.wps", "Laporan Daftar Nama Pasien Ranap POLRI", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DaftarPasienRanapPolri.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DaftarPasienRanapPolri.xlsx", tbBangsal);
                        break;

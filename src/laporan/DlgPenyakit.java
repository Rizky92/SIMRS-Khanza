        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Penyakit.html", "Data Penyakit", tbPenyakit);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Penyakit.wps", "Data Penyakit", tbPenyakit);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Penyakit.csv", tbPenyakit);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Penyakit.xlsx", tbPenyakit);
                        break;

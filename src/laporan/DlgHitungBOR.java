        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("HitungBor.html", "Data Hitung BOR", Tabel1);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("HitungBor.wps", "Data Hitung BOR", Tabel1);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("HitungBor.csv", Tabel1);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("HitungBor.xlsx", Tabel1);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("HitungBor.html", "Data Hitung BOR", Tabel2);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("HitungBor.wps", "Data Hitung BOR", Tabel2);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("HitungBor.csv", Tabel2);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("HitungBor.xlsx", Tabel2);
                            break;
                        case "Laporan 5 (Jasper)":
                            Map<String, Object> param = new HashMap<>();
                            param.put("namars",akses.getnamars());

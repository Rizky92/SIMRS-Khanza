        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PembatalanPeriksaPerDokter.html", "Laporan Pembatalan Periksa Rawat Jalan Per Dokter", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PembatalanPeriksaPerDokter.wps", "Laporan Pembatalan Periksa Rawat Jalan Per Dokter", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PembatalanPeriksaPerDokter.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PembatalanPeriksaPerDokter.xlsx", tbBangsal);
                        break;

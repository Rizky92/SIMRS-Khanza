        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KtgPenyakit.html", "Data Kategori Penyakit", tbKtgPny);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KtgPenyakit.wps", "Data Kategori Penyakit", tbKtgPny);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KtgPenyakit.csv", tbKtgPny);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KtgPenyakit.xlsx", tbKtgPny);
                        break;

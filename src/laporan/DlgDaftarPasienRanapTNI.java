        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DaftarPasienRanapTNI.html", "Laporan Daftar Nama Pasien Ranap TNI", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DaftarPasienRanapTNI.wps", "Laporan Daftar Nama Pasien Ranap TNI", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DaftarPasienRanapTNI.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DaftarPasienRanapTNI.xlsx", tbBangsal);
                        break;

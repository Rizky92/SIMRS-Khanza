        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PerujukRadiologiPerTahun.html", "Laporan Rekap Perujuk Laboratorium Per Tahun", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PerujukRadiologiPerTahun.wps", "Laporan Rekap Perujuk Laboratorium Per Tahun", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PerujukRadiologiPerTahun.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PerujukRadiologiPerTahun.xlsx", tbBangsal);
                        break;

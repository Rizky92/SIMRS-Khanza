        ...
        if(tbKamIn.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("SirkulasiBerkas.html", "Data Peminjaman Dan Pengembalian Berkas Rekam Medis", tbKamIn);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("SirkulasiBerkas.wps", "Data Peminjaman Dan Pengembalian Berkas Rekam Medis", tbKamIn);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("SirkulasiBerkas.csv", tbKamIn);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("SirkulasiBerkas.xlsx", tbKamIn);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RegistrasiPoliPerTanggal.html", "Registrasi Poli Per Tanggal", tbJadwal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RegistrasiPoliPerTanggal.wps", "Registrasi Poli Per Tanggal", tbJadwal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RegistrasiPoliPerTanggal.csv", tbJadwal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RegistrasiPoliPerTanggal.xlsx", tbJadwal);
                        break;

        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("HitungAlos.html", "Data Hitung ALOS", Tabel1);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("HitungAlos.wps", "Data Hitung ALOS", Tabel1);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("HitungAlos.csv", Tabel1);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("HitungAlos.xlsx", Tabel1);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("HitungAlos.html", "Data Hitung ALOS", Tabel2);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("HitungAlos.wps", "Data Hitung ALOS", Tabel2);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("HitungAlos.csv", Tabel2);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("HitungAlos.xlsx", Tabel2);
                            break;
                        case "Laporan 5 (Jasper)":
                            Map<String, Object> param = new HashMap<>();
                            param.put("namars",akses.getnamars());

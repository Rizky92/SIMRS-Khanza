        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("PenyakitRanapCaraBayar.html", "Laporan Penyakit Rawat Inap Per Cara Bayar", tbBangsal);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("PenyakitRanapCaraBayar.wps", "Laporan Penyakit Rawat Inap Per Cara Bayar", tbBangsal);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("PenyakitRanapCaraBayar.csv", tbBangsal);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("PenyakitRanapCaraBayar.xlsx", tbBangsal);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("PenyakitRanapCaraBayar.html", "Laporan Penyakit Rawat Inap Per Cara Bayar", tbBangsal2);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("PenyakitRanapCaraBayar.wps", "Laporan Penyakit Rawat Inap Per Cara Bayar", tbBangsal2);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("PenyakitRanapCaraBayar.csv", tbBangsal2);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("PenyakitRanapCaraBayar.xlsx", tbBangsal2);
                            break;
                        case "Laporan 5 (Jasper)":
                            Map<String, Object> param = new HashMap<>();
                            param.put("namars",akses.getnamars());

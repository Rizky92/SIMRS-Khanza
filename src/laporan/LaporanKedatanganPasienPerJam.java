        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KedatanganPasienPerJam.html", "Kedatangan Pasien Per Jam", tbJadwal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KedatanganPasienPerJam.wps", "Kedatangan Pasien Per Jam", tbJadwal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KedatanganPasienPerJam.csv", tbJadwal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KedatanganPasienPerJam.xlsx", tbJadwal);
                        break;

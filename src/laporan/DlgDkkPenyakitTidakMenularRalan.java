        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DkkPenyakitTakMenularRalan.html", "Penyakit Tidak Menular Rawat Jalan", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DkkPenyakitTakMenularRalan.wps", "Penyakit Tidak Menular Rawat Jalan", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DkkPenyakitTakMenularRalan.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DkkPenyakitTakMenularRalan.xlsx", tbBangsal);
                        break;

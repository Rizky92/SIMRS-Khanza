        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("RanapPerRuang.html", "Laporan Rawat Inap Per Ruang", tbBangsal);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("RanapPerRuang.wps", "Laporan Rawat Inap Per Ruang", tbBangsal);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("RanapPerRuang.csv", tbBangsal);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("RanapPerRuang.xlsx", tbBangsal);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("RanapPerRuang.html", "Laporan Rawat Inap Per Ruang", tbBangsal2);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("RanapPerRuang.wps", "Laporan Rawat Inap Per Ruang", tbBangsal2);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("RanapPerRuang.csv", tbBangsal2);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("RanapPerRuang.xlsx", tbBangsal2);
                            break;
                        case "Laporan 5 (Jasper)":
                            Map<String, Object> param = new HashMap<>();
                            param.put("namars",akses.getnamars());

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PerujukLabPerTahun.html", "Laporan Rekap Perujuk Laboratorium Per Tahun", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PerujukLabPerTahun.wps", "Laporan Rekap Perujuk Laboratorium Per Tahun", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PerujukLabPerTahun.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PerujukLabPerTahun.xlsx", tbBangsal);
                        break;

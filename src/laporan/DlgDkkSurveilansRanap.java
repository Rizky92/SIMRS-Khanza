        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("SurveilansRanap.html", "Surveilans PD3I", tbBangsal);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("SurveilansRanap.wps", "Surveilans PD3I", tbBangsal);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("SurveilansRanap.csv", tbBangsal);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("SurveilansRanap.xlsx", tbBangsal);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("SurveilansRanap.html", "Surveilans PD3I", tbBangsal2);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("SurveilansRanap.wps", "Surveilans PD3I", tbBangsal2);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("SurveilansRanap.csv", tbBangsal2);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("SurveilansRanap.xlsx", tbBangsal2);
                            break;
                        case "Laporan 5 (Jasper)":
                            Sequel.queryu("delete from temporary where temp37='"+akses.getalamatip()+"'");
                            Map<String, Object> param = new HashMap<>();

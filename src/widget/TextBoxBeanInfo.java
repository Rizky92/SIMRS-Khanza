...
//GEN-HEADEREND:Properties
        try {
            PropertyDescriptor placeholderTextDescriptor = new PropertyDescriptor("placeholderText", TextBox.class);
            placeholderTextDescriptor.setValue("default", "");
            List<PropertyDescriptor> list = Arrays.asList(properties);
            list.add(placeholderTextDescriptor);

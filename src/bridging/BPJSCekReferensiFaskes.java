    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariBPJSReferensiFaskes.html", "Pencarian Referensi Faskes", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariBPJSReferensiFaskes.wps", "Pencarian Referensi Faskes", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariSisruteReferensiAlasanRujuk.html", "Pencarian Referensi Alasan Rujuk", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariSisruteReferensiAlasanRujuk.wps", "Pencarian Referensi Alasan Rujuk", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariSisruteReferensiAlasanRujuk.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariSisruteReferensiAlasanRujuk.xlsx", tbKamar);
                        break;

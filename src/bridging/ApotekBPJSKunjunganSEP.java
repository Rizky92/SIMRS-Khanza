    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariBPJSKunjunganSEPApotek.html", "Pencarian SEP Apotek BPJS", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariBPJSKunjunganSEPApotek.wps", "Pencarian SEP Apotek BPJS", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariBPJSKunjunganSEPApotek.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariBPJSKunjunganSEPApotek.xlsx", tbKamar);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptCariBPJSKunjunganSEPApotek.jasper", "report", "::[ Pencarian SEP Apotek BPJS ]::", param);
                        break;
                }
            } catch (Exception e) {

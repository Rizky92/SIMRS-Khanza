    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MapingTindakanInhealth.html", "Mapping Tarif Rawat Jalan Inhealth", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MapingTindakanInhealth.wps", "Mapping Tarif Rawat Jalan Inhealth", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MapingTindakanInhealth.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MapingTindakanInhealth.xlsx", tbJnsPerawatan);
                        break;

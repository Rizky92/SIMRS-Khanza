        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MapingOrganisasiSatuSehat.html", "Mapping Departemen/Organisasi Satu Sehat Kemenkes", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MapingOrganisasiSatuSehat.wps", "Mapping Departemen/Organisasi Satu Sehat Kemenkes", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MapingOrganisasiSatuSehat.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MapingOrganisasiSatuSehat.xlsx", tbJnsPerawatan);
                        break;

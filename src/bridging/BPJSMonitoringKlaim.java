    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BridgingMonitoringSEP.html", "Monitoring Klaim SEP", tbDokter, 0, 1, 3, 4, 11, 29, 37, 38, 39);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BridgingMonitoringSEP.wps", "Monitoring Klaim SEP", tbDokter, 0, 1, 3, 4, 11, 29, 37, 38, 39);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BridgingMonitoringSEP.csv", tbDokter, 0, 1, 3, 4, 11, 29, 37, 38, 39);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BridgingMonitoringSEP.xlsx", tbDokter, 0, 1, 3, 4, 11, 29, 37, 38, 39);
                        break;

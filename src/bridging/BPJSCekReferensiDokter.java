    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariBPJSReferensiDokter.html", "Pencarian Referensi Dokter", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariBPJSReferensiDokter.wps", "Pencarian Referensi Dokter", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSatuSehatDiagnosticReportRadiologi.html", "Data Diagnostic Report Radiologi Satu Sehat", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSatuSehatDiagnosticReportRadiologi.wps", "Data Diagnostic Report Radiologi Satu Sehat", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSatuSehatDiagnosticReportRadiologi.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataSatuSehatDiagnosticReportRadiologi.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("kd_jenis_prw"),rs.getString("id_specimen"),rs.getString("id_observation"),rs.getString("id_diagnosticreport"),rs.getString("hasil"),accession.ambilAccession(rs.getString("noorder"),rs.getString("kd_jenis_prw"))
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);

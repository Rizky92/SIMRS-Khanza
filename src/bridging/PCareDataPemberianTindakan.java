    ...
    if(TabRawat.getSelectedIndex()==0){
        if(tbDokter.getSelectedRow()!= -1){
            if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString())>0){
                ...
                if(ttlpendapatan>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Suspen_Piutang_Tindakan_Ralan, "Suspen Piutang Tindakan Ralan", 0, ttlpendapatan);
                    if (sukses) sukses = Sequel.insertTampJurnal(Tindakan_Ralan, "Pendapatan Tindakan Rawat Jalan", ttlpendapatan, 0);
                }
                if(ttljmdokter>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Medik_Dokter_Tindakan_Ralan, "Beban Jasa Medik Dokter Tindakan Ralan", 0, ttljmdokter);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Dokter_Tindakan_Ralan, "Utang Jasa Medik Dokter Tindakan Ralan", ttljmdokter, 0);
                }
                if(ttljmperawat>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Medik_Paramedis_Tindakan_Ralan, "Beban Jasa Medik Paramedis Tindakan Ralan", 0, ttljmperawat);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Paramedis_Tindakan_Ralan, "Utang Jasa Medik Paramedis Tindakan Ralan", ttljmperawat, 0);
                }
                if(ttlkso>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_KSO_Tindakan_Ralan, "Beban KSO Tindakan Ralan", 0, ttlkso);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_KSO_Tindakan_Ralan, "Utang KSO Tindakan Ralan", ttlkso, 0);
                }
                if(ttlmenejemen>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Menejemen_Tindakan_Ralan, "Beban Jasa Manajemen Tindakan Ralan", 0, ttlmenejemen);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Menejemen_Tindakan_Ralan, "Utang Jasa Manajemen Tindakan Ralan", ttlmenejemen, 0);
                }
                if(ttljasasarana>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Sarana_Tindakan_Ralan, "Beban Jasa Sarana Tindakan Ralan", 0, ttljasasarana);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Sarana_Tindakan_Ralan, "Utang Jasa Sarana Tindakan Ralan", ttljasasarana, 0);
                }
                if(ttlbhp>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(HPP_BHP_Tindakan_Ralan, "HPP BHP Tindakan Ralan", 0, ttlbhp);
                    if (sukses) sukses = Sequel.insertTampJurnal(Persediaan_BHP_Tindakan_Ralan, "Persediaan BHP Tindakan Ralan", ttlbhp, 0);
                }
        ...
        if(tbDokter2.getSelectedRow()!= -1){
            if(Sequel.cariRegistrasi(tbDokter2.getValueAt(tbDokter2.getSelectedRow(),3).toString())>0){
                ...
                if(ttljmdokter>0){
                    ...
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Dokter_Tindakan_Ranap, "Utang Jasa Medik Dokter Tindakan Ranap", ttljmdokter, 0);
                }
                if(ttljmperawat>0){
                    ...
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Paramedis_Tindakan_Ranap, "Utang Jasa Medik Paramedis Tindakan Ranap", ttljmperawat, 0);
                }
                if(ttlkso>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_KSO_Tindakan_Ranap, "Beban KSO Tindakan Ranap", 0, ttlkso);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_KSO_Tindakan_Ranap, "Utang KSO Tindakan Ranap", ttlkso, 0);
                }
                if(ttlmenejemen>0){
                    if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Menejemen_Tindakan_Ranap, "Beban Jasa Manajemen Tindakan Ranap", 0, ttlmenejemen);
                    if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Menejemen_Tindakan_Ranap, "Utang Jasa Manajemen Tindakan Ranap", ttlmenejemen, 0);
                }
                if(ttljasasarana>0){

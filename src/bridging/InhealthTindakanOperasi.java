        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MapingTindakanInhealthOperasi.html", "Mapping Tarif Operasi Inhealth", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MapingTindakanInhealthOperasi.wps", "Mapping Tarif Operasi Inhealth", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MapingTindakanInhealthOperasi.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MapingTindakanInhealthOperasi.xlsx", tbJnsPerawatan);
                        break;

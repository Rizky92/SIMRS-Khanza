    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariBPJSReferensiObatApotek.html", "Pencarian Referensi Obat Apotek BPJS", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariBPJSReferensiObatApotek.wps", "Pencarian Referensi Obat Apotek BPJS", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariBPJSReferensiObatApotek.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariBPJSReferensiObatApotek.xlsx", tbKamar);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptCariBPJSReferensiObatApotek.jasper", "report", "::[ Pencarian Referensi Obat Apotek BPJS ]::", param);
                        break;
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);

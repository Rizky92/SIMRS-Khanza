    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BPJSAntreanPerTanggal.html", "Daftar Pelayanan Apotek BPJS", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BPJSAntreanPerTanggal.wps", "Daftar Pelayanan Apotek BPJS", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BPJSAntreanPerTanggal.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BPJSAntreanPerTanggal.xlsx", tbJnsPerawatan);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptBPJSAntreanPerTanggal.jasper", "report", "::[ Daftar Pelayanan Apotek BPJS ]::", param);
                        break;
                }
            } catch (Exception e) {

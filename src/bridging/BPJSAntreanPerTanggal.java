    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BPJSAntreanPerTanggal.html", "Antrean BPJS Per Tanggal", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BPJSAntreanPerTanggal.wps", "Antrean BPJS Per Tanggal", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                    ...
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptBPJSAntreanPerTanggal.jasper", "report", "::[ Antrean BPJS Per Tanggal ]::", param);
                        break;
                }
            } catch (Exception e) {

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariSisruteReferensiDiagnosa.html", "Pencarian Referensi Diagnosa", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariSisruteReferensiDiagnosa.wps", "Pencarian Referensi Diagnosa", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariSisruteReferensiDiagnosa.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariSisruteReferensiDiagnosa.xlsx", tbKamar);
                        break;

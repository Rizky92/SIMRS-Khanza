        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BatalPendaftaranMobileJKN.html", "Data Batal Pendaftaran Mobile JKN", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BatalPendaftaranMobileJKN.wps", "Data Batal Pendaftaran Mobile JKN", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BatalPendaftaranMobileJKN.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BatalPendaftaranMobileJKN.xlsx", tbJnsPerawatan);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MapingVaksinSatuSehat.html", "Mapping Vaksin Satu Sehat Kemenkes", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MapingVaksinSatuSehat.wps", "Mapping Vaksin Satu Sehat Kemenkes", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MapingVaksinSatuSehat.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MapingVaksinSatuSehat.xlsx", tbJnsPerawatan);
                        break;

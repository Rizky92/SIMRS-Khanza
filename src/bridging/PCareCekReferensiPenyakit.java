        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariPCAREReferensiDiagnosa.html", "Pencarian Referensi Diagnosa", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariPCAREReferensiDiagnosa.wps", "Pencarian Referensi Diagnosa", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariPCAREReferensiDiagnosa.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariPCAREReferensiDiagnosa.xlsx", tbKamar);
                        break;

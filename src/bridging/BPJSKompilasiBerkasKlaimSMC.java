...
public class BPJSKompilasiBerkasKlaimSMC extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.add(scrollPane9, java.awt.BorderLayout.LINE_END);
        ...
        tabPane1.addTab("Riwayat Perawatan", scrollPane2);

        scrollPane3.setName("scrollPane3"); // NOI18N
        tabPane1.addTab("Billing", scrollPane3);

        scrollPane4.setName("scrollPane4"); // NOI18N
        tabPane1.addTab("Keleongkapan Berkas", scrollPane4);

        scrollPane5.setName("scrollPane5"); // NOI18N
        tabPane1.addTab("INACBG", scrollPane5);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSKompilasiBerkasKlaimSMC dialog = new BPJSKompilasiBerkasKlaimSMC(new javax.swing.JFrame(), true);

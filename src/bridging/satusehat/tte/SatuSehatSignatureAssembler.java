...
public class SatuSehatSignatureAssembler {
    ...
    public static class Hasil {
        ...
        public List<DlgTTESatuSehat.DokumenTte> dokumen = new ArrayList<>();
    ...
    private void perluasPenanda(Hasil h) {
        List<DlgTTESatuSehat.DokumenTte> tambahan = new ArrayList<>();
        for (DlgTTESatuSehat.DokumenTte d : h.dokumen) {
            ...
            List<DlgTTESatuSehat.DokumenTte> barisSlot = new ArrayList<>();
            ...
            for (SatuSehatTteModel.Slot slot : aturan.slot) {
                ...
                for (String[] orang : penanda) {
                    ...
                    DlgTTESatuSehat.DokumenTte baris = new DlgTTESatuSehat.DokumenTte(
            ...
            DlgTTESatuSehat.DokumenTte pertama = barisSlot.get(0);
        ...
        try (PreparedStatement p = koneksi.prepareStatement(
            ...
            try (ResultSet r = p.executeQuery()) {
                while (r.next()) {
                    ...
                    DlgTTESatuSehat.DokumenTte d =
                            new DlgTTESatuSehat.DokumenTte(label, "Composition/" + id, display);
    ...
    private void tambahResume(String noRawat, String tabel, String label, Hasil h) {
        try {
            ...
            if (r.next()) {
                String id = nz(r.getString("id_composition"));
                if (!id.equals("")) {
                    h.dokumen.add(new DlgTTESatuSehat.DokumenTte(label, "Composition/" + id, label));
                }
            }
            r.close();
            p.close();
        ...
        try (PreparedStatement p = koneksi.prepareStatement(
            ...
            try (ResultSet r = p.executeQuery()) {
                if (r.next()) {
                    ...
                    if (!id.equals("")) {
                        h.dokumen.add(new DlgTTESatuSehat.DokumenTte(
            ...
            try (ResultSet r = p.executeQuery()) {
                while (r.next()) {
                    ...
                    if (aturan.slot.isEmpty()) {
                        ...
                        DlgTTESatuSehat.DokumenTte d = new DlgTTESatuSehat.DokumenTte(

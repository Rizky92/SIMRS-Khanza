 ...
 */
public class DlgTTESatuSehat extends JDialog {
            ...
            @Override protected void done() {
                ...
                try {
                    ...
                    if (uuid == null || uuid.equals("")) {
                        JOptionPane.showMessageDialog(DlgTTESatuSehat.this, "Gagal membuat Task (UUID kosong).");
                        return;
                    }
                    refreshDokTabel();
                    bukaPopupQr(uuid);
                    ...
                    if (body.contains("duplicate") || body.contains("20002")) {
                        ...
                        JOptionPane.showMessageDialog(DlgTTESatuSehat.this, "Gagal membuat TTE:\n" + pesan(ex));
                    }
            ...
            @Override protected void done() {
                try {
                    ...
                    if (agg == SatuSehatSignatureState.Status.SUDAH) {
                        ...
                        tutupPopupQr();
                        JOptionPane.showMessageDialog(DlgTTESatuSehat.this, ringkasHasilCampuran(uuid));
                    }
                } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTTESatuSehat dlg = new DlgTTESatuSehat(new javax.swing.JFrame(), true);

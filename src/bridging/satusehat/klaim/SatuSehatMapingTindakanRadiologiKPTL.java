...
public final class SatuSehatMapingTindakanRadiologiKPTL extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Code.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("satu_sehat_mapping_tindakanradiologi_kptl","?,?,?,?","Mapping Tindakan Radiologi",4,new String[]{
    ...
    */
    ...
    private void tampil() {
        ...
        try{
           //JOIN pakai trim() karena kd_jenis_prw di master jns_perawatan_radiologi banyak yang berspasi
           //depan/belakang, sedangkan kunci mapping bersih. Sama persis dengan cara SatuSehatBilling.lookupKptl.
           ps=koneksi.prepareStatement(
                   ...
                   "satu_sehat_mapping_tindakanradiologi_kptl.display from satu_sehat_mapping_tindakanradiologi_kptl inner join jns_perawatan_radiologi on trim(satu_sehat_mapping_tindakanradiologi_kptl.kd_jenis_prw)=trim(jns_perawatan_radiologi.kd_jenis_prw) "+

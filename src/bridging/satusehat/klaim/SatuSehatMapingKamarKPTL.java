 ...
 * @author dosen
 */
public final class SatuSehatMapingKamarKPTL extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatMapingKamarKPTL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "Code","System","Kd.Kamar","Nama Kamar","Display"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Akomodasi Kamar KPTL Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void btnBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarangActionPerformed
        // Picker kamar (DlgKamar) — sama seperti pola pilih tindakan di dialog KPTL lain.
        // Kolom DlgKamar: [2]=Kode Kamar, [3]=Nama Kamar, [4]=Kelas.
        ...
        pemeriksaan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pemeriksaan.getTable().getSelectedRow()!= -1){
                    KodeTindakan.setText(pemeriksaan.getTable().getValueAt(pemeriksaan.getTable().getSelectedRow(),2).toString());
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Code.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("satu_sehat_mapping_kamar_kptl","?,?,?,?","Mapping Akomodasi Kamar KPTL",4,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,KodeTindakan,"satu_sehat_mapping_kamar_kptl","kd_kamar")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Code.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("satu_sehat_mapping_kamar_kptl","kd_kamar=?","kd_kamar=?,code=?,system=?,display=?",5,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatMapingKamarKPTL dialog = new SatuSehatMapingKamarKPTL(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select m.kd_kamar,concat(ifnull(b.nm_bangsal,''),' - ',ifnull(k.kelas,'')) as nama,m.code,m.system,m.display "+
                   "from satu_sehat_mapping_kamar_kptl m "+
                   "left join kamar k on k.kd_kamar=m.kd_kamar "+
                   "left join bangsal b on b.kd_bangsal=k.kd_bangsal "+
                   (TCari.getText().equals("")?"":"where m.kd_kamar like ? or b.nm_bangsal like ? or m.code like ? or m.display like ? ")+
                   " order by b.nm_bangsal, m.kd_kamar");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("code"),rs.getString("system"),rs.getString("kd_kamar"),rs.getString("nama"),rs.getString("display")
                    });
                }
            } catch (Exception e) {

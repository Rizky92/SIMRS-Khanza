 ...
 * @author dosen
 */
public final class SatuSehatKirimDicomBerkas extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimDicomBerkas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            ...
            "No.KTP Dokter", "ID Encounter", "Accession Number", "Tgl Convert", "Tipe Sumber",
            "Modality", "SOP Class UID", "Study Instance UID", "Lokasi File DICOM", "ID Service Request",
            "ID Imaging", "Kode Berkas"
        }) {
            @Override
        ...
        for (i = 0; i < 19; i++) {
            ...
            if (i == 0) {
                ...
                // ID Service Request tidak relevan untuk berkas dokumen -> disembunyikan.
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ KIRIM DICOM BERKAS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            htmlContent.append(
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>ID Imaging</b></td>"
                    + "</tr>"
            );
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        siapkanTabelLogDicomRouter();
        for (i = 0; i < tbObat.getRowCount(); i++) {
            // Berkas dikirim bila dicentang dan path file DICOM lokal tersedia (col 15).
            if (tbObat.getValueAt(i, 0).toString().equals("true") && !tbObat.getValueAt(i, 15).toString().equals("")) {
                String noRawat = tbObat.getValueAt(i, 1).toString();
                String kode = tbObat.getValueAt(i, 18).toString();
                String accession = tbObat.getValueAt(i, 9).toString();
                String idEncounter = tbObat.getValueAt(i, 8).toString();
                String lokasiFileDicom = tbObat.getValueAt(i, 15).toString();
                String idImaging = tbObat.getValueAt(i, 17).toString();
                try {
...
//                            System.err.println("Error Response Body: " + e.getResponseBodyAsString());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimDicomBerkas dialog = new SatuSehatKirimDicomBerkas(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        if (ChkBelumTerkirim.isSelected() == true) {
            belumterkirim = " (satu_sehat_imagingstudy_berkas.id_imaging IS NULL or satu_sehat_imagingstudy_berkas.id_imaging='') and ";
        } else {
            belumterkirim = "";
        }
        try {
            // Sumber: berkas_digital_perawatan_dicom (dokumen di-wrap DICOM, accession_number sudah ada).
            ps = koneksi.prepareStatement(
                    ...
                    + "satu_sehat_encounter.id_encounter,ifnull(berkas_digital_perawatan_dicom.accession_number,'') as accession_number,berkas_digital_perawatan_dicom.tgl_convert,"
                    + "ifnull(berkas_digital_perawatan_dicom.tipe_sumber,'') as tipe_sumber,ifnull(berkas_digital_perawatan_dicom.modality,'') as modality,"
                    + "ifnull(berkas_digital_perawatan_dicom.sop_class_uid,'') as sop_class_uid,ifnull(berkas_digital_perawatan_dicom.study_instance_uid,'') as study_instance_uid,"
                    + "ifnull(berkas_digital_perawatan_dicom.lokasi_file_dicom,'') as lokasi_file_dicom,"
                    + "ifnull(satu_sehat_imagingstudy_berkas.id_imaging,'') as id_imaging,berkas_digital_perawatan_dicom.kode "
                    + "from berkas_digital_perawatan_dicom "
                    + "inner join reg_periksa on reg_periksa.no_rawat=berkas_digital_perawatan_dicom.no_rawat "
                    + "inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "
                    + "inner join pegawai on pegawai.nik=reg_periksa.kd_dokter "
                    + "inner join satu_sehat_encounter on satu_sehat_encounter.no_rawat=berkas_digital_perawatan_dicom.no_rawat "
                    + "left join satu_sehat_imagingstudy_berkas on satu_sehat_imagingstudy_berkas.no_rawat=berkas_digital_perawatan_dicom.no_rawat "
                    + "and satu_sehat_imagingstudy_berkas.kode=berkas_digital_perawatan_dicom.kode "
                    + "and satu_sehat_imagingstudy_berkas.accession_number=berkas_digital_perawatan_dicom.accession_number "
                    + "where " + belumterkirim + " ifnull(berkas_digital_perawatan_dicom.accession_number,'')<>'' and reg_periksa.tgl_registrasi between ? and ? "
                    + (TCari.getText().equals("") ? "" : "and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "
                    + "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.nama like ? or berkas_digital_perawatan_dicom.accession_number like ? or "
                    + "berkas_digital_perawatan_dicom.kode like ? or berkas_digital_perawatan_dicom.modality like ?)") + " order by berkas_digital_perawatan_dicom.tgl_convert desc");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nama"), rs.getString("ktpdokter"), rs.getString("id_encounter"), rs.getString("accession_number"), String.valueOf(rs.getString("tgl_convert")),
                        rs.getString("tipe_sumber"), rs.getString("modality"), rs.getString("sop_class_uid"), rs.getString("study_instance_uid"), rs.getString("lokasi_file_dicom"), "",
                        rs.getString("id_imaging"), rs.getString("kode")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
    ...
    private void siapkanTabelLogDicomRouter() {
        try {
            ps = koneksi.prepareStatement(
            ...
            System.out.println("Notifikasi siapkan tabel imaging dicom berkas : " + e);
        } finally {
            try {
                if (ps != null) {
                    ps.close();
                ...
                System.out.println("Notifikasi tutup query imaging dicom router : " + e);
            }
        }
    }

    private void simpanLogDicomRouter(String noRawat, String kode, String accessionNumber, String idImaging) {
        try {
            Sequel.queryu2(
                    ...
                    4,
                    new String[]{
                        noRawat, kode, accessionNumber, idImaging
                    }
            );
        } catch (Exception e) {
            System.out.println("Notifikasi simpan dicom berkas : " + e);
        }
    }

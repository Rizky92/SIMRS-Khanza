 ...
 * @author dosen
 */
public final class SatuSehatKirimDicomRouter extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimDicomRouter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ KIRIM DICOMROUTER ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        ...
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true") && !tbObat.getValueAt(i, 16).toString().equals("")) {
                ...
                try {
                    ...
                    // Pakai overload ber-Encounter: study disuntik AdmissionID (0038,0010) dulu, karena
                    // DICOM Router menolak kiriman tanpa tag itu ("AdmissionID (Encounter ID) is missing").
//                    boolean success = orthanc.sendStudyByAccessionNumber(
//                            noOrder, // accession number
//                            idEncounter, // Encounter ID -> disuntik sbg AdmissionID (0038,0010)
//                            koneksiDB.AETITLEDICOMROUTER(), // target AE title (configured in Orthanc)
...
//                    if (success) {
//                        if (idImaging.equals("")) {
//                            idImaging = cekViaSatuSehat.getImagingStudyID(noOrder);
//                        }
//                        simpanLogDicomRouter(noOrder, kdJenisPrw, idServiceRequest, idImaging);
...
//                            System.err.println("Error Response Body: " + e.getResponseBodyAsString());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimDicomRouter dialog = new SatuSehatKirimDicomRouter(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        if (ChkBelumTerkirim.isSelected() == true) {
            belumterkirim = " (satu_sehat_imagingstudy_radiologi.id_imaging IS NULL or satu_sehat_imagingstudy_radiologi.id_imaging='') and ";
        } else {
            belumterkirim = "";
        }
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("id_imaging"), rs.getString("kd_jenis_prw")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
    ...
    private void siapkanTabelLogDicomRouter() {
        try {
            ...
            System.out.println("Notifikasi siapkan tabel imaging dicom router : " + e);
        } finally {
            try {
                if (ps != null) {
                    ps.close();
    ...
    private void simpanLogDicomRouter(String noOrder, String kdJenisPrw, String idServiceRequest, String idImaging) {
        try {
            Sequel.queryu2(
                    ...
                    4,
                    new String[]{
                        noOrder, kdJenisPrw, idServiceRequest, idImaging
                    }
            );
        } catch (Exception e) {
            System.out.println("Notifikasi simpan dicom router : " + e);
        }
    }

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariAplicareReferensiKamar.html", "Pencarian Referensi Kamar Aplicare", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariAplicareReferensiKamar.wps", "Pencarian Referensi Kamar Aplicare", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariAplicareReferensiKamar.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariAplicareReferensiKamar.xlsx", tbKamar);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptCariAplicareReferensiKamar.jasper", "report", "::[ Pencarian Referensi Kamar Aplicare ]::", param);
                        break;
                }
            } catch (Exception e) {

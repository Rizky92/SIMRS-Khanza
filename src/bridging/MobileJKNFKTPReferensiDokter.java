        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariMobileJKNFKTPReferensiDokter.html", "Pencarian Referensi Dokter", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariMobileJKNFKTPReferensiDokter.wps", "Pencarian Referensi Dokter", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariMobileJKNFKTPReferensiDokter.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariMobileJKNFKTPReferensiDokter.xlsx", tbKamar);
                        break;

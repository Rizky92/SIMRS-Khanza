        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MandiriKodeTransaksiTujuanTransfer.html", "Kode Transaksi Bank Tujuan Transfer Bank Mandiri", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MandiriKodeTransaksiTujuanTransfer.wps", "Kode Transaksi Bank Tujuan Transfer Bank Mandiri", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MandiriKodeTransaksiTujuanTransfer.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MandiriKodeTransaksiTujuanTransfer.xlsx", tbJnsPerawatan);
                        break;

        ...
        if(TabRujukan.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("CariSisruteRujukanKeluar.html", "Data Bridging SEP", tbObat);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("CariSisruteRujukanKeluar.wps", "Data Bridging SEP", tbObat);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("CariSisruteRujukanKeluar.csv", tbObat);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("CariSisruteRujukanKeluar.xlsx", tbObat);
                            break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariPCAREReferensiPoli.html", "Pencarian Referensi Unit/Poli", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariPCAREReferensiPoli.wps", "Pencarian Referensi Unit/Poli", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariPCAREReferensiPoli.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariPCAREReferensiPoli.xlsx", tbKamar);
                        break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ApotekBPJSDaftarPelayananKlaim.html", "Daftar Pelayanan Apotek BPJS", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ApotekBPJSDaftarPelayananKlaim.wps", "Daftar Pelayanan Apotek BPJS", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ApotekBPJSDaftarPelayananKlaim.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ApotekBPJSDaftarPelayananKlaim.xlsx", tbKamar);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        for (int i = 0; i < tabMode.getRowCount(); i++) {
                            ...
                            (String) tabMode.getValueAt(i, 15), (String) tabMode.getValueAt(i, 16));
                        }

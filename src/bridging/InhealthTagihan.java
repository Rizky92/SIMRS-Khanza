        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BridgingDaftar.html", "Data Bridging SEP", tbSJP);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BridgingDaftar.wps", "Data Bridging SEP", tbSJP);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BridgingDaftar.csv", tbSJP);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BridgingDaftar.xlsx", tbSJP);
                        break;

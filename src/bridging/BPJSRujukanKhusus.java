    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BridgingDaftarRujukan.html", "Data Bridging Rujukan VClaim", tbProgramPRB);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BridgingDaftarRujukan.wps", "Data Bridging Rujukan VClaim", tbProgramPRB);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BridgingDaftarRujukan.csv", tbProgramPRB);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BridgingDaftarRujukan.xlsx", tbProgramPRB);
                        break;

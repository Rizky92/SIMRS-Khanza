        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KamarSiranap.html", "Data Ketersediaan Kamar Siranap", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KamarSiranap.wps", "Data Ketersediaan Kamar Siranap", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KamarSiranap.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KamarSiranap.xlsx", tbJnsPerawatan);
                        break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MapingTindakanInhealthRanap.html", "Mapping Tarif Rawat Inap Inhealth", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MapingTindakanInhealthRanap.wps", "Mapping Tarif Rawat Inap Inhealth", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MapingTindakanInhealthRanap.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MapingTindakanInhealthRanap.xlsx", tbJnsPerawatan);
                        break;

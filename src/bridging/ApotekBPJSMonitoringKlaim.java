    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ApotekBPJSMonitoringKlaim.html", "Monitoring Klaim Obat Apotek BPJS", tbKamar, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ApotekBPJSMonitoringKlaim.wps", "Monitoring Klaim Obat Apotek BPJS", tbKamar, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ApotekBPJSMonitoringKlaim.csv", tbKamar, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ApotekBPJSMonitoringKlaim.xlsx", tbKamar, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptApotekBPJSMonitoringKlaim.jasper", "report", "::[ Monitoring Klaim Obat Apotek BPJS ]::", param);
                        break;
                }
            } catch (Exception e) {

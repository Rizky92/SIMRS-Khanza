        ...
        if(TabRawat.getSelectedIndex()==1){
            if(tabMode.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("PCarePendaftaran.html", "Data Pendaftaran PCare", tbPendaftaran);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("PCarePendaftaran.wps", "Data Pendaftaran PCare", tbPendaftaran);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("PCarePendaftaran.csv", tbPendaftaran);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("PCarePendaftaran.xlsx", tbPendaftaran);
                            break;
            ...
            if(tabMode2.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("PCareKunjungan.html", "Data Kunjungan PCare", tbKunjungan);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("PCareKunjungan.wps", "Data Kunjungan PCare", tbKunjungan);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("PCareKunjungan.csv", tbKunjungan);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("PCareKunjungan.xlsx", tbKunjungan);
                            break;
                        case "Laporan 5 (Jasper)":
                            Map<String, Object> param = new HashMap<>();
                            param.put("namars",akses.getnamars());
            ...
            if(tabMode3.getRowCount()==0){
                ...
                try {
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("PCareRujukSpesialis.html", "Data Rujukan Spesialis PCare", tbSpesialis);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("PCareRujukSpesialis.wps", "Data Rujukan Spesialis PCare", tbSpesialis);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("PCareRujukSpesialis.csv", tbSpesialis);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("PCareRujukSpesialis.xlsx", tbSpesialis);
                            break;
                        case "Laporan 5 (Jasper)":
                            Map<String, Object> param = new HashMap<>();
                            param.put("namars",akses.getnamars());

                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            if (sukses) {
                                jur.clear();
                                if (sukses) sukses = jur.tampung(akunpengadaan, 0, rs.getDouble("total"));
                                ...
                                if (sukses) sukses = jur.simpanJurnalSMC(rs.getString("no_faktur"),"U","PEMBATALAN PEMBELIAN BARANG DAPUR KERING & BASAH"+", OLEH "+akses.getkode());
                            }
                            if(sukses==true){

        ...
        if(NoKeluar.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(sukses){
                    ...
                    if (!Sequel.insertTampJurnal(Sequel.cariIsi("select Stok_Keluar_Dapur from set_akun"), "PERSEDIAAN BARANG", ttl, 0)) {
                        sukses = false;
                    }
                    if (!Sequel.insertTampJurnal(Sequel.cariIsi("select Kontra_Stok_Keluar_Dapur from set_akun"), "KAS DI TANGAN", 0, ttl)) {
                        sukses = false;
                    }
                    if (sukses) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("StokKeluarDapurPerTanggal.html", "Pengadaan Barang Dapur Kering & Basah Per Tanggal", tbJadwal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("StokKeluarDapurPerTanggal.wps", "Pengadaan Barang Dapur Kering & Basah Per Tanggal", tbJadwal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("StokKeluarDapurPerTanggal.csv", tbJadwal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("StokKeluarDapurPerTanggal.xlsx", tbJadwal);
                        break;

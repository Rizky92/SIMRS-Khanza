    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PengajuanBarangDapur.html", "Data Pengajuan Permintaan/Pengadaan Barang Dapur Kering & Basah", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PengajuanBarangDapur.wps", "Data Pengajuan Permintaan/Pengadaan Barang Dapur Kering & Basah", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PengajuanBarangDapur.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PengajuanBarangDapur.xlsx", tbDokter);
                        break;

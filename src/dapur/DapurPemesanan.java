        ...
        if(NoFaktur.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(sukses==true){
                    ...
                    if (!Sequel.insertTampJurnal(Penerimaan_Dapur, "PERSEDIAAN BARANG DAPUR", ttl + meterai, 0)) {
                        sukses = false;
                    }
                    if (ppn > 0) {
                        if (!Sequel.insertTampJurnal(PPN_Masukan, "PPN Masukan Barang Dapur", ppn, 0)) {
                            sukses = false;
                        }
                    }
                    if (!Sequel.insertTampJurnal(Kontra_Penerimaan_Dapur, "HUTANG BARANG NON MEDIS", 0, ttl + ppn + meterai)) {
                        sukses = false;
                    }
                    if (sukses) {

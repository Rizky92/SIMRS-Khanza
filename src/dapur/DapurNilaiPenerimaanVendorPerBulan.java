    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DapurNilaiPenerimaanVendorPerBulan.html", "Nilai Penerimaan Vendor Dapur Per Bulan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DapurNilaiPenerimaanVendorPerBulan.wps", "Nilai Penerimaan Vendor Dapur Per Bulan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DapurNilaiPenerimaanVendorPerBulan.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DapurNilaiPenerimaanVendorPerBulan.xlsx", tbDokter);
                        break;

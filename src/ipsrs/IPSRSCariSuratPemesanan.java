    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPemesananNonMedis.html", "Data Surat Pemesanan Barang Non Medis dan Penunjang (Lab & Radiologi)", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPemesananNonMedis.wps", "Data Surat Pemesanan Barang Non Medis dan Penunjang (Lab & Radiologi)", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPemesananNonMedis.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPemesananNonMedis.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptDataPemesananNonMedis.jasper", "report", "::[ Data Surat Pemesanan Barang Non Medis dan Penunjang (Lab & Radiologi) ]::", param);
                        break;
                }
            } catch (Exception e) {

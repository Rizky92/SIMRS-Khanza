    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("StokKeluarIPSRSPerTanggal.html", "Stok Keluar Barang Non Medis Per Tanggal", tbJadwal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("StokKeluarIPSRSPerTanggal.wps", "Stok Keluar Barang Non Medis Per Tanggal", tbJadwal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("StokKeluarIPSRSPerTanggal.csv", tbJadwal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("StokKeluarIPSRSPerTanggal.xlsx", tbJadwal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptStokKeluarIPSRSPerTanggal.jasper", "report", "::[ Stok Keluar Barang Non Medis Per Tanggal ]::", param);
                        break;
                }
            } catch (Exception e) {

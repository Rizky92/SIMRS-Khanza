    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("IPSRSNilaiPenerimaanVendorNonMedisPerBulan.html", "Nilai Penerimaan Vendor Non Medis Per Bulan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("IPSRSNilaiPenerimaanVendorNonMedisPerBulan.wps", "Nilai Penerimaan Vendor Non Medis Per Bulan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("IPSRSNilaiPenerimaanVendorNonMedisPerBulan.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("IPSRSNilaiPenerimaanVendorNonMedisPerBulan.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        Sequel.deleteTemporary();
                        int i = 0;
                        for (; i < tabMode.getRowCount(); i++) {
                            Sequel.temporary(String.valueOf(i + 1), (String) tabMode.getValueAt(i, 0), (String) tabMode.getValueAt(i, 1), Valid.SetAngka((Double) tabMode.getValueAt(i, 2)),
                        ...
                        Valid.reportSmc("rptIPSRSNilaiPenerimaanVendorNonMedisPerBulan.jasper", "report", "::[ Nilai Penerimaan Vendor Non Medis Per Bulan ]::", param);
                        break;
                }
            } catch (Exception e) {

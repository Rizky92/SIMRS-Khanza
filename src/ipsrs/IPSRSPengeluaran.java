                ...
                if(Sequel.menyimpantf2("ipsrspengeluaran","?,?,?,?","No.Keluar",4,new String[]{NoKeluar.getText(),Valid.SetTgl(TglKeluar.getSelectedItem()+""),kdptg.getText(),Keterangan.getText()})==true){
                    ...
                    for(i=0;i<jml;i++){  
                         if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                             validasiStok(tbDokter.getValueAt(i, 1).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()));
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    */
    ...
    private void validasiStok(String kodeBarang, double jumlah)
    {

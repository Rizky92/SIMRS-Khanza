...
public class DlgSetAksesEditSementara extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbUser = new id.yaski.simrskhanza.widget.Table();
        ...
        TUser = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek = new id.yaski.simrskhanza.widget.Button();
        TNmUser = new id.yaski.simrskhanza.widget.TextBox();
        DTPTgl1 = new id.yaski.simrskhanza.widget.Tanggal();
        CmbJam1 = new id.yaski.simrskhanza.widget.ComboBox();
        CmbMenit1 = new id.yaski.simrskhanza.widget.ComboBox();
        CmbDetik1 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    private id.yaski.simrskhanza.widget.ComboBox CmbDetik1;
    private id.yaski.simrskhanza.widget.ComboBox CmbJam1;
    private id.yaski.simrskhanza.widget.ComboBox CmbMenit1;
    ...
    private id.yaski.simrskhanza.widget.TextBox TNmUser;
    private id.yaski.simrskhanza.widget.TextBox TUser;
    ...
    private id.yaski.simrskhanza.widget.Table tbUser;

...
public final class DlgSetOtoRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Table1 = new id.yaski.simrskhanza.widget.Table();
        ...
        nmtindakan = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek = new id.yaski.simrskhanza.widget.Button();
        BtnSeek1 = new id.yaski.simrskhanza.widget.Button();
        kddokter = new id.yaski.simrskhanza.widget.TextBox();
        kdtindakan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Table2 = new id.yaski.simrskhanza.widget.Table();
        panelGlass3 = new id.yaski.simrskhanza.widget.panelisi();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        nmtindakan2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek3 = new id.yaski.simrskhanza.widget.Button();
        kdtindakan2 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        kdpj2 = new id.yaski.simrskhanza.widget.TextBox();
        nmpj2 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        nmdokter3 = new id.yaski.simrskhanza.widget.TextBox();
        nmtindakan3 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek2 = new id.yaski.simrskhanza.widget.Button();
        BtnSeek4 = new id.yaski.simrskhanza.widget.Button();
        kddokter3 = new id.yaski.simrskhanza.widget.TextBox();
        kdtindakan3 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        kdpj3 = new id.yaski.simrskhanza.widget.TextBox();
        nmpj3 = new id.yaski.simrskhanza.widget.TextBox();
        BtnPenjab2 = new id.yaski.simrskhanza.widget.Button();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Table3 = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnPenjab2;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnSeek;
    private id.yaski.simrskhanza.widget.Button BtnSeek1;
    ...
    private id.yaski.simrskhanza.widget.Table Table1;
    private id.yaski.simrskhanza.widget.Table Table2;
    private id.yaski.simrskhanza.widget.Table Table3;
    ...
    private id.yaski.simrskhanza.widget.TextBox kddokter3;
    private id.yaski.simrskhanza.widget.TextBox kdpj;
    private id.yaski.simrskhanza.widget.TextBox kdpj2;
    private id.yaski.simrskhanza.widget.TextBox kdpj3;
    private id.yaski.simrskhanza.widget.TextBox kdtindakan;
    private id.yaski.simrskhanza.widget.TextBox kdtindakan2;
    private id.yaski.simrskhanza.widget.TextBox kdtindakan3;
    private id.yaski.simrskhanza.widget.TextBox nmdokter;
    private id.yaski.simrskhanza.widget.TextBox nmdokter3;
    private id.yaski.simrskhanza.widget.TextBox nmpj;
    private id.yaski.simrskhanza.widget.TextBox nmpj2;
    private id.yaski.simrskhanza.widget.TextBox nmpj3;
    private id.yaski.simrskhanza.widget.TextBox nmtindakan;
    private id.yaski.simrskhanza.widget.TextBox nmtindakan2;
    private id.yaski.simrskhanza.widget.TextBox nmtindakan3;
    private id.yaski.simrskhanza.widget.panelisi panelGlass2;
    private id.yaski.simrskhanza.widget.panelisi panelGlass3;

...
public class DlgSetPenjabLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kddokter2 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        kddokter4 = new id.yaski.simrskhanza.widget.TextBox();
        TDokter4 = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokter4 = new id.yaski.simrskhanza.widget.Button();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        kddokter5 = new id.yaski.simrskhanza.widget.TextBox();
        TDokter5 = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokter5 = new id.yaski.simrskhanza.widget.Button();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        kddokter6 = new id.yaski.simrskhanza.widget.TextBox();
        TDokter6 = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox TDokter4;
    private id.yaski.simrskhanza.widget.TextBox TDokter5;
    private id.yaski.simrskhanza.widget.TextBox TDokter6;
    ...
    private id.yaski.simrskhanza.widget.TextBox kddokter2;
    private id.yaski.simrskhanza.widget.TextBox kddokter3;
    private id.yaski.simrskhanza.widget.TextBox kddokter4;
    private id.yaski.simrskhanza.widget.TextBox kddokter5;
    private id.yaski.simrskhanza.widget.TextBox kddokter6;

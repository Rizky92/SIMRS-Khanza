...
public class DlgBiayaHarian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NmBiaya = new id.yaski.simrskhanza.widget.TextBox();
        BiayaHarian = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox BiayaHarian;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmBiaya;

...
public class DlgSetOtoLokasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbstok = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        btnBangsal1 = new id.yaski.simrskhanza.widget.Button();
        jLabel7 = new id.yaski.simrskhanza.widget.Label();
        KodeDepoRalan = new id.yaski.simrskhanza.widget.TextBox();
        NmDepoRalan = new id.yaski.simrskhanza.widget.TextBox();
        btnBangsal3 = new id.yaski.simrskhanza.widget.Button();
        ...
        btnBangsal2 = new id.yaski.simrskhanza.widget.Button();
        NamaBangsalRanap = new id.yaski.simrskhanza.widget.TextBox();
        KodeBangsalRanap = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        KodeDepoRanap = new id.yaski.simrskhanza.widget.TextBox();
        NamaDepoRanap = new id.yaski.simrskhanza.widget.TextBox();
        btnBangsal4 = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KodeBangsalRanap;
    private id.yaski.simrskhanza.widget.TextBox KodeDepoRalan;
    private id.yaski.simrskhanza.widget.TextBox KodeDepoRanap;
    private id.yaski.simrskhanza.widget.TextBox KodePoli;
    private id.yaski.simrskhanza.widget.TextBox NamaBangsalRanap;
    private id.yaski.simrskhanza.widget.TextBox NamaDepoRanap;
    private id.yaski.simrskhanza.widget.TextBox NmDepoRalan;
    ...
    private id.yaski.simrskhanza.widget.Button btnBangsal1;
    private id.yaski.simrskhanza.widget.Button btnBangsal2;
    private id.yaski.simrskhanza.widget.Button btnBangsal3;
    private id.yaski.simrskhanza.widget.Button btnBangsal4;
    private id.yaski.simrskhanza.widget.ComboBox cmbstok;

...
public class DlgSetKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbYes = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel7 = new id.yaski.simrskhanza.widget.Label();
        fee = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        cmbYes2 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        Bayi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        cmbYes3 = new id.yaski.simrskhanza.widget.ComboBox();
        cmbYes4 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        cmbYes5 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Bayi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox cmbYes;
    private id.yaski.simrskhanza.widget.ComboBox cmbYes2;
    private id.yaski.simrskhanza.widget.ComboBox cmbYes3;
    private id.yaski.simrskhanza.widget.ComboBox cmbYes4;
    private id.yaski.simrskhanza.widget.ComboBox cmbYes5;
    private id.yaski.simrskhanza.widget.TextBox fee;

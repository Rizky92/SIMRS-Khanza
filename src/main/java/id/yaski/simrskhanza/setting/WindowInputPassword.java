...
public class WindowInputPassword extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PassLama = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        BtnClosePass = new id.yaski.simrskhanza.widget.Button();
        BtnSimpanPass = new id.yaski.simrskhanza.widget.Button();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        Passbaru1 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        PassBaru2 = new id.yaski.simrskhanza.widget.TextBox();
    ...
    private id.yaski.simrskhanza.widget.Button BtnClosePass;
    private id.yaski.simrskhanza.widget.Button BtnSimpanPass;
    private id.yaski.simrskhanza.widget.TextBox PassBaru2;
    private id.yaski.simrskhanza.widget.TextBox PassLama;
    private id.yaski.simrskhanza.widget.TextBox Passbaru1;

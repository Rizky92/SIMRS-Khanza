...
package id.yaski.simrskhanza.inventaris;
...
public final class InventarisKoleksi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nm_ruangcari = new id.yaski.simrskhanza.widget.TextBox();
        btnRuang1 = new id.yaski.simrskhanza.widget.Button();
        ...
        no_inventaris = new id.yaski.simrskhanza.widget.TextBox();
        nm_merk = new id.yaski.simrskhanza.widget.TextBox();
        ...
        kode_barang = new id.yaski.simrskhanza.widget.TextBox();
        nama_barang = new id.yaski.simrskhanza.widget.TextBox();
        btnBarang = new id.yaski.simrskhanza.widget.Button();
        tgl_pengadaan = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        status_barang = new id.yaski.simrskhanza.widget.ComboBox();
        label12 = new id.yaski.simrskhanza.widget.Label();
        nm_kategori = new id.yaski.simrskhanza.widget.TextBox();
        ...
        nm_jenis = new id.yaski.simrskhanza.widget.TextBox();
        label15 = new id.yaski.simrskhanza.widget.Label();
        nm_produsen = new id.yaski.simrskhanza.widget.TextBox();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        asal_barang = new id.yaski.simrskhanza.widget.ComboBox();
        jPanel1 = new javax.swing.JPanel();
        btnRuang = new id.yaski.simrskhanza.widget.Button();
        nm_ruang = new id.yaski.simrskhanza.widget.TextBox();
        id_ruang = new id.yaski.simrskhanza.widget.TextBox();
        label20 = new id.yaski.simrskhanza.widget.Label();
        no_box = new id.yaski.simrskhanza.widget.ComboBox();
        no_rak = new id.yaski.simrskhanza.widget.ComboBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox asal_barang;
    private id.yaski.simrskhanza.widget.Button btnAmbilPhoto;
    private id.yaski.simrskhanza.widget.Button btnBarang;
    private id.yaski.simrskhanza.widget.Button btnRuang;
    private id.yaski.simrskhanza.widget.Button btnRuang1;
    private id.yaski.simrskhanza.widget.TextBox harga;
    private id.yaski.simrskhanza.widget.TextBox id_ruang;
    ...
    private id.yaski.simrskhanza.widget.TextBox kode_barang;
    ...
    private id.yaski.simrskhanza.widget.TextBox nama_barang;
    private id.yaski.simrskhanza.widget.TextBox nm_jenis;
    private id.yaski.simrskhanza.widget.TextBox nm_kategori;
    private id.yaski.simrskhanza.widget.TextBox nm_merk;
    private id.yaski.simrskhanza.widget.TextBox nm_produsen;
    private id.yaski.simrskhanza.widget.TextBox nm_ruang;
    private id.yaski.simrskhanza.widget.TextBox nm_ruangcari;
    private id.yaski.simrskhanza.widget.ComboBox no_box;
    private id.yaski.simrskhanza.widget.TextBox no_inventaris;
    private id.yaski.simrskhanza.widget.ComboBox no_rak;
    ...
    private id.yaski.simrskhanza.widget.ComboBox status_barang;
    private id.yaski.simrskhanza.widget.Table tbJnsPerawatan;
    private id.yaski.simrskhanza.widget.Tanggal tgl_pengadaan;

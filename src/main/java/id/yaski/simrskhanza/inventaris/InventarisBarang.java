...
public final class InventarisBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jml_barang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        thn_produksi = new id.yaski.simrskhanza.widget.ComboBox();
        label19 = new id.yaski.simrskhanza.widget.Label();
        kode_produsen = new id.yaski.simrskhanza.widget.TextBox();
        nama_produsen = new id.yaski.simrskhanza.widget.TextBox();
        btnProdusen = new id.yaski.simrskhanza.widget.Button();
        label20 = new id.yaski.simrskhanza.widget.Label();
        id_merk = new id.yaski.simrskhanza.widget.TextBox();
        nm_merk = new id.yaski.simrskhanza.widget.TextBox();
        btnMerk = new id.yaski.simrskhanza.widget.Button();
        label21 = new id.yaski.simrskhanza.widget.Label();
        id_kategori = new id.yaski.simrskhanza.widget.TextBox();
        ...
        id_jenis = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button btnMerk;
    private id.yaski.simrskhanza.widget.Button btnProdusen;
    private id.yaski.simrskhanza.widget.TextBox id_jenis;
    private id.yaski.simrskhanza.widget.TextBox id_kategori;
    private id.yaski.simrskhanza.widget.TextBox id_merk;
    ...
    private id.yaski.simrskhanza.widget.TextBox jml_barang;
    private id.yaski.simrskhanza.widget.TextBox kode_barang;
    private id.yaski.simrskhanza.widget.TextBox kode_produsen;
    ...
    private id.yaski.simrskhanza.widget.TextBox nama_produsen;
    ...
    private id.yaski.simrskhanza.widget.ComboBox thn_produksi;

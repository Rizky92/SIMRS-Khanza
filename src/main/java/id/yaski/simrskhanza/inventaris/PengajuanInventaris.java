...
public final class PengajuanInventaris extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LatarBelakang = new id.yaski.simrskhanza.widget.TextArea();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Spesifikasi = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea LatarBelakang;
    ...
    private id.yaski.simrskhanza.widget.TextArea Spesifikasi;

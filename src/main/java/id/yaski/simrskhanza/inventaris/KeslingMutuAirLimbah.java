...
public final class KeslingMutuAirLimbah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Meteran = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        JmlHarian = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PH = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TDS = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        EC = new id.yaski.simrskhanza.widget.TextBox();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        Salt = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox EC;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox JmlHarian;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Meteran;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.TextBox PH;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Salt;
    ...
    private id.yaski.simrskhanza.widget.TextBox TDS;

...
public final class DlgPengeluaranPengeluaran extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbBayarPesanObat = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBayarPesanNonMedis = new id.yaski.simrskhanza.widget.Table();
        Scroll3 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBayarPesanAset = new id.yaski.simrskhanza.widget.Table();
        Scroll4 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBayarPesanDapur = new id.yaski.simrskhanza.widget.Table();
        Scroll7 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBayarJM = new id.yaski.simrskhanza.widget.Table();
        Scroll8 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengeluaranHarian = new id.yaski.simrskhanza.widget.Table();
        Scroll9 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBebanHutang = new id.yaski.simrskhanza.widget.Table();
        Scroll10 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengadaanObat = new id.yaski.simrskhanza.widget.Table();
        Scroll11 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengadaanNonMedis = new id.yaski.simrskhanza.widget.Table();
        Scroll12 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengadaanAsetInventaris = new id.yaski.simrskhanza.widget.Table();
        Scroll13 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengadaanDapur = new id.yaski.simrskhanza.widget.Table();
        Scroll14 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBayarPesanToko = new id.yaski.simrskhanza.widget.Table();
        Scroll15 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengadaanToko = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbBayarJM;
    private id.yaski.simrskhanza.widget.Table tbBayarPesanAset;
    private id.yaski.simrskhanza.widget.Table tbBayarPesanDapur;
    private id.yaski.simrskhanza.widget.Table tbBayarPesanNonMedis;
    private id.yaski.simrskhanza.widget.Table tbBayarPesanObat;
    private id.yaski.simrskhanza.widget.Table tbBayarPesanToko;
    private id.yaski.simrskhanza.widget.Table tbBebanHutang;
    private id.yaski.simrskhanza.widget.Table tbPengadaanAsetInventaris;
    private id.yaski.simrskhanza.widget.Table tbPengadaanDapur;
    private id.yaski.simrskhanza.widget.Table tbPengadaanNonMedis;
    private id.yaski.simrskhanza.widget.Table tbPengadaanObat;
    private id.yaski.simrskhanza.widget.Table tbPengadaanToko;
    private id.yaski.simrskhanza.widget.Table tbPengeluaranHarian;

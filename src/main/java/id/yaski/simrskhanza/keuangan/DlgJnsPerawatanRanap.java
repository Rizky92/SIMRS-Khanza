...
import id.yaski.simrskhanza.restore.DlgRestoreTarifRanap;
...
import id.yaski.simrskhanza.simrskhanza.DlgKtgPerawatan;
...
public final class DlgJnsPerawatanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdKtg = new id.yaski.simrskhanza.widget.TextBox();
        BagianRs = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        TJmlDr = new id.yaski.simrskhanza.widget.TextBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        TJmlPr = new id.yaski.simrskhanza.widget.TextBox();
        NmKtg = new id.yaski.simrskhanza.widget.TextBox();
        btnKategori = new id.yaski.simrskhanza.widget.Button();
        TTndDr = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        TTndPr = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TJmlDrPr = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        BhpMedis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Menejemen = new id.yaski.simrskhanza.widget.TextBox();
        KSO = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox BagianRs;
    private id.yaski.simrskhanza.widget.TextBox BhpMedis;
    ...
    private id.yaski.simrskhanza.widget.TextBox KSO;
    private id.yaski.simrskhanza.widget.TextBox KdKamar;
    private id.yaski.simrskhanza.widget.TextBox KdKtg;
    private id.yaski.simrskhanza.widget.ComboBox Kelas;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Menejemen;
    private javax.swing.JMenuItem MnRestore;
    private id.yaski.simrskhanza.widget.TextBox NmKamar;
    private id.yaski.simrskhanza.widget.TextBox NmKtg;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TJmlDr;
    private id.yaski.simrskhanza.widget.TextBox TJmlDrPr;
    private id.yaski.simrskhanza.widget.TextBox TJmlPr;
    private id.yaski.simrskhanza.widget.TextBox TKd;
    private id.yaski.simrskhanza.widget.TextBox TNm;
    private id.yaski.simrskhanza.widget.TextBox TTndDr;
    private id.yaski.simrskhanza.widget.TextBox TTndPr;

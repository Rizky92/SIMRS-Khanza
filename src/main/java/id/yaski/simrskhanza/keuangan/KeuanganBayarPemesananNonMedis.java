...
import id.yaski.simrskhanza.bridging.MandiriCariKodeTransaksiTujuanTransfer;
...
import id.yaski.simrskhanza.ipsrs.IPSRSCariSuplier;
...
public final class KeuanganBayarPemesananNonMedis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKeluarMandiri = new id.yaski.simrskhanza.widget.Button();
        BtnSimpanMandiri = new id.yaski.simrskhanza.widget.Button();
        NoRekening = new id.yaski.simrskhanza.widget.TextBox();
        RekeningAtasNama = new id.yaski.simrskhanza.widget.TextBox();
        KotaAtasNamaRekening = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugas1 = new id.yaski.simrskhanza.widget.Button();
        jLabel102 = new id.yaski.simrskhanza.widget.Label();
        BiayaTransaksi = new id.yaski.simrskhanza.widget.TextBox();
        KodeMetode = new id.yaski.simrskhanza.widget.TextBox();
        MetodePembayaran = new id.yaski.simrskhanza.widget.TextBox();
        jLabel103 = new id.yaski.simrskhanza.widget.Label();
        KodeBank = new id.yaski.simrskhanza.widget.TextBox();
        BankTujuan = new id.yaski.simrskhanza.widget.TextBox();
        KodeTransaksi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoBukti = new id.yaski.simrskhanza.widget.TextBox();
        label35 = new id.yaski.simrskhanza.widget.Label();
        BesarBayar = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TglBayar = new id.yaski.simrskhanza.widget.Tanggal();
        SisaHutang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TglCari1 = new id.yaski.simrskhanza.widget.Tanggal();
        label37 = new id.yaski.simrskhanza.widget.Label();
        TglCari2 = new id.yaski.simrskhanza.widget.Tanggal();
        label19 = new id.yaski.simrskhanza.widget.Label();
        kdsup = new id.yaski.simrskhanza.widget.TextBox();
        nmsup = new id.yaski.simrskhanza.widget.TextBox();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data dengan mengklik pada table..!!");
        } else {
            try {
                Sequel.AutoComitFalse();
                sukses = true;
                if (Sequel.menghapustfSmc("bayar_pemesanan_non_medis", "tgl_bayar = ? and no_faktur = ? and no_bukti = ?",
                    ...
                    if (Sequel.cariDoubleSmc("select ifnull(round(sum(bayar_pemesanan_non_medis.besar_bayar)), 0) from bayar_pemesanan_non_medis where bayar_pemesanan_non_medis.no_faktur = ?",
                        tbKamar.getValueAt(tbKamar.getSelectedRow(), 4).toString()) <= 0
                    ) {
                        Sequel.mengupdateSmc("ipsrspemesanan", "status = 'Belum Dibayar'", "no_faktur = ?", tbKamar.getValueAt(tbKamar.getSelectedRow(), 4).toString());
                    } else {
                        Sequel.mengupdateSmc("ipsrspemesanan", "status = 'Belum Lunas'", "no_faktur = ?", tbKamar.getValueAt(tbKamar.getSelectedRow(), 4).toString());
                    }

                    koderekening = "";
                    try (FileReader fr = new FileReader("./cache/akunbayarhutang.iyem")) {
                        response = mapper.readTree(fr).path("akunbayarhutang");
                        if (response.isArray()) {
                            for (JsonNode list : response) {
                                if (list.path("NamaAkun").asText("").equals(tbKamar.getValueAt(tbKamar.getSelectedRow(), 6).toString())) {
                                    koderekening = list.path("KodeRek").asText();
                                }
                            }
                        }
                    ...
                    if (koderekening.isBlank()) {
                        sukses = false;
                    } else {
                        total = 0;
                        if (koderekening.equals(Host_to_Host_Bank_Mandiri)) {
                            total = Sequel.cariDoubleSmc("select metode_pembayaran_bankmandiri.biaya_transaksi from metode_pembayaran_bankmandiri join pembayaran_pihak_ke3_bankmandiri on pembayaran_pihak_ke3_bankmandiri.kode_metode = metode_pembayaran_bankmandiri.kode_metode where pembayaran_pihak_ke3_bankmandiri.nomor_pembayaran = ?", tbKamar.getValueAt(tbKamar.getSelectedRow(), 7).toString());
                            Sequel.menghapusSmc("pembayaran_pihak_ke3_bankmandiri", "nomor_pembayaran = ?", tbKamar.getValueAt(tbKamar.getSelectedRow(), 7).toString());
                        }
                        Sequel.deleteTampJurnal();
                        if (total > 0) {
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox BankTujuan;
    private id.yaski.simrskhanza.widget.TextBox BesarBayar;
    private id.yaski.simrskhanza.widget.TextBox BiayaTransaksi;
    ...
    private id.yaski.simrskhanza.widget.Button BtnKeluarMandiri;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSimpanMandiri;
    ...
    private id.yaski.simrskhanza.widget.TextBox KodeBank;
    private id.yaski.simrskhanza.widget.TextBox KodeMetode;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi;
    private id.yaski.simrskhanza.widget.TextBox KotaAtasNamaRekening;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.Label LTotal;
    private id.yaski.simrskhanza.widget.TextBox MetodePembayaran;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.TextBox NoBukti;
    private id.yaski.simrskhanza.widget.TextBox NoFaktur;
    private id.yaski.simrskhanza.widget.TextBox NoRekening;
    private id.yaski.simrskhanza.widget.TextBox RekeningAtasNama;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox SisaHutang;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.Tanggal TglBayar;
    private id.yaski.simrskhanza.widget.Tanggal TglCari1;
    private id.yaski.simrskhanza.widget.Tanggal TglCari2;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdsup;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmsup;

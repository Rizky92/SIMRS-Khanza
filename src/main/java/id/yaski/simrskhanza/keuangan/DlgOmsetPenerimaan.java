...
public final class DlgOmsetPenerimaan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbRawatJalan = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRawatInap = new id.yaski.simrskhanza.widget.Table();
        Scroll3 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPenjualanBebas = new id.yaski.simrskhanza.widget.Table();
        Scroll4 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPemasukanLain = new id.yaski.simrskhanza.widget.Table();
        Scroll7 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDeposit = new id.yaski.simrskhanza.widget.Table();
        Scroll8 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPiutangPasienDibayar = new id.yaski.simrskhanza.widget.Table();
        Scroll9 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPiutangUangDibayar = new id.yaski.simrskhanza.widget.Table();
        Scroll10 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPiutangJasaDibayar = new id.yaski.simrskhanza.widget.Table();
        Scroll11 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbLabKesehatanLingkungan = new id.yaski.simrskhanza.widget.Table();
        Scroll12 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPenjualanToko = new id.yaski.simrskhanza.widget.Table();
        Scroll13 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPiutangTokoDibayar = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbDeposit;
    private id.yaski.simrskhanza.widget.Table tbLabKesehatanLingkungan;
    private id.yaski.simrskhanza.widget.Table tbPemasukanLain;
    private id.yaski.simrskhanza.widget.Table tbPenjualanBebas;
    private id.yaski.simrskhanza.widget.Table tbPenjualanToko;
    private id.yaski.simrskhanza.widget.Table tbPiutangJasaDibayar;
    private id.yaski.simrskhanza.widget.Table tbPiutangPasienDibayar;
    private id.yaski.simrskhanza.widget.Table tbPiutangTokoDibayar;
    private id.yaski.simrskhanza.widget.Table tbPiutangUangDibayar;
    private id.yaski.simrskhanza.widget.Table tbRawatInap;
    private id.yaski.simrskhanza.widget.Table tbRawatJalan;

...
public class DlgPengaturanRekening extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPengaturan = new id.yaski.simrskhanza.widget.Table();
        Scroll1 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengaturanRalan = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPengaturanRanap = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbPengaturan;
    private id.yaski.simrskhanza.widget.Table tbPengaturanRalan;
    private id.yaski.simrskhanza.widget.Table tbPengaturanRanap;

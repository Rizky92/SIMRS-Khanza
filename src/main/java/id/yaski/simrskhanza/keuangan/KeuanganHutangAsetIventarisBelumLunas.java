...
import id.yaski.simrskhanza.fungsi.WarnaTable3;
...
import id.yaski.simrskhanza.inventaris.InventarisCariSuplier;
...
public final class KeuanganHutangAsetIventarisBelumLunas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnMetode = new id.yaski.simrskhanza.widget.Button();
        ...
        KodeSuplier = new id.yaski.simrskhanza.widget.TextBox();
        NamaSuplier = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ChkTanggalDatang = new id.yaski.simrskhanza.widget.CekBox();
        TglDatang1 = new id.yaski.simrskhanza.widget.Tanggal();
        label18 = new id.yaski.simrskhanza.widget.Label();
        TglDatang2 = new id.yaski.simrskhanza.widget.Tanggal();
        label21 = new id.yaski.simrskhanza.widget.Label();
        ChkTanggalTempo = new id.yaski.simrskhanza.widget.CekBox();
        TglTempo1 = new id.yaski.simrskhanza.widget.Tanggal();
        label20 = new id.yaski.simrskhanza.widget.Label();
        TglTempo2 = new id.yaski.simrskhanza.widget.Tanggal();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnMetode;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkTanggalDatang;
    private id.yaski.simrskhanza.widget.CekBox ChkTanggalTempo;
    ...
    private id.yaski.simrskhanza.widget.TextBox KodeSuplier;
    ...
    private id.yaski.simrskhanza.widget.TextBox NamaSuplier;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TglDatang1;
    private id.yaski.simrskhanza.widget.Tanggal TglDatang2;
    private id.yaski.simrskhanza.widget.Tanggal TglTempo1;
    private id.yaski.simrskhanza.widget.Tanggal TglTempo2;

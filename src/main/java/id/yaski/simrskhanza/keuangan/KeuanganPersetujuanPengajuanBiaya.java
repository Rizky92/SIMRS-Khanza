...
public final class KeuanganPersetujuanPengajuanBiaya extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnSimpanRekon = new id.yaski.simrskhanza.widget.Button();
        BtnKeluarRekon = new id.yaski.simrskhanza.widget.Button();
        ...
        kdpegawai = new id.yaski.simrskhanza.widget.TextBox();
        nmpegawai = new id.yaski.simrskhanza.widget.TextBox();
        BtnPegawai = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnSetujui = new id.yaski.simrskhanza.widget.Button();
        BtnTolak = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnKeluarRekon;
    private id.yaski.simrskhanza.widget.Button BtnPegawai;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnSetujui;
    private id.yaski.simrskhanza.widget.Button BtnSimpanRekon;
    private id.yaski.simrskhanza.widget.Button BtnTolak;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdpegawai;
    private id.yaski.simrskhanza.widget.Label label17;
    private id.yaski.simrskhanza.widget.Label label19;
    private id.yaski.simrskhanza.widget.TextBox nmpegawai;

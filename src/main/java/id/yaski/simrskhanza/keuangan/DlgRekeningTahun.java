...
public final class DlgRekeningTahun extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tahun = new id.yaski.simrskhanza.widget.ComboBox();
        label33 = new id.yaski.simrskhanza.widget.Label();
        Saldo = new id.yaski.simrskhanza.widget.TextBox();
        BtnCari7 = new id.yaski.simrskhanza.widget.Button();
        label35 = new id.yaski.simrskhanza.widget.Label();
        Tipe = new id.yaski.simrskhanza.widget.TextBox();
        Balance = new id.yaski.simrskhanza.widget.TextBox();
        label36 = new id.yaski.simrskhanza.widget.Label();
        ChkDebetKredit = new id.yaski.simrskhanza.widget.CekBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnCari7;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkDebetKredit;
    ...
    private id.yaski.simrskhanza.widget.TextBox Saldo;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.ComboBox Tahun;
    private id.yaski.simrskhanza.widget.TextBox Tipe;

...
public class DlgRekapPerShift extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPemasukan = new id.yaski.simrskhanza.widget.Table();
        ...
        tbPengeluaran = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbPemasukan;
    private id.yaski.simrskhanza.widget.Table tbPengeluaran;

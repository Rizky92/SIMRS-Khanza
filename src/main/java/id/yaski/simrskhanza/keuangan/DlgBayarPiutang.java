...
public final class DlgBayarPiutang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LDiskon = new id.yaski.simrskhanza.widget.Label();
        label14 = new id.yaski.simrskhanza.widget.Label();
        LTTerbayar = new id.yaski.simrskhanza.widget.Label();
        ...
        AkunPiutang = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        DiskonBayar = new id.yaski.simrskhanza.widget.TextBox();
        label37 = new id.yaski.simrskhanza.widget.Label();
        TidakTerbayar = new id.yaski.simrskhanza.widget.TextBox();
   ...
   Valid.pindah(evt,Cicilan,Kdmem);
    ...
    private void tbKamarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKamarMouseReleased
        if(tabMode.getRowCount()!=0){
            int c = tbKamar.columnAtPoint(evt.getPoint());
            int r = tbKamar.rowAtPoint(evt.getPoint());
            tbKamar.changeSelection(r, c, false, false);
            try {
                getData();
            } catch (java.lang.NullPointerException e) {
            }
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AkunPiutang;
    ...
    private id.yaski.simrskhanza.widget.TextBox DiskonBayar;
    ...
    private id.yaski.simrskhanza.widget.Label LDiskon;
    private id.yaski.simrskhanza.widget.Label LTTerbayar;
    ...
    private id.yaski.simrskhanza.widget.TextBox TidakTerbayar;

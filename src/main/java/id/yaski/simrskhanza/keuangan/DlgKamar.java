...
import id.yaski.simrskhanza.restore.DlgRestoreKamar;
...
public final class DlgKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kdbangsalcari = new id.yaski.simrskhanza.widget.TextBox();
        BangsalCari = new id.yaski.simrskhanza.widget.TextBox();
        btnKamarCari = new id.yaski.simrskhanza.widget.Button();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        CmbCrIsi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TBangsal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        TTarif = new id.yaski.simrskhanza.widget.TextBox();
        ...
        kd_bangsal = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox BangsalCari;
    ...
    private id.yaski.simrskhanza.widget.ComboBox CmbCrIsi;
    ...
    private id.yaski.simrskhanza.widget.TextBox TBangsal;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TKd;
    private id.yaski.simrskhanza.widget.TextBox TTarif;
    private id.yaski.simrskhanza.widget.Button btnKamar;
    private id.yaski.simrskhanza.widget.Button btnKamarCari;
    ...
    private id.yaski.simrskhanza.widget.TextBox kd_bangsal;
    private id.yaski.simrskhanza.widget.TextBox kdbangsalcari;

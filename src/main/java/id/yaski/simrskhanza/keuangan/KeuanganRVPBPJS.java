...
package id.yaski.simrskhanza.keuangan;

import id.yaski.simrskhanza.bridging.ApiBPJS;
...
import id.yaski.simrskhanza.kepegawaian.DlgCariPetugas;
...
public final class KeuanganRVPBPJS extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TKd = new id.yaski.simrskhanza.widget.TextBox();
        ...
        tbBangsal = new id.yaski.simrskhanza.widget.Table();
        panelisi4 = new id.yaski.simrskhanza.widget.panelisi();
        label33 = new id.yaski.simrskhanza.widget.Label();
        Tanggal = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        AkunBayar = new id.yaski.simrskhanza.widget.ComboBox();
        BtnAll1 = new id.yaski.simrskhanza.widget.Button();
        label19 = new id.yaski.simrskhanza.widget.Label();
        KdPetugas = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugas = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugas = new id.yaski.simrskhanza.widget.Button();
        jPanel1 = new javax.swing.JPanel();
        panelisi3 = new id.yaski.simrskhanza.widget.panelisi();
        ...
        panelisi5 = new id.yaski.simrskhanza.widget.panelisi();
        label34 = new id.yaski.simrskhanza.widget.Label();
        DTPTgl1 = new id.yaski.simrskhanza.widget.Tanggal();
        label35 = new id.yaski.simrskhanza.widget.Label();
        DTPTgl2 = new id.yaski.simrskhanza.widget.Tanggal();
        label1 = new id.yaski.simrskhanza.widget.Label();
        chkRalan = new id.yaski.simrskhanza.widget.CekBox();
        chkRanap = new id.yaski.simrskhanza.widget.CekBox();
        chkInternal = new id.yaski.simrskhanza.widget.CekBox();
        panelisi1 = new id.yaski.simrskhanza.widget.panelisi();
        label17 = new id.yaski.simrskhanza.widget.Label();
        ...
        BtnBayar = new id.yaski.simrskhanza.widget.Button();
        BtnPrint = new id.yaski.simrskhanza.widget.Button();
        BtnCari1 = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AkunBayar;
    private id.yaski.simrskhanza.widget.Button BtnAll;
    private id.yaski.simrskhanza.widget.Button BtnAll1;
    private id.yaski.simrskhanza.widget.Button BtnBayar;
    private id.yaski.simrskhanza.widget.Button BtnCari;
    private id.yaski.simrskhanza.widget.Button BtnCari1;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.Tanggal DTPTgl1;
    private id.yaski.simrskhanza.widget.Tanggal DTPTgl2;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TKd;
    private id.yaski.simrskhanza.widget.Tanggal Tanggal;
    private id.yaski.simrskhanza.widget.Button btnPetugas;
    private id.yaski.simrskhanza.widget.CekBox chkInternal;
    private id.yaski.simrskhanza.widget.CekBox chkRalan;
    private id.yaski.simrskhanza.widget.CekBox chkRanap;
    ...
    private id.yaski.simrskhanza.widget.Label label1;
    private id.yaski.simrskhanza.widget.Label label17;
    private id.yaski.simrskhanza.widget.Label label19;
    private id.yaski.simrskhanza.widget.Label label33;
    private id.yaski.simrskhanza.widget.Label label34;
    private id.yaski.simrskhanza.widget.Label label35;
    private id.yaski.simrskhanza.widget.panelisi panelisi1;
    private id.yaski.simrskhanza.widget.panelisi panelisi3;
    private id.yaski.simrskhanza.widget.panelisi panelisi4;
    private id.yaski.simrskhanza.widget.panelisi panelisi5;
    ...
    private id.yaski.simrskhanza.widget.Table tbBangsal;
            ...
            new SwingWorker<Void, Object[]>() {
                ...
                protected Void doInBackground() throws Exception {
                    ...
                    try (PreparedStatement ps = koneksi.prepareStatement(
                        ...
                        "piutang_pasien.tgl_piutang between ? and ? " + ralanranap + "and (piutang_pasien.no_rawat like ? or piutang_pasien.no_rkm_medis like ? or " +
                        "pasien.nm_pasien like ? or bridging_sep.no_sep like ?) order by piutang_pasien.tgl_piutang, bridging_sep.no_sep"
                    )) {
                    ...
                    if (chkInternal.isSelected()) {
                        try (PreparedStatement ps = koneksi.prepareStatement(
                            ...
                            "bridging_sep_internal.no_sep = inacbg_grouping.no_sep where piutang_pasien.status = 'Belum Lunas' and " +
                            "piutang_pasien.tgl_piutang between ? and ? " + ralanranap + "and (piutang_pasien.no_rawat like ? or " +
                            "piutang_pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or bridging_sep_internal.no_sep like ?) order by " +
                            "piutang_pasien.tgl_piutang, bridging_sep_internal.no_sep"
                        )) {
                            ps.setString(1, Valid.getTglSmc(DTPTgl1));
                            ps.setString(2, Valid.getTglSmc(DTPTgl2));
                            ps.setString(3, "%" + TCari.getText() + "%");
    ...
    private void tampil(Map<String, Double> withSEP) {
        String sepParams = "";
        for (int i = 0; i < withSEP.size(); i++) {
            sepParams = sepParams + "?, ";
        }
        sepParams = sepParams.substring(0, sepParams.length() - 2);
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "and bridging_sep.no_sep in (" + sepParams + ") order by piutang_pasien.tgl_piutang, bridging_sep.no_sep"
        )) {
            int i = 1;
        ...
        if (chkInternal.isSelected()) {
            try (PreparedStatement ps = koneksi.prepareStatement(
                ...
                "and bridging_sep_internal.no_sep in (" + sepParams + ") order by piutang_pasien.tgl_piutang, bridging_sep_internal.no_sep"
            )) {
                int i = 1;
                for (Map.Entry<String, Double> entry: withSEP.entrySet()) {
                    ps.setString(i++, entry.getKey());

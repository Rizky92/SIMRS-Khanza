...
public class KeuanganPiutangJasaPerusahaan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoPiutang = new id.yaski.simrskhanza.widget.TextBox();
        label11 = new id.yaski.simrskhanza.widget.Label();
        TanggalPiutang = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        JatuhTempo = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        TotalTagihan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BesarJasaMenejemen = new id.yaski.simrskhanza.widget.TextBox();
        label21 = new id.yaski.simrskhanza.widget.Label();
        DPPLainLain = new id.yaski.simrskhanza.widget.TextBox();
        PersenMenejemen = new id.yaski.simrskhanza.widget.TextBox();
        PersenPPN = new id.yaski.simrskhanza.widget.TextBox();
        label22 = new id.yaski.simrskhanza.widget.Label();
        PersenPPH = new id.yaski.simrskhanza.widget.TextBox();
        BesarPPH = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox BesarJasaMenejemen;
    private id.yaski.simrskhanza.widget.TextBox BesarPPH;
    ...
    private id.yaski.simrskhanza.widget.TextBox DPPLainLain;
    private id.yaski.simrskhanza.widget.Tanggal JatuhTempo;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoPiutang;
    private id.yaski.simrskhanza.widget.TextBox PersenMenejemen;
    private id.yaski.simrskhanza.widget.TextBox PersenPPH;
    private id.yaski.simrskhanza.widget.TextBox PersenPPN;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.Tanggal TanggalPiutang;
    private id.yaski.simrskhanza.widget.TextBox TotalTagihan;

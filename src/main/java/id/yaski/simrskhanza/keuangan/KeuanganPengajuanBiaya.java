...
public final class KeuanganPengajuanBiaya extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdPetugasPJ = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasPJ = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugasPJ = new id.yaski.simrskhanza.widget.Button();
        ...
        TargetSasaran = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdPetugasPJ;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmPetugasPJ;
    private id.yaski.simrskhanza.widget.TextBox NoPengajuan;
    ...
    private id.yaski.simrskhanza.widget.TextBox TargetSasaran;
    private id.yaski.simrskhanza.widget.TextBox Total;
    private id.yaski.simrskhanza.widget.TextArea Tujuan;
    private id.yaski.simrskhanza.widget.TextArea Uraian;
    private id.yaski.simrskhanza.widget.ComboBox Urgensi;
    private id.yaski.simrskhanza.widget.Button btnPetugas;
    private id.yaski.simrskhanza.widget.Button btnPetugasPJ;

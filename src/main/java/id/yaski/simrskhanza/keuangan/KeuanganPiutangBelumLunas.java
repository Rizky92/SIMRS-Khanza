...
public final class KeuanganPiutangBelumLunas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnCloseHitungKapitasi = new id.yaski.simrskhanza.widget.Button();
        BtnHitungKapitasi = new id.yaski.simrskhanza.widget.Button();
        jLabel43 = new id.yaski.simrskhanza.widget.Label();
        LebihBayarPiutang = new id.yaski.simrskhanza.widget.TextBox();
        PersentaseBayarPaket = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        NilaiKapitasiPaket = new id.yaski.simrskhanza.widget.TextBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        PiutangBelumDibayar = new id.yaski.simrskhanza.widget.TextBox();
        jLabel44 = new id.yaski.simrskhanza.widget.Label();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        PilihanKekurangan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnCloseHitungKapitasi;
    private id.yaski.simrskhanza.widget.Button BtnHitungKapitasi;
    ...
    private id.yaski.simrskhanza.widget.TextBox LebihBayarPiutang;
    private javax.swing.JMenuItem MnDetailPiutang;
    private id.yaski.simrskhanza.widget.TextBox NilaiKapitasiPaket;
    private id.yaski.simrskhanza.widget.TextBox PersentaseBayarPaket;
    private id.yaski.simrskhanza.widget.ComboBox PilihanKekurangan;
    private id.yaski.simrskhanza.widget.TextBox PiutangBelumDibayar;

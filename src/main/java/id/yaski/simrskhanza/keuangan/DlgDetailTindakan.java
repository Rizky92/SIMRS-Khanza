...
public final class DlgDetailTindakan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbRalanDokter = new id.yaski.simrskhanza.widget.Table();
        ...
        KdDokterRalanDokter = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterRalanDokter = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterRalanDokter = new id.yaski.simrskhanza.widget.Button();
        label19 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRalanDokter = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRalanDokter = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRalanDokter = new id.yaski.simrskhanza.widget.Button();
        label20 = new id.yaski.simrskhanza.widget.Label();
        KdPoliRalanDokter = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliRalanDokter = new id.yaski.simrskhanza.widget.TextBox();
        BtnPoliRalanDokter = new id.yaski.simrskhanza.widget.Button();
        internalFrame3 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll1 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRalanParamedis = new id.yaski.simrskhanza.widget.Table();
        PanelInput1 = new javax.swing.JPanel();
        ChkInput1 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput1 = new id.yaski.simrskhanza.widget.panelisi();
        label21 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasRalanParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasRalanParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasRalanParamedis = new id.yaski.simrskhanza.widget.Button();
        label22 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRalanParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRalanParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRalanParamedis = new id.yaski.simrskhanza.widget.Button();
        label23 = new id.yaski.simrskhanza.widget.Label();
        KdPoliRalanParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliRalanParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPoliRalanParamedis = new id.yaski.simrskhanza.widget.Button();
        internalFrame4 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRalanDokterParamedis = new id.yaski.simrskhanza.widget.Table();
        PanelInput2 = new javax.swing.JPanel();
        ChkInput2 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput2 = new id.yaski.simrskhanza.widget.panelisi();
        label24 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasRalanDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        label25 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRalanDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        label26 = new id.yaski.simrskhanza.widget.Label();
        KdPoliRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPoliRalanDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        label27 = new id.yaski.simrskhanza.widget.Label();
        KdDokterRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterRalanDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterRalanDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        internalFrame5 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll3 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbOperasi = new id.yaski.simrskhanza.widget.Table();
        PanelInput10 = new javax.swing.JPanel();
        ChkInput10 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput10 = new id.yaski.simrskhanza.widget.panelisi();
        label48 = new id.yaski.simrskhanza.widget.Label();
        KdAsistenOperasi = new id.yaski.simrskhanza.widget.TextBox();
        NmAsistenOperasi = new id.yaski.simrskhanza.widget.TextBox();
        BtnAsistenOperasi = new id.yaski.simrskhanza.widget.Button();
        label49 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarOperasi = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarOperasi = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarOperasi = new id.yaski.simrskhanza.widget.Button();
        label50 = new id.yaski.simrskhanza.widget.Label();
        KdOperatorOperasi = new id.yaski.simrskhanza.widget.TextBox();
        NmOperatorOperasi = new id.yaski.simrskhanza.widget.TextBox();
        BtnOperatorOperasi = new id.yaski.simrskhanza.widget.Button();
        internalFrame6 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll4 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRanapDokter = new id.yaski.simrskhanza.widget.Table();
        PanelInput3 = new javax.swing.JPanel();
        ChkInput3 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput3 = new id.yaski.simrskhanza.widget.panelisi();
        label28 = new id.yaski.simrskhanza.widget.Label();
        KdDokterRanapDokter = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterRanapDokter = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterRanapDokter = new id.yaski.simrskhanza.widget.Button();
        label29 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRanapDokter = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRanapDokter = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRanapDokter = new id.yaski.simrskhanza.widget.Button();
        internalFrame7 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll5 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRanapParamedis = new id.yaski.simrskhanza.widget.Table();
        PanelInput4 = new javax.swing.JPanel();
        ChkInput4 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput4 = new id.yaski.simrskhanza.widget.panelisi();
        label30 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasRanapParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasRanapParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasRanapParamedis = new id.yaski.simrskhanza.widget.Button();
        label31 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRanapParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRanapParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRanapParamedis = new id.yaski.simrskhanza.widget.Button();
        internalFrame8 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll6 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRanapDokterParamedis = new id.yaski.simrskhanza.widget.Table();
        PanelInput5 = new javax.swing.JPanel();
        ChkInput5 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput5 = new id.yaski.simrskhanza.widget.panelisi();
        label32 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasRanapDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasRanapDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasRanapDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        label33 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRanapDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRanapDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRanapDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        label35 = new id.yaski.simrskhanza.widget.Label();
        KdDokterRanapDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterRanapDokterParamedis = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterRanapDokterParamedis = new id.yaski.simrskhanza.widget.Button();
        internalFrame9 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll7 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRadiologi = new id.yaski.simrskhanza.widget.Table();
        PanelInput7 = new javax.swing.JPanel();
        ChkInput7 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput7 = new id.yaski.simrskhanza.widget.panelisi();
        label39 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasRad = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasRad = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasRad = new id.yaski.simrskhanza.widget.Button();
        label40 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarRad = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarRad = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarRad = new id.yaski.simrskhanza.widget.Button();
        label41 = new id.yaski.simrskhanza.widget.Label();
        KdDokterPerujukRad = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterPerujukRad = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterPerujukRad = new id.yaski.simrskhanza.widget.Button();
        internalFrame10 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll8 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbLaborat = new id.yaski.simrskhanza.widget.Table();
        PanelInput8 = new javax.swing.JPanel();
        ChkInput8 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput8 = new id.yaski.simrskhanza.widget.panelisi();
        label42 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasLab = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasLab = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasLab = new id.yaski.simrskhanza.widget.Button();
        label43 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarLab = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarLab = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarLab = new id.yaski.simrskhanza.widget.Button();
        label44 = new id.yaski.simrskhanza.widget.Label();
        KdDokterPerujukLab = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterPerujukLab = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterPerujukLab = new id.yaski.simrskhanza.widget.Button();
        internalFrame11 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll9 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDetailLaborat = new id.yaski.simrskhanza.widget.Table();
        PanelInput9 = new javax.swing.JPanel();
        ChkInput9 = new id.yaski.simrskhanza.widget.CekBox();
        FormInput9 = new id.yaski.simrskhanza.widget.panelisi();
        label45 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasDetailLab = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasDetailLab = new id.yaski.simrskhanza.widget.TextBox();
        BtnPetugasDetailLab = new id.yaski.simrskhanza.widget.Button();
        label46 = new id.yaski.simrskhanza.widget.Label();
        KdCaraBayarDetailLab = new id.yaski.simrskhanza.widget.TextBox();
        NmCaraBayarDetailLab = new id.yaski.simrskhanza.widget.TextBox();
        BtnCaraBayarDetailLab = new id.yaski.simrskhanza.widget.Button();
        label47 = new id.yaski.simrskhanza.widget.Label();
        KdDokterPerujukDetailLab = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterPerujukDetailLab = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokterPerujukDetailLab = new id.yaski.simrskhanza.widget.Button();
        panelGlass5 = new id.yaski.simrskhanza.widget.panelisi();
        label9 = new id.yaski.simrskhanza.widget.Label();
        ...
        cmbStatus = new id.yaski.simrskhanza.widget.ComboBox();
        label10 = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnAsistenOperasi;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarDetailLab;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarLab;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarOperasi;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRad;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRalanDokter;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRalanParamedis;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRanapDokter;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnCaraBayarRanapParamedis;
    private id.yaski.simrskhanza.widget.Button BtnCari;
    private id.yaski.simrskhanza.widget.Button BtnDokterPerujukDetailLab;
    private id.yaski.simrskhanza.widget.Button BtnDokterPerujukLab;
    private id.yaski.simrskhanza.widget.Button BtnDokterPerujukRad;
    private id.yaski.simrskhanza.widget.Button BtnDokterRalanDokter;
    private id.yaski.simrskhanza.widget.Button BtnDokterRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnDokterRanapDokter;
    private id.yaski.simrskhanza.widget.Button BtnDokterRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnOperatorOperasi;
    private id.yaski.simrskhanza.widget.Button BtnPetugasDetailLab;
    private id.yaski.simrskhanza.widget.Button BtnPetugasLab;
    private id.yaski.simrskhanza.widget.Button BtnPetugasRad;
    private id.yaski.simrskhanza.widget.Button BtnPetugasRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnPetugasRalanParamedis;
    private id.yaski.simrskhanza.widget.Button BtnPetugasRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnPetugasRanapParamedis;
    private id.yaski.simrskhanza.widget.Button BtnPoliRalanDokter;
    private id.yaski.simrskhanza.widget.Button BtnPoliRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.Button BtnPoliRalanParamedis;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkInput10;
    private id.yaski.simrskhanza.widget.CekBox ChkInput2;
    private id.yaski.simrskhanza.widget.CekBox ChkInput3;
    private id.yaski.simrskhanza.widget.CekBox ChkInput4;
    private id.yaski.simrskhanza.widget.CekBox ChkInput5;
    private id.yaski.simrskhanza.widget.CekBox ChkInput7;
    private id.yaski.simrskhanza.widget.CekBox ChkInput8;
    private id.yaski.simrskhanza.widget.CekBox ChkInput9;
    private id.yaski.simrskhanza.widget.panelisi FormInput;
    private id.yaski.simrskhanza.widget.panelisi FormInput1;
    private id.yaski.simrskhanza.widget.panelisi FormInput10;
    private id.yaski.simrskhanza.widget.panelisi FormInput2;
    private id.yaski.simrskhanza.widget.panelisi FormInput3;
    private id.yaski.simrskhanza.widget.panelisi FormInput4;
    private id.yaski.simrskhanza.widget.panelisi FormInput5;
    private id.yaski.simrskhanza.widget.panelisi FormInput7;
    private id.yaski.simrskhanza.widget.panelisi FormInput8;
    private id.yaski.simrskhanza.widget.panelisi FormInput9;
    private id.yaski.simrskhanza.widget.TextBox KdAsistenOperasi;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarDetailLab;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarLab;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarOperasi;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRad;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRalanDokter;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRalanParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRanapDokter;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdCaraBayarRanapParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdDokterPerujukDetailLab;
    private id.yaski.simrskhanza.widget.TextBox KdDokterPerujukLab;
    private id.yaski.simrskhanza.widget.TextBox KdDokterPerujukRad;
    private id.yaski.simrskhanza.widget.TextBox KdDokterRalanDokter;
    private id.yaski.simrskhanza.widget.TextBox KdDokterRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdDokterRanapDokter;
    private id.yaski.simrskhanza.widget.TextBox KdDokterRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdOperatorOperasi;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasDetailLab;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasLab;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasRad;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasRalanParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasRanapParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdPoliRalanDokter;
    private id.yaski.simrskhanza.widget.TextBox KdPoliRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox KdPoliRalanParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmAsistenOperasi;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarDetailLab;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarLab;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarOperasi;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRad;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRalanDokter;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRalanParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRanapDokter;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmCaraBayarRanapParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmDokterPerujukDetailLab;
    private id.yaski.simrskhanza.widget.TextBox NmDokterPerujukLab;
    private id.yaski.simrskhanza.widget.TextBox NmDokterPerujukRad;
    private id.yaski.simrskhanza.widget.TextBox NmDokterRalanDokter;
    private id.yaski.simrskhanza.widget.TextBox NmDokterRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmDokterRanapDokter;
    private id.yaski.simrskhanza.widget.TextBox NmDokterRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmOperatorOperasi;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasDetailLab;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasLab;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasRad;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasRalanParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasRanapParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmPoliRalanDokter;
    private id.yaski.simrskhanza.widget.TextBox NmPoliRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.TextBox NmPoliRalanParamedis;
    ...
    private id.yaski.simrskhanza.widget.ComboBox cmbStatus;
    private id.yaski.simrskhanza.widget.InternalFrame internalFrame1;
    private id.yaski.simrskhanza.widget.InternalFrame internalFrame10;
    private id.yaski.simrskhanza.widget.InternalFrame internalFrame11;
    ...
    private id.yaski.simrskhanza.widget.InternalFrame internalFrame9;
    private id.yaski.simrskhanza.widget.Label jLabel12;
    private id.yaski.simrskhanza.widget.Label label10;
    ...
    private id.yaski.simrskhanza.widget.Label label30;
    private id.yaski.simrskhanza.widget.Label label31;
    private id.yaski.simrskhanza.widget.Label label32;
    private id.yaski.simrskhanza.widget.Label label33;
    private id.yaski.simrskhanza.widget.Label label35;
    private id.yaski.simrskhanza.widget.Label label39;
    private id.yaski.simrskhanza.widget.Label label40;
    private id.yaski.simrskhanza.widget.Label label41;
    private id.yaski.simrskhanza.widget.Label label42;
    private id.yaski.simrskhanza.widget.Label label43;
    private id.yaski.simrskhanza.widget.Label label44;
    private id.yaski.simrskhanza.widget.Label label45;
    private id.yaski.simrskhanza.widget.Label label46;
    private id.yaski.simrskhanza.widget.Label label47;
    private id.yaski.simrskhanza.widget.Label label48;
    private id.yaski.simrskhanza.widget.Label label49;
    private id.yaski.simrskhanza.widget.Label label50;
    private id.yaski.simrskhanza.widget.Label label9;
    private id.yaski.simrskhanza.widget.panelisi panelGlass5;
    private id.yaski.simrskhanza.widget.Table tbDetailLaborat;
    private id.yaski.simrskhanza.widget.Table tbLaborat;
    private id.yaski.simrskhanza.widget.Table tbOperasi;
    private id.yaski.simrskhanza.widget.Table tbRadiologi;
    private id.yaski.simrskhanza.widget.Table tbRalanDokter;
    private id.yaski.simrskhanza.widget.Table tbRalanDokterParamedis;
    private id.yaski.simrskhanza.widget.Table tbRalanParamedis;
    private id.yaski.simrskhanza.widget.Table tbRanapDokter;
    private id.yaski.simrskhanza.widget.Table tbRanapDokterParamedis;
    private id.yaski.simrskhanza.widget.Table tbRanapParamedis;
    ...
    public void tampil2(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            ps.setString(1, Valid.getTglJamSmc(Tgl1));
            ps.setString(2, Valid.getTglJamSmc(Tgl2));
            ps.setString(3, KdPoliRalanParamedis.getText() + "%");
            ps.setString(4, KdPetugasRalanParamedis.getText() + "%");
            ps.setString(5, KdCaraBayarRalanParamedis.getText() + "%");
            if (!TCari.getText().isBlank()) {
                ps.setString(6, "%" + TCari.getText().trim() + "%");
                ps.setString(7, "%" + TCari.getText().trim() + "%");
                ps.setString(8, "%" + TCari.getText().trim() + "%");
    ...
    public void tampil5(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "rawat_inap_dr.kd_dokter, dokter.nm_dokter, rawat_inap_dr.tgl_perawatan, rawat_inap_dr.jam_rawat, penjab.png_jawab, ifnull((select " +
            "bangsal.nm_bangsal from kamar_inap join kamar on kamar_inap.kd_kamar = kamar.kd_kamar join bangsal on kamar.kd_bangsal = bangsal.kd_bangsal where " +
            "kamar_inap.no_rawat = rawat_inap_dr.no_rawat limit 1), 'Ruang Terhapus') as ruang, rawat_inap_dr.material, rawat_inap_dr.bhp, " +
            "rawat_inap_dr.tarif_tindakandr, rawat_inap_dr.kso, rawat_inap_dr.menejemen, rawat_inap_dr.biaya_rawat from rawat_inap_dr join " +
            "jns_perawatan_inap on rawat_inap_dr.kd_jenis_prw = jns_perawatan_inap.kd_jenis_prw join dokter on rawat_inap_dr.kd_dokter = dokter.kd_dokter " +
            "join reg_periksa on rawat_inap_dr.no_rawat = reg_periksa.no_rawat join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join penjab on " +
            "reg_periksa.kd_pj = penjab.kd_pj where concat(rawat_inap_dr.tgl_perawatan, ' ', rawat_inap_dr.jam_rawat) between ? and ? and " +
            "rawat_inap_dr.kd_dokter like ? and reg_periksa.kd_pj like ? " + statusbayar + (TCari.getText().isBlank() ? "" : "and (" +
            "rawat_inap_dr.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or jns_perawatan_inap.nm_perawatan like ? or " +
            "rawat_inap_dr.kd_dokter like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?) ") + "order by rawat_inap_dr.no_rawat desc"
        )) {
            ps.setString(1, Valid.getTglJamSmc(Tgl1));
            ps.setString(2, Valid.getTglJamSmc(Tgl2));
            ps.setString(3, KdDokterRanapDokter.getText() + "%");
            ps.setString(4, KdCaraBayarRanapDokter.getText() + "%");
            if (!TCari.getText().isBlank()) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                if (total > 0) {
                    tabModeRanapDokter.addRow(new Object[] {
                        "", "", "", "", "", "", "", "", "", "", "", "Jumlah Total :", material, bhp, jmdokter, kso, menejemen, total
                    });
                }
            }
        } catch (Exception e) {
    ...
    public void tampil6(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "rawat_inap_pr.nip, petugas.nama, rawat_inap_pr.tgl_perawatan, rawat_inap_pr.jam_rawat, penjab.png_jawab, ifnull((select bangsal.nm_bangsal " +
            "from kamar_inap join kamar on kamar_inap.kd_kamar = kamar.kd_kamar join bangsal on kamar.kd_bangsal = bangsal.kd_bangsal where " +
            "kamar_inap.no_rawat = rawat_inap_pr.no_rawat limit 1), 'Ruang Terhapus') as ruang, rawat_inap_pr.material, rawat_inap_pr.bhp, " +
            "rawat_inap_pr.tarif_tindakanpr, rawat_inap_pr.kso, rawat_inap_pr.menejemen, rawat_inap_pr.biaya_rawat from rawat_inap_pr join " +
            "jns_perawatan_inap on rawat_inap_pr.kd_jenis_prw = jns_perawatan_inap.kd_jenis_prw join petugas on rawat_inap_pr.nip = petugas.nip " +
            "join reg_periksa on rawat_inap_pr.no_rawat = reg_periksa.no_rawat join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join " +
            "penjab on reg_periksa.kd_pj = penjab.kd_pj where concat(rawat_inap_pr.tgl_perawatan, ' ', rawat_inap_pr.jam_rawat) between ? and ? and " +
            "rawat_inap_pr.nip like ? and reg_periksa.kd_pj like ? " + statusbayar + (TCari.getText().isBlank() ? "" : "and (rawat_inap_pr.no_rawat like ? or " +
            "reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or jns_perawatan_inap.nm_perawatan like ? or rawat_inap_pr.nip like ? or " +
            "petugas.nama like ? or penjab.png_jawab like ?) ") + "order by rawat_inap_pr.no_rawat desc"
        )) {
            ps.setString(1, Valid.getTglJamSmc(Tgl1));
            ps.setString(2, Valid.getTglJamSmc(Tgl2));
            ps.setString(3, KdPetugasRanapParamedis.getText() + "%");
            ps.setString(4, KdCaraBayarRanapParamedis.getText() + "%");
            if (!TCari.getText().isBlank()) {
                ps.setString(5, "%" + TCari.getText().trim() + "%");
                ps.setString(6, "%" + TCari.getText().trim() + "%");
                ps.setString(7, "%" + TCari.getText().trim() + "%");
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    tabModeRanapParamedis.addRow(new Object[] {
                        ...
                        rs.getDouble(13), rs.getDouble(14), rs.getDouble(15), rs.getDouble(16), rs.getDouble(17)
                    });
                }
                if (total > 0) {
                    tabModeRanapParamedis.addRow(new Object[] {
                        "", "", "", "", "", "", "", "", "", "", "", "Jumlah Total :", material, bhp, jmpetugas, kso, menejemen, total
                    });
                }
            }
        } catch (Exception e) {
    ...
    public void tampil7(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "rawat_inap_drpr.kd_dokter, dokter.nm_dokter, rawat_inap_drpr.nip, petugas.nama, rawat_inap_drpr.tgl_perawatan, rawat_inap_drpr.jam_rawat, " +
            "penjab.png_jawab, ifnull((select bangsal.nm_bangsal from kamar_inap join kamar on kamar_inap.kd_kamar = kamar.kd_kamar join bangsal on " +
            "kamar.kd_bangsal = bangsal.kd_bangsal where kamar_inap.no_rawat = rawat_inap_drpr.no_rawat limit 1), 'Ruang Terhapus') as ruang, " +
            "rawat_inap_drpr.material, rawat_inap_drpr.bhp, rawat_inap_drpr.tarif_tindakandr, rawat_inap_drpr.tarif_tindakanpr, rawat_inap_drpr.kso, " +
            "rawat_inap_drpr.menejemen, rawat_inap_drpr.biaya_rawat from rawat_inap_drpr join jns_perawatan_inap on rawat_inap_drpr.kd_jenis_prw = jns_perawatan_inap.kd_jenis_prw " +
            "join dokter on rawat_inap_drpr.kd_dokter = dokter.kd_dokter join petugas on rawat_inap_drpr.nip = petugas.nip join reg_periksa on " +
            "rawat_inap_drpr.no_rawat = reg_periksa.no_rawat join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join penjab on " +
            "reg_periksa.kd_pj = penjab.kd_pj where concat(rawat_inap_drpr.tgl_perawatan, ' ', rawat_inap_drpr.jam_rawat) between ? and ? and " +
            "rawat_inap_drpr.kd_dokter like ? and rawat_inap_drpr.nip like ? and reg_periksa.kd_pj like ? " + statusbayar + (TCari.getText().isBlank() ? "" :
            "and (rawat_inap_drpr.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or jns_perawatan_inap.nm_perawatan like ? or " +
            "rawat_inap_drpr.kd_dokter like ? or dokter.nm_dokter like ? or rawat_inap_drpr.nip like ? or petugas.nama like ? or penjab.png_jawab like ?) ") +
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    tabModeRanapDokterParamedis.addRow(new Object[] {
                        ...
                        rs.getString(13), rs.getDouble(14), rs.getDouble(15), rs.getDouble(16), rs.getDouble(17), rs.getDouble(18),
                        rs.getDouble(19), rs.getDouble(20)
                    });
                }
                if (total > 0) {
                    tabModeRanapDokterParamedis.addRow(new Object[] {
                        "", "", "", "", "", "", "", "", "", "", "", "", "", "Jumlah Total :", material, bhp, jmdokter, jmpetugas, kso, menejemen, total
                    });
                }
            }
        } catch (Exception e) {
    ...
    public void tampil8(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "periksa_radiologi.kd_dokter, dokter.nm_dokter, periksa_radiologi.nip, petugas.nama, periksa_radiologi.dokter_perujuk, perujuk.nm_dokter as perujuk, " +
            "periksa_radiologi.tgl_periksa, periksa_radiologi.jam, penjab.png_jawab, periksa_radiologi.bagian_rs, periksa_radiologi.bhp, periksa_radiologi.tarif_perujuk, " +
            "periksa_radiologi.tarif_tindakan_dokter, periksa_radiologi.tarif_tindakan_petugas, periksa_radiologi.kso, periksa_radiologi.menejemen, periksa_radiologi.biaya, " +
            "if(periksa_radiologi.status = 'Ralan', (select nm_poli from poliklinik where poliklinik.kd_poli = reg_periksa.kd_poli), (select bangsal.nm_bangsal from kamar_inap " +
            "join kamar on kamar_inap.kd_kamar = kamar.kd_kamar join bangsal on kamar.kd_bangsal = bangsal.kd_bangsal where kamar_inap.no_rawat = periksa_radiologi.no_rawat " +
            "limit 1)) as ruangan from periksa_radiologi join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw = jns_perawatan_radiologi.kd_jenis_prw join dokter on " +
            "periksa_radiologi.kd_dokter = dokter.kd_dokter join dokter as perujuk on periksa_radiologi.dokter_perujuk = perujuk.kd_dokter join petugas on " +
            "periksa_radiologi.nip = petugas.nip join reg_periksa on periksa_radiologi.no_rawat = reg_periksa.no_rawat join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
            "join penjab on reg_periksa.kd_pj = penjab.kd_pj where concat(periksa_radiologi.tgl_periksa, ' ', periksa_radiologi.jam) between ? and ? and " +
            "periksa_radiologi.dokter_perujuk like ? and periksa_radiologi.nip like ? and reg_periksa.kd_pj like ? " + statusbayar + (TCari.getText().isBlank() ? "" :
            "and (periksa_radiologi.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or periksa_radiologi.kd_jenis_prw like ? or " +
            "jns_perawatan_radiologi.nm_perawatan like ? or periksa_radiologi.kd_dokter like ? or dokter.nm_dokter like ? or periksa_radiologi.nip like ? or " +
            "petugas.nama like ? or periksa_radiologi.dokter_perujuk like ? or perujuk.nm_dokter like ? or penjab.png_jawab like ?) ") +
            "order by periksa_radiologi.no_rawat desc, periksa_radiologi.tgl_periksa desc, periksa_radiologi.jam desc"
        )) {
            ps.setString(1, Valid.getTglJamSmc(Tgl1));
            ps.setString(2, Valid.getTglJamSmc(Tgl2));
            ps.setString(3, KdDokterPerujukRad.getText() + "%");
            ps.setString(4, KdPetugasRad.getText() + "%");
            ps.setString(5, KdCaraBayarRad.getText() + "%");
            if (!TCari.getText().isBlank()) {
                ps.setString(6, "%" + TCari.getText().trim() + "%");
                ps.setString(7, "%" + TCari.getText().trim() + "%");
                ps.setString(8, "%" + TCari.getText().trim() + "%");
            ...
            try (ResultSet rs = ps.executeQuery()) {
                i = 1; material = 0; bhp = 0; jmdokter = 0; jmpetugas = 0; jmperujuk = 0; kso = 0; menejemen = 0; total = 0;
                while (rs.next()) {
                    ...
                    tabModeRadiologi.addRow(new Object[] {
                        ...
                        rs.getString("nm_perawatan"), rs.getString("kd_dokter"), rs.getString("nm_dokter"), rs.getString("nip"), rs.getString("nama"),
                        rs.getString("dokter_perujuk"), rs.getString("perujuk"), rs.getString("tgl_periksa"), rs.getString("jam"), rs.getString("png_jawab"),
                        rs.getString("ruangan"), rs.getDouble("bagian_rs"), rs.getDouble("bhp"), rs.getDouble("tarif_tindakan_dokter"),
                        rs.getDouble("tarif_tindakan_petugas"), rs.getDouble("tarif_perujuk"), rs.getDouble("kso"), rs.getDouble("menejemen"),
                        rs.getDouble("biaya")
                    });
                }
                if (total > 0) {
                    tabModeRadiologi.addRow(new Object[] {
                        "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "Jumlah Total :", material, bhp, jmdokter, jmpetugas, jmperujuk, kso, menejemen, total
                    });
                }
            }
        } catch (Exception e) {
    ...
    public void tampil9(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "periksa_lab.kd_dokter, dokter.nm_dokter, periksa_lab.nip, petugas.nama, periksa_lab.dokter_perujuk, perujuk.nm_dokter as perujuk, " +
            "periksa_lab.tgl_periksa, periksa_lab.jam, penjab.png_jawab, periksa_lab.bagian_rs, periksa_lab.bhp, periksa_lab.tarif_perujuk, " +
            "periksa_lab.tarif_tindakan_dokter, periksa_lab.tarif_tindakan_petugas, periksa_lab.kso, periksa_lab.menejemen, periksa_lab.biaya, " +
            "if(periksa_lab.status = 'Ralan', (select nm_poli from poliklinik where poliklinik.kd_poli = reg_periksa.kd_poli ), (select bangsal.nm_bangsal " +
            "from kamar_inap join kamar on kamar_inap.kd_kamar = kamar.kd_kamar join bangsal on kamar.kd_bangsal = bangsal.kd_bangsal where " +
            "kamar_inap.no_rawat = periksa_lab.no_rawat limit 1)) as ruangan from periksa_lab join reg_periksa on periksa_lab.no_rawat = reg_periksa.no_rawat join " +
            "pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join dokter on periksa_lab.kd_dokter = dokter.kd_dokter join dokter as perujuk on " +
            "periksa_lab.dokter_perujuk = perujuk.kd_dokter join petugas on periksa_lab.nip = petugas.nip join penjab on reg_periksa.kd_pj = penjab.kd_pj join " +
            "jns_perawatan_lab on periksa_lab.kd_jenis_prw = jns_perawatan_lab.kd_jenis_prw where concat(periksa_lab.tgl_periksa, ' ', periksa_lab.jam) between ? and ? and " +
            "periksa_lab.dokter_perujuk like ? and periksa_lab.nip like ? and reg_periksa.kd_pj like ? " + statusbayar + (TCari.getText().isBlank() ? "" : "and (" +
            "periksa_lab.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or periksa_lab.kd_jenis_prw like ? or " +
            "jns_perawatan_lab.nm_perawatan like ? or periksa_lab.kd_dokter like ? or dokter.nm_dokter like ? or periksa_lab.nip like ? or " +
            "petugas.nama like ? or periksa_lab.dokter_perujuk like ? or perujuk.nm_dokter like ? or penjab.png_jawab like ?) ") +
            "order by periksa_lab.no_rawat desc, periksa_lab.tgl_periksa desc, periksa_lab.jam desc"
        )) {
            ps.setString(1, Valid.getTglJamSmc(Tgl1));
            ps.setString(2, Valid.getTglJamSmc(Tgl2));
            ps.setString(3, KdDokterPerujukLab.getText() + "%");
            ps.setString(4, KdPetugasLab.getText() + "%");
            ps.setString(5, KdCaraBayarLab.getText() + "%");
            if (!TCari.getText().isBlank()) {
                ps.setString(6, "%" + TCari.getText().trim() + "%");
                ps.setString(7, "%" + TCari.getText().trim() + "%");
                ps.setString(8, "%" + TCari.getText().trim() + "%");
    ...
    public void tampil10(){
        ...
        try (PreparedStatement ps = koneksi.prepareStatement(
            ...
            "periksa_lab.kd_dokter, dokter.nm_dokter, periksa_lab.nip, petugas.nama, periksa_lab.dokter_perujuk, penjab.png_jawab, perujuk.nm_dokter as perujuk, " +
            "detail_periksa_lab.tgl_periksa, detail_periksa_lab.jam, if(periksa_lab.status = 'Ralan', (select nm_poli from poliklinik where poliklinik.kd_poli = reg_periksa.kd_poli), " +
            "(select bangsal.nm_bangsal from kamar_inap join kamar on kamar_inap.kd_kamar = kamar.kd_kamar join bangsal on kamar.kd_bangsal = bangsal.kd_bangsal where " +
            "kamar_inap.no_rawat = periksa_lab.no_rawat limit 1)) as ruangan, detail_periksa_lab.bagian_rs, detail_periksa_lab.bhp, detail_periksa_lab.bagian_perujuk, " +
            "detail_periksa_lab.bagian_dokter, detail_periksa_lab.bagian_laborat, detail_periksa_lab.kso, detail_periksa_lab.menejemen, detail_periksa_lab.biaya_item from " +
            "detail_periksa_lab join template_laboratorium on detail_periksa_lab.id_template = template_laboratorium.id_template join jns_perawatan_lab on " +
            "detail_periksa_lab.kd_jenis_prw = jns_perawatan_lab.kd_jenis_prw join periksa_lab on detail_periksa_lab.no_rawat = periksa_lab.no_rawat and " +
            "detail_periksa_lab.kd_jenis_prw = periksa_lab.kd_jenis_prw and detail_periksa_lab.tgl_periksa = periksa_lab.tgl_periksa and detail_periksa_lab.jam = periksa_lab.jam join " +
            "dokter as perujuk on periksa_lab.dokter_perujuk = perujuk.kd_dokter join dokter on periksa_lab.kd_dokter = dokter.kd_dokter join petugas on " +
            "periksa_lab.nip = petugas.nip join reg_periksa on detail_periksa_lab.no_rawat = reg_periksa.no_rawat join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join " +
            "penjab on reg_periksa.kd_pj = penjab.kd_pj where concat(detail_periksa_lab.tgl_periksa, ' ', detail_periksa_lab.jam) between ? and ? and periksa_lab.dokter_perujuk like ? and " +
            "periksa_lab.nip like ? and reg_periksa.kd_pj like ? " + statusbayar + (TCari.getText().isBlank() ? "" : "and (detail_periksa_lab.no_rawat like ? or " +
            "reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or detail_periksa_lab.kd_jenis_prw like ? or jns_perawatan_lab.nm_perawatan like ? or " +
            "periksa_lab.kd_dokter like ? or dokter.nm_dokter like ? or periksa_lab.nip like ? or petugas.nama like ? or periksa_lab.dokter_perujuk like ? or " +
            "perujuk.nm_dokter like ? or penjab.png_jawab like ?) ") + "order by detail_periksa_lab.no_rawat desc, detail_periksa_lab.tgl_periksa desc, " +
            "detail_periksa_lab.jam desc, detail_periksa_lab.kd_jenis_prw, detail_periksa_lab.id_template"
        )) {
            ps.setString(1, Valid.getTglJamSmc(Tgl1));
            ps.setString(2, Valid.getTglJamSmc(Tgl2));
            ps.setString(3, KdDokterPerujukDetailLab.getText() + "%");
            ps.setString(4, KdPetugasDetailLab.getText() + "%");
            ps.setString(5, KdCaraBayarDetailLab.getText() + "%");
            if (!TCari.getText().isBlank()) {
                ps.setString(6, "%" + TCari.getText().trim() + "%");
                ps.setString(7, "%" + TCari.getText().trim() + "%");
                ps.setString(8, "%" + TCari.getText().trim() + "%");
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    tabModeDetailLaborat.addRow(new Object[] {
                        i++, rs.getString("no_rawat"), rs.getString("no_rkm_medis"), rs.getString("nm_pasien"), rs.getString("id_template"),
                        rs.getString("Pemeriksaan"), rs.getString("kd_dokter"), rs.getString("nm_dokter"), rs.getString("nip"), rs.getString("nama"),
                        rs.getString("dokter_perujuk"), rs.getString("perujuk"), rs.getString("tgl_periksa"), rs.getString("jam"),
                        rs.getString("png_jawab"), rs.getString("ruangan"), rs.getDouble("bagian_rs"), rs.getDouble("bhp"), rs.getDouble("bagian_dokter"),
                        rs.getDouble("bagian_laborat"), rs.getDouble("bagian_perujuk"), rs.getDouble("kso"), rs.getDouble("menejemen"), rs.getDouble("biaya_item")
                    });
                }
    ...
    private void CetakRalanDokter() {
        if(tabModeRalanDokter.getRowCount()==0){
            ...
            Sequel.temporaryBesarBatch(tabModeRalanDokter, 3000);
            Valid.reportSmc("rptDetailTindakanRalanDokterSMC.jasper", "report", "::[ Detail Tindakan Ralan yang Ditangani Dokter ]::", param);
        }
    }
    ...
    private void CetakRalanParamedis() {
        if(tabModeRalanParamedis.getRowCount()==0){
            ...
            param.put("ipaddress", akses.getalamatip());
            Sequel.deleteTemporaryBesar();
            Sequel.temporaryBesarBatch(tabModeRalanParamedis, 3000);
            Valid.reportSmc("rptDetailTindakanRalanParamedisSMC.jasper", "report", "::[ Detail Tindakan Ralan yang Ditangani Paramedis ]::", param);
        }
    }
    ...
    private void CetakRalanDokterParamedis() {
        if(tabModeRalanDokterParamedis.getRowCount()==0){
            ...
            param.put("ipaddress", akses.getalamatip());
            Sequel.deleteTemporaryBesar();
            Sequel.temporaryBesarBatch(tabModeRalanDokterParamedis, 3000);
            Valid.reportSmc("rptDetailTindakanRalanDokterParamedisSMC.jasper", "report", "::[ Detail Tindakan Ralan yang Ditangani Dokter/Paramedis ]::", param);
        }
    }
    ...
    private void CetakRanapDokter() {
        if(tabModeRanapDokter.getRowCount()==0){
            ...
            param.put("ipaddress", akses.getalamatip());
            Sequel.deleteTemporaryBesar();
            Sequel.temporaryBesarBatch(tabModeRanapDokter, 3000);
            Valid.reportSmc("rptDetailTindakanRanapDokterSMC.jasper", "report", "::[ Detail Tindakan Ranap yang Ditangani Dokter ]::", param);
        }
    }
    ...
    private void CetakRanapParamedis() {
        if(tabModeRanapParamedis.getRowCount()==0){
            ...
            param.put("ipaddress", akses.getalamatip());
            Sequel.deleteTemporaryBesar();
            Sequel.temporaryBesarBatch(tabModeRanapParamedis, 3000);
            Valid.reportSmc("rptDetailTindakanRanapParamedisSMC.jasper", "report", "::[ Detail Tindakan Ranap yang Ditangani Paramedis ]::", param);
        }
    }

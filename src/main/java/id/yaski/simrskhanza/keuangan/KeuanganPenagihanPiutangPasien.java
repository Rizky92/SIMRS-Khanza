...
public final class KeuanganPenagihanPiutangPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdAkun = new id.yaski.simrskhanza.widget.TextBox();
        AtasNama = new id.yaski.simrskhanza.widget.TextBox();
        NoTelp = new id.yaski.simrskhanza.widget.TextBox();
        Perusahaan = new id.yaski.simrskhanza.widget.TextBox();
        AlamatAsuransi = new id.yaski.simrskhanza.widget.TextBox();
        Ditujukan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoPenagihan = new id.yaski.simrskhanza.widget.TextBox();
        label33 = new id.yaski.simrskhanza.widget.Label();
        TanggalTempo = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        Tempo = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnPenagihan = new id.yaski.simrskhanza.widget.Button();
        NamaBank = new id.yaski.simrskhanza.widget.TextBox();
        label14 = new id.yaski.simrskhanza.widget.Label();
        kdmenyetujui = new id.yaski.simrskhanza.widget.TextBox();
        nmmenyetujui = new id.yaski.simrskhanza.widget.TextBox();
        btnMenyetujui = new id.yaski.simrskhanza.widget.Button();
        NoRek = new id.yaski.simrskhanza.widget.TextBox();
        ...
        LCountBelumDibayar1 = new id.yaski.simrskhanza.widget.Label();
        LCountDipilih1 = new id.yaski.simrskhanza.widget.Label();
        ...
        Diskon = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new javax.swing.JLabel();
        TotalPenagihan = new javax.swing.JLabel();
        TabRawat = new javax.swing.JTabbedPane();
        Scroll = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBelumLunas = new id.yaski.simrskhanza.widget.Table();
        Scroll1 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbBelumDitagihkan = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AlamatAsuransi;
    private id.yaski.simrskhanza.widget.TextBox AtasNama;
    ...
    private id.yaski.simrskhanza.widget.Button BtnPenagihan;
    ...
    private id.yaski.simrskhanza.widget.TextBox Diskon;
    private id.yaski.simrskhanza.widget.TextBox Ditujukan;
    private id.yaski.simrskhanza.widget.TextBox KdAkun;
    private id.yaski.simrskhanza.widget.Label LCountBelumDibayar1;
    private javax.swing.JLabel LCountBelumDibayar2;
    private id.yaski.simrskhanza.widget.Label LCountDipilih1;
    private javax.swing.JLabel LCountDipilih2;
    private javax.swing.JMenuItem MnDetailPiutang;
    private id.yaski.simrskhanza.widget.TextBox NamaBank;
    private id.yaski.simrskhanza.widget.TextBox NoPenagihan;
    private id.yaski.simrskhanza.widget.TextBox NoRek;
    private id.yaski.simrskhanza.widget.TextBox NoTelp;
    private id.yaski.simrskhanza.widget.TextBox Perusahaan;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalTempo;
    private id.yaski.simrskhanza.widget.TextBox Tempo;
    private javax.swing.JLabel TotalPenagihan;
    private id.yaski.simrskhanza.widget.Button btnMenyetujui;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdmenyetujui;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmmenyetujui;
    ...
    private id.yaski.simrskhanza.widget.Table tbBelumDitagihkan;
    private id.yaski.simrskhanza.widget.Table tbBelumLunas;

...
public final class DlgPemasukanLain extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pemasukan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2025 21:01:40" }));
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbResep.getSelectedRow()>-1){
                ...
                if (Sequel.menghapustfSmc("pemasukan_lain", "no_masuk = ?", tbResep.getValueAt(tbResep.getSelectedRow(), 0).toString())) {
                    try (PreparedStatement ps = koneksi.prepareStatement("select p.kd_rek, p.kd_rek2 from kategori_pemasukan_lain p where p.kode_kategori = ?")) {
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox pemasukan;

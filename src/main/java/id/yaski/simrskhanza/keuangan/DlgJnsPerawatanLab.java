...
import id.yaski.simrskhanza.restore.DlgRestoreTarifLab;
...
public final class DlgJnsPerawatanLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Bhp = new id.yaski.simrskhanza.widget.TextBox();
        JMDokter = new id.yaski.simrskhanza.widget.TextBox();
        JMLaborat = new id.yaski.simrskhanza.widget.TextBox();
        JMPerujuk = new id.yaski.simrskhanza.widget.TextBox();
        TotalBiaya = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Bhp;
    ...
    private id.yaski.simrskhanza.widget.TextBox JMDokter;
    private id.yaski.simrskhanza.widget.TextBox JMLaborat;
    ...
    private id.yaski.simrskhanza.widget.TextBox TotalBiaya;

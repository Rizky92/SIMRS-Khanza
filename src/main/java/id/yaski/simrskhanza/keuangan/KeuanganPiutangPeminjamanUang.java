...
public final class KeuanganPiutangPeminjamanUang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LTotal1 = new id.yaski.simrskhanza.widget.Label();
        ...
        KdPeminjam = new id.yaski.simrskhanza.widget.TextBox();
        NmPeminjam = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Tempo = new id.yaski.simrskhanza.widget.Tanggal();
        NominalPinjam = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdPeminjam;
    ...
    private id.yaski.simrskhanza.widget.Label LTotal1;
    private id.yaski.simrskhanza.widget.TextBox NmPeminjam;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.TextBox NoNota;
    private id.yaski.simrskhanza.widget.TextBox NominalPinjam;
    ...
    private id.yaski.simrskhanza.widget.Tanggal Tempo;

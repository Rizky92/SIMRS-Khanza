...
public final class KeuanganBayarBebanHutangLain extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoHutang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Cicilan = new id.yaski.simrskhanza.widget.TextBox();
        label16 = new id.yaski.simrskhanza.widget.Label();
        KdPemberiHutang = new id.yaski.simrskhanza.widget.TextBox();
        NmPemberiHutang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnPeminjam = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnPeminjam;
    ...
    private id.yaski.simrskhanza.widget.TextBox Cicilan;
    ...
    private id.yaski.simrskhanza.widget.TextBox KdPemberiHutang;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmPemberiHutang;
    private id.yaski.simrskhanza.widget.TextBox NoBukti;
    private id.yaski.simrskhanza.widget.TextBox NoHutang;

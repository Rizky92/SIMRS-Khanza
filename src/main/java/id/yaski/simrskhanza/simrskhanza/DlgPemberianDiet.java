...
import id.yaski.simrskhanza.laporan.LaporanSisaDietPasien;
...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NmDiet = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KdDiet = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnJam = new id.yaski.simrskhanza.widget.Button();
        ...
        tbRekapDiet = new id.yaski.simrskhanza.widget.Table();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnJam;
    ...
    private id.yaski.simrskhanza.widget.TextBox KdDiet;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmDiet;
    ...
    private id.yaski.simrskhanza.widget.Table tbRekapDiet;

...
import id.yaski.simrskhanza.bridging.BPJSCekNIK;
import id.yaski.simrskhanza.bridging.BPJSCekNoKartu;
import id.yaski.simrskhanza.bridging.BPJSNik;
import id.yaski.simrskhanza.bridging.BPJSPeserta;
import id.yaski.simrskhanza.bridging.CoronaPasien;
import id.yaski.simrskhanza.bridging.DUKCAPILCekNIK;
import id.yaski.simrskhanza.bridging.DUKCAPILJakartaCekNik;
import id.yaski.simrskhanza.bridging.PCareNIK;
import id.yaski.simrskhanza.bridging.PCarePeserta;
import id.yaski.simrskhanza.bridging.SatuSehatCekNIK;
import id.yaski.simrskhanza.bridging.YaskiReferensiKabupaten;
import id.yaski.simrskhanza.bridging.YaskiReferensiKecamatan;
import id.yaski.simrskhanza.bridging.YaskiReferensiKelurahan;
import id.yaski.simrskhanza.bridging.YaskiReferensiPropinsi;
import id.yaski.simrskhanza.fungsi.WarnaTable;
import id.yaski.simrskhanza.fungsi.batasInput;
import id.yaski.simrskhanza.grafikanalisa.grafikjkel;
import id.yaski.simrskhanza.grafikanalisa.grafikpasienperagama;
import id.yaski.simrskhanza.grafikanalisa.grafikpasienperpekerjaaan;
import id.yaski.simrskhanza.grafikanalisa.grafiksql;
...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kd2 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnPrint2 = new id.yaski.simrskhanza.widget.Button();
        BtnKeluar2 = new id.yaski.simrskhanza.widget.Button();
        Kelurahan2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek8 = new id.yaski.simrskhanza.widget.Button();
        Kecamatan2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek9 = new id.yaski.simrskhanza.widget.Button();
        Kabupaten2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek10 = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnPrint3 = new id.yaski.simrskhanza.widget.Button();
        BtnSeek11 = new id.yaski.simrskhanza.widget.Button();
        Propinsi2 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnCloseIn6 = new id.yaski.simrskhanza.widget.Button();
        BtnSimpan6 = new id.yaski.simrskhanza.widget.Button();
        label40 = new id.yaski.simrskhanza.widget.Label();
        NoRmTujuan = new id.yaski.simrskhanza.widget.TextBox();
        NmPasienTujuan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Carialamat = new id.yaski.simrskhanza.widget.TextBox();
        ...
        cmbHlm = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        ChkDaftar = new id.yaski.simrskhanza.widget.CekBox();
        ...
        TUmurTh = new id.yaski.simrskhanza.widget.TextBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        TUmurBl = new id.yaski.simrskhanza.widget.TextBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        TUmurHr = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ChkAlamatPJ = new id.yaski.simrskhanza.widget.CekBox();
        ...
        NoRekamMedisDipilih = new id.yaski.simrskhanza.widget.TextBox();
        NamaPasienDipilih = new id.yaski.simrskhanza.widget.TextBox();
        FormPhotoPass = new id.yaski.simrskhanza.widget.PanelBiasa();
        FormPhoto = new id.yaski.simrskhanza.widget.PanelBiasa();
        FormPass2 = new id.yaski.simrskhanza.widget.PanelBiasa();
        btnAmbilPhoto = new id.yaski.simrskhanza.widget.Button();
        BtnRefreshPhoto = new id.yaski.simrskhanza.widget.Button();
        Scroll4 = new id.yaski.simrskhanza.widget.ScrollPane();
        LoadHTML = new id.yaski.simrskhanza.widget.editorpane();
        FormPass = new id.yaski.simrskhanza.widget.PanelBiasa();
        FormPass1 = new id.yaski.simrskhanza.widget.PanelBiasa();
        btnUbahPassword = new id.yaski.simrskhanza.widget.Button();
        PasswordPasien = new id.yaski.simrskhanza.widget.TextArea();
   ...
   if(Kabupaten2.getText().equals("")){
    ...
    private id.yaski.simrskhanza.widget.Button BtnCloseIn6;
    ...
    private id.yaski.simrskhanza.widget.Button BtnKeluar2;
    ...
    private id.yaski.simrskhanza.widget.Button BtnPrint2;
    private id.yaski.simrskhanza.widget.Button BtnPrint3;
    private id.yaski.simrskhanza.widget.Button BtnPropinsi;
    private id.yaski.simrskhanza.widget.Button BtnRefreshPhoto;
    private id.yaski.simrskhanza.widget.Button BtnSatuanPolri;
    private id.yaski.simrskhanza.widget.Button BtnSatuanTNI;
    private id.yaski.simrskhanza.widget.Button BtnSeek10;
    private id.yaski.simrskhanza.widget.Button BtnSeek11;
    private id.yaski.simrskhanza.widget.Button BtnSeek8;
    private id.yaski.simrskhanza.widget.Button BtnSeek9;
    private id.yaski.simrskhanza.widget.Button BtnSimpan;
    private id.yaski.simrskhanza.widget.Button BtnSimpan6;
    ...
    private id.yaski.simrskhanza.widget.TextBox Carialamat;
    private id.yaski.simrskhanza.widget.CekBox ChkAccor;
    private id.yaski.simrskhanza.widget.CekBox ChkAlamatPJ;
    private id.yaski.simrskhanza.widget.CekBox ChkDaftar;
    ...
    private id.yaski.simrskhanza.widget.PanelBiasa FormPass;
    private id.yaski.simrskhanza.widget.PanelBiasa FormPass1;
    private id.yaski.simrskhanza.widget.PanelBiasa FormPass2;
    private id.yaski.simrskhanza.widget.PanelBiasa FormPhoto;
    private id.yaski.simrskhanza.widget.PanelBiasa FormPhotoPass;
    private id.yaski.simrskhanza.widget.TextBox Kabupaten;
    private id.yaski.simrskhanza.widget.TextBox Kabupaten2;
    private id.yaski.simrskhanza.widget.TextBox KabupatenPj;
    private javax.swing.JMenu KartuPasien;
    private id.yaski.simrskhanza.widget.TextBox Kd2;
    ...
    private id.yaski.simrskhanza.widget.TextBox Kecamatan2;
    private id.yaski.simrskhanza.widget.TextBox KecamatanPj;
    private id.yaski.simrskhanza.widget.TextBox Kelurahan;
    private id.yaski.simrskhanza.widget.TextBox Kelurahan2;
    ...
    private id.yaski.simrskhanza.widget.TextBox NamaPasienDipilih;
    private id.yaski.simrskhanza.widget.TextBox NmIbu;
    private id.yaski.simrskhanza.widget.TextBox NmPasienTujuan;
    private id.yaski.simrskhanza.widget.TextBox NoRekamMedisDipilih;
    private id.yaski.simrskhanza.widget.TextBox NoRm;
    private id.yaski.simrskhanza.widget.TextBox NoRmTujuan;
    private id.yaski.simrskhanza.widget.PanelBiasa PanelAccor;
    private id.yaski.simrskhanza.widget.TextArea PasswordPasien;
    ...
    private id.yaski.simrskhanza.widget.TextBox Propinsi2;
    ...
    private id.yaski.simrskhanza.widget.TextBox TUmurBl;
    private id.yaski.simrskhanza.widget.TextBox TUmurHr;
    private id.yaski.simrskhanza.widget.TextBox TUmurTh;
    private javax.swing.JTabbedPane TabRawat;
    private javax.swing.JDialog WindowGabungRM;
    private id.yaski.simrskhanza.widget.Button btnAmbilPhoto;
    private id.yaski.simrskhanza.widget.Button btnPropinsiPj;
    private id.yaski.simrskhanza.widget.Button btnUbahPassword;
    ...
    private id.yaski.simrskhanza.widget.ComboBox cmbHlm;
    ...
    private id.yaski.simrskhanza.widget.Table tbPasien;
    private id.yaski.simrskhanza.widget.Table tbPasien2;
    private id.yaski.simrskhanza.widget.Table tbPasien3;

...
public class DlgPasienMati extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbMati = new id.yaski.simrskhanza.widget.Table();
        ...
        TKtg = new id.yaski.simrskhanza.widget.TextBox();
        ...
        icd1 = new id.yaski.simrskhanza.widget.TextBox();
        icd2 = new id.yaski.simrskhanza.widget.TextBox();
        icd3 = new id.yaski.simrskhanza.widget.TextBox();
        icd4 = new id.yaski.simrskhanza.widget.TextBox();
        tmptmeninggal = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox TKtg;
    ...
    private id.yaski.simrskhanza.widget.TextBox icd1;
    private id.yaski.simrskhanza.widget.TextBox icd2;
    private id.yaski.simrskhanza.widget.TextBox icd3;
    private id.yaski.simrskhanza.widget.TextBox icd4;
    ...
    private id.yaski.simrskhanza.widget.Table tbMati;
    private id.yaski.simrskhanza.widget.ComboBox tmptmeninggal;

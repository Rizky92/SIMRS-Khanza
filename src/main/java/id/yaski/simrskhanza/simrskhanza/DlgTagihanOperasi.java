...
import id.yaski.simrskhanza.keuangan.DlgJnsPerawatanOperasi;
...
import id.yaski.simrskhanza.rekammedis.MasterCariTemplateLaporanOperasi;
...
public class DlgTagihanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TCariPaket = new id.yaski.simrskhanza.widget.TextBox();
        BtnCari2 = new id.yaski.simrskhanza.widget.Button();
        BtnAll1 = new id.yaski.simrskhanza.widget.Button();
        BtnTambahOperasi = new id.yaski.simrskhanza.widget.Button();
        ...
        LTotal = new id.yaski.simrskhanza.widget.Label();
        ...
        kdoperator1 = new id.yaski.simrskhanza.widget.TextBox();
        nmoperator1 = new id.yaski.simrskhanza.widget.TextBox();
        BtnOperator1 = new id.yaski.simrskhanza.widget.Button();
        ...
        jenis = new id.yaski.simrskhanza.widget.TextBox();
        label17 = new id.yaski.simrskhanza.widget.Label();
        kdasistoperator1 = new id.yaski.simrskhanza.widget.TextBox();
        nmasistoperator1 = new id.yaski.simrskhanza.widget.TextBox();
        btnAsis1 = new id.yaski.simrskhanza.widget.Button();
        label19 = new id.yaski.simrskhanza.widget.Label();
        kdoperator2 = new id.yaski.simrskhanza.widget.TextBox();
        nmoperator2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnOperator2 = new id.yaski.simrskhanza.widget.Button();
        label20 = new id.yaski.simrskhanza.widget.Label();
        kdoperator3 = new id.yaski.simrskhanza.widget.TextBox();
        nmoperator3 = new id.yaski.simrskhanza.widget.TextBox();
        btnOperator3 = new id.yaski.simrskhanza.widget.Button();
        label21 = new id.yaski.simrskhanza.widget.Label();
        kdanestesi = new id.yaski.simrskhanza.widget.TextBox();
        nmanestesi = new id.yaski.simrskhanza.widget.TextBox();
        BtnAnastesi = new id.yaski.simrskhanza.widget.Button();
        label22 = new id.yaski.simrskhanza.widget.Label();
        kddranak = new id.yaski.simrskhanza.widget.TextBox();
        nmdranak = new id.yaski.simrskhanza.widget.TextBox();
        btnAnak = new id.yaski.simrskhanza.widget.Button();
        btnAsis2 = new id.yaski.simrskhanza.widget.Button();
        nmasistoperator2 = new id.yaski.simrskhanza.widget.TextBox();
        kdasistoperator2 = new id.yaski.simrskhanza.widget.TextBox();
        label18 = new id.yaski.simrskhanza.widget.Label();
        btnAsis3 = new id.yaski.simrskhanza.widget.Button();
        nminstrumen = new id.yaski.simrskhanza.widget.TextBox();
        kdInstrumen = new id.yaski.simrskhanza.widget.TextBox();
        label23 = new id.yaski.simrskhanza.widget.Label();
        btnPrwRes = new id.yaski.simrskhanza.widget.Button();
        nmprwresust = new id.yaski.simrskhanza.widget.TextBox();
        kdprwresust = new id.yaski.simrskhanza.widget.TextBox();
        label24 = new id.yaski.simrskhanza.widget.Label();
        label26 = new id.yaski.simrskhanza.widget.Label();
        kdasistanestesi = new id.yaski.simrskhanza.widget.TextBox();
        nmasistanestesi = new id.yaski.simrskhanza.widget.TextBox();
        BtnAsnes = new id.yaski.simrskhanza.widget.Button();
        label27 = new id.yaski.simrskhanza.widget.Label();
        kdbidan = new id.yaski.simrskhanza.widget.TextBox();
        nmbidan = new id.yaski.simrskhanza.widget.TextBox();
        btnBidan = new id.yaski.simrskhanza.widget.Button();
        label28 = new id.yaski.simrskhanza.widget.Label();
        kdprwluar = new id.yaski.simrskhanza.widget.TextBox();
        nmprwluar = new id.yaski.simrskhanza.widget.TextBox();
        btnPrwLuar = new id.yaski.simrskhanza.widget.Button();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        Kategori = new id.yaski.simrskhanza.widget.ComboBox();
        btnBidan2 = new id.yaski.simrskhanza.widget.Button();
        nmbidan2 = new id.yaski.simrskhanza.widget.TextBox();
        kdbidan2 = new id.yaski.simrskhanza.widget.TextBox();
        label29 = new id.yaski.simrskhanza.widget.Label();
        label30 = new id.yaski.simrskhanza.widget.Label();
        kdbidan3 = new id.yaski.simrskhanza.widget.TextBox();
        nmbidan3 = new id.yaski.simrskhanza.widget.TextBox();
        btnBidan3 = new id.yaski.simrskhanza.widget.Button();
        label25 = new id.yaski.simrskhanza.widget.Label();
        kdonloop1 = new id.yaski.simrskhanza.widget.TextBox();
        nmonloop1 = new id.yaski.simrskhanza.widget.TextBox();
        btnOnloop1 = new id.yaski.simrskhanza.widget.Button();
        btnOnloop2 = new id.yaski.simrskhanza.widget.Button();
        nmonloop2 = new id.yaski.simrskhanza.widget.TextBox();
        kdonloop2 = new id.yaski.simrskhanza.widget.TextBox();
        label31 = new id.yaski.simrskhanza.widget.Label();
        label32 = new id.yaski.simrskhanza.widget.Label();
        btnOnloop3 = new id.yaski.simrskhanza.widget.Button();
        nmonloop3 = new id.yaski.simrskhanza.widget.TextBox();
        kdonloop3 = new id.yaski.simrskhanza.widget.TextBox();
        label33 = new id.yaski.simrskhanza.widget.Label();
        kdpjanak = new id.yaski.simrskhanza.widget.TextBox();
        nmpjanak = new id.yaski.simrskhanza.widget.TextBox();
        btndrpjanak = new id.yaski.simrskhanza.widget.Button();
        label34 = new id.yaski.simrskhanza.widget.Label();
        kddrumum = new id.yaski.simrskhanza.widget.TextBox();
        nmdrumum = new id.yaski.simrskhanza.widget.TextBox();
        btndrumum = new id.yaski.simrskhanza.widget.Button();
        label35 = new id.yaski.simrskhanza.widget.Label();
        kdasistoperator3 = new id.yaski.simrskhanza.widget.TextBox();
        nmasistoperator3 = new id.yaski.simrskhanza.widget.TextBox();
        btnAsis4 = new id.yaski.simrskhanza.widget.Button();
        label36 = new id.yaski.simrskhanza.widget.Label();
        kdasistanestesi2 = new id.yaski.simrskhanza.widget.TextBox();
        nmasistanestesi2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnAsnes1 = new id.yaski.simrskhanza.widget.Button();
        label37 = new id.yaski.simrskhanza.widget.Label();
        kdonloop4 = new id.yaski.simrskhanza.widget.TextBox();
        nmonloop4 = new id.yaski.simrskhanza.widget.TextBox();
        btnOnloop4 = new id.yaski.simrskhanza.widget.Button();
        btnOnloop5 = new id.yaski.simrskhanza.widget.Button();
        nmonloop5 = new id.yaski.simrskhanza.widget.TextBox();
        kdonloop5 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PreOp = new id.yaski.simrskhanza.widget.TextBox();
        jLabel6 = new id.yaski.simrskhanza.widget.Label();
        jLabel7 = new id.yaski.simrskhanza.widget.Label();
        PostOp = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        Jaringan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        DikirimPA = new id.yaski.simrskhanza.widget.ComboBox();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Laporan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        btnTemplate = new id.yaski.simrskhanza.widget.Button();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        NomorImplant = new id.yaski.simrskhanza.widget.TextBox();
...
private void btnAnakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnakActionPerformed
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(sukses==true){
                    if(status.equals("Ranap")){
                        ...
                        if(ttlpendapatan>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Suspen_Piutang_Operasi_Ranap, "Suspen Piutang Operasi Ranap", ttlpendapatan, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Operasi_Ranap, "Pendapatan Operasi Rawat Inap", 0, ttlpendapatan);
                        }
                        if(ttljmdokter>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Dokter_Operasi_Ranap, "Beban Jasa Medik Dokter Operasi Ranap", ttljmdokter, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Dokter_Operasi_Ranap, "Utang Jasa Medik Dokter Operasi Ranap", 0, ttljmdokter);
                        }
                        if(ttljmpetugas>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Paramedis_Operasi_Ranap, "Beban Jasa Medik Petugas Operasi Ranap", ttljmpetugas, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Paramedis_Operasi_Ranap, "Utang Jasa Medik Petugas Operasi Ranap", 0, ttljmpetugas);
                        }
                        if(ttlbhp>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(HPP_Obat_Operasi_Ranap, "HPP Persediaan Operasi Rawat Inap", ttlbhp, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Persediaan_Obat_Kamar_Operasi_Ranap, "Persediaan BHP Operasi Ranap", 0, ttlbhp);
                        }
                        ...
                        Sequel.deleteTampJurnal();
                        if(ttlpendapatan>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Suspen_Piutang_Operasi_Ralan, "Suspen Piutang Operasi Ralan", ttlpendapatan, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Operasi_Ralan, "Pendapatan Operasi Rawat Jalan", 0, ttlpendapatan);
                        }
                        if(ttljmdokter>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Dokter_Operasi_Ralan, "Beban Jasa Medik Dokter Operasi Ralan", ttljmdokter, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Dokter_Operasi_Ralan, "Utang Jasa Medik Dokter Operasi Ralan", 0, ttljmdokter);
                        }
                        if(ttljmpetugas>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Beban_Jasa_Medik_Paramedis_Operasi_Ralan, "Beban Jasa Medik Petugas Operasi Ralan", ttljmpetugas, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Utang_Jasa_Medik_Paramedis_Operasi_Ralan, "Utang Jasa Medik Petugas Operasi Ralan", 0, ttljmpetugas);
                        }
                        if(ttlbhp>0){
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(HPP_Obat_Operasi_Ralan, "HPP Persediaan Operasi Rawat Jalan", ttlbhp, 0);
                            if (sukses) sukses = Sequel.insertOrUpdateTampJurnal(Persediaan_Obat_Kamar_Operasi_Ralan, "Persediaan BHP Operasi Ralan", 0, ttlbhp);
                        }
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnAnastesi;
    private id.yaski.simrskhanza.widget.Button BtnAsnes;
    private id.yaski.simrskhanza.widget.Button BtnAsnes1;
    ...
    private id.yaski.simrskhanza.widget.Button BtnOperator1;
    private id.yaski.simrskhanza.widget.Button BtnOperator2;
    private id.yaski.simrskhanza.widget.Button BtnSimpan;
    private id.yaski.simrskhanza.widget.Button BtnTambah;
    private id.yaski.simrskhanza.widget.Button BtnTambahOperasi;
    private id.yaski.simrskhanza.widget.CekBox ChkInput;
    private id.yaski.simrskhanza.widget.ComboBox DikirimPA;
    private id.yaski.simrskhanza.widget.panelisi FormInput;
    private id.yaski.simrskhanza.widget.TextBox Jaringan;
    private id.yaski.simrskhanza.widget.ComboBox Kategori;
    private id.yaski.simrskhanza.widget.TextBox Kd2;
    private id.yaski.simrskhanza.widget.Label LTotal;
    private id.yaski.simrskhanza.widget.TextArea Laporan;
    private id.yaski.simrskhanza.widget.TextBox NomorImplant;
    private javax.swing.JPanel PanelInput;
    private javax.swing.JPopupMenu Popup;
    private id.yaski.simrskhanza.widget.TextBox PostOp;
    private id.yaski.simrskhanza.widget.TextBox PreOp;
    ...
    private id.yaski.simrskhanza.widget.TextBox TCariPaket;
    private id.yaski.simrskhanza.widget.TextBox TNoRw;
    private id.yaski.simrskhanza.widget.TextBox TPasien;
    private id.yaski.simrskhanza.widget.Button btnAnak;
    private id.yaski.simrskhanza.widget.Button btnAsis1;
    private id.yaski.simrskhanza.widget.Button btnAsis2;
    private id.yaski.simrskhanza.widget.Button btnAsis3;
    private id.yaski.simrskhanza.widget.Button btnAsis4;
    private id.yaski.simrskhanza.widget.Button btnBidan;
    private id.yaski.simrskhanza.widget.Button btnBidan2;
    private id.yaski.simrskhanza.widget.Button btnBidan3;
    private id.yaski.simrskhanza.widget.Button btnOnloop1;
    private id.yaski.simrskhanza.widget.Button btnOnloop2;
    private id.yaski.simrskhanza.widget.Button btnOnloop3;
    private id.yaski.simrskhanza.widget.Button btnOnloop4;
    private id.yaski.simrskhanza.widget.Button btnOnloop5;
    private id.yaski.simrskhanza.widget.Button btnOperator3;
    private id.yaski.simrskhanza.widget.Button btnPrwLuar;
    private id.yaski.simrskhanza.widget.Button btnPrwRes;
    private id.yaski.simrskhanza.widget.Button btnTemplate;
    private id.yaski.simrskhanza.widget.Button btndrpjanak;
    private id.yaski.simrskhanza.widget.Button btndrumum;
    ...
    private id.yaski.simrskhanza.widget.TextBox jenis;
    private id.yaski.simrskhanza.widget.TextBox kdInstrumen;
    private id.yaski.simrskhanza.widget.TextBox kdanestesi;
    private id.yaski.simrskhanza.widget.TextBox kdasistanestesi;
    private id.yaski.simrskhanza.widget.TextBox kdasistanestesi2;
    private id.yaski.simrskhanza.widget.TextBox kdasistoperator1;
    private id.yaski.simrskhanza.widget.TextBox kdasistoperator2;
    private id.yaski.simrskhanza.widget.TextBox kdasistoperator3;
    private id.yaski.simrskhanza.widget.TextBox kdbidan;
    private id.yaski.simrskhanza.widget.TextBox kdbidan2;
    private id.yaski.simrskhanza.widget.TextBox kdbidan3;
    private id.yaski.simrskhanza.widget.TextBox kddranak;
    private id.yaski.simrskhanza.widget.TextBox kddrumum;
    private id.yaski.simrskhanza.widget.TextBox kdonloop1;
    private id.yaski.simrskhanza.widget.TextBox kdonloop2;
    private id.yaski.simrskhanza.widget.TextBox kdonloop3;
    private id.yaski.simrskhanza.widget.TextBox kdonloop4;
    private id.yaski.simrskhanza.widget.TextBox kdonloop5;
    private id.yaski.simrskhanza.widget.TextBox kdoperator1;
    private id.yaski.simrskhanza.widget.TextBox kdoperator2;
    private id.yaski.simrskhanza.widget.TextBox kdoperator3;
    private id.yaski.simrskhanza.widget.TextBox kdpjanak;
    private id.yaski.simrskhanza.widget.TextBox kdprwluar;
    private id.yaski.simrskhanza.widget.TextBox kdprwresust;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmanestesi;
    private id.yaski.simrskhanza.widget.TextBox nmasistanestesi;
    private id.yaski.simrskhanza.widget.TextBox nmasistanestesi2;
    private id.yaski.simrskhanza.widget.TextBox nmasistoperator1;
    private id.yaski.simrskhanza.widget.TextBox nmasistoperator2;
    private id.yaski.simrskhanza.widget.TextBox nmasistoperator3;
    private id.yaski.simrskhanza.widget.TextBox nmbidan;
    private id.yaski.simrskhanza.widget.TextBox nmbidan2;
    private id.yaski.simrskhanza.widget.TextBox nmbidan3;
    private id.yaski.simrskhanza.widget.TextBox nmdranak;
    private id.yaski.simrskhanza.widget.TextBox nmdrumum;
    private id.yaski.simrskhanza.widget.TextBox nminstrumen;
    private id.yaski.simrskhanza.widget.TextBox nmonloop1;
    private id.yaski.simrskhanza.widget.TextBox nmonloop2;
    private id.yaski.simrskhanza.widget.TextBox nmonloop3;
    private id.yaski.simrskhanza.widget.TextBox nmonloop4;
    private id.yaski.simrskhanza.widget.TextBox nmonloop5;
    private id.yaski.simrskhanza.widget.TextBox nmoperator1;
    private id.yaski.simrskhanza.widget.TextBox nmoperator2;
    private id.yaski.simrskhanza.widget.TextBox nmoperator3;
    private id.yaski.simrskhanza.widget.TextBox nmpjanak;
    private id.yaski.simrskhanza.widget.TextBox nmprwluar;
    private id.yaski.simrskhanza.widget.TextBox nmprwresust;

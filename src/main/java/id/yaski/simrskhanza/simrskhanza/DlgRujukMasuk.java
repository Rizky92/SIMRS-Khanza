...
public final class DlgRujukMasuk extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPerujuk = new id.yaski.simrskhanza.widget.Table();
        panelisi2 = new id.yaski.simrskhanza.widget.panelisi();
        label9 = new id.yaski.simrskhanza.widget.Label();
        TCariPerujuk = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TRujukan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TAlamat = new id.yaski.simrskhanza.widget.TextBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        btnCariRujuk = new id.yaski.simrskhanza.widget.Button();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        NoRujuk = new id.yaski.simrskhanza.widget.TextBox();
        JMPerujuk = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KategoriRujuk = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox JMPerujuk;
    private id.yaski.simrskhanza.widget.ComboBox KategoriRujuk;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoRujuk;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TAlamat;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TCariPerujuk;
    ...
    private id.yaski.simrskhanza.widget.TextBox TRujukan;
    public javax.swing.JDialog WindowPerujuk;
    private id.yaski.simrskhanza.widget.Button btnCariRujuk;
    ...
    private id.yaski.simrskhanza.widget.Table tbPerujuk;

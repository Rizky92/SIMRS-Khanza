...
import id.yaski.simrskhanza.fungsi.WarnaTable4;
...
public class DlgCariPeriksaLabPA extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DiagnosaKlinis = new id.yaski.simrskhanza.widget.TextArea();
        label17 = new id.yaski.simrskhanza.widget.Label();
        scrollPane3 = new id.yaski.simrskhanza.widget.ScrollPane();
        Makroskopis = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Mikroskopis = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Kesan = new id.yaski.simrskhanza.widget.TextArea();
        Scroll = new id.yaski.simrskhanza.widget.ScrollPane();
        LoadHTML1 = new id.yaski.simrskhanza.widget.editorpane();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea DiagnosaKlinis;
    ...
    private id.yaski.simrskhanza.widget.TextArea Kesan;
    ...
    private id.yaski.simrskhanza.widget.editorpane LoadHTML1;
    private id.yaski.simrskhanza.widget.TextArea Makroskopis;
    private id.yaski.simrskhanza.widget.TextArea Mikroskopis;

...
import id.yaski.simrskhanza.restore.DlgRestoreCaraBayar;
...
public final class DlgPenanggungJawab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NmAsuransi = new id.yaski.simrskhanza.widget.TextBox();
        label35 = new id.yaski.simrskhanza.widget.Label();
        KdAsuransi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Attn = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoNPWP = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Berakhir = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Attn;
    private id.yaski.simrskhanza.widget.Label Berakhir;
    ...
    private id.yaski.simrskhanza.widget.TextBox KdAsuransi;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private javax.swing.JMenuItem MnRestore;
    private id.yaski.simrskhanza.widget.TextBox NmAsuransi;
    private id.yaski.simrskhanza.widget.TextBox NoNPWP;

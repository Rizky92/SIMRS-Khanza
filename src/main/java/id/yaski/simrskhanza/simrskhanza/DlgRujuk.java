...
public final class DlgRujuk extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ket = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ambulance = new id.yaski.simrskhanza.widget.ComboBox();
        ChkJln = new id.yaski.simrskhanza.widget.CekBox();
        CmbDetik = new id.yaski.simrskhanza.widget.ComboBox();
        ktrujuk = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Tanggal DTPRujuk;
    ...
    private id.yaski.simrskhanza.widget.TextBox TDiagnosa;
    private id.yaski.simrskhanza.widget.TextBox TDokter;
    private id.yaski.simrskhanza.widget.TextBox TNoRM;
    private id.yaski.simrskhanza.widget.TextBox TNoRj;
    private id.yaski.simrskhanza.widget.TextBox TNoRw;
    private id.yaski.simrskhanza.widget.TextBox TPasien;
    private id.yaski.simrskhanza.widget.TextBox TTmpRujuk;
    private id.yaski.simrskhanza.widget.ComboBox ambulance;
    ...
    private id.yaski.simrskhanza.widget.TextBox ket;
    private id.yaski.simrskhanza.widget.ComboBox ktrujuk;

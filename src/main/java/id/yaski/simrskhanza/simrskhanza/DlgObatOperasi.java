...
public final class DlgObatOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        THarga = new id.yaski.simrskhanza.widget.TextBox();
        jLabel4 = new id.yaski.simrskhanza.widget.Label();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        TNama = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox THarga;
    private id.yaski.simrskhanza.widget.TextBox TKd;
    private id.yaski.simrskhanza.widget.TextBox TNama;

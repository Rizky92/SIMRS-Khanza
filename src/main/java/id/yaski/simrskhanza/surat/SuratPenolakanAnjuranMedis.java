...
public final class SuratPenolakanAnjuranMedis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        JKPJ = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        NoPernyataan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KodePenolakan = new id.yaski.simrskhanza.widget.TextBox();
        NamaPenolakan = new id.yaski.simrskhanza.widget.TextBox();
        btnPenolakan = new id.yaski.simrskhanza.widget.Button();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        AlasanPenolakan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        RisikoPenolakan = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AlasanPenolakan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox JKPJ;
    private id.yaski.simrskhanza.widget.TextBox KodePenolakan;
    ...
    private id.yaski.simrskhanza.widget.Button btnPenolakan;

...
public final class SuratSakitPihak2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalAkhir = new id.yaski.simrskhanza.widget.Tanggal();
        TNoRM = new id.yaski.simrskhanza.widget.TextBox();
        LamaSakit = new id.yaski.simrskhanza.widget.TextBox();
        ...
        cmbHubungan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Instansi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        TanggalAwal = new id.yaski.simrskhanza.widget.Tanggal();
        cmbPekerjaan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Instansi;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LamaSakit;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalAkhir;
    private id.yaski.simrskhanza.widget.Tanggal TanggalAwal;
    private id.yaski.simrskhanza.widget.Tanggal TglLahir;
    private id.yaski.simrskhanza.widget.ComboBox cmbHubungan;
    private id.yaski.simrskhanza.widget.ComboBox cmbJk;
    private id.yaski.simrskhanza.widget.ComboBox cmbPekerjaan;

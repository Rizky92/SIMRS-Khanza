...
public final class SuratPersetujuanPenundaanPelayanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        UmurPJ = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoTelpPJ = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PoliRuangan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        DokterPengirim = new id.yaski.simrskhanza.widget.TextBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        PelayananDilakukan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        PenundaanPelayananKarena = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPenundaanPelayananKarena = new id.yaski.simrskhanza.widget.TextBox();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        AlternatifDiberikan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAlternatifDiberikan = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AlternatifDiberikan;
    ...
    private id.yaski.simrskhanza.widget.TextBox DokterPengirim;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganAlternatifDiberikan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPenundaanPelayananKarena;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoTelpPJ;
    private id.yaski.simrskhanza.widget.PanelBiasa PanelAccor;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox PelayananDilakukan;
    private id.yaski.simrskhanza.widget.ComboBox PenundaanPelayananKarena;
    private id.yaski.simrskhanza.widget.TextBox PoliRuangan;
    ...
    private id.yaski.simrskhanza.widget.TextBox UmurPJ;

...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Keperluan = new id.yaski.simrskhanza.widget.TextBox();
        hasil1 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        hasil2 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        hasil4 = new id.yaski.simrskhanza.widget.ComboBox();
        hasil3 = new id.yaski.simrskhanza.widget.ComboBox();
        hasil5 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        hasil6 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Keperluan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox hasil1;
    private id.yaski.simrskhanza.widget.ComboBox hasil2;
    private id.yaski.simrskhanza.widget.ComboBox hasil3;
    private id.yaski.simrskhanza.widget.ComboBox hasil4;
    private id.yaski.simrskhanza.widget.ComboBox hasil5;
    private id.yaski.simrskhanza.widget.ComboBox hasil6;

...
public final class SuratPernyataanMemilihDPJP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PembuatPernyataan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        AlamatPembuatPernyataan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        TanggalLahir = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        JKPembuatPernyataan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AlamatPembuatPernyataan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox JKPembuatPernyataan;
    ...
    private id.yaski.simrskhanza.widget.TextBox PembuatPernyataan;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalLahir;

...
public final class SuratKeteranganCovid extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TPetugas = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugas = new id.yaski.simrskhanza.widget.Button();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        IgM = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        IgG = new id.yaski.simrskhanza.widget.ComboBox();
        TidakSehat = new id.yaski.simrskhanza.widget.RadioButton();
        Sehat = new id.yaski.simrskhanza.widget.RadioButton();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox IgG;
    private id.yaski.simrskhanza.widget.ComboBox IgM;
    ...
    private id.yaski.simrskhanza.widget.RadioButton Sehat;

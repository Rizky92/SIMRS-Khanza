...
package id.yaski.simrskhanza.surat;
...
public final class SuratPersetujuanPenolakanTindakan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        HubunganDenganPasien = new id.yaski.simrskhanza.widget.ComboBox();
        TglPernyataan = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        NoPenyataan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Biaya = new id.yaski.simrskhanza.widget.TextBox();
        jSeparator2 = new javax.swing.JSeparator();
        jLabel100 = new id.yaski.simrskhanza.widget.Label();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        AlasanDiwakilkan = new id.yaski.simrskhanza.widget.TextBox();
        PenerimaInformasi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        AlamatPenerima = new id.yaski.simrskhanza.widget.TextBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        TglLahirPenerima = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        UmurPenerima = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        JKPenerima = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        NoHPPenerima = new id.yaski.simrskhanza.widget.TextBox();
        jSeparator3 = new javax.swing.JSeparator();
        jLabel101 = new id.yaski.simrskhanza.widget.Label();
        label15 = new id.yaski.simrskhanza.widget.Label();
        KdPerawat = new id.yaski.simrskhanza.widget.TextBox();
        NmPerawat = new id.yaski.simrskhanza.widget.TextBox();
        BtnPerawat = new id.yaski.simrskhanza.widget.Button();
        ...
        LoadHTML3 = new id.yaski.simrskhanza.widget.editorpane();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AlamatPenerima;
    private id.yaski.simrskhanza.widget.TextBox AlasanDiwakilkan;
    private javax.swing.JTextArea AlternatifResiko;
    private id.yaski.simrskhanza.widget.TextBox Biaya;
    ...
    private id.yaski.simrskhanza.widget.Button BtnPerawat;
    ...
    private id.yaski.simrskhanza.widget.ComboBox HubunganDenganPasien;
    private javax.swing.JTextArea IndikasiTindakan;
    private id.yaski.simrskhanza.widget.ComboBox JKPenerima;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextBox KdPerawat;
    ...
    private id.yaski.simrskhanza.widget.editorpane LoadHTML3;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.TextBox NmPerawat;
    private id.yaski.simrskhanza.widget.TextBox NoHPPenerima;
    private id.yaski.simrskhanza.widget.TextBox NoPenyataan;
    private id.yaski.simrskhanza.widget.PanelBiasa PanelAccor;
    private id.yaski.simrskhanza.widget.TextBox PenerimaInformasi;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TglLahirPenerima;
    private id.yaski.simrskhanza.widget.Tanggal TglPernyataan;
    private javax.swing.JTextArea TindakanKedokteran;
    private javax.swing.JTextArea Tujuan;
    private id.yaski.simrskhanza.widget.TextBox UmurPenerima;

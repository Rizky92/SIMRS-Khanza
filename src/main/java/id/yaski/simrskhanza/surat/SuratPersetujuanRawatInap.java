...
public final class SuratPersetujuanRawatInap extends javax.swing.JDialog {
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox HakKelas;
    private id.yaski.simrskhanza.widget.ComboBox Hubungan;
    private id.yaski.simrskhanza.widget.TextBox JK;
    private id.yaski.simrskhanza.widget.ComboBox KelasDipilih;
    ...
    private id.yaski.simrskhanza.widget.TextBox NamaKeluarga;
    ...
    private id.yaski.simrskhanza.widget.TextBox Pembiayaan;
    private id.yaski.simrskhanza.widget.ComboBox PendidikanPJ;
    private id.yaski.simrskhanza.widget.TextBox RuangDipilih;

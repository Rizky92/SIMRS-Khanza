...
public final class PerpustakaanKoleksi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KodeBuku = new id.yaski.simrskhanza.widget.TextBox();
        Judul = new id.yaski.simrskhanza.widget.TextBox();
        Halaman = new id.yaski.simrskhanza.widget.TextBox();
        label7 = new id.yaski.simrskhanza.widget.Label();
        ISBN = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ThnTerbit = new id.yaski.simrskhanza.widget.ComboBox();
        label19 = new id.yaski.simrskhanza.widget.Label();
        KodePenerbit = new id.yaski.simrskhanza.widget.TextBox();
        NamaPenerbit = new id.yaski.simrskhanza.widget.TextBox();
        btnPenerbit = new id.yaski.simrskhanza.widget.Button();
        label20 = new id.yaski.simrskhanza.widget.Label();
        KodePengarang = new id.yaski.simrskhanza.widget.TextBox();
        NamaPengarang = new id.yaski.simrskhanza.widget.TextBox();
        btnPengarang = new id.yaski.simrskhanza.widget.Button();
        label21 = new id.yaski.simrskhanza.widget.Label();
        KodeKategori = new id.yaski.simrskhanza.widget.TextBox();
        NamaKategori = new id.yaski.simrskhanza.widget.TextBox();
        btnKategori = new id.yaski.simrskhanza.widget.Button();
        label22 = new id.yaski.simrskhanza.widget.Label();
        IdJenis = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Halaman;
    private id.yaski.simrskhanza.widget.TextBox ISBN;
    private id.yaski.simrskhanza.widget.TextBox IdJenis;
    private id.yaski.simrskhanza.widget.TextBox Judul;
    private id.yaski.simrskhanza.widget.TextBox KodeBuku;
    private id.yaski.simrskhanza.widget.TextBox KodeKategori;
    private id.yaski.simrskhanza.widget.TextBox KodePenerbit;
    private id.yaski.simrskhanza.widget.TextBox KodePengarang;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NamaKategori;
    private id.yaski.simrskhanza.widget.TextBox NamaPenerbit;
    private id.yaski.simrskhanza.widget.TextBox NamaPengarang;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.ComboBox ThnTerbit;
    private id.yaski.simrskhanza.widget.Button btnJenis;
    private id.yaski.simrskhanza.widget.Button btnKategori;
    private id.yaski.simrskhanza.widget.Button btnPenerbit;
    private id.yaski.simrskhanza.widget.Button btnPengarang;

...
package id.yaski.simrskhanza.perpustakaan;
...
public class PerpustakaanSirkulasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TNoI = new id.yaski.simrskhanza.widget.TextBox();
        label1 = new id.yaski.simrskhanza.widget.Label();
        StatusBuku = new id.yaski.simrskhanza.widget.TextBox();
        Penerbit = new id.yaski.simrskhanza.widget.TextBox();
        LblTgl = new id.yaski.simrskhanza.widget.Label();
        TJudul = new id.yaski.simrskhanza.widget.TextBox();
        btnInv = new id.yaski.simrskhanza.widget.Button();
        Pengarang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        LblHari = new id.yaski.simrskhanza.widget.Label();
        BtnPerpanjang = new id.yaski.simrskhanza.widget.Button();
        LblTerlambat = new id.yaski.simrskhanza.widget.Label();
        LblJmlT = new id.yaski.simrskhanza.widget.Label();
        LblDenda = new id.yaski.simrskhanza.widget.Label();
        LblJmlDenda = new id.yaski.simrskhanza.widget.Label();
        btnAng = new id.yaski.simrskhanza.widget.Button();
        TNmA = new id.yaski.simrskhanza.widget.TextBox();
        TNoA = new id.yaski.simrskhanza.widget.TextBox();
        label9 = new id.yaski.simrskhanza.widget.Label();
        TOut = new id.yaski.simrskhanza.widget.TextBox();
        TIn = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnIn = new id.yaski.simrskhanza.widget.Button();
        BtnOut = new id.yaski.simrskhanza.widget.Button();
        ...
        InventarisCari = new id.yaski.simrskhanza.widget.TextBox();
        ...
        StatusCari = new id.yaski.simrskhanza.widget.ComboBox();
        ChkTanggal = new id.yaski.simrskhanza.widget.CekBox();
        TglPinjam1 = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        TglPinjam2 = new id.yaski.simrskhanza.widget.Tanggal();
        Scroll = new id.yaski.simrskhanza.widget.ScrollPane();
        tbKamIn = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnIn;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnOut;
    private id.yaski.simrskhanza.widget.Button BtnPerpanjang;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkTanggal;
    private id.yaski.simrskhanza.widget.TextBox InventarisCari;
    ...
    private id.yaski.simrskhanza.widget.Label LblDenda;
    private id.yaski.simrskhanza.widget.Label LblHari;
    private id.yaski.simrskhanza.widget.Label LblJmlDenda;
    private id.yaski.simrskhanza.widget.Label LblJmlT;
    private javax.swing.JLabel LblPnjm;
    private javax.swing.JLabel LblSetPnjm;
    private id.yaski.simrskhanza.widget.Label LblTerlambat;
    private id.yaski.simrskhanza.widget.Label LblTgl;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelCariUtama;
    private id.yaski.simrskhanza.widget.TextBox Penerbit;
    private id.yaski.simrskhanza.widget.TextBox Pengarang;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox StatusBuku;
    private id.yaski.simrskhanza.widget.ComboBox StatusCari;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TIn;
    private id.yaski.simrskhanza.widget.TextBox TJudul;
    private id.yaski.simrskhanza.widget.TextBox TNmA;
    private id.yaski.simrskhanza.widget.TextBox TNoA;
    private id.yaski.simrskhanza.widget.TextBox TNoI;
    private id.yaski.simrskhanza.widget.TextBox TOut;
    private id.yaski.simrskhanza.widget.Tanggal TglPinjam1;
    private id.yaski.simrskhanza.widget.Tanggal TglPinjam2;
    private javax.swing.JDialog WindowInput;
    private id.yaski.simrskhanza.widget.Button btnAng;
    private id.yaski.simrskhanza.widget.Button btnInv;
    ...
    private id.yaski.simrskhanza.widget.Table tbKamIn;

...
public final class InventoryCariResepLuar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoResepUbah3 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSimpanInput3 = new id.yaski.simrskhanza.widget.Button();
        BtnKeluarInput3 = new id.yaski.simrskhanza.widget.Button();
        ...
        NoResepUbah4 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSimpanInput4 = new id.yaski.simrskhanza.widget.Button();
        BtnKeluarInput4 = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnResep = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnKeluarInput3;
    private id.yaski.simrskhanza.widget.Button BtnKeluarInput4;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnResep;
    private id.yaski.simrskhanza.widget.Button BtnSimpanInput3;
    private id.yaski.simrskhanza.widget.Button BtnSimpanInput4;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoResepUbah3;
    private id.yaski.simrskhanza.widget.TextBox NoResepUbah4;

...
public class DlgDataBatch extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        AsalBarang = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TanggalDatang = new id.yaski.simrskhanza.widget.Tanggal();
        label19 = new id.yaski.simrskhanza.widget.Label();
        JmlBeli = new id.yaski.simrskhanza.widget.TextBox();
    ...
    private id.yaski.simrskhanza.widget.ComboBox AsalBarang;
    ...
    private id.yaski.simrskhanza.widget.TextBox JmlBeli;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalDatang;

...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        checkboxSimpanTemplateResep = new id.yaski.simrskhanza.widget.CekBox();
        ...
        textTemplateResep = new id.yaski.simrskhanza.widget.TextBox();
        btnPilihTemplateResep = new id.yaski.simrskhanza.widget.Button();
        ...
        tbObatResepRacikan = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDetailResepObatRacikan = new id.yaski.simrskhanza.widget.Table();
...
// TODO add your handling code here:
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button btnPilihTemplateResep;
    private id.yaski.simrskhanza.widget.CekBox checkboxSimpanTemplateResep;
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailResepObatRacikan;
    private id.yaski.simrskhanza.widget.Table tbObatResepRacikan;
    private id.yaski.simrskhanza.widget.Table tbResep;
    private id.yaski.simrskhanza.widget.TextBox textTemplateResep;
                    ...
                    if(STOKKOSONGRESEP.equals("no")){
                        while(rsobat.next()){
                            if(rsobat.getDouble("jml")>rsobat.getDouble("stok")){
                                ...
                                tabModeResep.addRow(new Object[] {
                                    false,"",rsobat.getString("aturan_pakai"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                    rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble(hargaobat),100),
                                    rsobat.getString("nama"),rsobat.getString("nama_industri"),rsobat.getDouble("h_beli"),rsobat.getDouble("stok"),rsobat.getString("kategori")
                                });
                            }else{
                                tabModeResep.addRow(new Object[] {
                            ...
                            if(STOKKOSONGRESEP.equals("no")){
                                while(rs2.next()){
                                    if(rs2.getDouble("jml")>rs2.getDouble("stok")){
                                        ...
                                        tabModeDetailResepRacikan.addRow(new Object[] {
                                            rsobat.getString("no_racik"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),
                                            rs2.getString("kode_sat"),Valid.roundUp(rs2.getDouble(hargaobat),100),
                                            rs2.getDouble("h_beli"),rs2.getString("nama"),rs2.getDouble("stok"),
                                            rs2.getDouble("kapasitas"),rs2.getDouble("p1"),"/",rs2.getDouble("p2"),
                                            rs2.getString("kandungan"),0,rs2.getString("nama_industri"),rs2.getString("letak_barang"),rs2.getString("kategori")
                                        });

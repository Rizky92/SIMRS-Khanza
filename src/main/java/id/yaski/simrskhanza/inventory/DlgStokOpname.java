...
public final class DlgStokOpname extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Harga = new id.yaski.simrskhanza.widget.TextBox();
        label36 = new id.yaski.simrskhanza.widget.Label();
        Real = new id.yaski.simrskhanza.widget.TextBox();
        Selisih = new id.yaski.simrskhanza.widget.TextBox();
        label37 = new id.yaski.simrskhanza.widget.Label();
        label38 = new id.yaski.simrskhanza.widget.Label();
        Nominal = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Lebih = new id.yaski.simrskhanza.widget.TextBox();
        NomiLebih = new id.yaski.simrskhanza.widget.TextBox();
        TotalReal = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NmGudang = new id.yaski.simrskhanza.widget.TextBox();
        BtnKategori1 = new id.yaski.simrskhanza.widget.Button();
        ...
        LTotalReal = new id.yaski.simrskhanza.widget.Label();
        label12 = new id.yaski.simrskhanza.widget.Label();
        LTotalHilang = new id.yaski.simrskhanza.widget.Label();
        label14 = new id.yaski.simrskhanza.widget.Label();
        LTotalLebih = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnKategori1;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.TextBox Harga;
    ...
    private id.yaski.simrskhanza.widget.Label LTotalHilang;
    private id.yaski.simrskhanza.widget.Label LTotalLebih;
    private id.yaski.simrskhanza.widget.Label LTotalReal;
    private id.yaski.simrskhanza.widget.TextBox Lebih;
    ...
    private id.yaski.simrskhanza.widget.TextBox NomiLebih;
    private id.yaski.simrskhanza.widget.TextBox Nominal;
    private javax.swing.JPopupMenu Popup1;
    private id.yaski.simrskhanza.widget.TextBox Real;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox Selisih;
    ...
    private id.yaski.simrskhanza.widget.TextBox TotalReal;

...
import id.yaski.simrskhanza.setting.DlgSetHarga;
...
public class DlgPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LSubtotal = new id.yaski.simrskhanza.widget.Label();
        ...
        LPotongan = new id.yaski.simrskhanza.widget.Label();
        LTotal2 = new id.yaski.simrskhanza.widget.Label();
        ...
        LTagiha = new id.yaski.simrskhanza.widget.Label();
        tppn = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Meterai = new id.yaski.simrskhanza.widget.TextBox();
        BtnAll = new id.yaski.simrskhanza.widget.Button();
        BtnSetHarga = new id.yaski.simrskhanza.widget.Button();
        ...
        TglPesan = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        TglFaktur = new id.yaski.simrskhanza.widget.Tanggal();
        NoOrder = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnSetHarga;
    ...
    private id.yaski.simrskhanza.widget.Label LPotongan;
    private id.yaski.simrskhanza.widget.Label LPpn;
    private id.yaski.simrskhanza.widget.Label LSubtotal;
    private id.yaski.simrskhanza.widget.Label LTagiha;
    private id.yaski.simrskhanza.widget.Label LTotal2;
    private id.yaski.simrskhanza.widget.TextBox Meterai;
    private id.yaski.simrskhanza.widget.TextBox NoFaktur;
    private id.yaski.simrskhanza.widget.TextBox NoOrder;
    private javax.swing.JPopupMenu Popup;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.Tanggal TglFaktur;
    private id.yaski.simrskhanza.widget.Tanggal TglPesan;
    ...
    private id.yaski.simrskhanza.widget.TextBox tppn;

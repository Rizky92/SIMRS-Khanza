...
public final class DlgCariPPNObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPengadaan = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPembelian = new id.yaski.simrskhanza.widget.Table();
        ...
        tbObatJualBebas = new id.yaski.simrskhanza.widget.Table();
        ...
        tbPiutangObat = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbObatJualBebas;
    private id.yaski.simrskhanza.widget.Table tbPembelian;
    private id.yaski.simrskhanza.widget.Table tbPengadaan;
    private id.yaski.simrskhanza.widget.Table tbPiutangObat;

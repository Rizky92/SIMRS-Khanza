...
import id.yaski.simrskhanza.restore.DlgRestoreObat;
...
public class DlgBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nmsat = new id.yaski.simrskhanza.widget.TextBox();
        label19 = new id.yaski.simrskhanza.widget.Label();
        kdsat = new id.yaski.simrskhanza.widget.TextBox();
        BtnSatuan = new id.yaski.simrskhanza.widget.Button();
        label14 = new id.yaski.simrskhanza.widget.Label();
        stok_minimal = new id.yaski.simrskhanza.widget.TextBox();
        ...
        beli = new id.yaski.simrskhanza.widget.TextBox();
        label32 = new id.yaski.simrskhanza.widget.Label();
        Kapasitas = new id.yaski.simrskhanza.widget.TextBox();
        kelas3 = new id.yaski.simrskhanza.widget.TextBox();
        label30 = new id.yaski.simrskhanza.widget.Label();
        label33 = new id.yaski.simrskhanza.widget.Label();
        utama = new id.yaski.simrskhanza.widget.TextBox();
        kelasvip = new id.yaski.simrskhanza.widget.TextBox();
        label34 = new id.yaski.simrskhanza.widget.Label();
        label35 = new id.yaski.simrskhanza.widget.Label();
        kelasvvip = new id.yaski.simrskhanza.widget.TextBox();
        ...
        DTPExpired = new id.yaski.simrskhanza.widget.Tanggal();
        ChkKadaluarsa = new id.yaski.simrskhanza.widget.CekBox();
        label21 = new id.yaski.simrskhanza.widget.Label();
        KdIF = new id.yaski.simrskhanza.widget.TextBox();
        NmIF = new id.yaski.simrskhanza.widget.TextBox();
        BtnIF = new id.yaski.simrskhanza.widget.Button();
        ...
        kdsatBesar = new id.yaski.simrskhanza.widget.TextBox();
        nmsatBesar = new id.yaski.simrskhanza.widget.TextBox();
        BtnSatuanBesar = new id.yaski.simrskhanza.widget.Button();
        label39 = new id.yaski.simrskhanza.widget.Label();
        Isi = new id.yaski.simrskhanza.widget.TextBox();
        dasar = new id.yaski.simrskhanza.widget.TextBox();
    ...
    private id.yaski.simrskhanza.widget.Button BtnIF;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSatuan;
    private id.yaski.simrskhanza.widget.Button BtnSatuanBesar;
    private id.yaski.simrskhanza.widget.Button BtnSimpan;
    private id.yaski.simrskhanza.widget.CekBox ChkInput;
    private id.yaski.simrskhanza.widget.CekBox ChkKadaluarsa;
    private id.yaski.simrskhanza.widget.Tanggal DTPExpired;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Isi;
    private id.yaski.simrskhanza.widget.TextBox Kapasitas;
    private id.yaski.simrskhanza.widget.TextBox Kd;
    private id.yaski.simrskhanza.widget.TextBox KdIF;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Letak;
    private javax.swing.JMenuItem MnRestore;
    private id.yaski.simrskhanza.widget.TextBox Nm;
    private id.yaski.simrskhanza.widget.TextBox NmIF;
    private javax.swing.JPanel PanelInput;
    private javax.swing.JPopupMenu Popup;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox beli;
    private id.yaski.simrskhanza.widget.TextBox beliluar;
    private id.yaski.simrskhanza.widget.TextBox dasar;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdsat;
    private id.yaski.simrskhanza.widget.TextBox kdsatBesar;
    private id.yaski.simrskhanza.widget.TextBox kelas1;
    private id.yaski.simrskhanza.widget.TextBox kelas2;
    private id.yaski.simrskhanza.widget.TextBox kelas3;
    private id.yaski.simrskhanza.widget.TextBox kelasvip;
    private id.yaski.simrskhanza.widget.TextBox kelasvvip;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmsat;
    private id.yaski.simrskhanza.widget.TextBox nmsatBesar;
    ...
    private id.yaski.simrskhanza.widget.TextBox stok_minimal;
    private id.yaski.simrskhanza.widget.Table tbObat;
    private id.yaski.simrskhanza.widget.TextBox utama;

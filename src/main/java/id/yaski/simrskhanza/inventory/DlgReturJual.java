...
public class DlgReturJual extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Hargaretur = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Jmlretur = new id.yaski.simrskhanza.widget.TextBox();
        ...
        panelisiBeli = new id.yaski.simrskhanza.widget.panelisi();
        label15 = new id.yaski.simrskhanza.widget.Label();
        NoRetur = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TglRetur = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        BtnMmb = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnMmb;
    ...
    private id.yaski.simrskhanza.widget.TextBox Hargaretur;
    private id.yaski.simrskhanza.widget.ComboBox Jenisjual;
    private id.yaski.simrskhanza.widget.TextBox Jmlretur;
    ...
    private id.yaski.simrskhanza.widget.panelisi panelisiBeli;

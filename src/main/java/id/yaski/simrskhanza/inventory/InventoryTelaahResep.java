...
public final class InventoryTelaahResep extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormValidasi1 = new id.yaski.simrskhanza.widget.PanelBiasa();
        ...
        ResepTepatIdentifikasiPasien = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        ResepTepatObat = new id.yaski.simrskhanza.widget.ComboBox();
        KetResepTepatIdetifikasiPasien = new id.yaski.simrskhanza.widget.TextBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        KetResepTepatObat = new id.yaski.simrskhanza.widget.TextBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        ResepTepatDosis = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        KetResepTepatDosis = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ResepTepatCaraPemberian = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        KetResepTepatCaraPemberian = new id.yaski.simrskhanza.widget.TextBox();
        ResepTepatWaktuPemberian = new id.yaski.simrskhanza.widget.ComboBox();
        ResepTidakDuplikasiObat = new id.yaski.simrskhanza.widget.ComboBox();
        ResepInteraksiObat = new id.yaski.simrskhanza.widget.ComboBox();
        ResepKontraIndikasiObat = new id.yaski.simrskhanza.widget.ComboBox();
        KetResepTepatWaktuPemberian = new id.yaski.simrskhanza.widget.TextBox();
        KetResepTidakDuplikasiObat = new id.yaski.simrskhanza.widget.TextBox();
        KetResepInteraksiObat = new id.yaski.simrskhanza.widget.TextBox();
        KetResepKontraIndikasiObat = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ObatTepatPasien = new id.yaski.simrskhanza.widget.ComboBox();
        ObatTepatObat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        ObatTepatDosis = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        ObatTepatCaraPemberian = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        ObatTepatWaktuPemberian = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.PanelBiasa FormValidasi1;
    private id.yaski.simrskhanza.widget.TextBox JK;
    private id.yaski.simrskhanza.widget.TextBox KetResepInteraksiObat;
    private id.yaski.simrskhanza.widget.TextBox KetResepKontraIndikasiObat;
    private id.yaski.simrskhanza.widget.TextBox KetResepTepatCaraPemberian;
    private id.yaski.simrskhanza.widget.TextBox KetResepTepatDosis;
    private id.yaski.simrskhanza.widget.TextBox KetResepTepatIdetifikasiPasien;
    private id.yaski.simrskhanza.widget.TextBox KetResepTepatObat;
    private id.yaski.simrskhanza.widget.TextBox KetResepTepatWaktuPemberian;
    private id.yaski.simrskhanza.widget.TextBox KetResepTidakDuplikasiObat;
    ...
    private id.yaski.simrskhanza.widget.ComboBox ObatTepatCaraPemberian;
    private id.yaski.simrskhanza.widget.ComboBox ObatTepatDosis;
    private id.yaski.simrskhanza.widget.ComboBox ObatTepatObat;
    private id.yaski.simrskhanza.widget.ComboBox ObatTepatPasien;
    private id.yaski.simrskhanza.widget.ComboBox ObatTepatWaktuPemberian;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox ResepInteraksiObat;
    private id.yaski.simrskhanza.widget.ComboBox ResepKontraIndikasiObat;
    private id.yaski.simrskhanza.widget.ComboBox ResepTepatCaraPemberian;
    private id.yaski.simrskhanza.widget.ComboBox ResepTepatDosis;
    private id.yaski.simrskhanza.widget.ComboBox ResepTepatIdentifikasiPasien;
    private id.yaski.simrskhanza.widget.ComboBox ResepTepatObat;
    private id.yaski.simrskhanza.widget.ComboBox ResepTepatWaktuPemberian;
    private id.yaski.simrskhanza.widget.ComboBox ResepTidakDuplikasiObat;

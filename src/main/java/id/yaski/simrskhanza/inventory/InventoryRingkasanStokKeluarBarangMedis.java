...
public class InventoryRingkasanStokKeluarBarangMedis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kddepo = new id.yaski.simrskhanza.widget.TextBox();
        kdptg = new id.yaski.simrskhanza.widget.TextBox();
        nmdepo = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox kddepo;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmdepo;

...
public class DlgReturBeli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKnv = new id.yaski.simrskhanza.widget.Button();
        satuanretur = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Kadaluwarsa = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnSpl = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Kadaluwarsa;
    ...
    private id.yaski.simrskhanza.widget.TextBox satuanretur;

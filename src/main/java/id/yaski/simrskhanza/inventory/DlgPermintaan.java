...
public class DlgPermintaan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kdgudangTujuan = new id.yaski.simrskhanza.widget.TextBox();
        label16 = new id.yaski.simrskhanza.widget.Label();
        kdptg = new id.yaski.simrskhanza.widget.TextBox();
        nmgudangTujuan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        btnSuplier1 = new id.yaski.simrskhanza.widget.Button();
        nmgudangasal = new id.yaski.simrskhanza.widget.TextBox();
        kdgudangasal = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button btnSuplier1;
    private id.yaski.simrskhanza.widget.InternalFrame internalFrame1;
    private id.yaski.simrskhanza.widget.TextBox kdgudangTujuan;
    private id.yaski.simrskhanza.widget.TextBox kdgudangasal;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmgudangTujuan;
    private id.yaski.simrskhanza.widget.TextBox nmgudangasal;

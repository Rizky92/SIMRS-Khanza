...
import id.yaski.simrskhanza.simrskhanza.DlgCariObatPenyakit;
...
public class DlgPemberianObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        THBeli = new id.yaski.simrskhanza.widget.TextBox();
        ...
        tbPemberianObat = new id.yaski.simrskhanza.widget.Table();
        ...
        TKdOb = new id.yaski.simrskhanza.widget.TextBox();
        btnObat1 = new id.yaski.simrskhanza.widget.Button();
        TNmOb = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TBiayaObat = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        TSatuan = new id.yaski.simrskhanza.widget.TextBox();
        ChkJln = new id.yaski.simrskhanza.widget.CekBox();
        BtnObat2 = new id.yaski.simrskhanza.widget.Button();
        BtnObat3 = new id.yaski.simrskhanza.widget.Button();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnObat2;
    private id.yaski.simrskhanza.widget.Button BtnObat3;
    ...
    private id.yaski.simrskhanza.widget.TextBox TBiayaObat;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TCariPasien;
    private id.yaski.simrskhanza.widget.TextBox THBeli;
    private id.yaski.simrskhanza.widget.TextBox TKdOb;
    private id.yaski.simrskhanza.widget.TextBox TNmOb;
    ...
    private id.yaski.simrskhanza.widget.TextBox TSatuan;
    private id.yaski.simrskhanza.widget.Tanggal Tanggal;
    private id.yaski.simrskhanza.widget.Button btnObat1;
    ...
    private id.yaski.simrskhanza.widget.Table tbPemberianObat;

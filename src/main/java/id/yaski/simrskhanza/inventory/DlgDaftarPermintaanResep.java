...
import id.yaski.simrskhanza.bridging.ApotekBPJSDaftarPelayananObat2SMC;
import id.yaski.simrskhanza.bridging.ApotekBPJSKirimResepObatSMC;
import id.yaski.simrskhanza.bridging.BPJSDataSEP;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ObjectNode;
import id.yaski.simrskhanza.fungsi.BackgroundMusic;
...
import id.yaski.simrskhanza.support.kirimwa.DlgKirimWA;
...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglSelesai = new id.yaski.simrskhanza.widget.Tanggal();
        ChkSelesai = new id.yaski.simrskhanza.widget.CekBox();
        ...
        ChkAutoValidasiRalan = new id.yaski.simrskhanza.widget.CekBox();
        label1 = new id.yaski.simrskhanza.widget.Label();
        ChkAutoValidasiRanap = new id.yaski.simrskhanza.widget.CekBox();
        ChkPreviewLembarObat = new id.yaski.simrskhanza.widget.CekBox();
        CmbModelLembarObat = new id.yaski.simrskhanza.widget.ComboBox();
        ChkPreviewAturanPakai = new id.yaski.simrskhanza.widget.CekBox();
        CmbModelAturanPakai = new id.yaski.simrskhanza.widget.ComboBox();
        label2 = new id.yaski.simrskhanza.widget.Label();
        CmbPrinterLembarObat = new id.yaski.simrskhanza.widget.ComboBox();
        BtnRefreshPrinterLembarObat = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnKeluarPengaturan = new id.yaski.simrskhanza.widget.Button();
        BtnObat23HariBPJS = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnPenyerahan = new id.yaski.simrskhanza.widget.Button();
        BtnPrint = new id.yaski.simrskhanza.widget.Button();
        BtnRekap = new id.yaski.simrskhanza.widget.Button();
        ...
        tbResepRanap = new id.yaski.simrskhanza.widget.Table();
        scrollPane4 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDetailResepRanap = new id.yaski.simrskhanza.widget.Table();
        scrollPane5 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPermintaanStok = new id.yaski.simrskhanza.widget.Table();
        scrollPane6 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDetailPermintaanStok = new id.yaski.simrskhanza.widget.Table();
        scrollPane7 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPermintaanResepPulang = new id.yaski.simrskhanza.widget.Table();
        scrollPane8 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDetailPermintaanResepPulang = new id.yaski.simrskhanza.widget.Table();
        panelGlass9 = new id.yaski.simrskhanza.widget.panelisi();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        CrDokter2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek5 = new id.yaski.simrskhanza.widget.Button();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Kamar = new id.yaski.simrskhanza.widget.TextBox();
        BtnSeek6 = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnPemberianObat = new id.yaski.simrskhanza.widget.Button();
        BtnPiutangObat = new id.yaski.simrskhanza.widget.Button();
        BtnTelaahResep = new id.yaski.simrskhanza.widget.Button();
        BtnResepAwal = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnSEPBPJS = new id.yaski.simrskhanza.widget.Button();
        BtnKirimResepApotekBPJS = new id.yaski.simrskhanza.widget.Button();
        BtnDaftarPelayananApotekBPJS = new id.yaski.simrskhanza.widget.Button();
        BtnKirimWAPengerjaan = new id.yaski.simrskhanza.widget.Button();
        BtnKirimWASelesai = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnDaftarPelayananApotekBPJS;
    ...
    private id.yaski.simrskhanza.widget.Button BtnKeluarPengaturan;
    private id.yaski.simrskhanza.widget.Button BtnKirimResepApotekBPJS;
    private id.yaski.simrskhanza.widget.Button BtnKirimWAPengerjaan;
    private id.yaski.simrskhanza.widget.Button BtnKirimWASelesai;
    private id.yaski.simrskhanza.widget.Button BtnKonselingFarmasi;
    private id.yaski.simrskhanza.widget.Button BtnObat23HariBPJS;
    private id.yaski.simrskhanza.widget.Button BtnPemberianObat;
    private id.yaski.simrskhanza.widget.Button BtnPengaturan;
    private id.yaski.simrskhanza.widget.Button BtnPenyerahan;
    private id.yaski.simrskhanza.widget.Button BtnPiutangObat;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnRefreshPrinterLembarObat;
    private id.yaski.simrskhanza.widget.Button BtnRekap;
    private id.yaski.simrskhanza.widget.Button BtnResepAwal;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSEPBPJS;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSeek6;
    ...
    private id.yaski.simrskhanza.widget.Button BtnTelaahResep;
    private id.yaski.simrskhanza.widget.CekBox ChkAccor;
    private id.yaski.simrskhanza.widget.CekBox ChkAutoValidasiRalan;
    private id.yaski.simrskhanza.widget.CekBox ChkAutoValidasiRanap;
    private id.yaski.simrskhanza.widget.CekBox ChkPreviewAturanPakai;
    private id.yaski.simrskhanza.widget.CekBox ChkPreviewLembarObat;
    private id.yaski.simrskhanza.widget.CekBox ChkSelesai;
    private id.yaski.simrskhanza.widget.ComboBox CmbModelAturanPakai;
    private id.yaski.simrskhanza.widget.ComboBox CmbModelLembarObat;
    private id.yaski.simrskhanza.widget.ComboBox CmbPrinterLembarObat;
    private id.yaski.simrskhanza.widget.TextBox CrDokter;
    private id.yaski.simrskhanza.widget.TextBox CrDokter2;
    private id.yaski.simrskhanza.widget.TextBox CrPoli;
    ...
    private id.yaski.simrskhanza.widget.TextBox Kamar;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TglSelesai;
    ...
    private id.yaski.simrskhanza.widget.Label label2;
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailPermintaanResepPulang;
    private id.yaski.simrskhanza.widget.Table tbDetailPermintaanStok;
    private id.yaski.simrskhanza.widget.Table tbDetailResepRalan;
    private id.yaski.simrskhanza.widget.Table tbDetailResepRanap;
    private id.yaski.simrskhanza.widget.Table tbPermintaanResepPulang;
    private id.yaski.simrskhanza.widget.Table tbPermintaanStok;
    private id.yaski.simrskhanza.widget.Table tbResepRalan;
    private id.yaski.simrskhanza.widget.Table tbResepRanap;

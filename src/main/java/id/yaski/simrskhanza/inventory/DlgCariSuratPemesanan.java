...
public class DlgCariSuratPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents()
    {
        ...
        KabidKeu = new id.yaski.simrskhanza.widget.TextBox();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        Apoteker = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Apoteker;
    ...
    private id.yaski.simrskhanza.widget.TextBox KabidKeu;

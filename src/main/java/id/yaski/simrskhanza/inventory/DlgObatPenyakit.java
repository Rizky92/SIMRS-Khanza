...
import id.yaski.simrskhanza.laporan.DlgKtgPenyakit;
...
public final class DlgObatPenyakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbObatPenyakit = new id.yaski.simrskhanza.widget.Table();
        ...
        KtgCari = new id.yaski.simrskhanza.widget.TextBox();
        btnKategoriCari = new id.yaski.simrskhanza.widget.Button();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        PenyakitCari = new id.yaski.simrskhanza.widget.TextBox();
        btnPenyakitCari = new id.yaski.simrskhanza.widget.Button();
        ...
        TPenyakit = new id.yaski.simrskhanza.widget.TextBox();
        nmobat = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        TRef = new id.yaski.simrskhanza.widget.TextBox();
        btnpenyakit = new id.yaski.simrskhanza.widget.Button();
        btnobat = new id.yaski.simrskhanza.widget.Button();
...
// TODO add your handling code here:
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KtgCari;
    ...
    private id.yaski.simrskhanza.widget.TextBox TPenyakit;
    private id.yaski.simrskhanza.widget.TextBox TRef;
    private id.yaski.simrskhanza.widget.Button btnKategoriCari;
    private id.yaski.simrskhanza.widget.Button btnPenyakitCari;
    private id.yaski.simrskhanza.widget.Button btnobat;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmobat;
    ...
    private id.yaski.simrskhanza.widget.Table tbObatPenyakit;

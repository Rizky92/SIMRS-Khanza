...
import id.yaski.simrskhanza.keuangan.KeuanganBayarPemesananFarmasi;
...
public class DlgCariPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nmjenis = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TglBeli1 = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        btnSuplier = new id.yaski.simrskhanza.widget.Button();
        btnPetugas = new id.yaski.simrskhanza.widget.Button();
        label12 = new id.yaski.simrskhanza.widget.Label();
        TglBeli2 = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        RDatang = new id.yaski.simrskhanza.widget.RadioButton();
        RFaktur = new id.yaski.simrskhanza.widget.RadioButton();
        TglFaktur1 = new id.yaski.simrskhanza.widget.Tanggal();
        TglFaktur2 = new id.yaski.simrskhanza.widget.Tanggal();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.RadioButton RDatang;
    private id.yaski.simrskhanza.widget.RadioButton RFaktur;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TglBeli1;
    private id.yaski.simrskhanza.widget.Tanggal TglBeli2;
    private id.yaski.simrskhanza.widget.Tanggal TglFaktur1;
    private id.yaski.simrskhanza.widget.Tanggal TglFaktur2;
    ...
    private id.yaski.simrskhanza.widget.Button btnSuplier;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmjenis;

...
public final class RMPenilaianAwalMedisRanapKandungan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KetFisik = new id.yaski.simrskhanza.widget.TextArea();
        ...
        SPO = new id.yaski.simrskhanza.widget.TextBox();
        ...
        THT = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        Thoraks = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Genital = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        Ekstremitas = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Ultra = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Kardio = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Kontraksi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Inspeksi = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane16 = new id.yaski.simrskhanza.widget.ScrollPane();
        Inspekulo = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane17 = new id.yaski.simrskhanza.widget.ScrollPane();
        VT = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Ekstremitas;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox GCS;
    private id.yaski.simrskhanza.widget.ComboBox Genital;
    private id.yaski.simrskhanza.widget.ComboBox Gigi;
    private id.yaski.simrskhanza.widget.TextBox His;
    private id.yaski.simrskhanza.widget.TextBox Hubungan;
    private id.yaski.simrskhanza.widget.TextArea Inspeksi;
    private id.yaski.simrskhanza.widget.TextArea Inspekulo;
    private id.yaski.simrskhanza.widget.ComboBox Jantung;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextArea Kardio;
    ...
    private id.yaski.simrskhanza.widget.TextArea KetFisik;
    private id.yaski.simrskhanza.widget.ComboBox Kontraksi;
    ...
    private id.yaski.simrskhanza.widget.TextArea RT;
    private id.yaski.simrskhanza.widget.TextBox SPO;
    ...
    private id.yaski.simrskhanza.widget.ComboBox THT;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Thoraks;
    private id.yaski.simrskhanza.widget.TextArea Ultra;
    private id.yaski.simrskhanza.widget.TextArea VT;

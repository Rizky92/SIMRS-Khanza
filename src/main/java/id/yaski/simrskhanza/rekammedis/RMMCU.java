...
public final class RMMCU extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        RiwayatAlergiMakanan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        scrollPane10 = new id.yaski.simrskhanza.widget.ScrollPane();
        PemeriksaanLaboratorium = new id.yaski.simrskhanza.widget.TextArea();
        jLabel61 = new id.yaski.simrskhanza.widget.Label();
        jLabel62 = new id.yaski.simrskhanza.widget.Label();
        scrollPane11 = new id.yaski.simrskhanza.widget.ScrollPane();
        RongsenThorax = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane12 = new id.yaski.simrskhanza.widget.ScrollPane();
        EKG = new id.yaski.simrskhanza.widget.TextArea();
        jLabel101 = new id.yaski.simrskhanza.widget.Label();
        scrollPane14 = new id.yaski.simrskhanza.widget.ScrollPane();
        Kesimpulan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel102 = new id.yaski.simrskhanza.widget.Label();
        scrollPane15 = new id.yaski.simrskhanza.widget.ScrollPane();
        Anjuran = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Submandibula = new id.yaski.simrskhanza.widget.ComboBox();
        Kesadaran = new id.yaski.simrskhanza.widget.ComboBox();
        Leher = new id.yaski.simrskhanza.widget.ComboBox();
        Axila = new id.yaski.simrskhanza.widget.ComboBox();
        Inguinal = new id.yaski.simrskhanza.widget.ComboBox();
        Supraklavikula = new id.yaski.simrskhanza.widget.ComboBox();
        Oedema = new id.yaski.simrskhanza.widget.ComboBox();
        NyeriTekanSinusFrontalis = new id.yaski.simrskhanza.widget.ComboBox();
        NyeriTekananSinusMaxilaris = new id.yaski.simrskhanza.widget.ComboBox();
        Palpebra = new id.yaski.simrskhanza.widget.ComboBox();
        Sklera = new id.yaski.simrskhanza.widget.ComboBox();
        TestButaWarna = new id.yaski.simrskhanza.widget.ComboBox();
        Konjungtiva = new id.yaski.simrskhanza.widget.ComboBox();
        Lensa = new id.yaski.simrskhanza.widget.ComboBox();
        Cornea = new id.yaski.simrskhanza.widget.ComboBox();
        Pupil = new id.yaski.simrskhanza.widget.ComboBox();
        LubangTelinga = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel105 = new id.yaski.simrskhanza.widget.Label();
        jLabel63 = new id.yaski.simrskhanza.widget.Label();
        DaunTelinga = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel64 = new id.yaski.simrskhanza.widget.Label();
        SelaputPendengaran = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel65 = new id.yaski.simrskhanza.widget.Label();
        NyeriMastoideus = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        SeptumNasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        jLabel67 = new id.yaski.simrskhanza.widget.Label();
        LubangHidung = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Bibir = new id.yaski.simrskhanza.widget.ComboBox();
        Caries = new id.yaski.simrskhanza.widget.ComboBox();
        Lidah = new id.yaski.simrskhanza.widget.ComboBox();
        Faring = new id.yaski.simrskhanza.widget.ComboBox();
        Tonsil = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KelenjarLimfe = new id.yaski.simrskhanza.widget.ComboBox();
        KelenjarGondok = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        GerakanDada = new id.yaski.simrskhanza.widget.ComboBox();
        BunyiNapas = new id.yaski.simrskhanza.widget.ComboBox();
        VocalFremitus = new id.yaski.simrskhanza.widget.ComboBox();
        BunyiTambahan = new id.yaski.simrskhanza.widget.ComboBox();
        PerkusiDada = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        IctusCordis = new id.yaski.simrskhanza.widget.ComboBox();
        BunyiJantung = new id.yaski.simrskhanza.widget.ComboBox();
        Batas = new id.yaski.simrskhanza.widget.ComboBox();
        Inspeksi = new id.yaski.simrskhanza.widget.ComboBox();
        Palpasi = new id.yaski.simrskhanza.widget.ComboBox();
        PerkusiAbdomen = new id.yaski.simrskhanza.widget.ComboBox();
        Auskultasi = new id.yaski.simrskhanza.widget.ComboBox();
        Hepar = new id.yaski.simrskhanza.widget.ComboBox();
        Limpa = new id.yaski.simrskhanza.widget.ComboBox();
        NyeriKtok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel84 = new id.yaski.simrskhanza.widget.Label();
        ExtremitasAtas = new id.yaski.simrskhanza.widget.ComboBox();
        ExtremitasBawah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel90 = new id.yaski.simrskhanza.widget.Label();
        KetExtremitasAtas = new id.yaski.simrskhanza.widget.TextBox();
        KetExtremitasBawah = new id.yaski.simrskhanza.widget.TextBox();
        ...
        RiwayatPenyakitSekarang = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane3 = new id.yaski.simrskhanza.widget.ScrollPane();
        RiwayatPenyakitKeluarga = new id.yaski.simrskhanza.widget.TextArea();
        jLabel94 = new id.yaski.simrskhanza.widget.Label();
        scrollPane4 = new id.yaski.simrskhanza.widget.ScrollPane();
        RiwayatPenyakitDahulu = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Merokok = new id.yaski.simrskhanza.widget.TextBox();
        Alkohol = new id.yaski.simrskhanza.widget.TextBox();
        ...
        scrollPane13 = new id.yaski.simrskhanza.widget.ScrollPane();
        Spirometri = new id.yaski.simrskhanza.widget.TextArea();
        jSeparator16 = new javax.swing.JSeparator();
        jLabel108 = new id.yaski.simrskhanza.widget.Label();
        scrollPane16 = new id.yaski.simrskhanza.widget.ScrollPane();
        Audiometri = new id.yaski.simrskhanza.widget.TextArea();
        jSeparator17 = new javax.swing.JSeparator();
        jLabel109 = new id.yaski.simrskhanza.widget.Label();
        scrollPane17 = new id.yaski.simrskhanza.widget.ScrollPane();
        Treadmill = new id.yaski.simrskhanza.widget.TextArea();
        jSeparator18 = new javax.swing.JSeparator();
        jLabel110 = new id.yaski.simrskhanza.widget.Label();
        scrollPane18 = new id.yaski.simrskhanza.widget.ScrollPane();
        Lainlain = new id.yaski.simrskhanza.widget.TextArea();
        jLabel111 = new id.yaski.simrskhanza.widget.Label();
        Sinus = new id.yaski.simrskhanza.widget.ComboBox();
        BtnDokter3 = new id.yaski.simrskhanza.widget.Button();
        BtnDokter2 = new id.yaski.simrskhanza.widget.Button();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        IMT = new id.yaski.simrskhanza.widget.TextBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        KlasifikasiIMT = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Scoliosis = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Gusi = new id.yaski.simrskhanza.widget.ComboBox();
        Gigi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KeteranganLuasLapangPandang = new id.yaski.simrskhanza.widget.TextBox();
        LuasLapangPandang = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Mamae = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganMamae = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PenyakitKulit = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AreaGenitalia = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAreaGenitalia = new id.yaski.simrskhanza.widget.TextBox();
        jLabel149 = new id.yaski.simrskhanza.widget.Label();
        jSeparator21 = new javax.swing.JSeparator();
        jLabel152 = new id.yaski.simrskhanza.widget.Label();
        Anus = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel151 = new id.yaski.simrskhanza.widget.Label();
        KeteranganAnus = new id.yaski.simrskhanza.widget.TextBox();
        jSeparator22 = new javax.swing.JSeparator();
        jLabel153 = new id.yaski.simrskhanza.widget.Label();
        scrollPane19 = new id.yaski.simrskhanza.widget.ScrollPane();
        Romberg = new id.yaski.simrskhanza.widget.TextArea();
        jSeparator23 = new javax.swing.JSeparator();
        jLabel154 = new id.yaski.simrskhanza.widget.Label();
        scrollPane20 = new id.yaski.simrskhanza.widget.ScrollPane();
        Backstrength = new id.yaski.simrskhanza.widget.TextArea();
        jSeparator24 = new javax.swing.JSeparator();
        jLabel155 = new id.yaski.simrskhanza.widget.Label();
        jLabel156 = new id.yaski.simrskhanza.widget.Label();
        scrollPane21 = new id.yaski.simrskhanza.widget.ScrollPane();
        AbiTanganKanan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel157 = new id.yaski.simrskhanza.widget.Label();
        scrollPane22 = new id.yaski.simrskhanza.widget.ScrollPane();
        AbiTanganKiri = new id.yaski.simrskhanza.widget.TextArea();
        jLabel158 = new id.yaski.simrskhanza.widget.Label();
        scrollPane23 = new id.yaski.simrskhanza.widget.ScrollPane();
        AbiKakiKanan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel159 = new id.yaski.simrskhanza.widget.Label();
        scrollPane24 = new id.yaski.simrskhanza.widget.ScrollPane();
        AbiKakiKiri = new id.yaski.simrskhanza.widget.TextArea();
        BtnDokter4 = new id.yaski.simrskhanza.widget.Button();
    ...
    private void MnPenilaianMCUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMCUActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.reportSmc("rptCetakPenilaianAwalMCUSMC.jasper", "report", "::[ Laporan Pengkajian Awal MCU ]::", param);
        }
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea AbiKakiKanan;
    private id.yaski.simrskhanza.widget.TextArea AbiKakiKiri;
    private id.yaski.simrskhanza.widget.TextArea AbiTanganKanan;
    private id.yaski.simrskhanza.widget.TextArea AbiTanganKiri;
    private id.yaski.simrskhanza.widget.TextBox Alkohol;
    private id.yaski.simrskhanza.widget.TextArea Anjuran;
    private id.yaski.simrskhanza.widget.ComboBox Anus;
    private id.yaski.simrskhanza.widget.ComboBox AreaGenitalia;
    private id.yaski.simrskhanza.widget.TextArea Audiometri;
    private id.yaski.simrskhanza.widget.ComboBox Auskultasi;
    private id.yaski.simrskhanza.widget.ComboBox Axila;
    private id.yaski.simrskhanza.widget.TextBox BB;
    private id.yaski.simrskhanza.widget.TextArea Backstrength;
    private id.yaski.simrskhanza.widget.ComboBox Batas;
    private id.yaski.simrskhanza.widget.ComboBox Bibir;
    ...
    private id.yaski.simrskhanza.widget.Button BtnDokter2;
    private id.yaski.simrskhanza.widget.Button BtnDokter3;
    private id.yaski.simrskhanza.widget.Button BtnDokter4;
    ...
    private id.yaski.simrskhanza.widget.ComboBox BunyiJantung;
    private id.yaski.simrskhanza.widget.ComboBox BunyiNapas;
    private id.yaski.simrskhanza.widget.ComboBox BunyiTambahan;
    private id.yaski.simrskhanza.widget.ComboBox Caries;
    private id.yaski.simrskhanza.widget.ComboBox Cornea;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari1;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari2;
    private id.yaski.simrskhanza.widget.ComboBox DaunTelinga;
    private id.yaski.simrskhanza.widget.TextArea EKG;
    private id.yaski.simrskhanza.widget.ComboBox ExtremitasAtas;
    private id.yaski.simrskhanza.widget.ComboBox ExtremitasBawah;
    private id.yaski.simrskhanza.widget.ComboBox Faring;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.ComboBox GerakanDada;
    private id.yaski.simrskhanza.widget.ComboBox Gigi;
    private id.yaski.simrskhanza.widget.ComboBox Gusi;
    private id.yaski.simrskhanza.widget.ComboBox Hepar;
    private id.yaski.simrskhanza.widget.TextBox IMT;
    private id.yaski.simrskhanza.widget.ComboBox IctusCordis;
    private id.yaski.simrskhanza.widget.ComboBox Informasi;
    private id.yaski.simrskhanza.widget.ComboBox Inguinal;
    private id.yaski.simrskhanza.widget.ComboBox Inspeksi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KelenjarGondok;
    private id.yaski.simrskhanza.widget.ComboBox KelenjarLimfe;
    private id.yaski.simrskhanza.widget.ComboBox Kesadaran;
    private id.yaski.simrskhanza.widget.TextArea Kesimpulan;
    private id.yaski.simrskhanza.widget.TextBox KetExtremitasAtas;
    private id.yaski.simrskhanza.widget.TextBox KetExtremitasBawah;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAnus;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAreaGenitalia;
    private id.yaski.simrskhanza.widget.TextBox KeteranganLuasLapangPandang;
    private id.yaski.simrskhanza.widget.TextBox KeteranganMamae;
    private id.yaski.simrskhanza.widget.TextBox KlasifikasiIMT;
    ...
    private id.yaski.simrskhanza.widget.TextArea Lainlain;
    private id.yaski.simrskhanza.widget.ComboBox Leher;
    private id.yaski.simrskhanza.widget.ComboBox Lensa;
    private id.yaski.simrskhanza.widget.ComboBox Lidah;
    private id.yaski.simrskhanza.widget.ComboBox Limpa;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox LuasLapangPandang;
    private id.yaski.simrskhanza.widget.ComboBox LubangHidung;
    private id.yaski.simrskhanza.widget.ComboBox LubangTelinga;
    private id.yaski.simrskhanza.widget.ComboBox Mamae;
    private id.yaski.simrskhanza.widget.ComboBox MenggunakanKacamata;
    private id.yaski.simrskhanza.widget.TextBox Merokok;
    ...
    private id.yaski.simrskhanza.widget.ComboBox NyeriKtok;
    private id.yaski.simrskhanza.widget.ComboBox NyeriMastoideus;
    private id.yaski.simrskhanza.widget.ComboBox NyeriTekanSinusFrontalis;
    private id.yaski.simrskhanza.widget.ComboBox NyeriTekananSinusMaxilaris;
    private id.yaski.simrskhanza.widget.ComboBox Oedema;
    private id.yaski.simrskhanza.widget.ComboBox Palpasi;
    private id.yaski.simrskhanza.widget.ComboBox Palpebra;
    private id.yaski.simrskhanza.widget.TextArea PemeriksaanLaboratorium;
    private id.yaski.simrskhanza.widget.TextBox PenyakitKulit;
    private id.yaski.simrskhanza.widget.ComboBox PerkusiAbdomen;
    private id.yaski.simrskhanza.widget.ComboBox PerkusiDada;
    private id.yaski.simrskhanza.widget.ComboBox Pupil;
    private id.yaski.simrskhanza.widget.TextBox RR;
    private id.yaski.simrskhanza.widget.TextBox Rambut;
    private id.yaski.simrskhanza.widget.TextBox RisikoLP;
    private id.yaski.simrskhanza.widget.TextBox RiwayatAlergiMakanan;
    private id.yaski.simrskhanza.widget.TextArea RiwayatPenyakitDahulu;
    private id.yaski.simrskhanza.widget.TextArea RiwayatPenyakitKeluarga;
    private id.yaski.simrskhanza.widget.TextArea RiwayatPenyakitSekarang;
    private id.yaski.simrskhanza.widget.TextArea Romberg;
    private id.yaski.simrskhanza.widget.TextArea RongsenThorax;
    private id.yaski.simrskhanza.widget.ComboBox Scoliosis;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SelaputPendengaran;
    private id.yaski.simrskhanza.widget.ComboBox SeptumNasi;
    private id.yaski.simrskhanza.widget.ComboBox Sinus;
    private id.yaski.simrskhanza.widget.ComboBox Sklera;
    private id.yaski.simrskhanza.widget.TextArea Spirometri;
    private id.yaski.simrskhanza.widget.ComboBox Submandibula;
    private id.yaski.simrskhanza.widget.TextBox Suhu;
    private id.yaski.simrskhanza.widget.ComboBox Supraklavikula;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TestButaWarna;
    private id.yaski.simrskhanza.widget.Tanggal TglAsuhan;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.ComboBox Tonsil;
    private id.yaski.simrskhanza.widget.TextArea Treadmill;
    private id.yaski.simrskhanza.widget.TextBox Visus;
    private id.yaski.simrskhanza.widget.ComboBox VocalFremitus;
    ...
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane10;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane11;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane12;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane13;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane14;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane15;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane16;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane17;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane18;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane19;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane2;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane20;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane21;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane22;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane23;
    private id.yaski.simrskhanza.widget.ScrollPane scrollPane24;

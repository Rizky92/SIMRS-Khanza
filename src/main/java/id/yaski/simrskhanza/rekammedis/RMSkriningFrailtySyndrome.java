...
public final class RMSkriningFrailtySyndrome extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Resistensi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        NilaiResistensi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Aktivitas = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel93 = new id.yaski.simrskhanza.widget.Label();
        NilaiAktivitas = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NilaiPenyakit = new id.yaski.simrskhanza.widget.TextBox();
        ChkTidakPernah = new id.yaski.simrskhanza.widget.CekBox();
        ChkDiabetes = new id.yaski.simrskhanza.widget.CekBox();
        ChkKanker = new id.yaski.simrskhanza.widget.CekBox();
        ChkHipertensi = new id.yaski.simrskhanza.widget.CekBox();
        ChkPenyakitParuKronis = new id.yaski.simrskhanza.widget.CekBox();
        ChkSeranganJantung = new id.yaski.simrskhanza.widget.CekBox();
        ChkGagalJantung = new id.yaski.simrskhanza.widget.CekBox();
        ChkNyeriDada = new id.yaski.simrskhanza.widget.CekBox();
        ChkAsma = new id.yaski.simrskhanza.widget.CekBox();
        ChkNyeriSendi = new id.yaski.simrskhanza.widget.CekBox();
        ChkPenyakitGinjal = new id.yaski.simrskhanza.widget.CekBox();
        ChkStroke = new id.yaski.simrskhanza.widget.CekBox();
        jLabel82 = new id.yaski.simrskhanza.widget.Label();
        UsahaBerjalan = new id.yaski.simrskhanza.widget.ComboBox();
        NilaiUsahaBerjalan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BeratBadan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel100 = new id.yaski.simrskhanza.widget.Label();
        NilaiBeratBadan = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Aktivitas;
    private id.yaski.simrskhanza.widget.ComboBox BeratBadan;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkAsma;
    private id.yaski.simrskhanza.widget.CekBox ChkDiabetes;
    private id.yaski.simrskhanza.widget.CekBox ChkGagalJantung;
    private id.yaski.simrskhanza.widget.CekBox ChkHipertensi;
    private id.yaski.simrskhanza.widget.CekBox ChkInput;
    private id.yaski.simrskhanza.widget.CekBox ChkKanker;
    private id.yaski.simrskhanza.widget.CekBox ChkKejadian;
    private id.yaski.simrskhanza.widget.CekBox ChkNyeriDada;
    private id.yaski.simrskhanza.widget.CekBox ChkNyeriSendi;
    private id.yaski.simrskhanza.widget.CekBox ChkPenyakitGinjal;
    private id.yaski.simrskhanza.widget.CekBox ChkPenyakitParuKronis;
    private id.yaski.simrskhanza.widget.CekBox ChkSeranganJantung;
    private id.yaski.simrskhanza.widget.CekBox ChkStroke;
    private id.yaski.simrskhanza.widget.CekBox ChkTidakPernah;
    ...
    private id.yaski.simrskhanza.widget.TextBox NilaiAktivitas;
    private id.yaski.simrskhanza.widget.TextBox NilaiBeratBadan;
    private id.yaski.simrskhanza.widget.TextBox NilaiPenyakit;
    private id.yaski.simrskhanza.widget.TextBox NilaiResistensi;
    private id.yaski.simrskhanza.widget.TextBox NilaiUsahaBerjalan;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox Resistensi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox UsahaBerjalan;

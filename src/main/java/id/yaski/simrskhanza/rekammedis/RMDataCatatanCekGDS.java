...
public final class RMDataCatatanCekGDS extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ObatGula = new id.yaski.simrskhanza.widget.TextBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        Insulin = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Insulin;
    ...
    private id.yaski.simrskhanza.widget.TextBox ObatGula;

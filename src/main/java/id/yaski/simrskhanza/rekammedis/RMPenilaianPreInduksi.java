...
public final class RMPenilaianPreInduksi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        IntubasiSulitIntubasi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel125 = new id.yaski.simrskhanza.widget.Label();
        Asesmen = new id.yaski.simrskhanza.widget.ComboBox();
        Ventilasi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Perencanaan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        InfusPerifier = new id.yaski.simrskhanza.widget.TextArea();
        CVC = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Premedikasi = new id.yaski.simrskhanza.widget.ComboBox();
        PosisiInfus = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel130 = new id.yaski.simrskhanza.widget.Label();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        KeteranganPremedikasi = new id.yaski.simrskhanza.widget.TextBox();
        InfusInduksi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel132 = new id.yaski.simrskhanza.widget.Label();
        jLabel133 = new id.yaski.simrskhanza.widget.Label();
        KeteranganInfusInduksi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel134 = new id.yaski.simrskhanza.widget.Label();
        FaceMaskNo = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BronchoscopiFiberoptik = new id.yaski.simrskhanza.widget.TextBox();
        jLabel144 = new id.yaski.simrskhanza.widget.Label();
        Glidescopi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        jLabel145 = new id.yaski.simrskhanza.widget.Label();
        TatalaksanaLainlain = new id.yaski.simrskhanza.widget.TextBox();
        ...
        IntubasiSesudahTidur = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel147 = new id.yaski.simrskhanza.widget.Label();
        jLabel149 = new id.yaski.simrskhanza.widget.Label();
        IntubasiOral = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel150 = new id.yaski.simrskhanza.widget.Label();
        IntubasiTracheostomi = new id.yaski.simrskhanza.widget.ComboBox();
        scrollPane3 = new id.yaski.simrskhanza.widget.ScrollPane();
        KeteranganIntubasi = new id.yaski.simrskhanza.widget.TextArea();
        ...
        IntubasiSulitVentilasi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TeknikRegionalObatobatan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        TeknikRegionalKomplikasi = new id.yaski.simrskhanza.widget.TextArea();
        jLabel165 = new id.yaski.simrskhanza.widget.Label();
        jLabel167 = new id.yaski.simrskhanza.widget.Label();
        TeknikRegionalHasil = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Asesmen;
    private id.yaski.simrskhanza.widget.TextBox BronchoscopiFiberoptik;
    ...
    private id.yaski.simrskhanza.widget.TextBox CVC;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari1;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari2;
    private id.yaski.simrskhanza.widget.TextBox EKG;
    private id.yaski.simrskhanza.widget.TextBox ETTFiksasi;
    private id.yaski.simrskhanza.widget.TextBox ETTJenis;
    private id.yaski.simrskhanza.widget.TextBox ETTNo;
    private id.yaski.simrskhanza.widget.TextBox FaceMaskNo;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Glidescopi;
    private id.yaski.simrskhanza.widget.ComboBox InfusInduksi;
    private id.yaski.simrskhanza.widget.TextArea InfusPerifier;
    private id.yaski.simrskhanza.widget.ComboBox IntubasiOral;
    private id.yaski.simrskhanza.widget.ComboBox IntubasiSesudahTidur;
    private id.yaski.simrskhanza.widget.TextBox IntubasiSulitIntubasi;
    private id.yaski.simrskhanza.widget.TextBox IntubasiSulitVentilasi;
    private id.yaski.simrskhanza.widget.ComboBox IntubasiTracheostomi;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextBox KeteranganInfusInduksi;
    private id.yaski.simrskhanza.widget.TextArea KeteranganIntubasi;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPremedikasi;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LMAJenis;
    private id.yaski.simrskhanza.widget.TextBox LMANo;
    private id.yaski.simrskhanza.widget.TextBox Lainlain;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.TextBox Nadi;
    private id.yaski.simrskhanza.widget.TextBox NasopharingNo;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.TextArea Perencanaan;
    private id.yaski.simrskhanza.widget.ComboBox PosisiInfus;
    private id.yaski.simrskhanza.widget.ComboBox Premedikasi;
    ...
    private id.yaski.simrskhanza.widget.TextBox TatalaksanaLainlain;
    private id.yaski.simrskhanza.widget.TextBox TeknikRegionalHasil;
    private id.yaski.simrskhanza.widget.TextBox TeknikRegionalJenis;
    private id.yaski.simrskhanza.widget.TextBox TeknikRegionalJenisJarum;
    private id.yaski.simrskhanza.widget.ComboBox TeknikRegionalKateter;
    private id.yaski.simrskhanza.widget.TextBox TeknikRegionalKateterFiksasi;
    private id.yaski.simrskhanza.widget.TextArea TeknikRegionalKomplikasi;
    private id.yaski.simrskhanza.widget.TextBox TeknikRegionalLokasi;
    private id.yaski.simrskhanza.widget.TextArea TeknikRegionalObatobatan;
    private id.yaski.simrskhanza.widget.Tanggal TglAsuhan;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.TextBox Tracheostomi;
    private id.yaski.simrskhanza.widget.TextBox Ventilasi;

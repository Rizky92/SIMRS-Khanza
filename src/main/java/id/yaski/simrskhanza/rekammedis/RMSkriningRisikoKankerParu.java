...
public final class RMSkriningRisikoKankerParu extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        JenisKelamin = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel92 = new id.yaski.simrskhanza.widget.Label();
        Usia = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        NilaiJenisKelamin = new id.yaski.simrskhanza.widget.TextBox();
        NilaiUsia = new id.yaski.simrskhanza.widget.TextBox();
        PernahMenderitaKanker = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel70 = new id.yaski.simrskhanza.widget.Label();
        NilaiPernahMenderitaKanker = new id.yaski.simrskhanza.widget.TextBox();
        jLabel71 = new id.yaski.simrskhanza.widget.Label();
        NilaiKeluargaKanker = new id.yaski.simrskhanza.widget.TextBox();
        KeluargaKanker = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel148 = new id.yaski.simrskhanza.widget.Label();
        HasilSkrining = new id.yaski.simrskhanza.widget.TextBox();
        ...
        RiwayatMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel72 = new id.yaski.simrskhanza.widget.Label();
        NilaiRiwayatMerokok = new id.yaski.simrskhanza.widget.TextBox();
        jLabel85 = new id.yaski.simrskhanza.widget.Label();
        jLabel86 = new id.yaski.simrskhanza.widget.Label();
        RiwayatBekerja = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel74 = new id.yaski.simrskhanza.widget.Label();
        NilaiRiwayatBekerja = new id.yaski.simrskhanza.widget.TextBox();
        jLabel87 = new id.yaski.simrskhanza.widget.Label();
        jLabel88 = new id.yaski.simrskhanza.widget.Label();
        LingkunganTinggal = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel89 = new id.yaski.simrskhanza.widget.Label();
        NilaiLingkunganTinggal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel90 = new id.yaski.simrskhanza.widget.Label();
        DalamRumah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        NilaiDalamRumah = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PernahParu = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel96 = new id.yaski.simrskhanza.widget.Label();
        NilaiPernahParu = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox NilaiDalamRumah;
    private id.yaski.simrskhanza.widget.TextBox NilaiJenisKelamin;
    private id.yaski.simrskhanza.widget.TextBox NilaiKeluargaKanker;
    private id.yaski.simrskhanza.widget.TextBox NilaiLingkunganTinggal;
    private id.yaski.simrskhanza.widget.TextBox NilaiPernahMenderitaKanker;
    private id.yaski.simrskhanza.widget.TextBox NilaiPernahParu;
    private id.yaski.simrskhanza.widget.TextBox NilaiRiwayatBekerja;
    private id.yaski.simrskhanza.widget.TextBox NilaiRiwayatMerokok;
    private id.yaski.simrskhanza.widget.TextBox NilaiUsia;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PernahMenderitaKanker;
    private id.yaski.simrskhanza.widget.ComboBox PernahParu;
    private id.yaski.simrskhanza.widget.ComboBox RiwayatBekerja;
    private id.yaski.simrskhanza.widget.ComboBox RiwayatMerokok;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Usia;

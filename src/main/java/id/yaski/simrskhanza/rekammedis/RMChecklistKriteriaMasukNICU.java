...
public final class RMChecklistKriteriaMasukNICU extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Prematur2 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel68 = new id.yaski.simrskhanza.widget.Label();
        jLabel69 = new id.yaski.simrskhanza.widget.Label();
        Prematur1 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel70 = new id.yaski.simrskhanza.widget.Label();
        Prematur3 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kardio1;
    private id.yaski.simrskhanza.widget.ComboBox Kardio2;
    private id.yaski.simrskhanza.widget.ComboBox Kardio3;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kondisilain1;
    private id.yaski.simrskhanza.widget.ComboBox Kondisilain2;
    private id.yaski.simrskhanza.widget.ComboBox Kondisilain3;
    private id.yaski.simrskhanza.widget.ComboBox Kondisilain4;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox Metabolik1;
    private id.yaski.simrskhanza.widget.ComboBox Metabolik2;
    private id.yaski.simrskhanza.widget.ComboBox Metabolik3;
    private javax.swing.JMenuItem MnKriteriaMasukNICU;
    private id.yaski.simrskhanza.widget.TextBox NamaPetugas;
    private id.yaski.simrskhanza.widget.ComboBox Neuro1;
    private id.yaski.simrskhanza.widget.ComboBox Neuro2;
    private id.yaski.simrskhanza.widget.ComboBox Neuro3;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox Prematur1;
    private id.yaski.simrskhanza.widget.ComboBox Prematur2;
    private id.yaski.simrskhanza.widget.ComboBox Prematur3;

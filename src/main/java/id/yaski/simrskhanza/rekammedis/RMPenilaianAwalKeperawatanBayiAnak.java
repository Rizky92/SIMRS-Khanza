...
public final class RMPenilaianAwalKeperawatanBayiAnak extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Pengasuh = new id.yaski.simrskhanza.widget.ComboBox();
        KetPengasuh = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Frekuensi = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Frekuensi;
    ...
    private id.yaski.simrskhanza.widget.TextBox KetPengasuh;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Pengasuh;

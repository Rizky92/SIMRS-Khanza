...
public final class RMSkriningIndraPendengaran extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CurigaTuliTelingaKiri = new id.yaski.simrskhanza.widget.ComboBox();
        CurigaTuliTelingaKanan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        CongekTelingaKiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        CongekTelingaKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel88 = new id.yaski.simrskhanza.widget.Label();
        CurigaTuliTelingaRujuk = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        SumbatanSerumenTelingaKiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel92 = new id.yaski.simrskhanza.widget.Label();
        SumbatanSerumenTelingaKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel93 = new id.yaski.simrskhanza.widget.Label();
        SumbatanSerumenTelingaRujuk = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel94 = new id.yaski.simrskhanza.widget.Label();
        CongekTelingaRujuk = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PenurunanPendengaranTelingaKiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel96 = new id.yaski.simrskhanza.widget.Label();
        PenurunanPendengaranTelingaKanan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        MendengarBisikanTelingaKiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel101 = new id.yaski.simrskhanza.widget.Label();
        MendengarBisikanTelingaKanan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox CongekTelingaKanan;
    private id.yaski.simrskhanza.widget.ComboBox CongekTelingaKiri;
    private id.yaski.simrskhanza.widget.ComboBox CongekTelingaRujuk;
    private id.yaski.simrskhanza.widget.ComboBox CurigaTuliTelingaKanan;
    private id.yaski.simrskhanza.widget.ComboBox CurigaTuliTelingaKiri;
    private id.yaski.simrskhanza.widget.ComboBox CurigaTuliTelingaRujuk;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MendengarBisikanTelingaKanan;
    private id.yaski.simrskhanza.widget.ComboBox MendengarBisikanTelingaKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PenurunanPendengaranTelingaKanan;
    private id.yaski.simrskhanza.widget.ComboBox PenurunanPendengaranTelingaKiri;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SumbatanSerumenTelingaKanan;
    private id.yaski.simrskhanza.widget.ComboBox SumbatanSerumenTelingaKiri;
    private id.yaski.simrskhanza.widget.ComboBox SumbatanSerumenTelingaRujuk;

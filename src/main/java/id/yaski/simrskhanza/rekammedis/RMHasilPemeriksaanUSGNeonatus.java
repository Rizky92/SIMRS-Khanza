...
public final class RMHasilPemeriksaanUSGNeonatus extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        VentrikalSinistra = new id.yaski.simrskhanza.widget.TextArea();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        scrollPane19 = new id.yaski.simrskhanza.widget.ScrollPane();
        VentrikelDextra = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea VentrikalSinistra;
    private id.yaski.simrskhanza.widget.TextArea VentrikelDextra;

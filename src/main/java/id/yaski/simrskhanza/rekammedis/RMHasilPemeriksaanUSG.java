...
public final class RMHasilPemeriksaanUSG extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        HTA = new id.yaski.simrskhanza.widget.TextBox();
        ...
        UkuranKantong = new id.yaski.simrskhanza.widget.TextBox();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        UkuranBokong = new id.yaski.simrskhanza.widget.TextBox();
        JenisPrestasi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        DiameterBiparietal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        PanjangFemur = new id.yaski.simrskhanza.widget.TextBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        LingkarAbdomen = new id.yaski.simrskhanza.widget.TextBox();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        TafsiranBerat = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Plasenta = new id.yaski.simrskhanza.widget.TextBox();
        jLabel125 = new id.yaski.simrskhanza.widget.Label();
        DerajatMaturitas = new id.yaski.simrskhanza.widget.ComboBox();
        JumlahAir = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel126 = new id.yaski.simrskhanza.widget.Label();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        IndexCairan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PeluangSex = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox DerajatMaturitas;
    private id.yaski.simrskhanza.widget.TextBox DiagnosaKlinis;
    private id.yaski.simrskhanza.widget.TextBox DiameterBiparietal;
    ...
    private id.yaski.simrskhanza.widget.TextBox HTA;
    private id.yaski.simrskhanza.widget.TextBox IndexCairan;
    private id.yaski.simrskhanza.widget.TextBox JenisPrestasi;
    private id.yaski.simrskhanza.widget.ComboBox JumlahAir;
    ...
    private id.yaski.simrskhanza.widget.TextBox LingkarAbdomen;
    ...
    private id.yaski.simrskhanza.widget.TextBox PanjangFemur;
    private id.yaski.simrskhanza.widget.ComboBox PeluangSex;
    private id.yaski.simrskhanza.widget.TextBox Plasenta;
    ...
    private id.yaski.simrskhanza.widget.TextBox TafsiranBerat;
    ...
    private id.yaski.simrskhanza.widget.TextBox UkuranBokong;
    private id.yaski.simrskhanza.widget.TextBox UkuranKantong;

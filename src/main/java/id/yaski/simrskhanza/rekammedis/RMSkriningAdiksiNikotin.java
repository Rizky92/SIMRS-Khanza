...
public final class RMSkriningAdiksiNikotin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        RasaIngin = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel112 = new id.yaski.simrskhanza.widget.Label();
        NilaiRasaIngin = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SakitBerat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel116 = new id.yaski.simrskhanza.widget.Label();
        NilaiSakitBerat = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SkalaMotivasi = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox JamPertama;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MenyalakanRokok;
    private javax.swing.JMenuItem MnSkriningAdiksiNikotin;
    private id.yaski.simrskhanza.widget.TextBox NilaiJamPertama;
    private id.yaski.simrskhanza.widget.TextBox NilaiMenyalakanRokok;
    private id.yaski.simrskhanza.widget.TextBox NilaiRasaIngin;
    private id.yaski.simrskhanza.widget.TextBox NilaiRokokDihisab;
    private id.yaski.simrskhanza.widget.TextBox NilaiSakitBerat;
    private id.yaski.simrskhanza.widget.TextBox NilaiTidakRela;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox RasaIngin;
    private id.yaski.simrskhanza.widget.ComboBox RokokDihisab;
    private id.yaski.simrskhanza.widget.ComboBox SakitBerat;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SkalaMotivasi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TidakRela;

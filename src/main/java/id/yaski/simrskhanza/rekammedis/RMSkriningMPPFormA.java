...
public final class RMSkriningMPPFormA extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Assemen = new id.yaski.simrskhanza.widget.TextArea();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        scrollPane4 = new id.yaski.simrskhanza.widget.ScrollPane();
        Identifikasi = new id.yaski.simrskhanza.widget.TextArea();
        TglEvaluasi = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel94 = new id.yaski.simrskhanza.widget.Label();
        jSeparator3 = new javax.swing.JSeparator();
        Scroll6 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbIdentifikasiMPP = new id.yaski.simrskhanza.widget.Table();
        ...
        TDokter1 = new id.yaski.simrskhanza.widget.TextBox();
        KdDok1 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TDiagnosis = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane7 = new id.yaski.simrskhanza.widget.ScrollPane();
        TKelompok = new id.yaski.simrskhanza.widget.TextArea();
        BtnAllMasalah = new id.yaski.simrskhanza.widget.Button();
        TglMasuk = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnPrintLap = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea Assemen;
    ...
    private id.yaski.simrskhanza.widget.Button BtnPrintLap;
    ...
    private id.yaski.simrskhanza.widget.TextArea Identifikasi;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox Kamar;
    private id.yaski.simrskhanza.widget.TextBox KdDok1;
    ...
    private id.yaski.simrskhanza.widget.TextArea TDiagnosis;
    private id.yaski.simrskhanza.widget.TextBox TDokter1;
    private id.yaski.simrskhanza.widget.TextBox TDokter2;
    private id.yaski.simrskhanza.widget.TextArea TKelompok;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TglEvaluasi;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.TextBox TglMasuk;
    ...
    private id.yaski.simrskhanza.widget.Table tbIdentifikasiMPP;

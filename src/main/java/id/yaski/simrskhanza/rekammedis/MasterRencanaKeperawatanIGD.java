...
public class MasterRencanaKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kdrencana = new id.yaski.simrskhanza.widget.TextBox();
        namarencana = new id.yaski.simrskhanza.widget.TextBox();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        kdmasalah = new id.yaski.simrskhanza.widget.TextBox();
        nmmasalah = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox kdmasalah;
    private id.yaski.simrskhanza.widget.TextBox kdrencana;
    private id.yaski.simrskhanza.widget.TextBox namarencana;
    private id.yaski.simrskhanza.widget.TextBox nmmasalah;

...
public final class RMSkriningPUMA extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        skorJk = new id.yaski.simrskhanza.widget.TextBox();
        skorUsia = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PernahMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel97 = new id.yaski.simrskhanza.widget.Label();
        skorPernahMerokok = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NafasPendek = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel109 = new id.yaski.simrskhanza.widget.Label();
        skorNafas = new id.yaski.simrskhanza.widget.TextBox();
        jLabel110 = new id.yaski.simrskhanza.widget.Label();
        jLabel111 = new id.yaski.simrskhanza.widget.Label();
        Dahak = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel112 = new id.yaski.simrskhanza.widget.Label();
        skordahak = new id.yaski.simrskhanza.widget.TextBox();
        ...
        skorBatuk = new id.yaski.simrskhanza.widget.TextBox();
        jLabel117 = new id.yaski.simrskhanza.widget.Label();
        jLabel118 = new id.yaski.simrskhanza.widget.Label();
        Spirometri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel119 = new id.yaski.simrskhanza.widget.Label();
        skorSpirometri = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Dahak;
    ...
    private id.yaski.simrskhanza.widget.ComboBox NafasPendek;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PernahMerokok;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox Spirometri;
    ...
    private id.yaski.simrskhanza.widget.TextBox skorBatuk;
    private id.yaski.simrskhanza.widget.TextBox skorJk;
    private id.yaski.simrskhanza.widget.TextBox skorNafas;
    private id.yaski.simrskhanza.widget.TextBox skorPernahMerokok;
    private id.yaski.simrskhanza.widget.TextBox skorSpirometri;
    private id.yaski.simrskhanza.widget.TextBox skorUsia;
    private id.yaski.simrskhanza.widget.TextBox skordahak;

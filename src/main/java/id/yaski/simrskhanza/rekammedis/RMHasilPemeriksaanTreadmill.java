...
public final class RMHasilPemeriksaanTreadmill extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KeteranganProtokol = new id.yaski.simrskhanza.widget.TextBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        DiagnosaKlinis = new id.yaski.simrskhanza.widget.TextBox();
        TDAwal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        Protokol = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        NadiAwal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        DenyutJantungMaksimal = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox DenyutJantungMaksimal;
    ...
    private id.yaski.simrskhanza.widget.TextArea HasilPemeriksaan;
    private id.yaski.simrskhanza.widget.TextArea Interpretasi;
    private id.yaski.simrskhanza.widget.TextArea KapasitasFungsional;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextArea Kesimpulan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganProtokol;
    ...
    private id.yaski.simrskhanza.widget.TextBox TDAwal;
    ...
    private id.yaski.simrskhanza.widget.TextArea TemuanEKG;

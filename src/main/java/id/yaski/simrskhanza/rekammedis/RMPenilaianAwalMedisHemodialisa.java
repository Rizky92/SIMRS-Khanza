...
public final class RMPenilaianAwalMedisHemodialisa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        StatusNutrisi = new id.yaski.simrskhanza.widget.TextBox();
        DiabetesMelitus = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel44 = new id.yaski.simrskhanza.widget.Label();
        InfeksiSaluranKemih = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        BengkakSeluruhTubuh = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        Hipertensi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel49 = new id.yaski.simrskhanza.widget.Label();
        BatuSaluranKemih = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel50 = new id.yaski.simrskhanza.widget.Label();
        OperasiSaluranKemih = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        PenyakitGinjalLaom = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        UrinBerdarah = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        CAPD = new id.yaski.simrskhanza.widget.ComboBox();
        Transplantasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel53 = new id.yaski.simrskhanza.widget.Label();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        PenyakitLain = new id.yaski.simrskhanza.widget.ComboBox();
        KonsumsiObatNefrotoksis = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        Napas = new id.yaski.simrskhanza.widget.TextBox();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        Ikterik = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TekananVenaJugularis = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Kardiomegali = new id.yaski.simrskhanza.widget.ComboBox();
        Bising = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Whezzing = new id.yaski.simrskhanza.widget.ComboBox();
        Ronchi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Hepatomegali = new id.yaski.simrskhanza.widget.ComboBox();
        Splenomegali = new id.yaski.simrskhanza.widget.ComboBox();
        Ascites = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TglThorax = new id.yaski.simrskhanza.widget.Tanggal();
        TglDialisis = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel74 = new id.yaski.simrskhanza.widget.Label();
        TglEKG = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel75 = new id.yaski.simrskhanza.widget.Label();
        TglBNO = new id.yaski.simrskhanza.widget.Tanggal();
        TglUSG = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel76 = new id.yaski.simrskhanza.widget.Label();
        jLabel77 = new id.yaski.simrskhanza.widget.Label();
        TglRenogram = new id.yaski.simrskhanza.widget.Tanggal();
        TglLaboratorium = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        TglKultururin = new id.yaski.simrskhanza.widget.Tanggal();
        TglArteriografi = new id.yaski.simrskhanza.widget.Tanggal();
        TglCTscan = new id.yaski.simrskhanza.widget.Tanggal();
        TglBiopsi = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        Hematokrit = new id.yaski.simrskhanza.widget.TextBox();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        Hemoglobin = new id.yaski.simrskhanza.widget.TextBox();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        Leukosit = new id.yaski.simrskhanza.widget.TextBox();
        Trombosit = new id.yaski.simrskhanza.widget.TextBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        HitungJenis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel33 = new id.yaski.simrskhanza.widget.Label();
        Ureum = new id.yaski.simrskhanza.widget.TextBox();
        Kreatinin = new id.yaski.simrskhanza.widget.TextBox();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        AsamUrat = new id.yaski.simrskhanza.widget.TextBox();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        SGOT = new id.yaski.simrskhanza.widget.TextBox();
        SGPT = new id.yaski.simrskhanza.widget.TextBox();
        CT = new id.yaski.simrskhanza.widget.TextBox();
        UrinLengkap = new id.yaski.simrskhanza.widget.TextBox();
        CCT = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AntiHCV = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel88 = new id.yaski.simrskhanza.widget.Label();
        AsalRuangan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KeteranganHipertensi = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganDiabetesMelitus = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganBatuSaluranKemih = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganOperasiSaluranKemih = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganInfeksiSaluranKemih = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganBengkakSeluruhTubuh = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganUrinBerdarah = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganPenyakitGinjalLaom = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganPenyakitLain = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganKonsumsiObatNefrotoksis = new id.yaski.simrskhanza.widget.TextBox();
        jSeparator3 = new javax.swing.JSeparator();
        TglCAPD = new id.yaski.simrskhanza.widget.Tanggal();
        TglTransplantasi = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        ChkUSG = new id.yaski.simrskhanza.widget.CekBox();
        ChkThorax = new id.yaski.simrskhanza.widget.CekBox();
        ChkEKG = new id.yaski.simrskhanza.widget.CekBox();
        ChkBNO = new id.yaski.simrskhanza.widget.CekBox();
        ChkRenogram = new id.yaski.simrskhanza.widget.CekBox();
        ChkBiopsiGinjal = new id.yaski.simrskhanza.widget.CekBox();
        ChkCTScan = new id.yaski.simrskhanza.widget.CekBox();
        ChkArteriografi = new id.yaski.simrskhanza.widget.CekBox();
        ChkKulturUrin = new id.yaski.simrskhanza.widget.CekBox();
        ChkLaborat = new id.yaski.simrskhanza.widget.CekBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AntiHCV;
    private id.yaski.simrskhanza.widget.TextBox AsalRuangan;
    private id.yaski.simrskhanza.widget.TextBox AsamUrat;
    private id.yaski.simrskhanza.widget.ComboBox Ascites;
    private id.yaski.simrskhanza.widget.TextBox BB;
    private id.yaski.simrskhanza.widget.ComboBox BatuSaluranKemih;
    private id.yaski.simrskhanza.widget.ComboBox BengkakSeluruhTubuh;
    private id.yaski.simrskhanza.widget.ComboBox Bising;
    ...
    private id.yaski.simrskhanza.widget.ComboBox CAPD;
    private id.yaski.simrskhanza.widget.TextBox CCT;
    private id.yaski.simrskhanza.widget.TextBox CT;
    private id.yaski.simrskhanza.widget.CekBox ChkArteriografi;
    private id.yaski.simrskhanza.widget.CekBox ChkBNO;
    private id.yaski.simrskhanza.widget.CekBox ChkBiopsiGinjal;
    private id.yaski.simrskhanza.widget.CekBox ChkCTScan;
    private id.yaski.simrskhanza.widget.CekBox ChkEKG;
    private id.yaski.simrskhanza.widget.CekBox ChkKulturUrin;
    private id.yaski.simrskhanza.widget.CekBox ChkLaborat;
    private id.yaski.simrskhanza.widget.CekBox ChkRenogram;
    private id.yaski.simrskhanza.widget.CekBox ChkThorax;
    private id.yaski.simrskhanza.widget.CekBox ChkUSG;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari1;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari2;
    private id.yaski.simrskhanza.widget.ComboBox DiabetesMelitus;
    ...
    private id.yaski.simrskhanza.widget.TextBox Hematokrit;
    private id.yaski.simrskhanza.widget.TextBox Hemoglobin;
    private id.yaski.simrskhanza.widget.ComboBox Hepatomegali;
    private id.yaski.simrskhanza.widget.ComboBox Hipertensi;
    private id.yaski.simrskhanza.widget.TextBox HitungJenis;
    private id.yaski.simrskhanza.widget.TextBox Hubungan;
    private id.yaski.simrskhanza.widget.ComboBox Ikterik;
    private id.yaski.simrskhanza.widget.ComboBox InfeksiSaluranKemih;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.ComboBox Kardiomegali;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganBatuSaluranKemih;
    private id.yaski.simrskhanza.widget.TextBox KeteranganBengkakSeluruhTubuh;
    private id.yaski.simrskhanza.widget.TextBox KeteranganDiabetesMelitus;
    private id.yaski.simrskhanza.widget.TextBox KeteranganHipertensi;
    private id.yaski.simrskhanza.widget.TextBox KeteranganInfeksiSaluranKemih;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKonsumsiObatNefrotoksis;
    private id.yaski.simrskhanza.widget.TextBox KeteranganOperasiSaluranKemih;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPenyakitGinjalLaom;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPenyakitLain;
    private id.yaski.simrskhanza.widget.TextBox KeteranganUrinBerdarah;
    private id.yaski.simrskhanza.widget.ComboBox Konjungtiva;
    private id.yaski.simrskhanza.widget.ComboBox KonsumsiObatNefrotoksis;
    private id.yaski.simrskhanza.widget.TextBox Kreatinin;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Leukosit;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.TextBox Nadi;
    private id.yaski.simrskhanza.widget.TextBox Napas;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.ComboBox Nyeri;
    private id.yaski.simrskhanza.widget.ComboBox OperasiSaluranKemih;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitGinjalLaom;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitLain;
    private id.yaski.simrskhanza.widget.ComboBox Ronchi;
    private id.yaski.simrskhanza.widget.TextBox SGOT;
    private id.yaski.simrskhanza.widget.TextBox SGPT;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox Splenomegali;
    private id.yaski.simrskhanza.widget.TextBox StatusNutrisi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TekananVenaJugularis;
    private id.yaski.simrskhanza.widget.Tanggal TglArteriografi;
    private id.yaski.simrskhanza.widget.Tanggal TglAsuhan;
    private id.yaski.simrskhanza.widget.Tanggal TglBNO;
    private id.yaski.simrskhanza.widget.Tanggal TglBiopsi;
    private id.yaski.simrskhanza.widget.Tanggal TglCAPD;
    private id.yaski.simrskhanza.widget.Tanggal TglCTscan;
    private id.yaski.simrskhanza.widget.Tanggal TglDialisis;
    private id.yaski.simrskhanza.widget.Tanggal TglEKG;
    private id.yaski.simrskhanza.widget.Tanggal TglKultururin;
    private id.yaski.simrskhanza.widget.Tanggal TglLaboratorium;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.Tanggal TglRenogram;
    private id.yaski.simrskhanza.widget.Tanggal TglThorax;
    private id.yaski.simrskhanza.widget.Tanggal TglTransplantasi;
    private id.yaski.simrskhanza.widget.Tanggal TglUSG;
    private id.yaski.simrskhanza.widget.ComboBox Transplantasi;
    private id.yaski.simrskhanza.widget.TextBox Trombosit;
    private id.yaski.simrskhanza.widget.TextBox Ureum;
    private id.yaski.simrskhanza.widget.ComboBox UrinBerdarah;
    private id.yaski.simrskhanza.widget.TextBox UrinLengkap;
    private id.yaski.simrskhanza.widget.ComboBox Whezzing;

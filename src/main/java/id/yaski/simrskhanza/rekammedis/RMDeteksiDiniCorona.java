...
import id.yaski.simrskhanza.simrskhanza.DlgRujuk;
...
public class RMDeteksiDiniCorona extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        A1 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        RiwayatSakitSebelumnya = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoHP = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AsalDaerah = new id.yaski.simrskhanza.widget.TextBox();
        ...
        B1 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel33 = new id.yaski.simrskhanza.widget.Label();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        RiwayatPeriksaSebelumnya = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        TglKedatangan = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        B2e = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel49 = new id.yaski.simrskhanza.widget.Label();
        B2a = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        HasilRadiologi = new id.yaski.simrskhanza.widget.TextArea();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox A1;
    private id.yaski.simrskhanza.widget.ComboBox A2;
    private id.yaski.simrskhanza.widget.ComboBox A3;
    private id.yaski.simrskhanza.widget.TextBox Alamat;
    private id.yaski.simrskhanza.widget.TextBox AsalDaerah;
    private id.yaski.simrskhanza.widget.ComboBox B1;
    private id.yaski.simrskhanza.widget.ComboBox B2a;
    private id.yaski.simrskhanza.widget.ComboBox B2b;
    private id.yaski.simrskhanza.widget.ComboBox B2c;
    private id.yaski.simrskhanza.widget.ComboBox B2d;
    private id.yaski.simrskhanza.widget.ComboBox B2e;
    ...
    private id.yaski.simrskhanza.widget.TextArea HasilRadiologi;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.ComboBox Kesimpulan;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoHP;
    ...
    private id.yaski.simrskhanza.widget.TextBox RiwayatPeriksaSebelumnya;
    private id.yaski.simrskhanza.widget.TextBox RiwayatSakitSebelumnya;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.Tanggal TglGejala;
    private id.yaski.simrskhanza.widget.Tanggal TglKedatangan;

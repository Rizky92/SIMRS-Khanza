...
public final class RMPenilaianLanjutanRisikoJatuhGeriatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        HasilSkrining = new id.yaski.simrskhanza.widget.TextArea();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Saran = new id.yaski.simrskhanza.widget.TextArea();
        ...
        SkalaResiko8 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel250 = new id.yaski.simrskhanza.widget.Label();
        NilaiResiko8 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SkalaResiko9 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel254 = new id.yaski.simrskhanza.widget.Label();
        NilaiResiko9 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SkalaResiko10 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel258 = new id.yaski.simrskhanza.widget.Label();
        NilaiResiko10 = new id.yaski.simrskhanza.widget.TextBox();
        NilaiResiko11 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel259 = new id.yaski.simrskhanza.widget.Label();
        SkalaResiko11 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea HasilSkrining;
    ...
    private id.yaski.simrskhanza.widget.TextBox NilaiResiko10;
    private id.yaski.simrskhanza.widget.TextBox NilaiResiko11;
    ...
    private id.yaski.simrskhanza.widget.TextBox NilaiResiko8;
    private id.yaski.simrskhanza.widget.TextBox NilaiResiko9;
    private id.yaski.simrskhanza.widget.TextBox NilaiResikoTotal;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextArea Saran;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SkalaResiko1;
    private id.yaski.simrskhanza.widget.ComboBox SkalaResiko10;
    private id.yaski.simrskhanza.widget.ComboBox SkalaResiko11;
    ...
    private id.yaski.simrskhanza.widget.ComboBox SkalaResiko8;
    private id.yaski.simrskhanza.widget.ComboBox SkalaResiko9;

...
public final class RMSkriningKesehatanGigiMulutRemaja extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PernahPemeriksaanGigi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        JumlahGigiTumbuh = new id.yaski.simrskhanza.widget.ComboBox();
        KebersihanGigiMulut = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        GigiBerlubang = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        GusiBerdarah = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        GigiTidakteratur = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        jLabel95 = new id.yaski.simrskhanza.widget.Label();
        KebiasaanMenyikatGigi = new id.yaski.simrskhanza.widget.ComboBox();
        PunyaSariawan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox GigiBerlubang;
    private id.yaski.simrskhanza.widget.ComboBox GigiTidakteratur;
    private id.yaski.simrskhanza.widget.ComboBox GusiBerdarah;
    ...
    private id.yaski.simrskhanza.widget.ComboBox JumlahGigiTumbuh;
    private id.yaski.simrskhanza.widget.ComboBox KarangGigi;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.ComboBox KebersihanGigiMulut;
    private id.yaski.simrskhanza.widget.ComboBox KebiasaanMenyikatGigi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PernahPemeriksaanGigi;
    private id.yaski.simrskhanza.widget.ComboBox PunyaSariawan;

...
public final class RMSignInSebelumAnastesi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ResikoKehilanganDarah = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        JalurIVLine = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AntisipasiResikoAspirasi = new id.yaski.simrskhanza.widget.TextBox();
        ResikoAspirasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        RencanaAntisipasiKehilanganDarah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel59 = new id.yaski.simrskhanza.widget.Label();
        KesiapanAlatAnes = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        RencanaAntisipasiKesiapanAlat = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AntisipasiResikoAspirasi;
    ...
    private id.yaski.simrskhanza.widget.TextBox JalurIVLine;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasOK;
    private id.yaski.simrskhanza.widget.ComboBox KesiapanAlatAnes;
    ...
    private id.yaski.simrskhanza.widget.TextBox RencanaAntisipasiKehilanganDarah;
    private id.yaski.simrskhanza.widget.TextBox RencanaAntisipasiKesiapanAlat;
    private id.yaski.simrskhanza.widget.ComboBox ResikoAspirasi;
    private id.yaski.simrskhanza.widget.ComboBox ResikoKehilanganDarah;

...
public final class RMHasilPemeriksaanEchoPediatrik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Situs = new id.yaski.simrskhanza.widget.TextBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        Pulmonal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        AVVA = new id.yaski.simrskhanza.widget.TextBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        SeptumAtrium = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        Tricuspid = new id.yaski.simrskhanza.widget.TextBox();
        ...
        RuangJantung = new id.yaski.simrskhanza.widget.TextBox();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        Drainase = new id.yaski.simrskhanza.widget.TextBox();
        Dopler = new id.yaski.simrskhanza.widget.TextBox();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        KirimanDari = new id.yaski.simrskhanza.widget.TextBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        DiagnosaKlinis = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Mitral = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Aorta = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SeptumVentrikal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        ArkusAorta = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Saran = new id.yaski.simrskhanza.widget.TextBox();
        ...
        FormPass3 = new id.yaski.simrskhanza.widget.PanelBiasa();
        btnAmbil = new id.yaski.simrskhanza.widget.Button();
        BtnRefreshPhoto1 = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AVVA;
    private id.yaski.simrskhanza.widget.TextBox Aorta;
    private id.yaski.simrskhanza.widget.TextBox ArkusAorta;
    ...
    private id.yaski.simrskhanza.widget.Button BtnRefreshPhoto1;
    ...
    private id.yaski.simrskhanza.widget.TextBox DiagnosaKlinis;
    private id.yaski.simrskhanza.widget.TextBox Dopler;
    private id.yaski.simrskhanza.widget.TextBox Drainase;
    private id.yaski.simrskhanza.widget.TextBox EjectionFraction;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.PanelBiasa FormOrthan;
    private id.yaski.simrskhanza.widget.PanelBiasa FormPass3;
    private id.yaski.simrskhanza.widget.PanelBiasa FormPhoto;
    private id.yaski.simrskhanza.widget.TextBox FractionShotening;
    private id.yaski.simrskhanza.widget.TextBox IVDS;
    private id.yaski.simrskhanza.widget.TextBox IVSS;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextArea Kesimpulan;
    private id.yaski.simrskhanza.widget.TextBox KirimanDari;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LVIDdextra;
    private id.yaski.simrskhanza.widget.TextBox LVIDsinistra;
    private id.yaski.simrskhanza.widget.TextBox LVPWdextra;
    private id.yaski.simrskhanza.widget.TextBox LVPWsinistra;
    ...
    private id.yaski.simrskhanza.widget.TextBox Mitral;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.PanelBiasa PanelAccor;
    private id.yaski.simrskhanza.widget.TextBox Pulmonal;
    private id.yaski.simrskhanza.widget.TextBox RuangJantung;
    private id.yaski.simrskhanza.widget.TextBox Saran;
    ...
    private id.yaski.simrskhanza.widget.TextBox SeptumAtrium;
    private id.yaski.simrskhanza.widget.TextBox SeptumVentrikal;
    private id.yaski.simrskhanza.widget.TextBox Situs;
    ...
    private id.yaski.simrskhanza.widget.TextBox Tricuspid;
    private id.yaski.simrskhanza.widget.Button btnAmbil;

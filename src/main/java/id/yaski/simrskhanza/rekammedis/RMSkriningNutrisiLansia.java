...
public final class RMSkriningNutrisiLansia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TBPB = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Nilai1 = new id.yaski.simrskhanza.widget.TextBox();
        Nilai2 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Nilai3 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel71 = new id.yaski.simrskhanza.widget.Label();
        Nilai4 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SG6 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel72 = new id.yaski.simrskhanza.widget.Label();
        Nilai5 = new id.yaski.simrskhanza.widget.TextBox();
        R1 = new id.yaski.simrskhanza.widget.RadioButton();
        SG5 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel74 = new id.yaski.simrskhanza.widget.Label();
        Nilai6 = new id.yaski.simrskhanza.widget.TextBox();
        Nilai7 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel76 = new id.yaski.simrskhanza.widget.Label();
        SG7 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        LabelSkrining = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Label LabelSkrining;
    ...
    private id.yaski.simrskhanza.widget.TextBox Nilai1;
    private id.yaski.simrskhanza.widget.TextBox Nilai2;
    private id.yaski.simrskhanza.widget.TextBox Nilai3;
    private id.yaski.simrskhanza.widget.TextBox Nilai4;
    private id.yaski.simrskhanza.widget.TextBox Nilai5;
    private id.yaski.simrskhanza.widget.TextBox Nilai6;
    private id.yaski.simrskhanza.widget.TextBox Nilai7;
    ...
    private id.yaski.simrskhanza.widget.ComboBox SG5;
    private id.yaski.simrskhanza.widget.ComboBox SG6;
    private id.yaski.simrskhanza.widget.ComboBox SG7;
    ...
    private id.yaski.simrskhanza.widget.TextBox TBPB;

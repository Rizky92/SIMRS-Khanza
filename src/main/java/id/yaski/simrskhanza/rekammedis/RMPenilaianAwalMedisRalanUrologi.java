...
public final class RMPenilaianAwalMedisRalanUrologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KeteranganThoraks = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Darah = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Diagnosis2 = new id.yaski.simrskhanza.widget.TextArea();
        ...
        RiwayatOperasiUrologi = new id.yaski.simrskhanza.widget.TextArea();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        scrollPane3 = new id.yaski.simrskhanza.widget.ScrollPane();
        RiwayatKebiasaan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel50 = new id.yaski.simrskhanza.widget.Label();
        NyeriKetokCVA = new id.yaski.simrskhanza.widget.TextBox();
        GenitaliaEksternal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        jLabel52 = new id.yaski.simrskhanza.widget.Label();
        ColokDubur = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PenunjangLainnya = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox ColokDubur;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari1;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari2;
    private id.yaski.simrskhanza.widget.TextArea Darah;
    private id.yaski.simrskhanza.widget.TextArea Diagnosis;
    private id.yaski.simrskhanza.widget.TextArea Diagnosis2;
    ...
    private id.yaski.simrskhanza.widget.TextBox GenitaliaEksternal;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganThoraks;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextArea Lainnya;
    ...
    private id.yaski.simrskhanza.widget.TextBox NyeriKetokCVA;
    private id.yaski.simrskhanza.widget.TextArea PenunjangLainnya;
    ...
    private id.yaski.simrskhanza.widget.TextArea RiwayatKebiasaan;
    private id.yaski.simrskhanza.widget.TextArea RiwayatOperasiUrologi;
    ...
    private id.yaski.simrskhanza.widget.TextArea USGUrologi;
    private id.yaski.simrskhanza.widget.TextArea Urinalisis;

...
public final class RMSkriningTBC extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PernahTerdiagnosaTBC = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PernahberobatTBC = new id.yaski.simrskhanza.widget.ComboBox();
        Malnutrisi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Odhiv = new id.yaski.simrskhanza.widget.ComboBox();
        RiwayatDM = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KesimpulanHasilSkrining = new id.yaski.simrskhanza.widget.TextBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        jLabel93 = new id.yaski.simrskhanza.widget.Label();
        KetHasilSkrining = new id.yaski.simrskhanza.widget.TextBox();
        ...
        RiwayatKontakTBC = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel95 = new id.yaski.simrskhanza.widget.Label();
        JenisKontakTBC = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AbnormalitasTBC;
    private id.yaski.simrskhanza.widget.TextBox BB;
    private id.yaski.simrskhanza.widget.ComboBox BBTurun;
    private id.yaski.simrskhanza.widget.ComboBox Batuk;
    private id.yaski.simrskhanza.widget.ComboBox BerkeringatMalam;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Demam;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Ibuhamil;
    private id.yaski.simrskhanza.widget.ComboBox Jam;
    private id.yaski.simrskhanza.widget.ComboBox JenisKontakTBC;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.TextBox KesimpulanHasilSkrining;
    private id.yaski.simrskhanza.widget.TextBox KetGejalaPenyakit;
    private id.yaski.simrskhanza.widget.TextBox KetHasilSkrining;
    private id.yaski.simrskhanza.widget.TextBox KetPernahTerdiagnosa;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Lansia;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox Malnutrisi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Odhiv;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PernahTerdiagnosaTBC;
    private id.yaski.simrskhanza.widget.ComboBox PernahberobatTBC;
    private id.yaski.simrskhanza.widget.TextBox RisikoLP;
    private id.yaski.simrskhanza.widget.ComboBox RiwayatDM;
    private id.yaski.simrskhanza.widget.ComboBox RiwayatKontakTBC;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Tingaldiwilayahkumuh;
    private id.yaski.simrskhanza.widget.ComboBox WargaBinaan;

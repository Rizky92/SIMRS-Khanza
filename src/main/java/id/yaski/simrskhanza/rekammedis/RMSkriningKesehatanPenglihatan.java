...
public final class RMSkriningKesehatanPenglihatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MataLuar = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TajamKiri = new id.yaski.simrskhanza.widget.ComboBox();
        TajamKanan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        ButaWarnaKiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel89 = new id.yaski.simrskhanza.widget.Label();
        ButaWarnaKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel82 = new id.yaski.simrskhanza.widget.Label();
        jLabel83 = new id.yaski.simrskhanza.widget.Label();
        Kacamata = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        RefraksiKiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        RefraksiKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel92 = new id.yaski.simrskhanza.widget.Label();
        RujukRefraksi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        VisusKiri = new id.yaski.simrskhanza.widget.ComboBox();
        VisusKanan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KatarakKiri = new id.yaski.simrskhanza.widget.ComboBox();
        KatarakKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel102 = new id.yaski.simrskhanza.widget.Label();
        RujukKatarak = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox ButaWarnaKanan;
    private id.yaski.simrskhanza.widget.ComboBox ButaWarnaKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kacamata;
    private id.yaski.simrskhanza.widget.ComboBox KatarakKanan;
    private id.yaski.simrskhanza.widget.ComboBox KatarakKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MataLuar;
    ...
    private id.yaski.simrskhanza.widget.ComboBox RefraksiKanan;
    private id.yaski.simrskhanza.widget.ComboBox RefraksiKiri;
    private id.yaski.simrskhanza.widget.ComboBox RujukKatarak;
    private id.yaski.simrskhanza.widget.ComboBox RujukRefraksi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TajamKanan;
    private id.yaski.simrskhanza.widget.ComboBox TajamKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox VisusKanan;
    private id.yaski.simrskhanza.widget.ComboBox VisusKiri;

...
public final class RMPerencanaanPemulangan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TinggalSendiri = new id.yaski.simrskhanza.widget.ComboBox();
        RencanaPemulangan = new id.yaski.simrskhanza.widget.Tanggal();
        jSeparator1 = new javax.swing.JSeparator();
        KeteranganTinggalSendiri = new id.yaski.simrskhanza.widget.TextBox();
        ...
        SaksiKeluarga = new id.yaski.simrskhanza.widget.TextBox();
        MasukDirawat = new id.yaski.simrskhanza.widget.TextBox();
        label12 = new id.yaski.simrskhanza.widget.Label();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        DiagnosaMedis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        AlasanMasuk = new id.yaski.simrskhanza.widget.TextBox();
        jLabel53 = new id.yaski.simrskhanza.widget.Label();
        jLabel43 = new id.yaski.simrskhanza.widget.Label();
        KeteranganPengaruhRIKeluarga = new id.yaski.simrskhanza.widget.TextBox();
        PengaruhRIKeluarga = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel44 = new id.yaski.simrskhanza.widget.Label();
        PengaruhRIPekerjaanSekolah = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPengaruhRIPekerjaanSekolah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        PengaruhRIKeuangan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPengaruhRIKeuangan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        AntisipasiMasalah = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAntisipasiMasalah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        BantuanDiperlukan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganBantuanDiperlukan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        YangMembantuKeperluan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganYangMembantuKeperluan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        jLabel58 = new id.yaski.simrskhanza.widget.Label();
        PeralatanMedis = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPeralatanMedis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel59 = new id.yaski.simrskhanza.widget.Label();
        AlatBantu = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAlatBantu = new id.yaski.simrskhanza.widget.TextBox();
        jLabel60 = new id.yaski.simrskhanza.widget.Label();
        PerawatanKhusus = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPerawatanKhusus = new id.yaski.simrskhanza.widget.TextBox();
        jLabel61 = new id.yaski.simrskhanza.widget.Label();
        MemenuhiKebutuhan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganMemenuhiKebutuhan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel62 = new id.yaski.simrskhanza.widget.Label();
        NyeriKronis = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganNyeriKronis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel63 = new id.yaski.simrskhanza.widget.Label();
        EdukasiPasien = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganEdukasiPasien = new id.yaski.simrskhanza.widget.TextBox();
        jLabel64 = new id.yaski.simrskhanza.widget.Label();
        KeterampilanKhusus = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganKeterampilanKhusus = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AlasanMasuk;
    private id.yaski.simrskhanza.widget.ComboBox AlatBantu;
    private id.yaski.simrskhanza.widget.ComboBox AntisipasiMasalah;
    private id.yaski.simrskhanza.widget.ComboBox BantuanDiperlukan;
    ...
    private id.yaski.simrskhanza.widget.TextBox DiagnosaMedis;
    private id.yaski.simrskhanza.widget.ComboBox EdukasiPasien;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KeterampilanKhusus;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAlatBantu;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAntisipasiMasalah;
    private id.yaski.simrskhanza.widget.TextBox KeteranganBantuanDiperlukan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganEdukasiPasien;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKeterampilanKhusus;
    private id.yaski.simrskhanza.widget.TextBox KeteranganMemenuhiKebutuhan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganNyeriKronis;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPengaruhRIKeluarga;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPengaruhRIKeuangan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPengaruhRIPekerjaanSekolah;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPeralatanMedis;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPerawatanKhusus;
    private id.yaski.simrskhanza.widget.TextBox KeteranganTinggalSendiri;
    private id.yaski.simrskhanza.widget.TextBox KeteranganYangMembantuKeperluan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML2;
    private id.yaski.simrskhanza.widget.TextBox MasukDirawat;
    private id.yaski.simrskhanza.widget.ComboBox MemenuhiKebutuhan;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.ComboBox NyeriKronis;
    private id.yaski.simrskhanza.widget.PanelBiasa PanelAccor;
    private id.yaski.simrskhanza.widget.ComboBox PengaruhRIKeluarga;
    private id.yaski.simrskhanza.widget.ComboBox PengaruhRIKeuangan;
    private id.yaski.simrskhanza.widget.ComboBox PengaruhRIPekerjaanSekolah;
    private id.yaski.simrskhanza.widget.ComboBox PeralatanMedis;
    private id.yaski.simrskhanza.widget.ComboBox PerawatanKhusus;
    private id.yaski.simrskhanza.widget.Tanggal RencanaPemulangan;
    private id.yaski.simrskhanza.widget.TextBox SaksiKeluarga;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TinggalSendiri;
    private id.yaski.simrskhanza.widget.ComboBox YangMembantuKeperluan;

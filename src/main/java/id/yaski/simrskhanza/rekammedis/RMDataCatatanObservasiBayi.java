...
public final class RMDataCatatanObservasiBayi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelRetraksi = new id.yaski.simrskhanza.widget.Label();
        RetraksiDada = new id.yaski.simrskhanza.widget.TextBox();
        jLabelOgt = new id.yaski.simrskhanza.widget.Label();
        OGTResidu = new id.yaski.simrskhanza.widget.TextBox();
        jLabelNch = new id.yaski.simrskhanza.widget.Label();
        NCH = new id.yaski.simrskhanza.widget.TextBox();
        jLabelAsi = new id.yaski.simrskhanza.widget.Label();
        AsiJumlah = new id.yaski.simrskhanza.widget.TextBox();
        jLabelPasi = new id.yaski.simrskhanza.widget.Label();
        PasiJumlah = new id.yaski.simrskhanza.widget.TextBox();
        IkterikStatus = new id.yaski.simrskhanza.widget.TextBox();
        jLabelIkterik = new id.yaski.simrskhanza.widget.Label();
        BabStatus = new id.yaski.simrskhanza.widget.TextBox();
        jLabelBab = new id.yaski.simrskhanza.widget.Label();
        BakStatus = new id.yaski.simrskhanza.widget.TextBox();
        jLabelBak = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AsiJumlah;
    private id.yaski.simrskhanza.widget.TextBox BabStatus;
    private id.yaski.simrskhanza.widget.TextBox BakStatus;
    ...
    private id.yaski.simrskhanza.widget.TextBox IkterikStatus;
    ...
    private id.yaski.simrskhanza.widget.TextBox NCH;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.TextBox OGTResidu;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox PasiJumlah;
    private id.yaski.simrskhanza.widget.TextBox RR;
    private id.yaski.simrskhanza.widget.TextBox RetraksiDada;
    ...
    private id.yaski.simrskhanza.widget.Label jLabelAsi;
    private id.yaski.simrskhanza.widget.Label jLabelBab;
    private id.yaski.simrskhanza.widget.Label jLabelBak;
    private id.yaski.simrskhanza.widget.Label jLabelIkterik;
    private id.yaski.simrskhanza.widget.Label jLabelNch;
    private id.yaski.simrskhanza.widget.Label jLabelOgt;
    private id.yaski.simrskhanza.widget.Label jLabelPasi;
    private id.yaski.simrskhanza.widget.Label jLabelRetraksi;

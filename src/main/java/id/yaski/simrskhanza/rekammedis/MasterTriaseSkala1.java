...
public class MasterTriaseSkala1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kdskala = new id.yaski.simrskhanza.widget.TextBox();
        namaskala = new id.yaski.simrskhanza.widget.TextBox();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        kdpemeriksaan = new id.yaski.simrskhanza.widget.TextBox();
        nmpemeriksaan = new id.yaski.simrskhanza.widget.TextBox();
        btnPemeriksaan = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button btnPemeriksaan;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdpemeriksaan;
    private id.yaski.simrskhanza.widget.TextBox kdskala;
    private id.yaski.simrskhanza.widget.TextBox namaskala;
    private id.yaski.simrskhanza.widget.TextBox nmpemeriksaan;

...
public final class RMPenilaianPsikologi extends javax.swing.JDialog {
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Bentuktubuh;
    private id.yaski.simrskhanza.widget.ComboBox Berbicara;
    ...
    private id.yaski.simrskhanza.widget.TextArea Ciriyangmenyolok;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Ekspresi;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextArea Hasilpsikotes;
    ...
    private id.yaski.simrskhanza.widget.TextArea Kepribadian;
    private id.yaski.simrskhanza.widget.TextArea Kesimpulanpsikolog;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Pakaian;
    private id.yaski.simrskhanza.widget.ComboBox Penggunaankata;
    private id.yaski.simrskhanza.widget.TextArea Psikodinamika;
    private id.yaski.simrskhanza.widget.ComboBox Rupa;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Tindakan;

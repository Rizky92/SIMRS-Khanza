...
public final class RMPenilaianAwalMedisRalanGeriatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KondisiUmum = new id.yaski.simrskhanza.widget.TextArea();
        PosturTulang = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KeteranganEkstremitas = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Kognitif = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        IntegumentKebersihan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        IntegumentWarna = new id.yaski.simrskhanza.widget.ComboBox();
        IntegumentGangguan = new id.yaski.simrskhanza.widget.ComboBox();
        IntegumentKelembaban = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KondisiSosial = new id.yaski.simrskhanza.widget.TextArea();
        jLabel59 = new id.yaski.simrskhanza.widget.Label();
        Fungsional = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel60 = new id.yaski.simrskhanza.widget.Label();
        RisikoJatuh = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PenunjangLain = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane10 = new id.yaski.simrskhanza.widget.ScrollPane();
        Rad = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane9 = new id.yaski.simrskhanza.widget.ScrollPane();
        Lab = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Fungsional;
    private id.yaski.simrskhanza.widget.TextBox Hubungan;
    private id.yaski.simrskhanza.widget.ComboBox IntegumentGangguan;
    private id.yaski.simrskhanza.widget.ComboBox IntegumentKebersihan;
    private id.yaski.simrskhanza.widget.ComboBox IntegumentKelembaban;
    private id.yaski.simrskhanza.widget.ComboBox IntegumentWarna;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganEkstremitas;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kognitif;
    private id.yaski.simrskhanza.widget.TextArea KondisiSosial;
    private id.yaski.simrskhanza.widget.TextArea KondisiUmum;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextArea Lab;
    ...
    private id.yaski.simrskhanza.widget.TextArea PenunjangLain;
    private id.yaski.simrskhanza.widget.TextArea Permasalahan;
    private id.yaski.simrskhanza.widget.ComboBox PosturTulang;
    ...
    private id.yaski.simrskhanza.widget.TextArea Rad;
    private id.yaski.simrskhanza.widget.ComboBox RisikoJatuh;

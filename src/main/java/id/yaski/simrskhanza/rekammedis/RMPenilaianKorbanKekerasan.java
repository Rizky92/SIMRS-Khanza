...
public final class RMPenilaianKorbanKekerasan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PemicuKekerasan = new id.yaski.simrskhanza.widget.TextBox();
        SeberapaSeringPenganiayaan = new id.yaski.simrskhanza.widget.TextBox();
        Anamnesis = new id.yaski.simrskhanza.widget.ComboBox();
        scrollPane1 = new id.yaski.simrskhanza.widget.ScrollPane();
        KekerasanYangDialami = new id.yaski.simrskhanza.widget.TextArea();
        jLabel28 = new id.yaski.simrskhanza.widget.Label();
        JumlahSaudara = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KondisiKeluargaInti = new id.yaski.simrskhanza.widget.ComboBox();
        PeriodeKekerasan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        HubunganOrangTerdekat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        TempatKejadian = new id.yaski.simrskhanza.widget.TextBox();
        LamaKekerasan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        MemerlukanPendampingan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PemeriksaanKepala = new id.yaski.simrskhanza.widget.TextBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanThoraks = new id.yaski.simrskhanza.widget.TextBox();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanLeher = new id.yaski.simrskhanza.widget.TextBox();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanAbdomen = new id.yaski.simrskhanza.widget.TextBox();
        jLabel47 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanGenitalia = new id.yaski.simrskhanza.widget.TextBox();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanEkstrimitasAtas = new id.yaski.simrskhanza.widget.TextBox();
        jLabel49 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanEkstrimitasBawah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel50 = new id.yaski.simrskhanza.widget.Label();
        PemeriksaanAnus = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea DampakYangTerjadi;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Hubungan;
    private id.yaski.simrskhanza.widget.ComboBox HubunganOrangTerdekat;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox JumlahSaudara;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextArea KekerasanYangDialami;
    private id.yaski.simrskhanza.widget.ComboBox KondisiKeluargaInti;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LamaKekerasan;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox MemerlukanPendampingan;
    ...
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanAbdomen;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanAnus;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanEkstrimitasAtas;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanEkstrimitasBawah;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanGenitalia;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanKepala;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanLeher;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanThoraks;
    private id.yaski.simrskhanza.widget.TextBox PemicuKekerasan;
    private id.yaski.simrskhanza.widget.ComboBox PeriodeKekerasan;
    private id.yaski.simrskhanza.widget.TextBox RiwayatKelainan;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox SeberapaSeringPenganiayaan;
    private id.yaski.simrskhanza.widget.TextBox SiapaYangMelakukanKekerasan;
    ...
    private id.yaski.simrskhanza.widget.TextArea TandaYangDidapatkan;
    private id.yaski.simrskhanza.widget.TextBox TempatKejadian;

...
public final class RMSkriningPneumoniaSeverityIndex extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kelas = new id.yaski.simrskhanza.widget.TextBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        jLabel93 = new id.yaski.simrskhanza.widget.Label();
        SkorInterpretasi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TinggalDiPanti = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TotalSkorPSI = new id.yaski.simrskhanza.widget.TextBox();
        jLabel67 = new id.yaski.simrskhanza.widget.Label();
        Mortalitas = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox BUN;
    ...
    private id.yaski.simrskhanza.widget.ComboBox DisorentasiMental;
    private id.yaski.simrskhanza.widget.ComboBox EfusiPleura;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.ComboBox FrekuensiNapas;
    private id.yaski.simrskhanza.widget.ComboBox GagalJantung;
    private id.yaski.simrskhanza.widget.ComboBox GinjalKronis;
    private id.yaski.simrskhanza.widget.ComboBox Glukosa;
    private id.yaski.simrskhanza.widget.ComboBox Hematokrit;
    private id.yaski.simrskhanza.widget.ComboBox Jam;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.ComboBox KankerNeoplasma;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.TextBox Kelas;
    ...
    private id.yaski.simrskhanza.widget.TextBox Mortalitas;
    private id.yaski.simrskhanza.widget.ComboBox Nadi;
    private id.yaski.simrskhanza.widget.ComboBox Natrium;
    private id.yaski.simrskhanza.widget.TextBox NilaiBUN;
    private id.yaski.simrskhanza.widget.TextBox NilaiDisorentasiMental;
    private id.yaski.simrskhanza.widget.TextBox NilaiEfusiPleura;
    private id.yaski.simrskhanza.widget.TextBox NilaiFrekuensiNapas;
    private id.yaski.simrskhanza.widget.TextBox NilaiGagalJantung;
    private id.yaski.simrskhanza.widget.TextBox NilaiGinjalKronis;
    private id.yaski.simrskhanza.widget.TextBox NilaiGlukosa;
    private id.yaski.simrskhanza.widget.TextBox NilaiHematokrit;
    private id.yaski.simrskhanza.widget.TextBox NilaiKankerNeoplasma;
    private id.yaski.simrskhanza.widget.TextBox NilaiNadi;
    private id.yaski.simrskhanza.widget.TextBox NilaiNatrium;
    private id.yaski.simrskhanza.widget.TextBox NilaiPaO;
    private id.yaski.simrskhanza.widget.TextBox NilaiPenyakitHati;
    private id.yaski.simrskhanza.widget.TextBox NilaiPenyakitSerebrovaskular;
    private id.yaski.simrskhanza.widget.TextBox NilaiSuhu;
    private id.yaski.simrskhanza.widget.TextBox NilaiTDSistolik;
    private id.yaski.simrskhanza.widget.TextBox NilaiTinggalDiPanti;
    private id.yaski.simrskhanza.widget.TextBox NilaiUmur;
    private id.yaski.simrskhanza.widget.TextBox NilaipHDarah;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.ComboBox PaO;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitHati;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitSerebrovaskular;
    private id.yaski.simrskhanza.widget.TextBox Rekomendasi;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox SkorInterpretasi;
    private id.yaski.simrskhanza.widget.ComboBox Suhu;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.ComboBox TDSistolik;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TinggalDiPanti;
    private id.yaski.simrskhanza.widget.TextBox TotalSkorPSI;
    ...
    private id.yaski.simrskhanza.widget.ComboBox pHDarah;

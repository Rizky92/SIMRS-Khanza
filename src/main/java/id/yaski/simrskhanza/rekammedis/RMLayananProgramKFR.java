...
public final class RMLayananProgramKFR extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PermintaanTerapi = new id.yaski.simrskhanza.widget.TextArea();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        Program = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea PermintaanTerapi;
    private id.yaski.simrskhanza.widget.TextBox Program;

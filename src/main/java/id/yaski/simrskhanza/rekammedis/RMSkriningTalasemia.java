...
public final class RMSkriningTalasemia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TransfusiDarah = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        SaudaraTalasemia = new id.yaski.simrskhanza.widget.ComboBox();
        RutinTransfusi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel81 = new id.yaski.simrskhanza.widget.Label();
        jLabel96 = new id.yaski.simrskhanza.widget.Label();
        TumbangTerlambat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel102 = new id.yaski.simrskhanza.widget.Label();
        Anemia = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel103 = new id.yaski.simrskhanza.widget.Label();
        jLabel106 = new id.yaski.simrskhanza.widget.Label();
        Icterus = new id.yaski.simrskhanza.widget.ComboBox();
        FaciesCooley = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel109 = new id.yaski.simrskhanza.widget.Label();
        jLabel112 = new id.yaski.simrskhanza.widget.Label();
        PerutBuncit = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel115 = new id.yaski.simrskhanza.widget.Label();
        GiziKurang = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel118 = new id.yaski.simrskhanza.widget.Label();
        Pendek = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel121 = new id.yaski.simrskhanza.widget.Label();
        Hiperpigmentasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel123 = new id.yaski.simrskhanza.widget.Label();
        Hb = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel125 = new id.yaski.simrskhanza.widget.Label();
        jLabel128 = new id.yaski.simrskhanza.widget.Label();
        MVC = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel131 = new id.yaski.simrskhanza.widget.Label();
        MCHC = new id.yaski.simrskhanza.widget.ComboBox();
        DarahTepi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel137 = new id.yaski.simrskhanza.widget.Label();
        TindakLanjut = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Anemia;
    ...
    private id.yaski.simrskhanza.widget.ComboBox DarahTepi;
    private id.yaski.simrskhanza.widget.ComboBox Detik;
    private id.yaski.simrskhanza.widget.ComboBox FaciesCooley;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.ComboBox GiziKurang;
    private id.yaski.simrskhanza.widget.ComboBox Hb;
    private id.yaski.simrskhanza.widget.ComboBox Hiperpigmentasi;
    private id.yaski.simrskhanza.widget.ComboBox Icterus;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MCHC;
    private id.yaski.simrskhanza.widget.ComboBox MVC;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Pendek;
    private id.yaski.simrskhanza.widget.ComboBox PerutBuncit;
    private id.yaski.simrskhanza.widget.ComboBox RutinTransfusi;
    private id.yaski.simrskhanza.widget.ComboBox SaudaraTalasemia;
    ...
    private id.yaski.simrskhanza.widget.TextBox TindakLanjut;
    private id.yaski.simrskhanza.widget.ComboBox TransfusiDarah;
    private id.yaski.simrskhanza.widget.ComboBox TumbangTerlambat;

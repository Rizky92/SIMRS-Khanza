...
public final class RMSkriningAnemia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MasalahPubertas = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel87 = new id.yaski.simrskhanza.widget.Label();
        RisikoIMS = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel88 = new id.yaski.simrskhanza.widget.Label();
        KekerasanSeksual = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel89 = new id.yaski.simrskhanza.widget.Label();
        SudahMenstruasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel90 = new id.yaski.simrskhanza.widget.Label();
        GangguanMenstruasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        jLabel92 = new id.yaski.simrskhanza.widget.Label();
        TambahDarah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel93 = new id.yaski.simrskhanza.widget.Label();
        jLabel94 = new id.yaski.simrskhanza.widget.Label();
        KelainanDarah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel95 = new id.yaski.simrskhanza.widget.Label();
        KeluargaThalasemia = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Rambut = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        JenisAnemia = new id.yaski.simrskhanza.widget.TextBox();
        KadarHemo = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox BekasSuntikan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox GangguanMenstruasi;
    private id.yaski.simrskhanza.widget.TextBox HasilSkrining;
    private id.yaski.simrskhanza.widget.ComboBox Jam;
    private id.yaski.simrskhanza.widget.TextBox JenisAnemia;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox KadarHemo;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.ComboBox KekerasanSeksual;
    private id.yaski.simrskhanza.widget.ComboBox KelainanDarah;
    private id.yaski.simrskhanza.widget.ComboBox KeluargaThalasemia;
    private id.yaski.simrskhanza.widget.TextBox Keterangan;
    private id.yaski.simrskhanza.widget.ComboBox KonsumsiBuahSayur;
    private id.yaski.simrskhanza.widget.ComboBox KonsumsiProteinHewani;
    private id.yaski.simrskhanza.widget.ComboBox Kuku;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MasalahPubertas;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private javax.swing.JMenuItem MnSkriningAnemia;
    private id.yaski.simrskhanza.widget.ComboBox MudahLelah;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanHB;
    private id.yaski.simrskhanza.widget.ComboBox Rambut;
    private id.yaski.simrskhanza.widget.ComboBox RisikoIMS;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SudahMenstruasi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TambahDarah;
    private id.yaski.simrskhanza.widget.ComboBox TandaKlinis;

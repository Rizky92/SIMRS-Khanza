...
public final class RMPenilaianFisioterapi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NyeriGerak = new id.yaski.simrskhanza.widget.TextBox();
        NyeriDiam = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        HR = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NyeriTekan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Palpasi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        LuasGerakSendi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel33 = new id.yaski.simrskhanza.widget.Label();
        KekuatanOtot = new id.yaski.simrskhanza.widget.TextBox();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        Statis = new id.yaski.simrskhanza.widget.TextBox();
        Dinamis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        Kognitif = new id.yaski.simrskhanza.widget.TextBox();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        Auskultasi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Deformitas = new id.yaski.simrskhanza.widget.ComboBox();
        KetDeformitas = new id.yaski.simrskhanza.widget.TextBox();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        ResikoJatuh = new id.yaski.simrskhanza.widget.ComboBox();
        KetResikoJatuh = new id.yaski.simrskhanza.widget.TextBox();
        ...
        LainlainFungsioal = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PemeriksaanMuscu = new id.yaski.simrskhanza.widget.TextArea();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        scrollPane5 = new id.yaski.simrskhanza.widget.ScrollPane();
        PemeriksaanNeuro = new id.yaski.simrskhanza.widget.TextArea();
        ...
        PemeriksaanCardio = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane7 = new id.yaski.simrskhanza.widget.ScrollPane();
        PemeriksaanInte = new id.yaski.simrskhanza.widget.TextArea();
        ...
        PengukuranNeuro = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane10 = new id.yaski.simrskhanza.widget.ScrollPane();
        PengukuranMuscu = new id.yaski.simrskhanza.widget.TextArea();
        ...
        PengukuranInte = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane12 = new id.yaski.simrskhanza.widget.ScrollPane();
        PengukuranCardio = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Auskultasi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Deformitas;
    private id.yaski.simrskhanza.widget.TextArea Diagnosis;
    private id.yaski.simrskhanza.widget.TextBox Dinamis;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox HR;
    ...
    private id.yaski.simrskhanza.widget.TextBox KekuatanOtot;
    private id.yaski.simrskhanza.widget.TextArea KeluhanUtama;
    private id.yaski.simrskhanza.widget.TextBox KetBantu;
    private id.yaski.simrskhanza.widget.TextBox KetDeformitas;
    private id.yaski.simrskhanza.widget.TextArea KetFisik;
    private id.yaski.simrskhanza.widget.TextBox KetProthesa;
    private id.yaski.simrskhanza.widget.TextBox KetResikoJatuh;
    private id.yaski.simrskhanza.widget.TextBox Kognitif;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LainlainFungsioal;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.TextBox LuasGerakSendi;
    private javax.swing.JMenuItem MnPenilaianFisio;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.TextBox NyeriDiam;
    private id.yaski.simrskhanza.widget.TextBox NyeriGerak;
    private id.yaski.simrskhanza.widget.TextBox NyeriTekan;
    private id.yaski.simrskhanza.widget.TextBox Palpasi;
    private usu.widget.glass.PanelGlass PanelWall;
    private usu.widget.glass.PanelGlass PanelWall1;
    private id.yaski.simrskhanza.widget.TextArea PemeriksaanCardio;
    private id.yaski.simrskhanza.widget.TextArea PemeriksaanInte;
    private id.yaski.simrskhanza.widget.TextArea PemeriksaanMuscu;
    private id.yaski.simrskhanza.widget.TextArea PemeriksaanNeuro;
    private id.yaski.simrskhanza.widget.TextArea PengukuranCardio;
    private id.yaski.simrskhanza.widget.TextArea PengukuranInte;
    private id.yaski.simrskhanza.widget.TextArea PengukuranMuscu;
    private id.yaski.simrskhanza.widget.TextArea PengukuranNeuro;
    ...
    private id.yaski.simrskhanza.widget.TextBox Statis;

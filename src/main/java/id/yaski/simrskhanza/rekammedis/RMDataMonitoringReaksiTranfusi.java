...
public final class RMDataMonitoringReaksiTranfusi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        JenisDarah = new id.yaski.simrskhanza.widget.TextBox();
        NoKantong = new id.yaski.simrskhanza.widget.TextBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        LokasiInsersi = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox JenisDarah;
    ...
    private id.yaski.simrskhanza.widget.TextBox LokasiInsersi;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoKantong;

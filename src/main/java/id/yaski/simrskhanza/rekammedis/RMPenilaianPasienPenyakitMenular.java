...
public final class RMPenilaianPasienPenyakitMenular extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KeluhanYangDirasakan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        MengetahuiKondisi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KeteranganRiwayatKontak = new id.yaski.simrskhanza.widget.TextBox();
        PenyakitSama = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        RiwayatKontak = new id.yaski.simrskhanza.widget.ComboBox();
        TransmisiPenularan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        KeteranganTransmisiPenularan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        KebutuhanRuangRawat = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        RiwayatPengobatan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        RiwayatVaksin = new id.yaski.simrskhanza.widget.TextBox();
        jLabel43 = new id.yaski.simrskhanza.widget.Label();
        scrollPane4 = new id.yaski.simrskhanza.widget.ScrollPane();
        DiagnosaUtama = new id.yaski.simrskhanza.widget.TextArea();
        ...
        DiagnosaTambahan = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea DiagnosaTambahan;
    private id.yaski.simrskhanza.widget.TextArea DiagnosaUtama;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KebutuhanRuangRawat;
    private id.yaski.simrskhanza.widget.TextArea KeluhanYangDirasakan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganRiwayatKontak;
    private id.yaski.simrskhanza.widget.TextBox KeteranganTransmisiPenularan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox MengetahuiKondisi;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitSama;
    private id.yaski.simrskhanza.widget.TextBox RiwayatAlergi;
    private id.yaski.simrskhanza.widget.ComboBox RiwayatKontak;
    private id.yaski.simrskhanza.widget.TextArea RiwayatPengobatan;
    private id.yaski.simrskhanza.widget.TextArea RiwayatPenyakitKeluarga;
    private id.yaski.simrskhanza.widget.TextBox RiwayatVaksin;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TransmisiPenularan;

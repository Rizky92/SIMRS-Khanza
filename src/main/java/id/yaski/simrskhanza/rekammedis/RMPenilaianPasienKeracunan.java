...
public final class RMPenilaianPasienKeracunan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KeluhanSaatIni = new id.yaski.simrskhanza.widget.TextArea();
        ...
        KeteranganTempatKejadian = new id.yaski.simrskhanza.widget.TextBox();
        TempatKejadian = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        RiwayatPenyakitSatIni = new id.yaski.simrskhanza.widget.TextArea();
        Hamil = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        Menyusui = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Penyebab = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel52 = new id.yaski.simrskhanza.widget.Label();
        jLabel53 = new id.yaski.simrskhanza.widget.Label();
        KeteranganBauBahan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        JumlahBahan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        TipeKejadian = new id.yaski.simrskhanza.widget.ComboBox();
        NamaBahan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        BauBahan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        TipePemaparan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganTipePemaparan = new id.yaski.simrskhanza.widget.TextBox();
        Pupil = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel58 = new id.yaski.simrskhanza.widget.Label();
        KeteranganPupil = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Urine = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PengobatanSebelumIGD = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Diagnosa = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Penatalaksanaan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel61 = new id.yaski.simrskhanza.widget.Label();
        jLabel63 = new id.yaski.simrskhanza.widget.Label();
        TindakLanjut = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox BauBahan;
    ...
    private id.yaski.simrskhanza.widget.TextArea Diagnosa;
    ...
    private id.yaski.simrskhanza.widget.TextBox JumlahBahan;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextArea KeluhanSaatIni;
    private id.yaski.simrskhanza.widget.ComboBox Kesadaran;
    private id.yaski.simrskhanza.widget.TextBox KeteranganBauBahan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPupil;
    private id.yaski.simrskhanza.widget.TextBox KeteranganTempatKejadian;
    private id.yaski.simrskhanza.widget.TextBox KeteranganTipePemaparan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox Menyusui;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.TextBox Nadi;
    private id.yaski.simrskhanza.widget.TextBox NamaBahan;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.TextArea Penatalaksanaan;
    private id.yaski.simrskhanza.widget.TextArea PengobatanSebelumIGD;
    private id.yaski.simrskhanza.widget.TextArea Penunjang;
    private id.yaski.simrskhanza.widget.ComboBox Penyebab;
    private id.yaski.simrskhanza.widget.ComboBox Pupil;
    private id.yaski.simrskhanza.widget.TextBox RR;
    private id.yaski.simrskhanza.widget.TextArea RiwayatPenyakitSatIni;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TempatKejadian;
    private id.yaski.simrskhanza.widget.Tanggal TglAsuhan;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.ComboBox TindakLanjut;
    private id.yaski.simrskhanza.widget.ComboBox TipeKejadian;
    private id.yaski.simrskhanza.widget.ComboBox TipePemaparan;
    private id.yaski.simrskhanza.widget.TextBox Urine;

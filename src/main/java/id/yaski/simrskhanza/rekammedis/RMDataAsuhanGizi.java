...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    private String alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, alergi_ikan, alergi_hazelnut, alergi_ayam,sttsumur="";
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Kacang","Gluten","Udang","Ikan","Hazelnut","Ayam","Pola Makan","Riwayat Personal","Diagnosis Gizi","Intervensi Gizi",
    ...
    private void initComponents() {
        ...
        DiagnosaMasukRanap = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TL = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PolaMakan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TelurYa = new id.yaski.simrskhanza.widget.RadioButton();
        TelurTidak = new id.yaski.simrskhanza.widget.RadioButton();
        SusuTidak = new id.yaski.simrskhanza.widget.RadioButton();
        SusuYa = new id.yaski.simrskhanza.widget.RadioButton();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        KacangYa = new id.yaski.simrskhanza.widget.RadioButton();
        KacangTidak = new id.yaski.simrskhanza.widget.RadioButton();
        jLabel47 = new id.yaski.simrskhanza.widget.Label();
        GlutenYa = new id.yaski.simrskhanza.widget.RadioButton();
        GlutenTidak = new id.yaski.simrskhanza.widget.RadioButton();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        UdangYa = new id.yaski.simrskhanza.widget.RadioButton();
        UdangTidak = new id.yaski.simrskhanza.widget.RadioButton();
        jLabel49 = new id.yaski.simrskhanza.widget.Label();
        IkanYa = new id.yaski.simrskhanza.widget.RadioButton();
        IkanTidak = new id.yaski.simrskhanza.widget.RadioButton();
        HazelnutYa = new id.yaski.simrskhanza.widget.RadioButton();
        HazelnutTidak = new id.yaski.simrskhanza.widget.RadioButton();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        jLabel50 = new id.yaski.simrskhanza.widget.Label();
        RiwayatPersonal = new id.yaski.simrskhanza.widget.TextBox();
        scrollPane1 = new id.yaski.simrskhanza.widget.ScrollPane();
        FisikKlinis = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Biokimia = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane3 = new id.yaski.simrskhanza.widget.ScrollPane();
        Monitoring = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane4 = new id.yaski.simrskhanza.widget.ScrollPane();
        IntervensiGizi = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane5 = new id.yaski.simrskhanza.widget.ScrollPane();
        DiagnosisGizi = new id.yaski.simrskhanza.widget.TextArea();
        jLabel52 = new id.yaski.simrskhanza.widget.Label();
        AyamYa = new id.yaski.simrskhanza.widget.RadioButton();
        AyamTidak = new id.yaski.simrskhanza.widget.RadioButton();
        ...
        jLabel52.setText("Ayam");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(545, 420, 100, 23);

        buttonGroup8.add(AyamYa);
        AyamYa.setText("Ya");
        AyamYa.setName("AyamYa"); // NOI18N
        AyamYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(AyamYa);
        AyamYa.setBounds(650, 420, 45, 23);

        buttonGroup8.add(AyamTidak);
        AyamTidak.setSelected(true);
        AyamTidak.setText("Tidak");
        AyamTidak.setName("AyamTidak"); // NOI18N
        FormInput.add(AyamTidak);
        AyamTidak.setBounds(700, 420, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if (AyamYa.isSelected()) {
                alergi_ayam = "Ya";
            }
            if (Sequel.menyimpantfSmc("asuhan_gizi", null, TNoRw.getText(), Valid.getTglSmc(TglAsuhan), BB.getText(), TB.getText(),
                IMT.getText(), LiLA.getText(), TL.getText(), ULNA.getText(), BBIdeal.getText(), BBPerU.getText(), TBPerU.getText(),
                BBPerTB.getText(), LiLAPerU.getText(), Biokimia.getText(), FisikKlinis.getText(), alergi_telur, alergi_susu_sapi,
                ...
                tabMode.addRow(new Object[] {
                    ...
                    alergi_ikan, alergi_hazelnut, alergi_ayam, PolaMakan.getText(), RiwayatPersonal.getText(), DiagnosisGizi.getText(), IntervensiGizi.getText(), Monitoring.getText(),
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.RadioButton AyamTidak;
    private id.yaski.simrskhanza.widget.RadioButton AyamYa;
    private id.yaski.simrskhanza.widget.TextBox BB;
    private id.yaski.simrskhanza.widget.TextBox BBIdeal;
    private id.yaski.simrskhanza.widget.TextBox BBPerTB;
    private id.yaski.simrskhanza.widget.TextBox BBPerU;
    private id.yaski.simrskhanza.widget.TextArea Biokimia;
    ...
    private id.yaski.simrskhanza.widget.TextBox DiagnosaMasukRanap;
    private id.yaski.simrskhanza.widget.TextArea DiagnosisGizi;
    private id.yaski.simrskhanza.widget.TextArea FisikKlinis;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.RadioButton GlutenTidak;
    private id.yaski.simrskhanza.widget.RadioButton GlutenYa;
    private id.yaski.simrskhanza.widget.RadioButton HazelnutTidak;
    private id.yaski.simrskhanza.widget.RadioButton HazelnutYa;
    private id.yaski.simrskhanza.widget.TextBox IMT;
    private id.yaski.simrskhanza.widget.RadioButton IkanTidak;
    private id.yaski.simrskhanza.widget.RadioButton IkanYa;
    private id.yaski.simrskhanza.widget.TextArea IntervensiGizi;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.RadioButton KacangTidak;
    private id.yaski.simrskhanza.widget.RadioButton KacangYa;
    ...
    private id.yaski.simrskhanza.widget.TextBox LiLAPerU;
    private javax.swing.JMenuItem MnAsuhanGizi;
    private id.yaski.simrskhanza.widget.TextArea Monitoring;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox PolaMakan;
    private id.yaski.simrskhanza.widget.TextBox RiwayatPersonal;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.RadioButton SusuTidak;
    private id.yaski.simrskhanza.widget.RadioButton SusuYa;
    private id.yaski.simrskhanza.widget.TextBox TB;
    private id.yaski.simrskhanza.widget.TextBox TBPerU;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TL;
    ...
    private id.yaski.simrskhanza.widget.RadioButton TelurTidak;
    private id.yaski.simrskhanza.widget.RadioButton TelurYa;
    private id.yaski.simrskhanza.widget.Tanggal TglAsuhan;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.TextBox ULNA;
    private id.yaski.simrskhanza.widget.RadioButton UdangTidak;
    private id.yaski.simrskhanza.widget.RadioButton UdangYa;
    ...
    private void tampil() {
        ...
        try {
            try (PreparedStatement ps = koneksi.prepareStatement(
                "select reg_periksa.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien, pasien.jk, pasien.tgl_lahir, asuhan_gizi.tanggal, " +
                "asuhan_gizi.antropometri_bb, asuhan_gizi.antropometri_tb, asuhan_gizi.antropometri_imt, asuhan_gizi.antropometri_lla, " +
                "asuhan_gizi.antropometri_tl, asuhan_gizi.antropometri_ulna, asuhan_gizi.antropometri_bbideal, asuhan_gizi.antropometri_bbperu, " +
                "asuhan_gizi.antropometri_tbperu, asuhan_gizi.antropometri_bbpertb, asuhan_gizi.antropometri_llaperu, asuhan_gizi.biokimia, " +
                "asuhan_gizi.fisik_klinis, asuhan_gizi.alergi_telur, asuhan_gizi.alergi_susu_sapi, asuhan_gizi.alergi_kacang, asuhan_gizi.alergi_gluten, " +
                "asuhan_gizi.alergi_udang, asuhan_gizi.alergi_ikan, asuhan_gizi.alergi_hazelnut, asuhan_gizi.alergi_ayam, asuhan_gizi.pola_makan, " +
                "asuhan_gizi.riwayat_personal, asuhan_gizi.diagnosis, asuhan_gizi.intervensi_gizi, asuhan_gizi.monitoring_evaluasi, asuhan_gizi.nip, " +
                "petugas.nama from reg_periksa join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis join asuhan_gizi on " +
                "reg_periksa.no_rawat = asuhan_gizi.no_rawat join petugas on asuhan_gizi.nip = petugas.nip where asuhan_gizi.tanggal between ? and ? " +
                (TCari.getText().isBlank() ? "" : "and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or " +
                "asuhan_gizi.nip like ? or asuhan_gizi.diagnosis like ? or petugas.nama like ?) ") + "order by asuhan_gizi.tanggal"
            )) {
                int p = 0;
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                            ...
                            rs.getString("alergi_hazelnut"), rs.getString("alergi_ayam"), rs.getString("pola_makan"), rs.getString("riwayat_personal"),
                            rs.getString("diagnosis"), rs.getString("intervensi_gizi"), rs.getString("monitoring_evaluasi"), rs.getString("nip"), rs.getString("nama")
                        });
                    }
                }
            }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 26).toString().equals("Ya")) {
                AyamYa.setSelected(true);
            } else {
                AyamTidak.setSelected(true);
            }
            PolaMakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            RiwayatPersonal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            DiagnosisGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            IntervensiGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            Monitoring.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
    ...
    private void ganti() {
        ...
        if (Sequel.mengupdatetfSmc("asuhan_gizi", "no_rawat = ?, tanggal = ?, antropometri_bb = ?, antropometri_tb = ?, " +
            "antropometri_imt = ?, antropometri_lla = ?, antropometri_tl = ?, antropometri_ulna = ?, antropometri_bbideal = ?, " +
            ...
            "alergi_gluten = ?, alergi_udang = ?, alergi_ikan = ?, alergi_hazelnut = ?, alergi_ayam = ?, " +
            "pola_makan = ?, riwayat_personal = ?, diagnosis = ?, intervensi_gizi = ?, monitoring_evaluasi = ?, " +
            "nip = ?", "no_rawat = ? and tanggal = ?",
            TNoRw.getText(), Valid.getTglSmc(TglAsuhan), BB.getText(), TB.getText(), IMT.getText(), LiLA.getText(), TL.getText(),
            ULNA.getText(), BBIdeal.getText(), BBPerU.getText(), TBPerU.getText(), BBPerTB.getText(), LiLAPerU.getText(),
            Biokimia.getText(), FisikKlinis.getText(), alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang,
            alergi_ikan, alergi_hazelnut, alergi_ayam, PolaMakan.getText(), RiwayatPersonal.getText(), DiagnosisGizi.getText(),
            IntervensiGizi.getText(), Monitoring.getText(), KdPetugas.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
            ...
            tbObat.setValueAt(Valid.getTglSmc(TglAsuhan), tbObat.getSelectedRow(), 5);
            ...
            tbObat.setValueAt(alergi_ayam, tbObat.getSelectedRow(), 26);
            tbObat.setValueAt(PolaMakan.getText(), tbObat.getSelectedRow(), 27);
            tbObat.setValueAt(RiwayatPersonal.getText(), tbObat.getSelectedRow(), 28);
            tbObat.setValueAt(DiagnosisGizi.getText(), tbObat.getSelectedRow(), 29);
            tbObat.setValueAt(IntervensiGizi.getText(), tbObat.getSelectedRow(), 30);
    ...
    private void hapus() {
        if (Sequel.menghapustfSmc("asuhan_gizi", "no_rawat = ? and tanggal = ?",

...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Keluhan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Obat2an = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Kondisi = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea Keluhan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kondisi;
    ...
    private id.yaski.simrskhanza.widget.TextArea Obat2an;

...
public final class RMSkriningMerokokUsiaSekolahRemaja extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdAsalSekolah = new id.yaski.simrskhanza.widget.TextBox();
        btnAsalSekolah = new id.yaski.simrskhanza.widget.Button();
        NmAsalSekolah = new id.yaski.simrskhanza.widget.TextBox();
        ApakahAndaMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        SatuanRokok = new id.yaski.simrskhanza.widget.ComboBox();
        JumlahRokok = new id.yaski.simrskhanza.widget.TextBox();
        jLabel79 = new id.yaski.simrskhanza.widget.Label();
        jLabel80 = new id.yaski.simrskhanza.widget.Label();
        KeteranganJenisRokokDigunakan = new id.yaski.simrskhanza.widget.TextBox();
        JenisRokokDigunakan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel81 = new id.yaski.simrskhanza.widget.Label();
        jLabel82 = new id.yaski.simrskhanza.widget.Label();
        UsiaMulaiMerokok = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AlasanUtamaMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAlasanUtamaMerokok = new id.yaski.simrskhanza.widget.TextBox();
        jLabel86 = new id.yaski.simrskhanza.widget.Label();
        jLabel87 = new id.yaski.simrskhanza.widget.Label();
        LamaMerokok = new id.yaski.simrskhanza.widget.TextBox();
        ...
        CaraMendapatkanRokok = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganCaraMendapatkanRokok = new id.yaski.simrskhanza.widget.TextBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        jLabel92 = new id.yaski.simrskhanza.widget.Label();
        KeinginanBerhentiMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAlasanUtamaBerhentiMerokok = new id.yaski.simrskhanza.widget.TextBox();
        AlasanUtamaBerhentiMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TahuDampakKesehatanMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel97 = new id.yaski.simrskhanza.widget.Label();
        jLabel98 = new id.yaski.simrskhanza.widget.Label();
        DampakKesehatanMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel101 = new id.yaski.simrskhanza.widget.Label();
        jLabel102 = new id.yaski.simrskhanza.widget.Label();
        PintuMasukNarkoba = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        MerokokDiPendidikan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel106 = new id.yaski.simrskhanza.widget.Label();
        jLabel107 = new id.yaski.simrskhanza.widget.Label();
        YangPalingSeringMerokokDiSekolah = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganYangPalingSeringMerokokDiSekolah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel108 = new id.yaski.simrskhanza.widget.Label();
        jLabel109 = new id.yaski.simrskhanza.widget.Label();
        AnggotaKeluargaMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel110 = new id.yaski.simrskhanza.widget.Label();
        TemanDekatMerokok = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        DilakukanPemeriksaanCO = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel115 = new id.yaski.simrskhanza.widget.Label();
        HasilPemeriksaanCO = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AlasanUtamaBerhentiMerokok;
    private id.yaski.simrskhanza.widget.ComboBox AlasanUtamaMerokok;
    private id.yaski.simrskhanza.widget.ComboBox AnggotaKeluargaMerokok;
    private id.yaski.simrskhanza.widget.ComboBox ApakahAndaMerokok;
    ...
    private id.yaski.simrskhanza.widget.ComboBox CaraMendapatkanRokok;
    ...
    private id.yaski.simrskhanza.widget.ComboBox DampakKesehatanMerokok;
    private id.yaski.simrskhanza.widget.ComboBox Detik;
    private id.yaski.simrskhanza.widget.ComboBox DilakukanPemeriksaanCO;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox HasilPemeriksaanCO;
    private id.yaski.simrskhanza.widget.ComboBox Jam;
    private id.yaski.simrskhanza.widget.ComboBox JenisRokokDigunakan;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox JumlahRokok;
    private id.yaski.simrskhanza.widget.TextBox KdAsalSekolah;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.ComboBox KeinginanBerhentiMerokok;
    private id.yaski.simrskhanza.widget.ComboBox Kelas;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAlasanUtamaBerhentiMerokok;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAlasanUtamaMerokok;
    private id.yaski.simrskhanza.widget.TextBox KeteranganCaraMendapatkanRokok;
    private id.yaski.simrskhanza.widget.TextBox KeteranganJenisRokokDigunakan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganYangPalingSeringMerokokDiSekolah;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LamaMerokok;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.ComboBox MerokokDiPendidikan;
    private javax.swing.JMenuItem MnSkriningMerokok;
    private id.yaski.simrskhanza.widget.TextBox NmAsalSekolah;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PintuMasukNarkoba;
    private id.yaski.simrskhanza.widget.ComboBox SatuanRokok;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TahuDampakKesehatanMerokok;
    private id.yaski.simrskhanza.widget.Tanggal Tanggal;
    private id.yaski.simrskhanza.widget.TextBox TanggalRegistrasi;
    private id.yaski.simrskhanza.widget.ComboBox TemanDekatMerokok;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.TextBox Umur;
    private id.yaski.simrskhanza.widget.TextBox UsiaMulaiMerokok;
    private id.yaski.simrskhanza.widget.ComboBox YangPalingSeringMerokokDiSekolah;
    private id.yaski.simrskhanza.widget.Button btnAsalSekolah;

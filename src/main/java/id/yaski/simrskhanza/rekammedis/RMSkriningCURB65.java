...
public final class RMSkriningCURB65 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CURB1 = new id.yaski.simrskhanza.widget.ComboBox();
        CURB2 = new id.yaski.simrskhanza.widget.ComboBox();
        CURB3 = new id.yaski.simrskhanza.widget.ComboBox();
        CURB4 = new id.yaski.simrskhanza.widget.ComboBox();
        CURB5 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel130 = new id.yaski.simrskhanza.widget.Label();
        NilaiCURB1 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NilaiCURB2 = new id.yaski.simrskhanza.widget.TextBox();
        NilaiCURB3 = new id.yaski.simrskhanza.widget.TextBox();
        NilaiCURB4 = new id.yaski.simrskhanza.widget.TextBox();
        NilaiCURB5 = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox CURB1;
    private id.yaski.simrskhanza.widget.ComboBox CURB2;
    private id.yaski.simrskhanza.widget.ComboBox CURB3;
    private id.yaski.simrskhanza.widget.ComboBox CURB4;
    private id.yaski.simrskhanza.widget.ComboBox CURB5;
    ...
    private id.yaski.simrskhanza.widget.TextBox NilaiCURB1;
    private id.yaski.simrskhanza.widget.TextBox NilaiCURB2;
    private id.yaski.simrskhanza.widget.TextBox NilaiCURB3;
    private id.yaski.simrskhanza.widget.TextBox NilaiCURB4;
    private id.yaski.simrskhanza.widget.TextBox NilaiCURB5;

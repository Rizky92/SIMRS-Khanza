...
public final class RMCatatanPersalinan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        WaktuSelesai = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        WaktuMulai = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        WaktuPersalinanKala1 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        WaktuPersalinanKala2 = new id.yaski.simrskhanza.widget.TextBox();
        label20 = new id.yaski.simrskhanza.widget.Label();
        WaktuPersalinanKala3 = new id.yaski.simrskhanza.widget.TextBox();
        label21 = new id.yaski.simrskhanza.widget.Label();
        WaktuPersalinanJumlah = new id.yaski.simrskhanza.widget.TextBox();
        label23 = new id.yaski.simrskhanza.widget.Label();
        Perineum = new id.yaski.simrskhanza.widget.ComboBox();
        label22 = new id.yaski.simrskhanza.widget.Label();
        label24 = new id.yaski.simrskhanza.widget.Label();
        JahitanLuar1 = new id.yaski.simrskhanza.widget.TextBox();
        JahitanLuar2 = new id.yaski.simrskhanza.widget.TextBox();
        label25 = new id.yaski.simrskhanza.widget.Label();
        label26 = new id.yaski.simrskhanza.widget.Label();
        JahitanDalam1 = new id.yaski.simrskhanza.widget.TextBox();
        label27 = new id.yaski.simrskhanza.widget.Label();
        JahitanDalam2 = new id.yaski.simrskhanza.widget.TextBox();
        label28 = new id.yaski.simrskhanza.widget.Label();
        label29 = new id.yaski.simrskhanza.widget.Label();
        Anak = new id.yaski.simrskhanza.widget.ComboBox();
        label30 = new id.yaski.simrskhanza.widget.Label();
        StatusLahir = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PB = new id.yaski.simrskhanza.widget.TextBox();
        label35 = new id.yaski.simrskhanza.widget.Label();
        label36 = new id.yaski.simrskhanza.widget.Label();
        Kelainan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        DarahKeluarKala4 = new id.yaski.simrskhanza.widget.TextBox();
        label52 = new id.yaski.simrskhanza.widget.Label();
        label53 = new id.yaski.simrskhanza.widget.Label();
        KondisiUmum = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KontraksiUterus = new id.yaski.simrskhanza.widget.TextBox();
        label56 = new id.yaski.simrskhanza.widget.Label();
        Perdarahan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Pengobatan = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Anak;
    ...
    private id.yaski.simrskhanza.widget.TextBox DarahKeluarJumlah;
    private id.yaski.simrskhanza.widget.TextBox DarahKeluarKala1;
    private id.yaski.simrskhanza.widget.TextBox DarahKeluarKala2;
    private id.yaski.simrskhanza.widget.TextBox DarahKeluarKala3;
    private id.yaski.simrskhanza.widget.TextBox DarahKeluarKala4;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Insertio;
    private id.yaski.simrskhanza.widget.TextBox JahitanDalam1;
    private id.yaski.simrskhanza.widget.TextBox JahitanDalam2;
    private id.yaski.simrskhanza.widget.TextBox JahitanLuar1;
    private id.yaski.simrskhanza.widget.TextBox JahitanLuar2;
    ...
    private id.yaski.simrskhanza.widget.TextBox Kelainan;
    private id.yaski.simrskhanza.widget.TextBox Ketuban;
    private id.yaski.simrskhanza.widget.TextBox KondisiUmum;
    private id.yaski.simrskhanza.widget.TextBox KontraksiUterus;
    ...
    private id.yaski.simrskhanza.widget.TextBox PB;
    private id.yaski.simrskhanza.widget.TextArea Pengobatan;
    private id.yaski.simrskhanza.widget.TextBox Perdarahan;
    private id.yaski.simrskhanza.widget.ComboBox Perineum;
    private id.yaski.simrskhanza.widget.TextBox Placenta;
    private id.yaski.simrskhanza.widget.TextBox RR;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox StatusLahir;
    ...
    private id.yaski.simrskhanza.widget.TextBox TaliPusat;
    private id.yaski.simrskhanza.widget.TextBox TanggalRegistrasi;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.TextBox Ukuran;
    private id.yaski.simrskhanza.widget.Tanggal WaktuMulai;
    private id.yaski.simrskhanza.widget.TextBox WaktuPersalinanJumlah;
    private id.yaski.simrskhanza.widget.TextBox WaktuPersalinanKala1;
    private id.yaski.simrskhanza.widget.TextBox WaktuPersalinanKala2;
    private id.yaski.simrskhanza.widget.TextBox WaktuPersalinanKala3;
    private id.yaski.simrskhanza.widget.Tanggal WaktuSelesai;

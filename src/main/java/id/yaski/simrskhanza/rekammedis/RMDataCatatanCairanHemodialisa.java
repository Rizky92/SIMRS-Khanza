...
public final class RMDataCatatanCairanHemodialisa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Minum = new id.yaski.simrskhanza.widget.TextBox();
        Tranfusi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        WashOut = new id.yaski.simrskhanza.widget.TextBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        Infus = new id.yaski.simrskhanza.widget.TextBox();
        Priming = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Pendarahan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        Muntah = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TtlInput = new id.yaski.simrskhanza.widget.TextBox();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        TtlOutput = new id.yaski.simrskhanza.widget.TextBox();
        Balance = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Balance;
    ...
    private id.yaski.simrskhanza.widget.TextBox Infus;
    ...
    private id.yaski.simrskhanza.widget.TextBox Minum;
    private javax.swing.JMenuItem MnCatatanCairanHemodialisa;
    private id.yaski.simrskhanza.widget.TextBox Muntah;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Pendarahan;
    private id.yaski.simrskhanza.widget.TextBox Priming;
    ...
    private id.yaski.simrskhanza.widget.TextBox Tranfusi;
    private id.yaski.simrskhanza.widget.TextBox TtlInput;
    private id.yaski.simrskhanza.widget.TextBox TtlOutput;
    ...
    private id.yaski.simrskhanza.widget.TextBox WashOut;

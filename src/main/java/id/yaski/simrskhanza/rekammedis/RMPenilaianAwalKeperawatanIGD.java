...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KetAlatBantu = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Edema = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel104 = new id.yaski.simrskhanza.widget.Label();
        Mukosa = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel105 = new id.yaski.simrskhanza.widget.Label();
        Perdarahan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        JumlahPerdarahan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        WarnaPerdarahan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        jLabel106 = new id.yaski.simrskhanza.widget.Label();
        Intoksikasi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Psikologis = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel119 = new id.yaski.simrskhanza.widget.Label();
        Jiwa = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel120 = new id.yaski.simrskhanza.widget.Label();
        Perilaku = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel118 = new id.yaski.simrskhanza.widget.Label();
        Dilaporkan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel121 = new id.yaski.simrskhanza.widget.Label();
        Sebutkan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel122 = new id.yaski.simrskhanza.widget.Label();
        Hubungan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel123 = new id.yaski.simrskhanza.widget.Label();
        StatusPernikahan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KetPendidikanPJ = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Abortus;
    ...
    private id.yaski.simrskhanza.widget.TextBox Dilaporkan;
    private id.yaski.simrskhanza.widget.TextBox Durasi;
    private id.yaski.simrskhanza.widget.ComboBox Edema;
    ...
    private id.yaski.simrskhanza.widget.TextBox Gravida;
    private id.yaski.simrskhanza.widget.TextBox HPHT;
    private id.yaski.simrskhanza.widget.ComboBox Hasil;
    private id.yaski.simrskhanza.widget.ComboBox Hubungan;
    private id.yaski.simrskhanza.widget.ComboBox Informasi;
    private id.yaski.simrskhanza.widget.ComboBox Integumen;
    private id.yaski.simrskhanza.widget.ComboBox Intoksikasi;
    private id.yaski.simrskhanza.widget.ComboBox Jiwa;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox JumlahPerdarahan;
    ...
    private id.yaski.simrskhanza.widget.TextBox KetAlatBantu;
    ...
    private id.yaski.simrskhanza.widget.TextBox KetPendidikanPJ;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Mukosa;
    private id.yaski.simrskhanza.widget.ComboBox Neurosensorik;
    ...
    private id.yaski.simrskhanza.widget.TextBox Para;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Perdarahan;
    private id.yaski.simrskhanza.widget.ComboBox Perilaku;
    private id.yaski.simrskhanza.widget.ComboBox Provokes;
    private id.yaski.simrskhanza.widget.ComboBox Psikologis;
    ...
    private id.yaski.simrskhanza.widget.TextBox Sebutkan;
    private id.yaski.simrskhanza.widget.ComboBox SkalaNyeri;
    private id.yaski.simrskhanza.widget.ComboBox StatusBudaya;
    private id.yaski.simrskhanza.widget.ComboBox StatusKehamilan;
    private id.yaski.simrskhanza.widget.TextBox StatusPernikahan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Tekanan;
    ...
    private id.yaski.simrskhanza.widget.TextBox WarnaPerdarahan;

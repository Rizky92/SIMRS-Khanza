...
public final class RMPelaksanaanInformasiEdukasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Materi = new id.yaski.simrskhanza.widget.TextArea();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        Kepada = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        KeteranganKepada = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnSeek = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnSeek;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kepada;
    private id.yaski.simrskhanza.widget.TextBox Keterangan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKepada;
    ...
    private id.yaski.simrskhanza.widget.TextArea Materi;

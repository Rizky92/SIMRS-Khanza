...
public final class RMPenilaianTambahanGeriatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KondisiMasuk = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganKondisiMasuk = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AsalMasuk = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        InfeksiTelinga = new id.yaski.simrskhanza.widget.ComboBox();
        Sinus = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        Antibiotik = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Pneumonia = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        Abses = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        Sariawan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        MemerlukanAntibitotika = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        InfeksiDalam = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        Immunodefisiensi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        JenisKanker = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        InfeksiOportunistik = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Mobilitas = new id.yaski.simrskhanza.widget.ComboBox();
        PerawatanDiri = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        AktivitasSeharihari = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        NyeriTidakNyaman = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        IstirahatTidur = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganIstirahat = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganPenggunaanObatTidur = new id.yaski.simrskhanza.widget.TextBox();
        PenggunaanObatTidur = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KeteranganOlahraga = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Abses;
    private id.yaski.simrskhanza.widget.ComboBox AktivitasSeharihari;
    private id.yaski.simrskhanza.widget.ComboBox Anamnesis;
    private id.yaski.simrskhanza.widget.ComboBox Antibiotik;
    private id.yaski.simrskhanza.widget.ComboBox AsalMasuk;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Immunodefisiensi;
    private id.yaski.simrskhanza.widget.ComboBox InfeksiDalam;
    private id.yaski.simrskhanza.widget.ComboBox InfeksiOportunistik;
    private id.yaski.simrskhanza.widget.ComboBox InfeksiTelinga;
    private id.yaski.simrskhanza.widget.ComboBox IstirahatTidur;
    private id.yaski.simrskhanza.widget.ComboBox JenisKanker;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.TextBox KeteranganIstirahat;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKondisiMasuk;
    private id.yaski.simrskhanza.widget.TextBox KeteranganOlahraga;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPenggunaanObatTidur;
    private id.yaski.simrskhanza.widget.ComboBox KondisiMasuk;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox MemerlukanAntibitotika;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.ComboBox Mobilitas;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.ComboBox NyeriTidakNyaman;
    private id.yaski.simrskhanza.widget.ComboBox Olahraga;
    private id.yaski.simrskhanza.widget.ComboBox PenggunaanObatTidur;
    private id.yaski.simrskhanza.widget.ComboBox PerawatanDiri;
    private id.yaski.simrskhanza.widget.ComboBox Pneumonia;
    private id.yaski.simrskhanza.widget.ComboBox Sariawan;

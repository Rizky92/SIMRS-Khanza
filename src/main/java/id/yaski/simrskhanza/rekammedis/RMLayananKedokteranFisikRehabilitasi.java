...
public final class RMLayananKedokteranFisikRehabilitasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DiagnosisMedis = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Pendamping = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPendamping = new id.yaski.simrskhanza.widget.TextBox();
        jLabel105 = new id.yaski.simrskhanza.widget.Label();
        scrollPane14 = new id.yaski.simrskhanza.widget.ScrollPane();
        DiagnosisFungsi = new id.yaski.simrskhanza.widget.TextArea();
        jLabel106 = new id.yaski.simrskhanza.widget.Label();
        scrollPane15 = new id.yaski.simrskhanza.widget.ScrollPane();
        TatalaksanaKFR = new id.yaski.simrskhanza.widget.TextArea();
        ...
        SuspekPenyakit = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        KeteranganSuspekPenyakit = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextArea DiagnosisFungsi;
    private id.yaski.simrskhanza.widget.TextArea DiagnosisMedis;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganPendamping;
    private id.yaski.simrskhanza.widget.TextBox KeteranganSuspekPenyakit;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Pendamping;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll5;
    private id.yaski.simrskhanza.widget.ComboBox SuspekPenyakit;
    ...
    private id.yaski.simrskhanza.widget.TextArea TatalaksanaKFR;

...
public class MasterTemplateLaporanOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DiagnosisPreOp = new id.yaski.simrskhanza.widget.TextBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Template = new id.yaski.simrskhanza.widget.TextArea();
        DiagnosisPostOp = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NamaOperasi = new id.yaski.simrskhanza.widget.TextBox();
        label21 = new id.yaski.simrskhanza.widget.Label();
        JaringanDieksisi = new id.yaski.simrskhanza.widget.TextBox();

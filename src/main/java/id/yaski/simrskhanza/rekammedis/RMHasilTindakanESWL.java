...
public final class RMHasilTindakanESWL extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        UraianTindakan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        ObatAnastesi = new id.yaski.simrskhanza.widget.TextBox();
        label19 = new id.yaski.simrskhanza.widget.Label();
        ObatLainLain = new id.yaski.simrskhanza.widget.TextBox();
        label20 = new id.yaski.simrskhanza.widget.Label();
        Focus = new id.yaski.simrskhanza.widget.TextBox();
        label21 = new id.yaski.simrskhanza.widget.Label();
        Rate = new id.yaski.simrskhanza.widget.TextBox();
        label22 = new id.yaski.simrskhanza.widget.Label();
        Power = new id.yaski.simrskhanza.widget.TextBox();
        label23 = new id.yaski.simrskhanza.widget.Label();
        Shock = new id.yaski.simrskhanza.widget.TextBox();
        label24 = new id.yaski.simrskhanza.widget.Label();
        Diintegrasi = new id.yaski.simrskhanza.widget.TextBox();
        jSeparator2 = new javax.swing.JSeparator();
        jSeparator3 = new javax.swing.JSeparator();
        jSeparator4 = new javax.swing.JSeparator();
        label25 = new id.yaski.simrskhanza.widget.Label();
        Kekurangan = new id.yaski.simrskhanza.widget.TextBox();
        label26 = new id.yaski.simrskhanza.widget.Label();
        Anjungan = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Anjungan;
    ...
    private id.yaski.simrskhanza.widget.TextBox Diintegrasi;
    private id.yaski.simrskhanza.widget.TextBox Focus;
    ...
    private id.yaski.simrskhanza.widget.TextBox Kekurangan;
    ...
    private id.yaski.simrskhanza.widget.TextBox ObatAnastesi;
    private id.yaski.simrskhanza.widget.TextBox ObatLainLain;
    private id.yaski.simrskhanza.widget.TextBox Power;
    private id.yaski.simrskhanza.widget.TextBox Rate;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox Shock;
    ...
    private id.yaski.simrskhanza.widget.TextArea UraianTindakan;

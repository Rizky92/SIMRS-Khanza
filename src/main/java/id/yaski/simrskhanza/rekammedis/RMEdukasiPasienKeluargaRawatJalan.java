...
public final class RMEdukasiPasienKeluargaRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Bicara = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganBicara = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KeteranganBahasa = new id.yaski.simrskhanza.widget.TextBox();
        Bahasa = new id.yaski.simrskhanza.widget.TextBox();
        jLabel47 = new id.yaski.simrskhanza.widget.Label();
        Penerjemah = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPenerjemah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        BahasaIsyarat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel49 = new id.yaski.simrskhanza.widget.Label();
        CaraBelajar = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KemampuanBelajar = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganKemampuanBelajar = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PenyakitnyaMerupakan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganPenyakitnyaMerupakan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel58 = new id.yaski.simrskhanza.widget.Label();
        KeputusanMemilihLayanan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganKeputusanMemilihLayanan = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganKeyakinanTerhadapHasil = new id.yaski.simrskhanza.widget.TextBox();
        KeyakinanTerhadapHasil = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel59 = new id.yaski.simrskhanza.widget.Label();
        jLabel60 = new id.yaski.simrskhanza.widget.Label();
        AspekKeyakinan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganAspekKeyakinan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KesediaanInformasi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PenyakitYangDiderita = new id.yaski.simrskhanza.widget.ComboBox();
        RencanaTindakan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel69 = new id.yaski.simrskhanza.widget.Label();
        jLabel70 = new id.yaski.simrskhanza.widget.Label();
        PengobatanProsedur = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel71 = new id.yaski.simrskhanza.widget.Label();
        HasilLayanan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AspekKeyakinan;
    private id.yaski.simrskhanza.widget.TextBox Bahasa;
    private id.yaski.simrskhanza.widget.ComboBox BahasaIsyarat;
    private id.yaski.simrskhanza.widget.ComboBox Bicara;
    ...
    private id.yaski.simrskhanza.widget.ComboBox CaraBelajar;
    ...
    private id.yaski.simrskhanza.widget.ComboBox HasilLayanan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KemampuanBelajar;
    private id.yaski.simrskhanza.widget.ComboBox KeputusanMemilihLayanan;
    private id.yaski.simrskhanza.widget.ComboBox KesediaanInformasi;
    private id.yaski.simrskhanza.widget.TextBox KeteranganAspekKeyakinan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganBahasa;
    private id.yaski.simrskhanza.widget.TextBox KeteranganBicara;
    private id.yaski.simrskhanza.widget.TextBox KeteranganHambatanBelajar;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKemampuanBelajar;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKeputusanMemilihLayanan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganKeyakinanTerhadapHasil;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPenerjemah;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPenyakitnyaMerupakan;
    private id.yaski.simrskhanza.widget.ComboBox KeyakinanTerhadapHasil;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Penerjemah;
    private id.yaski.simrskhanza.widget.ComboBox PengobatanProsedur;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitYangDiderita;
    private id.yaski.simrskhanza.widget.ComboBox PenyakitnyaMerupakan;
    private id.yaski.simrskhanza.widget.ComboBox RencanaTindakan;

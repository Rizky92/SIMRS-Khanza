...
public final class RMChecklistPostOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdPetugasAnest = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasAnest = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugasRuangan = new id.yaski.simrskhanza.widget.Button();
        ...
        JumlahDrain = new id.yaski.simrskhanza.widget.TextBox();
        SNCN = new id.yaski.simrskhanza.widget.TextBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        KodeDokterBedah = new id.yaski.simrskhanza.widget.TextBox();
        NamaDokterBedah = new id.yaski.simrskhanza.widget.TextBox();
        btnDokterBedah = new id.yaski.simrskhanza.widget.Button();
        btnDokterAnestesi = new id.yaski.simrskhanza.widget.Button();
        NamaDokterAnestesi = new id.yaski.simrskhanza.widget.TextBox();
        KodeDokterAnestesi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Drain = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Radiologi = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganRadiologi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel60 = new id.yaski.simrskhanza.widget.Label();
        KeteranganEKG = new id.yaski.simrskhanza.widget.TextBox();
        EKG = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel61 = new id.yaski.simrskhanza.widget.Label();
        CTScan = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganCTScan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        MRI = new id.yaski.simrskhanza.widget.ComboBox();
        KeteranganMRI = new id.yaski.simrskhanza.widget.TextBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasOK = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasOK = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugasOK = new id.yaski.simrskhanza.widget.Button();
        ...
        LetakDrain = new id.yaski.simrskhanza.widget.TextBox();
        WarnaDrain = new id.yaski.simrskhanza.widget.TextBox();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        CairanInfus = new id.yaski.simrskhanza.widget.TextBox();
        jLabel64 = new id.yaski.simrskhanza.widget.Label();
        JaringanPA = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AreaLukaOperasi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox CTScan;
    private id.yaski.simrskhanza.widget.TextBox CairanInfus;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Drain;
    private id.yaski.simrskhanza.widget.ComboBox EKG;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox JK;
    private id.yaski.simrskhanza.widget.ComboBox JaringanPA;
    private id.yaski.simrskhanza.widget.TextBox JumlahDrain;
    private id.yaski.simrskhanza.widget.TextBox JumlahUrine;
    private id.yaski.simrskhanza.widget.ComboBox KateterUrine;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasAnest;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasOK;
    private id.yaski.simrskhanza.widget.ComboBox KeadaanUmum;
    private id.yaski.simrskhanza.widget.TextBox KeteranganCTScan;
    private id.yaski.simrskhanza.widget.TextBox KeteranganEKG;
    private id.yaski.simrskhanza.widget.TextBox KeteranganMRI;
    private id.yaski.simrskhanza.widget.TextBox KeteranganRadiologi;
    private id.yaski.simrskhanza.widget.TextBox KeteranganUSG;
    private id.yaski.simrskhanza.widget.TextBox KodeDokterAnestesi;
    private id.yaski.simrskhanza.widget.TextBox KodeDokterBedah;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LetakDrain;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox MRI;
    private javax.swing.JMenuItem MnPostOperasi;
    private id.yaski.simrskhanza.widget.TextBox NamaDokterAnestesi;
    private id.yaski.simrskhanza.widget.TextBox NamaDokterBedah;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasAnest;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasOK;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox Radiologi;
    private id.yaski.simrskhanza.widget.TextBox SNCN;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalKateter;
    ...
    private id.yaski.simrskhanza.widget.TextBox WarnaDrain;
    private id.yaski.simrskhanza.widget.ComboBox WarnaUrine;
    private id.yaski.simrskhanza.widget.Button btnDokterAnestesi;
    private id.yaski.simrskhanza.widget.Button btnDokterBedah;
    private id.yaski.simrskhanza.widget.Button btnPetugasOK;
    private id.yaski.simrskhanza.widget.Button btnPetugasRuangan;

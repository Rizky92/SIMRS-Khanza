...
public final class RMTimeOutSebelumInsisi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PemberianAntibiotik = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        AreaOperasi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        AntisipisasiKehialnganDarah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel53 = new id.yaski.simrskhanza.widget.Label();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        VerbalTindakan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        VerbalArea = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        jLabel52 = new id.yaski.simrskhanza.widget.Label();
        PenayanganRadiologi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        PenayanganCTScan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        PenayanganMRI = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        VerbalIdentitas = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        JamPemberianAntibiotik = new id.yaski.simrskhanza.widget.TextBox();
        jLabel33 = new id.yaski.simrskhanza.widget.Label();
        PerkiraanLama = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        AdaHalKhusus = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel58 = new id.yaski.simrskhanza.widget.Label();
        NamaAntibiotikDIberikan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel59 = new id.yaski.simrskhanza.widget.Label();
        HalKhususDiperhatikan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        TanggalSeteril = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        PetunjukSterilisasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        VerifikasiOperatif = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AdaHalKhusus;
    private id.yaski.simrskhanza.widget.TextBox AntisipisasiKehialnganDarah;
    private id.yaski.simrskhanza.widget.ComboBox AreaOperasi;
    ...
    private id.yaski.simrskhanza.widget.TextBox HalKhususDiperhatikan;
    private id.yaski.simrskhanza.widget.TextBox JamPemberianAntibiotik;
    ...
    private id.yaski.simrskhanza.widget.TextBox NamaAntibiotikDIberikan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PemberianAntibiotik;
    private id.yaski.simrskhanza.widget.ComboBox PenayanganCTScan;
    private id.yaski.simrskhanza.widget.ComboBox PenayanganMRI;
    private id.yaski.simrskhanza.widget.ComboBox PenayanganRadiologi;
    private id.yaski.simrskhanza.widget.TextBox PerkiraanLama;
    private id.yaski.simrskhanza.widget.ComboBox PetunjukSterilisasi;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalSeteril;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.TextBox Tindakan;
    private id.yaski.simrskhanza.widget.ComboBox VerbalArea;
    private id.yaski.simrskhanza.widget.ComboBox VerbalIdentitas;
    private id.yaski.simrskhanza.widget.ComboBox VerbalTindakan;
    private id.yaski.simrskhanza.widget.ComboBox VerifikasiOperatif;

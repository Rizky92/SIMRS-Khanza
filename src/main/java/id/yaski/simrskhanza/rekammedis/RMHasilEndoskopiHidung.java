...
public final class RMHasilEndoskopiHidung extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KavumNasiKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        HidungKiri = new id.yaski.simrskhanza.widget.ComboBox();
        HidungKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        KonkaInferiorKanan = new id.yaski.simrskhanza.widget.ComboBox();
        MeatusMediusKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        SeptumKanan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        NasofaringKanan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KavumNasiKiri = new id.yaski.simrskhanza.widget.ComboBox();
        KonkaInferiorKiri = new id.yaski.simrskhanza.widget.ComboBox();
        MeatusMediusKiri = new id.yaski.simrskhanza.widget.ComboBox();
        SeptumKiri = new id.yaski.simrskhanza.widget.ComboBox();
        NasofaringKiri = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox HidungKanan;
    private id.yaski.simrskhanza.widget.ComboBox HidungKiri;
    private id.yaski.simrskhanza.widget.ComboBox KavumNasiKanan;
    private id.yaski.simrskhanza.widget.ComboBox KavumNasiKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KonkaInferiorKanan;
    private id.yaski.simrskhanza.widget.ComboBox KonkaInferiorKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MeatusMediusKanan;
    private id.yaski.simrskhanza.widget.ComboBox MeatusMediusKiri;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.ComboBox NasofaringKanan;
    private id.yaski.simrskhanza.widget.ComboBox NasofaringKiri;
    ...
    private id.yaski.simrskhanza.widget.ComboBox SeptumKanan;
    private id.yaski.simrskhanza.widget.ComboBox SeptumKiri;

...
public final class RMPenilaianAwalMedisRalanMata extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PemeriksaanLain = new id.yaski.simrskhanza.widget.TextArea();
        scrollPane21 = new id.yaski.simrskhanza.widget.ScrollPane();
        TesPenglihatan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        MBOkiri = new id.yaski.simrskhanza.widget.TextBox();
        Visuskanan = new id.yaski.simrskhanza.widget.TextBox();
        Visuskiri = new id.yaski.simrskhanza.widget.TextBox();
        CCkanan = new id.yaski.simrskhanza.widget.TextBox();
        CCkiri = new id.yaski.simrskhanza.widget.TextBox();
        Palkanan = new id.yaski.simrskhanza.widget.TextBox();
        Palkiri = new id.yaski.simrskhanza.widget.TextBox();
        Conkanan = new id.yaski.simrskhanza.widget.TextBox();
        Conkiri = new id.yaski.simrskhanza.widget.TextBox();
        Corneakanan = new id.yaski.simrskhanza.widget.TextBox();
        Corneakiri = new id.yaski.simrskhanza.widget.TextBox();
        COAkanan = new id.yaski.simrskhanza.widget.TextBox();
        COAkiri = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Funduskanan = new id.yaski.simrskhanza.widget.TextBox();
        Funduskiri = new id.yaski.simrskhanza.widget.TextBox();
        Papilkanan = new id.yaski.simrskhanza.widget.TextBox();
        Papilkiri = new id.yaski.simrskhanza.widget.TextBox();
        Retinakanan = new id.yaski.simrskhanza.widget.TextBox();
        Retinakiri = new id.yaski.simrskhanza.widget.TextBox();
        Makulakanan = new id.yaski.simrskhanza.widget.TextBox();
        Makulakiri = new id.yaski.simrskhanza.widget.TextBox();
        TIOkanan = new id.yaski.simrskhanza.widget.TextBox();
        TIOkiri = new id.yaski.simrskhanza.widget.TextBox();
        MBOkanan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Nyeri = new id.yaski.simrskhanza.widget.TextBox();
        ...
        DiagnosisBdg = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Terapi = new id.yaski.simrskhanza.widget.TextArea();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox CCkanan;
    private id.yaski.simrskhanza.widget.TextBox CCkiri;
    private id.yaski.simrskhanza.widget.TextBox COAkanan;
    private id.yaski.simrskhanza.widget.TextBox COAkiri;
    private id.yaski.simrskhanza.widget.TextBox Conkanan;
    private id.yaski.simrskhanza.widget.TextBox Conkiri;
    private id.yaski.simrskhanza.widget.TextBox Corneakanan;
    private id.yaski.simrskhanza.widget.TextBox Corneakiri;
    ...
    private id.yaski.simrskhanza.widget.TextArea DiagnosisBdg;
    private id.yaski.simrskhanza.widget.TextArea Edukasi;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Funduskanan;
    private id.yaski.simrskhanza.widget.TextBox Funduskiri;
    ...
    private id.yaski.simrskhanza.widget.TextBox MBOkanan;
    private id.yaski.simrskhanza.widget.TextBox MBOkiri;
    private id.yaski.simrskhanza.widget.TextBox Makulakanan;
    private id.yaski.simrskhanza.widget.TextBox Makulakiri;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private id.yaski.simrskhanza.widget.TextBox Nadi;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.TextBox Nyeri;
    private id.yaski.simrskhanza.widget.TextBox Palkanan;
    private id.yaski.simrskhanza.widget.TextBox Palkiri;
    private usu.widget.glass.PanelGlass PanelWall;
    private usu.widget.glass.PanelGlass PanelWall1;
    private id.yaski.simrskhanza.widget.TextBox Papilkanan;
    private id.yaski.simrskhanza.widget.TextBox Papilkiri;
    private id.yaski.simrskhanza.widget.TextArea PemeriksaanLain;
    ...
    private id.yaski.simrskhanza.widget.TextBox Retinakanan;
    private id.yaski.simrskhanza.widget.TextBox Retinakiri;
    ...
    private id.yaski.simrskhanza.widget.TextArea Terapi;
    private id.yaski.simrskhanza.widget.TextArea TesPenglihatan;

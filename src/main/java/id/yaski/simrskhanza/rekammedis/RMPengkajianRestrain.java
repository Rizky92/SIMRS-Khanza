...
public final class RMPengkajianRestrain extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LahirPasien = new id.yaski.simrskhanza.widget.TextBox();
        ...
        ReflekaCahayaKanan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        ReflekaCahayaKiri = new id.yaski.simrskhanza.widget.TextBox();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        UkuranPupilKiri = new id.yaski.simrskhanza.widget.TextBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        UkuranPupilKanan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        HasilObservasi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PertimbanganKlinis = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        RestrainNonFarmakologi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel107 = new id.yaski.simrskhanza.widget.Label();
        KeteranganNonRestrainFarmakologi = new id.yaski.simrskhanza.widget.TextBox();
        scrollPane1 = new id.yaski.simrskhanza.widget.ScrollPane();
        RestrainFarmakologi = new id.yaski.simrskhanza.widget.TextArea();
        ...
        SudahDijelaskan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        Keluarga = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox HasilObservasi;
    private id.yaski.simrskhanza.widget.TextBox JK;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.TextBox Keluarga;
    private id.yaski.simrskhanza.widget.TextBox KeteranganNonRestrainFarmakologi;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LahirPasien;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PertimbanganKlinis;
    private id.yaski.simrskhanza.widget.TextBox RR;
    private id.yaski.simrskhanza.widget.TextBox ReflekaCahayaKanan;
    private id.yaski.simrskhanza.widget.TextBox ReflekaCahayaKiri;
    private id.yaski.simrskhanza.widget.TextArea RestrainFarmakologi;
    private id.yaski.simrskhanza.widget.ComboBox RestrainNonFarmakologi;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll5;
    private id.yaski.simrskhanza.widget.ComboBox SudahDijelaskan;
    ...
    private id.yaski.simrskhanza.widget.TextBox UkuranPupilKanan;
    private id.yaski.simrskhanza.widget.TextBox UkuranPupilKiri;

...
public final class RMPenilaianRisikoJatuhNeonatus extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Intervensi6 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Intervensi5 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel61 = new id.yaski.simrskhanza.widget.Label();
        Intervensi9 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel62 = new id.yaski.simrskhanza.widget.Label();
        Intervensi4 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Edukasi1;
    private id.yaski.simrskhanza.widget.ComboBox Edukasi2;
    private id.yaski.simrskhanza.widget.ComboBox Edukasi3;
    private id.yaski.simrskhanza.widget.ComboBox Edukasi4;
    private id.yaski.simrskhanza.widget.ComboBox Edukasi5;
    private id.yaski.simrskhanza.widget.ComboBox Evaluasi1;
    private id.yaski.simrskhanza.widget.ComboBox Evaluasi2;
    private id.yaski.simrskhanza.widget.ComboBox Evaluasi3;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi1;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi2;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi3;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi4;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi5;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi6;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi7;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi8;
    private id.yaski.simrskhanza.widget.ComboBox Intervensi9;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Sasaran1;
    private id.yaski.simrskhanza.widget.ComboBox Sasaran2;
    private id.yaski.simrskhanza.widget.ComboBox Sasaran3;
    private id.yaski.simrskhanza.widget.ComboBox Sasaran4;

...
public final class RMHasilPemeriksaanEcho extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Sistolik = new id.yaski.simrskhanza.widget.TextBox();
        Katup = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        Diastolik = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        AnalisaSegmental = new id.yaski.simrskhanza.widget.TextBox();
        Dimensi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Erap = new id.yaski.simrskhanza.widget.TextBox();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        Kontraktilitas = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AnalisaSegmental;
    ...
    private id.yaski.simrskhanza.widget.TextBox Diastolik;
    private id.yaski.simrskhanza.widget.TextBox Dimensi;
    private id.yaski.simrskhanza.widget.TextBox Erap;
    ...
    private id.yaski.simrskhanza.widget.TextBox Katup;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextArea Kesimpulan;
    private id.yaski.simrskhanza.widget.TextBox Kontraktilitas;
    ...
    private id.yaski.simrskhanza.widget.TextBox Sistolik;

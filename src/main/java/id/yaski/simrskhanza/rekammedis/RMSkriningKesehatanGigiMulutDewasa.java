...
public final class RMSkriningKesehatanGigiMulutDewasa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        GigiBungsuTumbuh = new id.yaski.simrskhanza.widget.ComboBox();
        GigiHilang = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox GigiBungsuTumbuh;
    private id.yaski.simrskhanza.widget.ComboBox GigiHilang;

...
public final class RMChecklistKriteriaKeluarPICU extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KondisiKlinis2 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel64 = new id.yaski.simrskhanza.widget.Label();
        jLabel65 = new id.yaski.simrskhanza.widget.Label();
        KondisiKlinis1 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TindakLanjut2 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel77 = new id.yaski.simrskhanza.widget.Label();
        jLabel78 = new id.yaski.simrskhanza.widget.Label();
        TindakLanjut1 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel79 = new id.yaski.simrskhanza.widget.Label();
        TindakLanjut4 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel80 = new id.yaski.simrskhanza.widget.Label();
        TindakLanjut3 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox KebutuhanPerawatan1;
    private id.yaski.simrskhanza.widget.ComboBox KebutuhanPerawatan2;
    private id.yaski.simrskhanza.widget.ComboBox KebutuhanPerawatan3;
    private id.yaski.simrskhanza.widget.ComboBox KebutuhanPerawatan4;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KondisiKlinis1;
    private id.yaski.simrskhanza.widget.ComboBox KondisiKlinis2;
    private id.yaski.simrskhanza.widget.ComboBox KondisiKlinis3;
    private id.yaski.simrskhanza.widget.ComboBox KondisiKlinis4;
    private id.yaski.simrskhanza.widget.ComboBox KondisiKlinis5;
    private id.yaski.simrskhanza.widget.ComboBox KondisiKlinis6;
    ...
    private id.yaski.simrskhanza.widget.ComboBox TindakLanjut1;
    private id.yaski.simrskhanza.widget.ComboBox TindakLanjut2;
    private id.yaski.simrskhanza.widget.ComboBox TindakLanjut3;
    private id.yaski.simrskhanza.widget.ComboBox TindakLanjut4;

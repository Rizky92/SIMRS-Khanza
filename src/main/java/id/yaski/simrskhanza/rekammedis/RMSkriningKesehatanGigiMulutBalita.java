...
public final class RMSkriningKesehatanGigiMulutBalita extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        SudahAdaGigiTumbuh = new id.yaski.simrskhanza.widget.ComboBox();
        JumlahGigiSudahTumbuh = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        MengemilManis = new id.yaski.simrskhanza.widget.ComboBox();
        KebiasaanSusuBotol = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        MenyikatGigi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel91 = new id.yaski.simrskhanza.widget.Label();
        jLabel95 = new id.yaski.simrskhanza.widget.Label();
        MengemutMakanan = new id.yaski.simrskhanza.widget.ComboBox();
        LidahAnak = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        CelahBibir = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox CelahBibir;
    ...
    private id.yaski.simrskhanza.widget.ComboBox JumlahGigiSudahTumbuh;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.ComboBox KebersihanGigiMulut;
    private id.yaski.simrskhanza.widget.ComboBox KebiasaanSusuBotol;
    private id.yaski.simrskhanza.widget.TextBox Keterangan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.ComboBox LidahAnak;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox MengemilManis;
    private id.yaski.simrskhanza.widget.ComboBox MengemutMakanan;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.ComboBox MenyikatGigi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox SudahAdaGigiTumbuh;

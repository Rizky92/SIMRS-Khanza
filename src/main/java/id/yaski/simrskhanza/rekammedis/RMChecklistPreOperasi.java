...
public final class RMChecklistPreOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdPetugasRuangan = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasRuangan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KeteranganPersiapanDarah = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Identitas = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        IjinBedah = new id.yaski.simrskhanza.widget.ComboBox();
        IjinAnestesi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        IjinTransfusi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        PersiapanDarah = new id.yaski.simrskhanza.widget.ComboBox();
        Tindakan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        PerlengkapanKhusus = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Identitas;
    private id.yaski.simrskhanza.widget.ComboBox IjinAnestesi;
    private id.yaski.simrskhanza.widget.ComboBox IjinBedah;
    private id.yaski.simrskhanza.widget.ComboBox IjinTransfusi;
    private id.yaski.simrskhanza.widget.TextBox JK;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasOK;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasRuangan;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganPersiapanDarah;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmPetugasRuangan;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PerlengkapanKhusus;
    private id.yaski.simrskhanza.widget.ComboBox PersiapanDarah;

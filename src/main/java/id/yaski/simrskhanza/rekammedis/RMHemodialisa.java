...
public final class RMHemodialisa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TLama = new id.yaski.simrskhanza.widget.TextBox();
        TQD = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TAkses = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TUreum = new id.yaski.simrskhanza.widget.TextBox();
        THb = new id.yaski.simrskhanza.widget.TextBox();
        ...
        THbsag = new id.yaski.simrskhanza.widget.TextBox();
        TCreatinin = new id.yaski.simrskhanza.widget.TextBox();
        THIV = new id.yaski.simrskhanza.widget.TextBox();
        THCV = new id.yaski.simrskhanza.widget.TextBox();
        TDialist = new id.yaski.simrskhanza.widget.TextBox();
        TTransfusi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TLain = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TPenarikan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        TQB = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox TAkses;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TCreatinin;
    private id.yaski.simrskhanza.widget.TextBox TDialist;
    private id.yaski.simrskhanza.widget.TextBox THCV;
    private id.yaski.simrskhanza.widget.TextBox THIV;
    private id.yaski.simrskhanza.widget.TextBox THb;
    private id.yaski.simrskhanza.widget.TextBox THbsag;
    private id.yaski.simrskhanza.widget.TextBox TLain;
    private id.yaski.simrskhanza.widget.TextBox TLama;
    ...
    private id.yaski.simrskhanza.widget.TextBox TPenarikan;
    private id.yaski.simrskhanza.widget.TextBox TQB;
    private id.yaski.simrskhanza.widget.TextBox TQD;
    private id.yaski.simrskhanza.widget.TextBox TTransfusi;
    private id.yaski.simrskhanza.widget.TextBox TUreum;

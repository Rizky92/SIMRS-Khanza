...
public final class RMHasilEndoskopiFaringLaring extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DindingPosterior = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        ArkusFaring = new id.yaski.simrskhanza.widget.TextBox();
        Uvula = new id.yaski.simrskhanza.widget.TextBox();
        Tonsil = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TonsilLingual = new id.yaski.simrskhanza.widget.TextBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        Valekula = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        SinusPiriformis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        Epiglitos = new id.yaski.simrskhanza.widget.TextBox();
        jLabel43 = new id.yaski.simrskhanza.widget.Label();
        PlikaVentrikulais = new id.yaski.simrskhanza.widget.TextBox();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        Arytenoid = new id.yaski.simrskhanza.widget.TextBox();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        RimaVocalis = new id.yaski.simrskhanza.widget.TextBox();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        PitaSuara = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox ArkusFaring;
    private id.yaski.simrskhanza.widget.TextBox Arytenoid;
    ...
    private id.yaski.simrskhanza.widget.TextBox DindingPosterior;
    private id.yaski.simrskhanza.widget.TextBox Epiglitos;
    ...
    private id.yaski.simrskhanza.widget.TextBox PitaSuara;
    private id.yaski.simrskhanza.widget.TextBox PlikaVentrikulais;
    private id.yaski.simrskhanza.widget.TextBox RimaVocalis;
    ...
    private id.yaski.simrskhanza.widget.TextBox SinusPiriformis;
    ...
    private id.yaski.simrskhanza.widget.TextBox Tonsil;
    private id.yaski.simrskhanza.widget.TextBox TonsilLingual;
    private id.yaski.simrskhanza.widget.TextBox Uvula;
    private id.yaski.simrskhanza.widget.TextBox Valekula;

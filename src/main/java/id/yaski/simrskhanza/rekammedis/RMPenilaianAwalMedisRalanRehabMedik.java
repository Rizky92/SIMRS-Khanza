...
public final class RMPenilaianAwalMedisRalanRehabMedik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Columna = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KeteranganMusku = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KeteranganColumna = new id.yaski.simrskhanza.widget.TextBox();
        ...
        DiagnosaFungsi = new id.yaski.simrskhanza.widget.TextArea();
        ...
        Fisio = new id.yaski.simrskhanza.widget.TextBox();
        Okupasi = new id.yaski.simrskhanza.widget.TextBox();
        Wicara = new id.yaski.simrskhanza.widget.TextBox();
        Akupuntur = new id.yaski.simrskhanza.widget.TextBox();
        PanelWall1 = new usu.widget.glass.PanelGlass();
        SkalaNyeri = new id.yaski.simrskhanza.widget.ComboBox();
        Tatalainnya = new id.yaski.simrskhanza.widget.TextBox();
        Frekuensiterapi = new id.yaski.simrskhanza.widget.TextBox();
        Resikojatuh = new id.yaski.simrskhanza.widget.ComboBox();
        Resikonutrisional = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        Kebutuhanfungsional = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TglFisioterapi = new id.yaski.simrskhanza.widget.Tanggal();
        TglOkupasi = new id.yaski.simrskhanza.widget.Tanggal();
        TglWicara = new id.yaski.simrskhanza.widget.Tanggal();
        TglAkupuntur = new id.yaski.simrskhanza.widget.Tanggal();
        TglTerapilainnya = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        ChkTerapiLainnya = new id.yaski.simrskhanza.widget.CekBox();
        ChkFisioterapi = new id.yaski.simrskhanza.widget.CekBox();
        ChkOkupasi = new id.yaski.simrskhanza.widget.CekBox();
        ChkWicara = new id.yaski.simrskhanza.widget.CekBox();
        ChkAkupungtur = new id.yaski.simrskhanza.widget.CekBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Akupuntur;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkAkupungtur;
    private id.yaski.simrskhanza.widget.CekBox ChkFisioterapi;
    private id.yaski.simrskhanza.widget.CekBox ChkOkupasi;
    private id.yaski.simrskhanza.widget.CekBox ChkTerapiLainnya;
    private id.yaski.simrskhanza.widget.CekBox ChkWicara;
    private id.yaski.simrskhanza.widget.ComboBox Columna;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari1;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari2;
    private id.yaski.simrskhanza.widget.TextArea DiagnosaFungsi;
    ...
    private id.yaski.simrskhanza.widget.TextBox Fisio;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Frekuensiterapi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Kebutuhanfungsional;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganColumna;
    ...
    private id.yaski.simrskhanza.widget.TextBox KeteranganMusku;
    ...
    private id.yaski.simrskhanza.widget.TextBox Okupasi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Resikonutrisional;
    ...
    private id.yaski.simrskhanza.widget.TextBox Tatalainnya;
    private id.yaski.simrskhanza.widget.Tanggal TglAkupuntur;
    private id.yaski.simrskhanza.widget.Tanggal TglAsuhan;
    private id.yaski.simrskhanza.widget.Tanggal TglFisioterapi;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.Tanggal TglOkupasi;
    private id.yaski.simrskhanza.widget.Tanggal TglTerapilainnya;
    private id.yaski.simrskhanza.widget.Tanggal TglWicara;
    private id.yaski.simrskhanza.widget.ComboBox Thoraks;
    private id.yaski.simrskhanza.widget.TextBox Wicara;

...
public final class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MenyetujuiPemindahan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TanggalMasuk = new id.yaski.simrskhanza.widget.Tanggal();
        label12 = new id.yaski.simrskhanza.widget.Label();
        TanggalPindah = new id.yaski.simrskhanza.widget.Tanggal();
        KeteranganIndikasiPindahRuang = new id.yaski.simrskhanza.widget.TextBox();
        jSeparator1 = new javax.swing.JSeparator();
        KeteranganPeralatan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        RuangSelanjutnya = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        PeralatanMenyertai = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        DiagnosaSekunder = new id.yaski.simrskhanza.widget.TextArea();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        ProsedurDilakukan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        ObatYangDiberikan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        IndikasiPindah = new id.yaski.simrskhanza.widget.ComboBox();
        AsalRuang = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        MetodePemindahan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        NamaMenyetujui = new id.yaski.simrskhanza.widget.TextBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        HubunganMenyetujui = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KeluhanUtamaSebelumTransfer = new id.yaski.simrskhanza.widget.TextArea();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        KeadaanUmumSebelumTransfer = new id.yaski.simrskhanza.widget.ComboBox();
        TDSebelumTransfer = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NadiSebelumTransfer = new id.yaski.simrskhanza.widget.TextBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        RRSebelumTransfer = new id.yaski.simrskhanza.widget.TextBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        SuhuSebelumTransfer = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KeadaanUmumSetelahTransfer = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        TDSetelahTransfer = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KeluhanUtamaSetelahTransfer = new id.yaski.simrskhanza.widget.TextArea();
        jLabel47 = new id.yaski.simrskhanza.widget.Label();
        NadiSetelahTransfer = new id.yaski.simrskhanza.widget.TextBox();
        jLabel48 = new id.yaski.simrskhanza.widget.Label();
        jLabel49 = new id.yaski.simrskhanza.widget.Label();
        RRSetelahTransfer = new id.yaski.simrskhanza.widget.TextBox();
        jLabel50 = new id.yaski.simrskhanza.widget.Label();
        jLabel51 = new id.yaski.simrskhanza.widget.Label();
        SuhuSetelahTransfer = new id.yaski.simrskhanza.widget.TextBox();
        jLabel52 = new id.yaski.simrskhanza.widget.Label();
        jSeparator7 = new javax.swing.JSeparator();
        label14 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasMenyerahkan = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasMenyerahkan = new id.yaski.simrskhanza.widget.TextBox();
        BtnDokter = new id.yaski.simrskhanza.widget.Button();
        label15 = new id.yaski.simrskhanza.widget.Label();
        KdPetugasMenerima = new id.yaski.simrskhanza.widget.TextBox();
        NmPetugasMenerima = new id.yaski.simrskhanza.widget.TextBox();
        BtnMenerima = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AsalRuang;
    ...
    private id.yaski.simrskhanza.widget.Button BtnMenerima;
    ...
    private id.yaski.simrskhanza.widget.TextArea DiagnosaSekunder;
    ...
    private id.yaski.simrskhanza.widget.ComboBox HubunganMenyetujui;
    private id.yaski.simrskhanza.widget.ComboBox IndikasiPindah;
    private id.yaski.simrskhanza.widget.TextBox Jk;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasMenerima;
    private id.yaski.simrskhanza.widget.TextBox KdPetugasMenyerahkan;
    private id.yaski.simrskhanza.widget.ComboBox KeadaanUmumSebelumTransfer;
    private id.yaski.simrskhanza.widget.ComboBox KeadaanUmumSetelahTransfer;
    private id.yaski.simrskhanza.widget.TextArea KeluhanUtamaSebelumTransfer;
    private id.yaski.simrskhanza.widget.TextArea KeluhanUtamaSetelahTransfer;
    private id.yaski.simrskhanza.widget.TextBox KeteranganIndikasiPindahRuang;
    private id.yaski.simrskhanza.widget.TextBox KeteranganPeralatan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox MenyetujuiPemindahan;
    private id.yaski.simrskhanza.widget.ComboBox MetodePemindahan;
    private id.yaski.simrskhanza.widget.TextBox NadiSebelumTransfer;
    private id.yaski.simrskhanza.widget.TextBox NadiSetelahTransfer;
    private id.yaski.simrskhanza.widget.TextBox NamaMenyetujui;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasMenerima;
    private id.yaski.simrskhanza.widget.TextBox NmPetugasMenyerahkan;
    private id.yaski.simrskhanza.widget.TextArea ObatYangDiberikan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PeralatanMenyertai;
    private id.yaski.simrskhanza.widget.TextArea ProsedurDilakukan;
    private id.yaski.simrskhanza.widget.TextBox RRSebelumTransfer;
    private id.yaski.simrskhanza.widget.TextBox RRSetelahTransfer;
    private id.yaski.simrskhanza.widget.TextBox RuangSelanjutnya;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll5;
    private id.yaski.simrskhanza.widget.TextBox SuhuSebelumTransfer;
    private id.yaski.simrskhanza.widget.TextBox SuhuSetelahTransfer;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TDSebelumTransfer;
    private id.yaski.simrskhanza.widget.TextBox TDSetelahTransfer;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalMasuk;
    private id.yaski.simrskhanza.widget.Tanggal TanggalPindah;

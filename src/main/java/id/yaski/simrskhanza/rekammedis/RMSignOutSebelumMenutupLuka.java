...
public final class RMSignOutSebelumMenutupLuka extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        VerbalKasa = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        VerbalInstrumen = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        VerbalAlatTajam = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        KelengkapanSpesimenLabel = new id.yaski.simrskhanza.widget.ComboBox();
        KelengkapanSpesimenFormulir = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PeninjauanKembaliDokterBedah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        PeninjauanKembaliDokterAnestesi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        PeninjauanKembaliPerawatKamarOK = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        jLabel58 = new id.yaski.simrskhanza.widget.Label();
        PerhatianUtamaFasePemulihan = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox KelengkapanSpesimenFormulir;
    private id.yaski.simrskhanza.widget.ComboBox KelengkapanSpesimenLabel;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PeninjauanKembaliDokterAnestesi;
    private id.yaski.simrskhanza.widget.ComboBox PeninjauanKembaliDokterBedah;
    private id.yaski.simrskhanza.widget.ComboBox PeninjauanKembaliPerawatKamarOK;
    private id.yaski.simrskhanza.widget.TextBox PerhatianUtamaFasePemulihan;
    ...
    private id.yaski.simrskhanza.widget.ComboBox VerbalAlatTajam;
    private id.yaski.simrskhanza.widget.ComboBox VerbalInstrumen;
    private id.yaski.simrskhanza.widget.ComboBox VerbalKasa;

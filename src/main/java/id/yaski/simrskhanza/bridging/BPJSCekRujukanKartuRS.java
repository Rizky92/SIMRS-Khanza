...
package id.yaski.simrskhanza.bridging;
...
import id.yaski.simrskhanza.keuangan.DlgKamar;
...
import id.yaski.simrskhanza.simrskhanza.DlgCariBahasa;
import id.yaski.simrskhanza.simrskhanza.DlgCariCacatFisik;
import id.yaski.simrskhanza.simrskhanza.DlgCariCaraBayar;
import id.yaski.simrskhanza.simrskhanza.DlgCariPerusahaan;
import id.yaski.simrskhanza.simrskhanza.DlgCariSuku;
import id.yaski.simrskhanza.simrskhanza.DlgGolonganPolri;
import id.yaski.simrskhanza.simrskhanza.DlgGolonganTNI;
import id.yaski.simrskhanza.simrskhanza.DlgJabatanPolri;
import id.yaski.simrskhanza.simrskhanza.DlgJabatanTNI;
import id.yaski.simrskhanza.simrskhanza.DlgKabupaten;
import id.yaski.simrskhanza.simrskhanza.DlgKecamatan;
import id.yaski.simrskhanza.simrskhanza.DlgKelurahan;
import id.yaski.simrskhanza.simrskhanza.DlgPangkatPolri;
import id.yaski.simrskhanza.simrskhanza.DlgPangkatTNI;
import id.yaski.simrskhanza.simrskhanza.DlgPasien;
import id.yaski.simrskhanza.simrskhanza.DlgPilihanCetakDokumen;
import id.yaski.simrskhanza.simrskhanza.DlgPropinsi;
import id.yaski.simrskhanza.simrskhanza.DlgSatuanPolri;
import id.yaski.simrskhanza.simrskhanza.DlgSatuanTNI;
...
public final class BPJSCekRujukanKartuRS extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CmbJk = new id.yaski.simrskhanza.widget.ComboBox();
        DTPLahir = new id.yaski.simrskhanza.widget.Tanggal();
        TUmur = new id.yaski.simrskhanza.widget.TextBox();
        TNoPeserta = new id.yaski.simrskhanza.widget.TextBox();
        TKtp = new id.yaski.simrskhanza.widget.TextBox();
        NoRm = new id.yaski.simrskhanza.widget.TextBox();
        buttonGroup1 = new javax.swing.ButtonGroup();
        kdpoli = new id.yaski.simrskhanza.widget.TextBox();
        TPoli = new id.yaski.simrskhanza.widget.TextBox();
        TBiaya = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoBalasan = new id.yaski.simrskhanza.widget.TextBox();
        kdsuku = new id.yaski.simrskhanza.widget.TextBox();
        kdbahasa = new id.yaski.simrskhanza.widget.TextBox();
        kdgolongantni = new id.yaski.simrskhanza.widget.TextBox();
        kdsatuantni = new id.yaski.simrskhanza.widget.TextBox();
        kdpangkattni = new id.yaski.simrskhanza.widget.TextBox();
        kdjabatantni = new id.yaski.simrskhanza.widget.TextBox();
        kdgolonganpolri = new id.yaski.simrskhanza.widget.TextBox();
        kdsatuanpolri = new id.yaski.simrskhanza.widget.TextBox();
        kdpangkatpolri = new id.yaski.simrskhanza.widget.TextBox();
        kdjabatanpolri = new id.yaski.simrskhanza.widget.TextBox();
        kdperusahaan = new id.yaski.simrskhanza.widget.TextBox();
        kdcacat = new id.yaski.simrskhanza.widget.TextBox();
        KdKec = new id.yaski.simrskhanza.widget.TextBox();
        KdProp = new id.yaski.simrskhanza.widget.TextBox();
        KdKel = new id.yaski.simrskhanza.widget.TextBox();
        KdKab = new id.yaski.simrskhanza.widget.TextBox();
        internalFrame1 = new id.yaski.simrskhanza.widget.InternalFrame();
        Scroll = new id.yaski.simrskhanza.widget.ScrollPane();
        tbKamar = new id.yaski.simrskhanza.widget.Table();
        PanelInput = new javax.swing.JPanel();
        ChkCari = new id.yaski.simrskhanza.widget.CekBox();
        panelGlass6 = new id.yaski.simrskhanza.widget.panelisi();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        NoKartu = new id.yaski.simrskhanza.widget.TextBox();
        ...
        panelCari = new id.yaski.simrskhanza.widget.panelisi();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        FormInput = new id.yaski.simrskhanza.widget.PanelBiasa();
        FormKelengkapanPasien = new id.yaski.simrskhanza.widget.PanelBiasa();
        jLabel3 = new id.yaski.simrskhanza.widget.Label();
        TTmp = new id.yaski.simrskhanza.widget.TextBox();
        CMbGd = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        cmbAgama = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        CmbStts = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Alamat = new id.yaski.simrskhanza.widget.TextBox();
        TTlp = new id.yaski.simrskhanza.widget.TextBox();
        TNo = new id.yaski.simrskhanza.widget.TextBox();
        DTPDaftar = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        CMbPnd = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        Kdpnj = new id.yaski.simrskhanza.widget.TextBox();
        nmpnj = new id.yaski.simrskhanza.widget.TextBox();
        BtnPenjab = new id.yaski.simrskhanza.widget.Button();
        Kelurahan = new id.yaski.simrskhanza.widget.TextBox();
        Kecamatan = new id.yaski.simrskhanza.widget.TextBox();
        Kabupaten = new id.yaski.simrskhanza.widget.TextBox();
        BtnKelurahan = new id.yaski.simrskhanza.widget.Button();
        BtnKecamatan = new id.yaski.simrskhanza.widget.Button();
        BtnKabupaten = new id.yaski.simrskhanza.widget.Button();
        ...
        AlamatPj = new id.yaski.simrskhanza.widget.TextBox();
        KecamatanPj = new id.yaski.simrskhanza.widget.TextBox();
        BtnKecamatanPj = new id.yaski.simrskhanza.widget.Button();
        KabupatenPj = new id.yaski.simrskhanza.widget.TextBox();
        BtnKabupatenPj = new id.yaski.simrskhanza.widget.Button();
        BtnKelurahanPj = new id.yaski.simrskhanza.widget.Button();
        KelurahanPj = new id.yaski.simrskhanza.widget.TextBox();
        ChkRM = new id.yaski.simrskhanza.widget.CekBox();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        nmsukubangsa = new id.yaski.simrskhanza.widget.TextBox();
        BtnSuku = new id.yaski.simrskhanza.widget.Button();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        nmbahasa = new id.yaski.simrskhanza.widget.TextBox();
        BtnBahasa = new id.yaski.simrskhanza.widget.Button();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        nmcacat = new id.yaski.simrskhanza.widget.TextBox();
        BtnCacat = new id.yaski.simrskhanza.widget.Button();
        jLabel43 = new id.yaski.simrskhanza.widget.Label();
        nmperusahaan = new id.yaski.simrskhanza.widget.TextBox();
        BtnPerusahaan = new id.yaski.simrskhanza.widget.Button();
        jLabel44 = new id.yaski.simrskhanza.widget.Label();
        NIP = new id.yaski.simrskhanza.widget.TextBox();
        jLabel45 = new id.yaski.simrskhanza.widget.Label();
        EMail = new id.yaski.simrskhanza.widget.TextBox();
        Propinsi = new id.yaski.simrskhanza.widget.TextBox();
        BtnPropinsi = new id.yaski.simrskhanza.widget.Button();
        PropinsiPj = new id.yaski.simrskhanza.widget.TextBox();
        btnPropinsiPj = new id.yaski.simrskhanza.widget.Button();
        chkTNI = new id.yaski.simrskhanza.widget.CekBox();
        LabelGolonganTNI = new id.yaski.simrskhanza.widget.Label();
        nmgolongantni = new id.yaski.simrskhanza.widget.TextBox();
        BtnGolonganTNI = new id.yaski.simrskhanza.widget.Button();
        BtnSatuanTNI = new id.yaski.simrskhanza.widget.Button();
        nmsatuantni = new id.yaski.simrskhanza.widget.TextBox();
        LabelSatuanTNI = new id.yaski.simrskhanza.widget.Label();
        LabelPangkatTNI = new id.yaski.simrskhanza.widget.Label();
        nmpangkattni = new id.yaski.simrskhanza.widget.TextBox();
        BtnPangkatTNI = new id.yaski.simrskhanza.widget.Button();
        BtnJabatanTNI = new id.yaski.simrskhanza.widget.Button();
        nmjabatantni = new id.yaski.simrskhanza.widget.TextBox();
        LabelJabatanTNI = new id.yaski.simrskhanza.widget.Label();
        chkPolri = new id.yaski.simrskhanza.widget.CekBox();
        LabelGolonganPolri = new id.yaski.simrskhanza.widget.Label();
        nmgolonganpolri = new id.yaski.simrskhanza.widget.TextBox();
        BtnGolonganPolri = new id.yaski.simrskhanza.widget.Button();
        BtnSatuanPolri = new id.yaski.simrskhanza.widget.Button();
        nmsatuanpolri = new id.yaski.simrskhanza.widget.TextBox();
        LabelSatuanPolri = new id.yaski.simrskhanza.widget.Label();
        LabelPangkatPolri = new id.yaski.simrskhanza.widget.Label();
        nmpangkatpolri = new id.yaski.simrskhanza.widget.TextBox();
        BtnPangkatPolri = new id.yaski.simrskhanza.widget.Button();
        BtnJabatanPolri = new id.yaski.simrskhanza.widget.Button();
        nmjabatanpolri = new id.yaski.simrskhanza.widget.TextBox();
        LabelJabatanPolri = new id.yaski.simrskhanza.widget.Label();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        CmbKeluarga = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Saudara = new id.yaski.simrskhanza.widget.TextBox();
        FormKelengkapanSEP = new id.yaski.simrskhanza.widget.PanelBiasa();
        ...
        KdPPK = new id.yaski.simrskhanza.widget.TextBox();
        NmPPK = new id.yaski.simrskhanza.widget.TextBox();
        btnPPKRujukan = new id.yaski.simrskhanza.widget.Button();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        KdPpkRujukan = new id.yaski.simrskhanza.widget.TextBox();
        NmPpkRujukan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        KdPenyakit = new id.yaski.simrskhanza.widget.TextBox();
        NmPenyakit = new id.yaski.simrskhanza.widget.TextBox();
        btnDiagnosa = new id.yaski.simrskhanza.widget.Button();
        btnPoli = new id.yaski.simrskhanza.widget.Button();
        NmPoli = new id.yaski.simrskhanza.widget.TextBox();
        KdPoli = new id.yaski.simrskhanza.widget.TextBox();
        LabelPoli = new id.yaski.simrskhanza.widget.Label();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        TNoReg = new id.yaski.simrskhanza.widget.TextBox();
        jLabel37 = new id.yaski.simrskhanza.widget.Label();
        LabelPoli2 = new id.yaski.simrskhanza.widget.Label();
        KdDPJP = new id.yaski.simrskhanza.widget.TextBox();
        NmDPJP = new id.yaski.simrskhanza.widget.TextBox();
        btnDPJP = new id.yaski.simrskhanza.widget.Button();
        btnSKDP = new id.yaski.simrskhanza.widget.Button();
        AsalRujukan = new id.yaski.simrskhanza.widget.ComboBox();
        btnSPRI = new id.yaski.simrskhanza.widget.Button();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        NoSKDP = new id.yaski.simrskhanza.widget.TextBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        TanggalSEP = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        TanggalRujuk = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel31 = new id.yaski.simrskhanza.widget.Label();
        NoRujukan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        jLabel33 = new id.yaski.simrskhanza.widget.Label();
        Catatan = new id.yaski.simrskhanza.widget.TextBox();
        JenisPelayanan = new id.yaski.simrskhanza.widget.ComboBox();
        LabelKelas = new id.yaski.simrskhanza.widget.Label();
        Kelas = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel38 = new id.yaski.simrskhanza.widget.Label();
        Eksekutif = new id.yaski.simrskhanza.widget.ComboBox();
        LabelKelas1 = new id.yaski.simrskhanza.widget.Label();
        COB = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel46 = new id.yaski.simrskhanza.widget.Label();
        Katarak = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        NaikKelas = new id.yaski.simrskhanza.widget.ComboBox();
        Pembiayaan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel52 = new id.yaski.simrskhanza.widget.Label();
        PenanggungJawab = new id.yaski.simrskhanza.widget.TextBox();
        LabelKelas2 = new id.yaski.simrskhanza.widget.Label();
        ...
        LabelPoli3 = new id.yaski.simrskhanza.widget.Label();
        KdPropinsi = new id.yaski.simrskhanza.widget.TextBox();
        NmPropinsi = new id.yaski.simrskhanza.widget.TextBox();
        btnPropinsi = new id.yaski.simrskhanza.widget.Button();
        btnKabupaten = new id.yaski.simrskhanza.widget.Button();
        NmKabupaten = new id.yaski.simrskhanza.widget.TextBox();
        KdKabupaten = new id.yaski.simrskhanza.widget.TextBox();
        LabelPoli4 = new id.yaski.simrskhanza.widget.Label();
        LabelPoli5 = new id.yaski.simrskhanza.widget.Label();
        KdKecamatan = new id.yaski.simrskhanza.widget.TextBox();
        NmKecamatan = new id.yaski.simrskhanza.widget.TextBox();
        btnKecamatan = new id.yaski.simrskhanza.widget.Button();
        jLabel58 = new id.yaski.simrskhanza.widget.Label();
        TujuanKunjungan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel55 = new id.yaski.simrskhanza.widget.Label();
        Penunjang = new id.yaski.simrskhanza.widget.ComboBox();
        FlagProsedur = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        jLabel57 = new id.yaski.simrskhanza.widget.Label();
        LabelPoli6 = new id.yaski.simrskhanza.widget.Label();
        KdDPJPLayanan = new id.yaski.simrskhanza.widget.TextBox();
        NmDPJPLayanan = new id.yaski.simrskhanza.widget.TextBox();
        btnDPJPLayanan = new id.yaski.simrskhanza.widget.Button();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        LakaLantas = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel47 = new id.yaski.simrskhanza.widget.Label();
        TanggalKKL = new id.yaski.simrskhanza.widget.Tanggal();
        AsesmenPoli = new id.yaski.simrskhanza.widget.ComboBox();
        btnRiwayat = new id.yaski.simrskhanza.widget.Button();
        jLabel50 = new id.yaski.simrskhanza.widget.Label();
        NoSEPSuplesi = new id.yaski.simrskhanza.widget.TextBox();
        btnSuplesi = new id.yaski.simrskhanza.widget.Button();
        NoLP = new id.yaski.simrskhanza.widget.TextBox();
        jLabel59 = new id.yaski.simrskhanza.widget.Label();
        Keterangan = new id.yaski.simrskhanza.widget.TextBox();
        Suplesi = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Alamat;
    private id.yaski.simrskhanza.widget.TextBox AlamatPj;
    private id.yaski.simrskhanza.widget.ComboBox AsalRujukan;
    private id.yaski.simrskhanza.widget.ComboBox AsesmenPoli;
    private id.yaski.simrskhanza.widget.Button BtnBahasa;
    private id.yaski.simrskhanza.widget.Button BtnCacat;
    ...
    private id.yaski.simrskhanza.widget.Button BtnGolonganPolri;
    private id.yaski.simrskhanza.widget.Button BtnGolonganTNI;
    private id.yaski.simrskhanza.widget.Button BtnJabatanPolri;
    private id.yaski.simrskhanza.widget.Button BtnJabatanTNI;
    private id.yaski.simrskhanza.widget.Button BtnKabupaten;
    private id.yaski.simrskhanza.widget.Button BtnKabupatenPj;
    private id.yaski.simrskhanza.widget.Button BtnKecamatan;
    private id.yaski.simrskhanza.widget.Button BtnKecamatanPj;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnKelurahan;
    private id.yaski.simrskhanza.widget.Button BtnKelurahanPj;
    private id.yaski.simrskhanza.widget.Button BtnPangkatPolri;
    private id.yaski.simrskhanza.widget.Button BtnPangkatTNI;
    private id.yaski.simrskhanza.widget.Button BtnPenjab;
    private id.yaski.simrskhanza.widget.Button BtnPerusahaan;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnPropinsi;
    private id.yaski.simrskhanza.widget.Button BtnSatuanPolri;
    private id.yaski.simrskhanza.widget.Button BtnSatuanTNI;
    private id.yaski.simrskhanza.widget.Button BtnSimpan;
    private id.yaski.simrskhanza.widget.Button BtnSuku;
    private id.yaski.simrskhanza.widget.ComboBox CMbGd;
    private id.yaski.simrskhanza.widget.ComboBox CMbPnd;
    private id.yaski.simrskhanza.widget.ComboBox COB;
    private id.yaski.simrskhanza.widget.TextBox Catatan;
    private id.yaski.simrskhanza.widget.CekBox ChkCari;
    private id.yaski.simrskhanza.widget.CekBox ChkRM;
    private id.yaski.simrskhanza.widget.ComboBox CmbJk;
    private id.yaski.simrskhanza.widget.ComboBox CmbKeluarga;
    private id.yaski.simrskhanza.widget.ComboBox CmbStts;
    private id.yaski.simrskhanza.widget.Tanggal DTPDaftar;
    private id.yaski.simrskhanza.widget.Tanggal DTPLahir;
    private id.yaski.simrskhanza.widget.TextBox EMail;
    private id.yaski.simrskhanza.widget.ComboBox Eksekutif;
    private id.yaski.simrskhanza.widget.ComboBox FlagProsedur;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.PanelBiasa FormKelengkapanPasien;
    private id.yaski.simrskhanza.widget.PanelBiasa FormKelengkapanSEP;
    private id.yaski.simrskhanza.widget.ComboBox JenisPelayanan;
    private id.yaski.simrskhanza.widget.TextBox Kabupaten;
    private id.yaski.simrskhanza.widget.TextBox KabupatenPj;
    private id.yaski.simrskhanza.widget.ComboBox Katarak;
    private id.yaski.simrskhanza.widget.TextBox KdDPJP;
    private id.yaski.simrskhanza.widget.TextBox KdDPJPLayanan;
    private id.yaski.simrskhanza.widget.TextBox KdKab;
    private id.yaski.simrskhanza.widget.TextBox KdKabupaten;
    private id.yaski.simrskhanza.widget.TextBox KdKec;
    private id.yaski.simrskhanza.widget.TextBox KdKecamatan;
    private id.yaski.simrskhanza.widget.TextBox KdKel;
    private id.yaski.simrskhanza.widget.TextBox KdPPK;
    private id.yaski.simrskhanza.widget.TextBox KdPenyakit;
    private id.yaski.simrskhanza.widget.TextBox KdPoli;
    private id.yaski.simrskhanza.widget.TextBox KdPpkRujukan;
    private id.yaski.simrskhanza.widget.TextBox KdProp;
    private id.yaski.simrskhanza.widget.TextBox KdPropinsi;
    private id.yaski.simrskhanza.widget.TextBox Kdpnj;
    private id.yaski.simrskhanza.widget.TextBox Kecamatan;
    private id.yaski.simrskhanza.widget.TextBox KecamatanPj;
    private id.yaski.simrskhanza.widget.ComboBox Kelas;
    private id.yaski.simrskhanza.widget.TextBox Kelurahan;
    private id.yaski.simrskhanza.widget.TextBox KelurahanPj;
    private id.yaski.simrskhanza.widget.TextBox Keterangan;
    private id.yaski.simrskhanza.widget.Label LabelGolonganPolri;
    private id.yaski.simrskhanza.widget.Label LabelGolonganTNI;
    private id.yaski.simrskhanza.widget.Label LabelJabatanPolri;
    private id.yaski.simrskhanza.widget.Label LabelJabatanTNI;
    private id.yaski.simrskhanza.widget.Label LabelKelas;
    private id.yaski.simrskhanza.widget.Label LabelKelas1;
    private id.yaski.simrskhanza.widget.Label LabelKelas2;
    private id.yaski.simrskhanza.widget.Label LabelPangkatPolri;
    private id.yaski.simrskhanza.widget.Label LabelPangkatTNI;
    private id.yaski.simrskhanza.widget.Label LabelPoli;
    private id.yaski.simrskhanza.widget.Label LabelPoli2;
    private id.yaski.simrskhanza.widget.Label LabelPoli3;
    private id.yaski.simrskhanza.widget.Label LabelPoli4;
    private id.yaski.simrskhanza.widget.Label LabelPoli5;
    private id.yaski.simrskhanza.widget.Label LabelPoli6;
    private id.yaski.simrskhanza.widget.Label LabelSatuanPolri;
    private id.yaski.simrskhanza.widget.Label LabelSatuanTNI;
    private id.yaski.simrskhanza.widget.ComboBox LakaLantas;
    private javax.swing.JMenuItem MnDocument;
    private id.yaski.simrskhanza.widget.TextBox NIP;
    private id.yaski.simrskhanza.widget.ComboBox NaikKelas;
    private id.yaski.simrskhanza.widget.TextBox NmDPJP;
    private id.yaski.simrskhanza.widget.TextBox NmDPJPLayanan;
    private id.yaski.simrskhanza.widget.TextBox NmIbu;
    private id.yaski.simrskhanza.widget.TextBox NmKabupaten;
    private id.yaski.simrskhanza.widget.TextBox NmKecamatan;
    private id.yaski.simrskhanza.widget.TextBox NmPPK;
    private id.yaski.simrskhanza.widget.TextBox NmPenyakit;
    private id.yaski.simrskhanza.widget.TextBox NmPoli;
    private id.yaski.simrskhanza.widget.TextBox NmPpkRujukan;
    private id.yaski.simrskhanza.widget.TextBox NmPropinsi;
    private id.yaski.simrskhanza.widget.TextBox NoBalasan;
    private id.yaski.simrskhanza.widget.TextBox NoKartu;
    private id.yaski.simrskhanza.widget.TextBox NoLP;
    private id.yaski.simrskhanza.widget.TextBox NoRm;
    private id.yaski.simrskhanza.widget.TextBox NoRujukan;
    private id.yaski.simrskhanza.widget.TextBox NoSEPSuplesi;
    private id.yaski.simrskhanza.widget.TextBox NoSKDP;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Pekerjaan;
    private id.yaski.simrskhanza.widget.TextBox PekerjaanPj;
    private id.yaski.simrskhanza.widget.ComboBox Pembiayaan;
    private id.yaski.simrskhanza.widget.TextBox PenanggungJawab;
    private id.yaski.simrskhanza.widget.ComboBox Penunjang;
    private id.yaski.simrskhanza.widget.TextBox Propinsi;
    private id.yaski.simrskhanza.widget.TextBox PropinsiPj;
    private id.yaski.simrskhanza.widget.TextBox Saudara;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox Suplesi;
    private id.yaski.simrskhanza.widget.TextBox TBiaya;
    private id.yaski.simrskhanza.widget.TextBox TDokter;
    private id.yaski.simrskhanza.widget.TextBox TKtp;
    private id.yaski.simrskhanza.widget.TextBox TNm;
    private id.yaski.simrskhanza.widget.TextBox TNo;
    private id.yaski.simrskhanza.widget.TextBox TNoPeserta;
    private id.yaski.simrskhanza.widget.TextBox TNoReg;
    private id.yaski.simrskhanza.widget.TextBox TNoRw;
    private id.yaski.simrskhanza.widget.TextBox TPoli;
    private id.yaski.simrskhanza.widget.TextBox TTlp;
    private id.yaski.simrskhanza.widget.TextBox TTmp;
    private id.yaski.simrskhanza.widget.TextBox TUmur;
    private id.yaski.simrskhanza.widget.Tanggal TanggalKKL;
    private id.yaski.simrskhanza.widget.Tanggal TanggalRujuk;
    private id.yaski.simrskhanza.widget.Tanggal TanggalSEP;
    private id.yaski.simrskhanza.widget.ComboBox TujuanKunjungan;
    private id.yaski.simrskhanza.widget.Button btnDPJP;
    private id.yaski.simrskhanza.widget.Button btnDPJPLayanan;
    private id.yaski.simrskhanza.widget.Button btnDiagnosa;
    private id.yaski.simrskhanza.widget.Button btnKabupaten;
    private id.yaski.simrskhanza.widget.Button btnKecamatan;
    private id.yaski.simrskhanza.widget.Button btnPPKRujukan;
    private id.yaski.simrskhanza.widget.Button btnPasien;
    private id.yaski.simrskhanza.widget.Button btnPoli;
    private id.yaski.simrskhanza.widget.Button btnPropinsi;
    private id.yaski.simrskhanza.widget.Button btnPropinsiPj;
    private id.yaski.simrskhanza.widget.Button btnRiwayat;
    private id.yaski.simrskhanza.widget.Button btnSKDP;
    private id.yaski.simrskhanza.widget.Button btnSPRI;
    private id.yaski.simrskhanza.widget.Button btnSuplesi;
    private javax.swing.ButtonGroup buttonGroup1;
    private id.yaski.simrskhanza.widget.CekBox chkPolri;
    private id.yaski.simrskhanza.widget.CekBox chkTNI;
    private id.yaski.simrskhanza.widget.ComboBox cmbAgama;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdbahasa;
    private id.yaski.simrskhanza.widget.TextBox kdcacat;
    private id.yaski.simrskhanza.widget.TextBox kddokter;
    private id.yaski.simrskhanza.widget.TextBox kdgolonganpolri;
    private id.yaski.simrskhanza.widget.TextBox kdgolongantni;
    private id.yaski.simrskhanza.widget.TextBox kdjabatanpolri;
    private id.yaski.simrskhanza.widget.TextBox kdjabatantni;
    private id.yaski.simrskhanza.widget.TextBox kdpangkatpolri;
    private id.yaski.simrskhanza.widget.TextBox kdpangkattni;
    private id.yaski.simrskhanza.widget.TextBox kdperusahaan;
    private id.yaski.simrskhanza.widget.TextBox kdpoli;
    private id.yaski.simrskhanza.widget.TextBox kdsatuanpolri;
    private id.yaski.simrskhanza.widget.TextBox kdsatuantni;
    private id.yaski.simrskhanza.widget.TextBox kdsuku;
    private id.yaski.simrskhanza.widget.TextBox nmbahasa;
    private id.yaski.simrskhanza.widget.TextBox nmcacat;
    private id.yaski.simrskhanza.widget.TextBox nmgolonganpolri;
    private id.yaski.simrskhanza.widget.TextBox nmgolongantni;
    private id.yaski.simrskhanza.widget.TextBox nmjabatanpolri;
    private id.yaski.simrskhanza.widget.TextBox nmjabatantni;
    private id.yaski.simrskhanza.widget.TextBox nmpangkatpolri;
    private id.yaski.simrskhanza.widget.TextBox nmpangkattni;
    private id.yaski.simrskhanza.widget.TextBox nmperusahaan;
    private id.yaski.simrskhanza.widget.TextBox nmpnj;
    private id.yaski.simrskhanza.widget.TextBox nmsatuanpolri;
    private id.yaski.simrskhanza.widget.TextBox nmsatuantni;
    private id.yaski.simrskhanza.widget.TextBox nmsukubangsa;
    private id.yaski.simrskhanza.widget.panelisi panelCari;
    private id.yaski.simrskhanza.widget.panelisi panelGlass6;
    ...
    private id.yaski.simrskhanza.widget.Table tbKamar;

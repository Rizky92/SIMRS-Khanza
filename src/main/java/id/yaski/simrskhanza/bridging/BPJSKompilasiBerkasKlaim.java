...
public class BPJSKompilasiBerkasKlaim extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnCloseIn8 = new id.yaski.simrskhanza.widget.Button();
        BtnSimpan8 = new id.yaski.simrskhanza.widget.Button();
        ...
        TNoRwPulang = new id.yaski.simrskhanza.widget.TextBox();
        TNoRMPulang = new id.yaski.simrskhanza.widget.TextBox();
        TPasienPulang = new id.yaski.simrskhanza.widget.TextBox();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        TNoSEPRanapPulang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnBukaFolderExport = new id.yaski.simrskhanza.widget.Button();
        CmbPilihanAplikasiPDF = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        TPathAplikasiPDF = new id.yaski.simrskhanza.widget.TextBox();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        CmbPilihanTanggalExport = new id.yaski.simrskhanza.widget.ComboBox();
        BtnPilihAplikasiPDF = new id.yaski.simrskhanza.widget.Button();
        TMaxMemory = new id.yaski.simrskhanza.widget.TextBox();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        CekAktifkanHapusOtomatis = new id.yaski.simrskhanza.widget.CekBox();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        CmbPilihanKategoriBerkas = new id.yaski.simrskhanza.widget.ComboBox();
        panelBiasa5 = new id.yaski.simrskhanza.widget.PanelBiasa();
        BtnSimpanPengaturan = new id.yaski.simrskhanza.widget.Button();
        BtnResetPengaturan = new id.yaski.simrskhanza.widget.Button();
        BtnTutupPengaturan = new id.yaski.simrskhanza.widget.Button();
        ...
        namaPJ = new id.yaski.simrskhanza.widget.TextBox();
        BtnPenjamin = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnPengaturan = new id.yaski.simrskhanza.widget.Button();
        ...
        CmbStatusRawat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        CmbStatusKirim = new id.yaski.simrskhanza.widget.ComboBox();
        lblCoderNIK = new id.yaski.simrskhanza.widget.Label();
        jPanel1 = new javax.swing.JPanel();
        jPanel4 = new javax.swing.JPanel();
        panelGlass11 = new id.yaski.simrskhanza.widget.panelisi();
        Scroll = new id.yaski.simrskhanza.widget.ScrollPane();
        tbKompilasi = new id.yaski.simrskhanza.widget.Table();
        ...
        lblNamaPasien = new id.yaski.simrskhanza.widget.Label();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        lblNoRawat = new id.yaski.simrskhanza.widget.Label();
        lblNoRM = new id.yaski.simrskhanza.widget.Label();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        btnSEP = new id.yaski.simrskhanza.widget.Button();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        btnResumeRanap = new id.yaski.simrskhanza.widget.Button();
        ...
        btnHasilLab = new id.yaski.simrskhanza.widget.Button();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        btnHasilRad = new id.yaski.simrskhanza.widget.Button();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        btnSurkon = new id.yaski.simrskhanza.widget.Button();
        ...
        lblStatusRawat = new id.yaski.simrskhanza.widget.Label();
        BtnSimpanKoding = new id.yaski.simrskhanza.widget.Button();
        BtnHapusKoding = new id.yaski.simrskhanza.widget.Button();
        jLabel32 = new id.yaski.simrskhanza.widget.Label();
        btnRiwayatPasien = new id.yaski.simrskhanza.widget.Button();
        jLabel33 = new id.yaski.simrskhanza.widget.Label();
        btnHasilKlaim = new id.yaski.simrskhanza.widget.Button();
        jLabel34 = new id.yaski.simrskhanza.widget.Label();
        btnTriaseIGD = new id.yaski.simrskhanza.widget.Button();
        lblTglSEP = new id.yaski.simrskhanza.widget.Label();
        tabPaneKoding = new id.yaski.simrskhanza.widget.TabPane();
        panelIdrg = new id.yaski.simrskhanza.laporan.PanelIdrgSmc();
        panelInacbg = new id.yaski.simrskhanza.laporan.PanelInacbgSmc();
        panelBiasa2 = new id.yaski.simrskhanza.widget.PanelBiasa();
        BtnKompilasi = new id.yaski.simrskhanza.widget.Button();
        jPanel5 = new javax.swing.JPanel();
        tabKanan = new id.yaski.simrskhanza.widget.TabPane();
        panelInvoices = new id.yaski.simrskhanza.widget.panelisi();
        panelBiasa3 = new id.yaski.simrskhanza.widget.PanelBiasa();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        loadBillingHTML = new id.yaski.simrskhanza.widget.editorpane();
        btnInvoice = new id.yaski.simrskhanza.widget.Button();
        PanelContentINACBG = new id.yaski.simrskhanza.widget.panelisi();
        PanelBerkasDigital = new id.yaski.simrskhanza.widget.panelisi();
    ...
    private id.yaski.simrskhanza.widget.Button BtnBukaFolderExport;
    private id.yaski.simrskhanza.widget.Button BtnCari;
    private id.yaski.simrskhanza.widget.Button BtnCloseIn8;
    private id.yaski.simrskhanza.widget.Button BtnHapusKoding;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnKompilasi;
    private id.yaski.simrskhanza.widget.Button BtnPengaturan;
    private id.yaski.simrskhanza.widget.Button BtnPenjamin;
    private id.yaski.simrskhanza.widget.Button BtnPilihAplikasiPDF;
    private id.yaski.simrskhanza.widget.Button BtnResetPengaturan;
    private id.yaski.simrskhanza.widget.Button BtnSimpan8;
    private id.yaski.simrskhanza.widget.Button BtnSimpanKoding;
    private id.yaski.simrskhanza.widget.Button BtnSimpanPengaturan;
    private id.yaski.simrskhanza.widget.Button BtnTutupPengaturan;
    private id.yaski.simrskhanza.widget.CekBox CekAktifkanHapusOtomatis;
    private id.yaski.simrskhanza.widget.ComboBox CmbPilihanAplikasiPDF;
    private id.yaski.simrskhanza.widget.ComboBox CmbPilihanKategoriBerkas;
    private id.yaski.simrskhanza.widget.ComboBox CmbPilihanTanggalExport;
    private id.yaski.simrskhanza.widget.ComboBox CmbStatusKirim;
    private id.yaski.simrskhanza.widget.ComboBox CmbStatusRawat;
    ...
    private id.yaski.simrskhanza.widget.panelisi PanelBerkasDigital;
    private id.yaski.simrskhanza.widget.panelisi PanelContentINACBG;
    ...
    private id.yaski.simrskhanza.widget.TextBox TMaxMemory;
    private id.yaski.simrskhanza.widget.TextBox TNoRMPulang;
    private id.yaski.simrskhanza.widget.TextBox TNoRwPulang;
    private id.yaski.simrskhanza.widget.TextBox TNoSEPRanapPulang;
    private id.yaski.simrskhanza.widget.TextBox TPasienPulang;
    private id.yaski.simrskhanza.widget.TextBox TPathAplikasiPDF;
    ...
    private id.yaski.simrskhanza.widget.Button btnHasilKlaim;
    private id.yaski.simrskhanza.widget.Button btnHasilLab;
    private id.yaski.simrskhanza.widget.Button btnHasilRad;
    private id.yaski.simrskhanza.widget.Button btnInvoice;
    private id.yaski.simrskhanza.widget.Button btnResumeRanap;
    private id.yaski.simrskhanza.widget.Button btnRiwayatPasien;
    private id.yaski.simrskhanza.widget.Button btnSEP;
    private id.yaski.simrskhanza.widget.Button btnSPRI;
    private id.yaski.simrskhanza.widget.Button btnSurkon;
    ...
    private id.yaski.simrskhanza.widget.Label lblCoderNIK;
    private id.yaski.simrskhanza.widget.Label lblNamaPasien;
    private id.yaski.simrskhanza.widget.Label lblNoRM;
    private id.yaski.simrskhanza.widget.Label lblNoRawat;
    private id.yaski.simrskhanza.widget.Label lblStatusRawat;
    private id.yaski.simrskhanza.widget.Label lblTglSEP;
    private id.yaski.simrskhanza.widget.editorpane loadBillingHTML;
    private id.yaski.simrskhanza.widget.TextBox namaPJ;
    ...
    private id.yaski.simrskhanza.widget.PanelBiasa panelBiasa5;
    ...
    private id.yaski.simrskhanza.widget.panelisi panelInvoices;
    ...
    private id.yaski.simrskhanza.widget.TabPane tabKanan;
    private id.yaski.simrskhanza.widget.TabPane tabPaneKoding;
    private id.yaski.simrskhanza.widget.Table tbKompilasi;

...
public final class BPJSCekReferensiJadwalHFIS extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnSimpanUpdate = new id.yaski.simrskhanza.widget.Button();
        jLabel21 = new id.yaski.simrskhanza.widget.Label();
        KodePoliUpdate = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliUpdate = new id.yaski.simrskhanza.widget.TextBox();
        btnPoliklinikUpdate = new id.yaski.simrskhanza.widget.Button();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        KodeDokterUpdate = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterUpdate = new id.yaski.simrskhanza.widget.TextBox();
        btnDokterUpdate = new id.yaski.simrskhanza.widget.Button();
        jLabel4 = new id.yaski.simrskhanza.widget.Label();
        cmbHari = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        cmbJam1 = new id.yaski.simrskhanza.widget.ComboBox();
        cmbMnt1 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        cmbJam2 = new id.yaski.simrskhanza.widget.ComboBox();
        cmbMnt2 = new id.yaski.simrskhanza.widget.ComboBox();
        KodeSubspesialis = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnSimpanUpdate;
    private id.yaski.simrskhanza.widget.TextBox KdPoli;
    private id.yaski.simrskhanza.widget.TextBox KodeDokterUpdate;
    private id.yaski.simrskhanza.widget.TextBox KodePoliUpdate;
    private id.yaski.simrskhanza.widget.TextBox KodeSubspesialis;
    private id.yaski.simrskhanza.widget.TextBox NmDokterUpdate;
    private id.yaski.simrskhanza.widget.TextBox NmPoli;
    private id.yaski.simrskhanza.widget.TextBox NmPoliUpdate;
    ...
    private id.yaski.simrskhanza.widget.Button btnDokterUpdate;
    private id.yaski.simrskhanza.widget.Button btnPoliklinikUpdate;
    private id.yaski.simrskhanza.widget.ComboBox cmbHari;
    private id.yaski.simrskhanza.widget.ComboBox cmbJam1;
    private id.yaski.simrskhanza.widget.ComboBox cmbJam2;
    private id.yaski.simrskhanza.widget.ComboBox cmbMnt1;
    private id.yaski.simrskhanza.widget.ComboBox cmbMnt2;

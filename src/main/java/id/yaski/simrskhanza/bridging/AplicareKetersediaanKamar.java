...
public final class AplicareKetersediaanKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdKelas = new id.yaski.simrskhanza.widget.TextBox();
        NmKelas = new id.yaski.simrskhanza.widget.TextBox();
        btnKelas = new id.yaski.simrskhanza.widget.Button();
        ...
        TersediaPW = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdKelas;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmKelas;
    ...
    private id.yaski.simrskhanza.widget.TextBox TersediaPW;
    ...
    private id.yaski.simrskhanza.widget.Button btnKelas;

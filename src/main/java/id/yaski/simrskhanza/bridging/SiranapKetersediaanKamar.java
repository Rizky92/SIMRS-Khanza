...
public final class SiranapKetersediaanKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tersedia = new id.yaski.simrskhanza.widget.TextBox();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        TersediaMenunggu = new id.yaski.simrskhanza.widget.TextBox();
        TersediaPria = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        TersediaWanita = new id.yaski.simrskhanza.widget.TextBox();
        RuangSiranap = new id.yaski.simrskhanza.widget.ComboBox();
        KelasSiranap = new id.yaski.simrskhanza.widget.ComboBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox KelasSiranap;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmKamar;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox RuangSiranap;
    ...
    private id.yaski.simrskhanza.widget.TextBox Tersedia;
    private id.yaski.simrskhanza.widget.TextBox TersediaMenunggu;
    private id.yaski.simrskhanza.widget.TextBox TersediaPria;
    private id.yaski.simrskhanza.widget.TextBox TersediaWanita;

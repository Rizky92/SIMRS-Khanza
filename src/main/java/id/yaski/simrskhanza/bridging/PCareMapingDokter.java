...
public final class PCareMapingDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdPoliPCare = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliPCare = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdPoliPCare;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmPoliPCare;

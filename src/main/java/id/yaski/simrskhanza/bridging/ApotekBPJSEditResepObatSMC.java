...
public final class ApotekBPJSEditResepObatSMC extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Iterasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        JenisObat = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        TglResep = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        TglPelayanan = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        LTotal = new id.yaski.simrskhanza.widget.Label();
        TabRawat = new id.yaski.simrskhanza.widget.TabPane();
        ...
        tbRacikan = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbDetailRacikanObat = new id.yaski.simrskhanza.widget.Table();
    ...
    private id.yaski.simrskhanza.widget.ComboBox Iterasi;
    private id.yaski.simrskhanza.widget.ComboBox JenisObat;
    ...
    private id.yaski.simrskhanza.widget.TabPane TabRawat;
    private id.yaski.simrskhanza.widget.TextBox TglLahir;
    private id.yaski.simrskhanza.widget.Tanggal TglPelayanan;
    private id.yaski.simrskhanza.widget.Tanggal TglResep;
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailRacikanObat;
    private id.yaski.simrskhanza.widget.Table tbObat;
    private id.yaski.simrskhanza.widget.Table tbRacikan;

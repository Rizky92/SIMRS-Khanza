...
public class InhealthReferensiJenpelRuang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TKdBngsal = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KdJenisPelayanan = new id.yaski.simrskhanza.widget.TextBox();
        NmJenisPelayanan = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdJenisPelayanan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmJenisPelayanan;
    ...
    private id.yaski.simrskhanza.widget.TextBox TKdBngsal;

...
public final class SatuSehatMapingLaborat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        IDTemplate = new id.yaski.simrskhanza.widget.TextBox();
        BtnCariTemplateLab = new id.yaski.simrskhanza.widget.Button();
        PeriksaCode = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        PeriksaDisplay = new id.yaski.simrskhanza.widget.TextBox();
        PeriksaSystem = new id.yaski.simrskhanza.widget.TextBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        SampelCode = new id.yaski.simrskhanza.widget.TextBox();
        SampelDisplay = new id.yaski.simrskhanza.widget.TextBox();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        SampelSystem = new id.yaski.simrskhanza.widget.TextBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        NamaTindakan = new id.yaski.simrskhanza.widget.TextBox();
        NamaPemeriksaan = new id.yaski.simrskhanza.widget.TextBox();
        BtnCariReferensiMapping = new id.yaski.simrskhanza.widget.Button();
        BtnCariReferensiSampel = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnCariReferensiMapping;
    private id.yaski.simrskhanza.widget.Button BtnCariReferensiSampel;
    private id.yaski.simrskhanza.widget.Button BtnCariTemplateLab;
    ...
    private id.yaski.simrskhanza.widget.TextBox IDTemplate;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NamaPemeriksaan;
    private id.yaski.simrskhanza.widget.TextBox NamaTindakan;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox PeriksaCode;
    private id.yaski.simrskhanza.widget.TextBox PeriksaDisplay;
    private id.yaski.simrskhanza.widget.TextBox PeriksaSystem;
    private id.yaski.simrskhanza.widget.TextBox SampelCode;
    private id.yaski.simrskhanza.widget.TextBox SampelDisplay;
    private id.yaski.simrskhanza.widget.TextBox SampelSystem;

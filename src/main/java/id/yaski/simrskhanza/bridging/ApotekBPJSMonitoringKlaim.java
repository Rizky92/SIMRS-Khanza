...
public final class ApotekBPJSMonitoringKlaim extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LCountPengajuan = new id.yaski.simrskhanza.widget.Label();
        label15 = new id.yaski.simrskhanza.widget.Label();
        LCountDisetujui = new id.yaski.simrskhanza.widget.Label();
        ...
        Bulan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Bulan;
    private id.yaski.simrskhanza.widget.ComboBox Jenis;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.Label LCountDisetujui;
    private id.yaski.simrskhanza.widget.Label LCountPengajuan;

...
public final class BPJSMapingPoli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdPoliBPJS = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliBPJS = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdPoliBPJS;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmPoliBPJS;

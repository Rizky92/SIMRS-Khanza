...
public final class InhealthTagihan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbSJP = new id.yaski.simrskhanza.widget.Table();
        ...
        LTagihan = new id.yaski.simrskhanza.widget.Label();
        ...
        tbTagihanKamar = new id.yaski.simrskhanza.widget.Table();
        Scroll4 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbTagihanRawatJalan = new id.yaski.simrskhanza.widget.Table();
        Scroll5 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbTagihanRawatInap = new id.yaski.simrskhanza.widget.Table();
        Scroll6 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbTagihanOperasi = new id.yaski.simrskhanza.widget.Table();
        Scroll7 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbTagihanRadiologi = new id.yaski.simrskhanza.widget.Table();
        Scroll8 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbTagihanLaborat = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Label LTagihan;
    ...
    private id.yaski.simrskhanza.widget.Table tbSJP;
    private id.yaski.simrskhanza.widget.Table tbTagihanKamar;
    private id.yaski.simrskhanza.widget.Table tbTagihanLaborat;
    private id.yaski.simrskhanza.widget.Table tbTagihanOperasi;
    private id.yaski.simrskhanza.widget.Table tbTagihanRadiologi;
    private id.yaski.simrskhanza.widget.Table tbTagihanRawatInap;
    private id.yaski.simrskhanza.widget.Table tbTagihanRawatJalan;

...
public final class PCareKegiatanKelompok extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        EduId = new id.yaski.simrskhanza.widget.TextBox();
        ...
        kdClub = new id.yaski.simrskhanza.widget.TextBox();
        NmClub = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Kegiatan = new id.yaski.simrskhanza.widget.ComboBox();
        Kelompok = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel28 = new id.yaski.simrskhanza.widget.Label();
        jLabel36 = new id.yaski.simrskhanza.widget.Label();
        Materi = new id.yaski.simrskhanza.widget.TextBox();
        Pembicara = new id.yaski.simrskhanza.widget.TextBox();
        ...
        btnPoliRS1 = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox EduId;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.ComboBox Kegiatan;
    private id.yaski.simrskhanza.widget.ComboBox Kelompok;
    ...
    private id.yaski.simrskhanza.widget.TextBox Materi;
    private id.yaski.simrskhanza.widget.TextBox NmClub;
    ...
    private id.yaski.simrskhanza.widget.TextBox Pembicara;
    ...
    private id.yaski.simrskhanza.widget.Button btnPoliRS1;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdClub;

...
public final class InhealthMapingDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdDokterRS = new id.yaski.simrskhanza.widget.TextBox();
        NmDokterRS = new id.yaski.simrskhanza.widget.TextBox();
        btnPoliRS = new id.yaski.simrskhanza.widget.Button();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        KdDokterInhealth = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdDokterInhealth;
    private id.yaski.simrskhanza.widget.TextBox KdDokterRS;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmDokterRS;

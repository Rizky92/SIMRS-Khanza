...
public class OrthancDICOM extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PanelMenu = new id.yaski.simrskhanza.widget.panelisi();
        BtnPng = new id.yaski.simrskhanza.widget.Button();
        BtnJpg = new id.yaski.simrskhanza.widget.Button();
        BtnBmp = new id.yaski.simrskhanza.widget.Button();
        BtnDcm = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnBmp;
    private id.yaski.simrskhanza.widget.Button BtnDcm;
    private id.yaski.simrskhanza.widget.Button BtnJpg;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnPng;
    private id.yaski.simrskhanza.widget.panelisi PanelMenu;

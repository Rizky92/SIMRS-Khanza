...
public final class SatuSehatKirimObservationTTV extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnUpdate = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnUpdate;
    ...
    private id.yaski.simrskhanza.widget.Table tbBB;
    private id.yaski.simrskhanza.widget.Table tbGCS;
    private id.yaski.simrskhanza.widget.Table tbKesadaran;
    private id.yaski.simrskhanza.widget.Table tbLP;
    private id.yaski.simrskhanza.widget.Table tbNadi;
    private id.yaski.simrskhanza.widget.Table tbRespirasi;
    private id.yaski.simrskhanza.widget.Table tbSpO2;
    private id.yaski.simrskhanza.widget.Table tbSuhu;
    private id.yaski.simrskhanza.widget.Table tbTB;
    private id.yaski.simrskhanza.widget.Table tbTensi;

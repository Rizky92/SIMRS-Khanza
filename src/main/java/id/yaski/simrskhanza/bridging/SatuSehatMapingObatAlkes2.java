...
public final class SatuSehatMapingObatAlkes2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormCode = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        NumeratorCode = new id.yaski.simrskhanza.widget.TextBox();
        KodeBarang = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        KFADisplay = new id.yaski.simrskhanza.widget.TextBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        FormSystem = new id.yaski.simrskhanza.widget.TextBox();
        FormDisplay = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NumeratorSystem = new id.yaski.simrskhanza.widget.TextBox();
        DenominatorCode = new id.yaski.simrskhanza.widget.TextBox();
        KFASystem = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        DenominatorSystem = new id.yaski.simrskhanza.widget.TextBox();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        RouteCode = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        RouteSystem = new id.yaski.simrskhanza.widget.TextBox();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        RouteDisplay = new id.yaski.simrskhanza.widget.TextBox();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        KFACode = new id.yaski.simrskhanza.widget.TextBox();
        btnCariKFA = new id.yaski.simrskhanza.widget.Button();
        Satuan = new id.yaski.simrskhanza.widget.TextBox();
        Kategori = new id.yaski.simrskhanza.widget.TextBox();
        btnNumer = new id.yaski.simrskhanza.widget.Button();
        btnDenom = new id.yaski.simrskhanza.widget.Button();
        btnRoute = new id.yaski.simrskhanza.widget.Button();
    ...
    private id.yaski.simrskhanza.widget.TextBox DenominatorCode;
    private id.yaski.simrskhanza.widget.TextBox DenominatorSystem;
    private id.yaski.simrskhanza.widget.TextBox FormCode;
    private id.yaski.simrskhanza.widget.TextBox FormDisplay;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox FormSystem;
    private id.yaski.simrskhanza.widget.TextBox KFACode;
    private id.yaski.simrskhanza.widget.TextBox KFADisplay;
    private id.yaski.simrskhanza.widget.TextBox KFASystem;
    private id.yaski.simrskhanza.widget.TextBox Kategori;
    private id.yaski.simrskhanza.widget.TextBox KodeBarang;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NamaBarang;
    private id.yaski.simrskhanza.widget.TextBox NumeratorCode;
    private id.yaski.simrskhanza.widget.TextBox NumeratorSystem;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox RouteCode;
    private id.yaski.simrskhanza.widget.TextBox RouteDisplay;
    private id.yaski.simrskhanza.widget.TextBox RouteSystem;
    private id.yaski.simrskhanza.widget.TextBox Satuan;
    ...
    private id.yaski.simrskhanza.widget.Button btnCariKFA;
    private id.yaski.simrskhanza.widget.Button btnDenom;
    private id.yaski.simrskhanza.widget.Button btnNumer;
    private id.yaski.simrskhanza.widget.Button btnRoute;

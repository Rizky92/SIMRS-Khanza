...
public final class PCareMapingTindakanRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TTindakan = new id.yaski.simrskhanza.widget.TextBox();
        btnPoliRS = new id.yaski.simrskhanza.widget.Button();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        KdTindakanPCare = new id.yaski.simrskhanza.widget.TextBox();
        NmTindakanPCare = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdTindakanPCare;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmTindakanPCare;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TTindakan;

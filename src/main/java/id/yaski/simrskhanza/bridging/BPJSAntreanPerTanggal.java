...
public final class BPJSAntreanPerTanggal extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TotBelum = new id.yaski.simrskhanza.widget.Label();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        TotSelesai = new id.yaski.simrskhanza.widget.Label();
        ...
        SEPTerbit = new id.yaski.simrskhanza.widget.Label();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        JknBelum = new id.yaski.simrskhanza.widget.Label();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        JknSelesai = new id.yaski.simrskhanza.widget.Label();
        JknCapaian = new id.yaski.simrskhanza.widget.Label();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        MJknBelum = new id.yaski.simrskhanza.widget.Label();
        MJknCapaian = new id.yaski.simrskhanza.widget.Label();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        MJknSelesai = new id.yaski.simrskhanza.widget.Label();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        NonJKNBelum = new id.yaski.simrskhanza.widget.Label();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        NonJKNSelesai = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Label JknBelum;
    private id.yaski.simrskhanza.widget.Label JknCapaian;
    private id.yaski.simrskhanza.widget.Label JknSelesai;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.Label MJknBelum;
    private id.yaski.simrskhanza.widget.Label MJknCapaian;
    private id.yaski.simrskhanza.widget.Label MJknSelesai;
    private javax.swing.JMenuItem MnCekKodeBooking;
    private id.yaski.simrskhanza.widget.Label NonJKNBelum;
    private id.yaski.simrskhanza.widget.Label NonJKNSelesai;
    private id.yaski.simrskhanza.widget.Label SEPTerbit;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.Label TotBelum;
    private id.yaski.simrskhanza.widget.Label TotSelesai;

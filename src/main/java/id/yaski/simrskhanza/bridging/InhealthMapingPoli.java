...
public final class InhealthMapingPoli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdPoliInhealth = new id.yaski.simrskhanza.widget.TextBox();
        NmPoliInhealth = new id.yaski.simrskhanza.widget.TextBox();
        btnPoliInhealth = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdPoliInhealth;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmPoliInhealth;
    ...
    private id.yaski.simrskhanza.widget.Button btnPoliInhealth;

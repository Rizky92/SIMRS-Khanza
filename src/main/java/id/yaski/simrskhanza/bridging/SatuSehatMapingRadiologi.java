...
public final class SatuSehatMapingRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KodePemeriksaan = new id.yaski.simrskhanza.widget.TextBox();
        BtnCariTindakanRadiologi = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnCariTindakanRadiologi;
    ...
    private id.yaski.simrskhanza.widget.TextBox KodePemeriksaan;

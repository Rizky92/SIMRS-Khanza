...
import id.yaski.simrskhanza.inventory.DlgPiutang;
...
public final class ApotekBPJSKirimResepObatSMC extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnSimpanResepKosong = new id.yaski.simrskhanza.widget.Button();
        BtnInsertObat = new id.yaski.simrskhanza.widget.Button();
        BtnInsertObatRacikan = new id.yaski.simrskhanza.widget.Button();
        ...
        JadikanPiutang = new id.yaski.simrskhanza.widget.CekBox();
    ...
    private id.yaski.simrskhanza.widget.Button BtnInsertObat;
    private id.yaski.simrskhanza.widget.Button BtnInsertObatRacikan;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnSimpan;
    private id.yaski.simrskhanza.widget.Button BtnSimpanResepKosong;
    ...
    private id.yaski.simrskhanza.widget.CekBox JadikanPiutang;

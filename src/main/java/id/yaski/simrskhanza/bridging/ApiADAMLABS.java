...
public class ApiADAMLABS
{
    ...
    private RestTemplate http() throws NoSuchAlgorithmException, KeyManagementException {
        ...
        sslFactory = new SSLConnectionSocketFactory(sslContext, SSLConnectionSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
        // sslFactory = new SSLConnectioniSocketFactory(sslContext, SSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);

...
public class BPJSMonitoringKlaim extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglSEP1 = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        btnPenyakit = new id.yaski.simrskhanza.widget.Button();
        label12 = new id.yaski.simrskhanza.widget.Label();
        TglSEP2 = new id.yaski.simrskhanza.widget.Tanggal();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Tanggal TglSEP1;
    private id.yaski.simrskhanza.widget.Tanggal TglSEP2;
    private id.yaski.simrskhanza.widget.Button btnPPKRujukan;
    private id.yaski.simrskhanza.widget.Button btnPenyakit;
                            ...
                            try {
                                ...
                                while(rssep.next()){
                                    tabMode.addRow(new Object[]{
                                        ...
                                        rssep.getString("no_kartu"),rssep.getString("tglpulang"),rssep.getString("asal_rujukan"),rssep.getString("eksekutif"),rssep.getString("cob"),rssep.getString("pembiayaan").replaceAll("1","1. Pribadi").replaceAll("2","2. Pemberi Kerja").replaceAll("2","3. Asuransi Lain"),rssep.getString("notelep"),

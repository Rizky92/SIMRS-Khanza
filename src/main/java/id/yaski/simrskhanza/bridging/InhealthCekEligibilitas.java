...
import id.yaski.simrskhanza.laporan.DlgCariPenyakit;
...
public final class InhealthCekEligibilitas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LokasiLaka = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KdPenyakit2 = new id.yaski.simrskhanza.widget.TextBox();
        NmPenyakit2 = new id.yaski.simrskhanza.widget.TextBox();
        btnDiagnosa1 = new id.yaski.simrskhanza.widget.Button();
        LabelJenpel = new id.yaski.simrskhanza.widget.Label();
        KdJenpel = new id.yaski.simrskhanza.widget.TextBox();
        KdKamar = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdJenpel;
    private id.yaski.simrskhanza.widget.TextBox KdKamar;
    private id.yaski.simrskhanza.widget.TextBox KdPPK;
    private id.yaski.simrskhanza.widget.TextBox KdPenyakit;
    private id.yaski.simrskhanza.widget.TextBox KdPenyakit2;
    ...
    private id.yaski.simrskhanza.widget.Label LabelJenpel;
    ...
    private id.yaski.simrskhanza.widget.TextBox LokasiLaka;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmPenyakit2;
    ...
    private id.yaski.simrskhanza.widget.Button btnDiagnosa1;

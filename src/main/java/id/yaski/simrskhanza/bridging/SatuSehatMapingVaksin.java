...
public final class SatuSehatMapingVaksin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DoseCode = new id.yaski.simrskhanza.widget.TextBox();
        VaksinCode = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        VaksinDisplay = new id.yaski.simrskhanza.widget.TextBox();
        ...
        DoseSystem = new id.yaski.simrskhanza.widget.TextBox();
        DoseUnit = new id.yaski.simrskhanza.widget.TextBox();
        VaksinSystem = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox DoseCode;
    private id.yaski.simrskhanza.widget.TextBox DoseSystem;
    private id.yaski.simrskhanza.widget.TextBox DoseUnit;
    ...
    private id.yaski.simrskhanza.widget.TextBox VaksinCode;
    private id.yaski.simrskhanza.widget.TextBox VaksinDisplay;
    private id.yaski.simrskhanza.widget.TextBox VaksinSystem;

...
public final class PCareCekFaskesThalasemia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KdSpesialis = new id.yaski.simrskhanza.widget.TextBox();
        NmSpesialis = new id.yaski.simrskhanza.widget.TextBox();
        BtnPropinsi = new id.yaski.simrskhanza.widget.Button();
        jLabel21 = new id.yaski.simrskhanza.widget.Label();
        Khusus = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdSpesialis;
    private id.yaski.simrskhanza.widget.ComboBox Khusus;
    private id.yaski.simrskhanza.widget.TextBox NmSpesialis;

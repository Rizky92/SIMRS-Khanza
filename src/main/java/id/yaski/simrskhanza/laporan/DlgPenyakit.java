...
public final class DlgPenyakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPenyakit = new id.yaski.simrskhanza.widget.Table();
        ...
        ScrollCiri = new id.yaski.simrskhanza.widget.ScrollPane();
        TCiri = new id.yaski.simrskhanza.widget.TextArea();
        TKeterangan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        btnKtg = new id.yaski.simrskhanza.widget.Button();
        kd_ktg = new id.yaski.simrskhanza.widget.TextBox();
        ...
        cmbIM = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        cmbValidCode = new id.yaski.simrskhanza.widget.ComboBox();
        cmbACCPDX = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        cmbAsterisk = new id.yaski.simrskhanza.widget.ComboBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ScrollPane ScrollCiri;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextArea TCiri;
    private id.yaski.simrskhanza.widget.TextBox TKd;
    private id.yaski.simrskhanza.widget.TextBox TKeterangan;
    private id.yaski.simrskhanza.widget.TextBox TKtg;
    private id.yaski.simrskhanza.widget.TextBox TNm;
    private id.yaski.simrskhanza.widget.Button btnKtg;
    private id.yaski.simrskhanza.widget.ComboBox cmbACCPDX;
    private id.yaski.simrskhanza.widget.ComboBox cmbAsterisk;
    private id.yaski.simrskhanza.widget.ComboBox cmbHlm;
    private id.yaski.simrskhanza.widget.ComboBox cmbIM;
    private id.yaski.simrskhanza.widget.ComboBox cmbStatus;
    private id.yaski.simrskhanza.widget.ComboBox cmbValidCode;

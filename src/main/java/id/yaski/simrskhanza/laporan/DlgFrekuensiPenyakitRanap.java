...
import id.yaski.simrskhanza.keuangan.*;
...
public class DlgFrekuensiPenyakitRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nmkamar = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnSeek7 = new id.yaski.simrskhanza.widget.Button();
        nmkelurahan = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnSeek7;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmkamar;
    private id.yaski.simrskhanza.widget.TextBox nmkecamatan;
    private id.yaski.simrskhanza.widget.TextBox nmkelurahan;

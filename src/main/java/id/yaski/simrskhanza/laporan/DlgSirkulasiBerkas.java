...
import id.yaski.simrskhanza.inventaris.InventarisRuang;
...
public class DlgSirkulasiBerkas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        peminjam = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PertamaDaftar = new id.yaski.simrskhanza.widget.TextBox();
        ...
        LblTgl1 = new id.yaski.simrskhanza.widget.Label();
        ...
        RmCari = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Label LblTgl1;
    ...
    private id.yaski.simrskhanza.widget.TextBox PertamaDaftar;
    private id.yaski.simrskhanza.widget.TextBox RmCari;
    ...
    private id.yaski.simrskhanza.widget.TextBox peminjam;

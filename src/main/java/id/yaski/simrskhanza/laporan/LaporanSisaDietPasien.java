...
import id.yaski.simrskhanza.setting.DlgCariJamDiet;
...
public class LaporanSisaDietPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Ruang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        WaktuDiet2 = new id.yaski.simrskhanza.widget.TextBox();
        JamDiet2 = new id.yaski.simrskhanza.widget.TextBox();
        BtnJam2 = new id.yaski.simrskhanza.widget.Button();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        NmBangsalCari = new id.yaski.simrskhanza.widget.TextBox();
        ...
        WaktuDiet = new id.yaski.simrskhanza.widget.TextBox();
        JamDiet = new id.yaski.simrskhanza.widget.TextBox();
        Tanggal = new id.yaski.simrskhanza.widget.TextBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        Karbo = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        Sayur = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        Hewani = new id.yaski.simrskhanza.widget.TextBox();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        Buah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Nabati = new id.yaski.simrskhanza.widget.TextBox();
        ...
        tbDataDiet = new id.yaski.simrskhanza.widget.Table();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnJam2;
    ...
    private id.yaski.simrskhanza.widget.TextBox Buah;
    ...
    private id.yaski.simrskhanza.widget.TextBox Hewani;
    private id.yaski.simrskhanza.widget.TextBox JamDiet;
    private id.yaski.simrskhanza.widget.TextBox JamDiet2;
    private id.yaski.simrskhanza.widget.TextBox Kamar;
    private id.yaski.simrskhanza.widget.TextBox Karbo;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Nabati;
    private id.yaski.simrskhanza.widget.TextBox NmBangsalCari;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Ruang;
    private id.yaski.simrskhanza.widget.TextBox Sayur;
    ...
    private id.yaski.simrskhanza.widget.TextBox WaktuDiet;
    private id.yaski.simrskhanza.widget.TextBox WaktuDiet2;
    ...
    private id.yaski.simrskhanza.widget.Table tbDataDiet;

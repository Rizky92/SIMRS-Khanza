...
public final class DlgDataHAIs extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CVL = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        ETT = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Deku = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        IVL = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        UC = new id.yaski.simrskhanza.widget.TextBox();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        VAP = new id.yaski.simrskhanza.widget.TextBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        IAD = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        PLEB = new id.yaski.simrskhanza.widget.TextBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        ISK = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Antibiotik;
    ...
    private id.yaski.simrskhanza.widget.TextBox CVL;
    ...
    private id.yaski.simrskhanza.widget.TextBox Darah;
    private id.yaski.simrskhanza.widget.ComboBox Deku;
    private id.yaski.simrskhanza.widget.TextBox ETT;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox HAP;
    private id.yaski.simrskhanza.widget.TextBox IAD;
    private id.yaski.simrskhanza.widget.TextBox ILO;
    private id.yaski.simrskhanza.widget.TextBox ISK;
    private id.yaski.simrskhanza.widget.TextBox IVL;
    private id.yaski.simrskhanza.widget.TextBox Kamar;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox PLEB;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Scabies;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.TextBox Sputum;
    ...
    private id.yaski.simrskhanza.widget.TextBox Tania;
    private id.yaski.simrskhanza.widget.TextBox UC;
    private id.yaski.simrskhanza.widget.TextBox Urine;
    private id.yaski.simrskhanza.widget.TextBox VAP;

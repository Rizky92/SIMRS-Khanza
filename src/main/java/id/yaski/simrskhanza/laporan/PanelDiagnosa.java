...
public class PanelDiagnosa extends widget.panelisi {
    ...
    private void initComponents() {
        ...
        btnTambahPenyakit = new id.yaski.simrskhanza.widget.Button();
        ...
        btnTambahProsedur = new id.yaski.simrskhanza.widget.Button();
        ...
        tbTindakanPasien = new id.yaski.simrskhanza.widget.Table();
    ...
    private id.yaski.simrskhanza.widget.Button btnTambahPenyakit;
    private id.yaski.simrskhanza.widget.Button btnTambahProsedur;
    ...
    private id.yaski.simrskhanza.widget.Table tbTindakanPasien;

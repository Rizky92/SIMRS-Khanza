...
public final class DlgDataInsidenKeselamatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kejadian = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        JamKejadian = new id.yaski.simrskhanza.widget.ComboBox();
        MenitKejadian = new id.yaski.simrskhanza.widget.ComboBox();
        DetikKejadian = new id.yaski.simrskhanza.widget.ComboBox();
        ChkKejadian = new id.yaski.simrskhanza.widget.CekBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Lapor = new id.yaski.simrskhanza.widget.Tanggal();
        JamLapor = new id.yaski.simrskhanza.widget.ComboBox();
        MenitLapor = new id.yaski.simrskhanza.widget.ComboBox();
        DetikLapor = new id.yaski.simrskhanza.widget.ComboBox();
        ChkLapor = new id.yaski.simrskhanza.widget.CekBox();
        ...
        UnitTerkait = new id.yaski.simrskhanza.widget.TextBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        Akibat = new id.yaski.simrskhanza.widget.TextBox();
        btnInsiden = new id.yaski.simrskhanza.widget.Button();
        NmInsiden = new id.yaski.simrskhanza.widget.TextBox();
        KodeInsiden = new id.yaski.simrskhanza.widget.TextBox();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        Dampak = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Identifikasi = new id.yaski.simrskhanza.widget.TextBox();
        jLabel28 = new id.yaski.simrskhanza.widget.Label();
        TindakLanjut = new id.yaski.simrskhanza.widget.TextBox();
        Kronologis = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Akibat;
    ...
    private id.yaski.simrskhanza.widget.CekBox ChkLapor;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari1;
    private id.yaski.simrskhanza.widget.Tanggal DTPCari2;
    private id.yaski.simrskhanza.widget.TextBox Dampak;
    private id.yaski.simrskhanza.widget.ComboBox DetikKejadian;
    private id.yaski.simrskhanza.widget.ComboBox DetikLapor;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.TextBox Identifikasi;
    private id.yaski.simrskhanza.widget.ComboBox JamKejadian;
    private id.yaski.simrskhanza.widget.ComboBox JamLapor;
    private id.yaski.simrskhanza.widget.TextBox Jenis;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.Tanggal Kejadian;
    private id.yaski.simrskhanza.widget.TextBox KodeInsiden;
    private id.yaski.simrskhanza.widget.TextBox Kronologis;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.Tanggal Lapor;
    private id.yaski.simrskhanza.widget.TextBox Lokasi;
    private id.yaski.simrskhanza.widget.ComboBox MenitKejadian;
    private id.yaski.simrskhanza.widget.ComboBox MenitLapor;
    private id.yaski.simrskhanza.widget.TextBox NmInsiden;
    ...
    private id.yaski.simrskhanza.widget.TextBox UnitTerkait;
    private id.yaski.simrskhanza.widget.Button btnInsiden;

...
public class LabKeslingCariPenugasanPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPenugasan = new id.yaski.simrskhanza.widget.Table();
        ...
        tbDetailPenugasan = new id.yaski.simrskhanza.widget.Table();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRekapPenugasan = new id.yaski.simrskhanza.widget.Table();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailPenugasan;
    private id.yaski.simrskhanza.widget.Table tbPenugasan;
    private id.yaski.simrskhanza.widget.Table tbRekapPenugasan;

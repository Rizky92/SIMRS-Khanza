...
public class LabKeslingCariVerifikasiPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbVerifikasi = new id.yaski.simrskhanza.widget.Table();
        ...
        tbDetailVerifikasi = new id.yaski.simrskhanza.widget.Table();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRekapVerifikasi = new id.yaski.simrskhanza.widget.Table();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailVerifikasi;
    private id.yaski.simrskhanza.widget.Table tbRekapVerifikasi;
    private id.yaski.simrskhanza.widget.Table tbVerifikasi;

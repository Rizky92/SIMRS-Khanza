...
public class LabKeslingPembayaranPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnBayarTagihan = new id.yaski.simrskhanza.widget.Button();
        BtnRekapPembayaran = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnBayarTagihan;
    ...
    private id.yaski.simrskhanza.widget.Button BtnRekapPembayaran;

...
public final class LabKeslingParameterPengujian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kode = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        Parameter = new id.yaski.simrskhanza.widget.TextBox();
        JasaSarana = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        TotalTarif = new id.yaski.simrskhanza.widget.TextBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        JasaPetugas = new id.yaski.simrskhanza.widget.TextBox();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        JasaPJLab = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        PaketBHP = new id.yaski.simrskhanza.widget.TextBox();
        KSO = new id.yaski.simrskhanza.widget.TextBox();
        Manajemen = new id.yaski.simrskhanza.widget.TextBox();
        ...
        MetodePengujian = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        JasaPJPengujian = new id.yaski.simrskhanza.widget.TextBox();
        jLabel21 = new id.yaski.simrskhanza.widget.Label();
        JasaPJVerifikator = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox JasaPJLab;
    private id.yaski.simrskhanza.widget.TextBox JasaPJPengujian;
    private id.yaski.simrskhanza.widget.TextBox JasaPJVerifikator;
    private id.yaski.simrskhanza.widget.TextBox JasaPetugas;
    private id.yaski.simrskhanza.widget.TextBox JasaSarana;
    private id.yaski.simrskhanza.widget.TextBox KSO;
    private id.yaski.simrskhanza.widget.ComboBox Kategori;
    private id.yaski.simrskhanza.widget.TextBox Kode;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Manajemen;
    private id.yaski.simrskhanza.widget.ComboBox MetodePengujian;
    private id.yaski.simrskhanza.widget.TextBox PaketBHP;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Parameter;
    ...
    private id.yaski.simrskhanza.widget.TextBox TotalTarif;

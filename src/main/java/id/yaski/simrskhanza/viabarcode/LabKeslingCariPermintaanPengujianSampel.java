...
public class LabKeslingCariPermintaanPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoPermintaanVerifikasi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AsalPermintaan = new id.yaski.simrskhanza.widget.TextBox();
        label3 = new id.yaski.simrskhanza.widget.Label();
        label4 = new id.yaski.simrskhanza.widget.Label();
        WindowInput2 = new javax.swing.JDialog();
        internalFrame3 = new id.yaski.simrskhanza.widget.InternalFrame();
        BtnTutup2 = new id.yaski.simrskhanza.widget.Button();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        BtnSimpan2 = new id.yaski.simrskhanza.widget.Button();
        BtnBatal2 = new id.yaski.simrskhanza.widget.Button();
        NoPermintaanVerifikasi2 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel43 = new id.yaski.simrskhanza.widget.Label();
        scrollPane5 = new id.yaski.simrskhanza.widget.ScrollPane();
        Keterangan2 = new id.yaski.simrskhanza.widget.TextArea();
        label5 = new id.yaski.simrskhanza.widget.Label();
        AsalPermintaan2 = new id.yaski.simrskhanza.widget.TextBox();
        label6 = new id.yaski.simrskhanza.widget.Label();
        ...
        tbPermintaan = new id.yaski.simrskhanza.widget.Table();
        ...
        tbDetailPermintaan = new id.yaski.simrskhanza.widget.Table();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbRekapPermintaan = new id.yaski.simrskhanza.widget.Table();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AsalPermintaan;
    private id.yaski.simrskhanza.widget.TextBox AsalPermintaan2;
    private id.yaski.simrskhanza.widget.Button BtnAll;
    private id.yaski.simrskhanza.widget.Button BtnBatal;
    private id.yaski.simrskhanza.widget.Button BtnBatal2;
    ...
    private id.yaski.simrskhanza.widget.Button BtnTutup2;
    private id.yaski.simrskhanza.widget.CekBox ChkAccor;
    private id.yaski.simrskhanza.widget.TextArea Keterangan;
    private id.yaski.simrskhanza.widget.TextArea Keterangan2;
    ...
    private id.yaski.simrskhanza.widget.TextBox NoPermintaanVerifikasi;
    private id.yaski.simrskhanza.widget.TextBox NoPermintaanVerifikasi2;
    ...
    private id.yaski.simrskhanza.widget.Label label4;
    private id.yaski.simrskhanza.widget.Label label5;
    private id.yaski.simrskhanza.widget.Label label6;
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailPermintaan;
    private id.yaski.simrskhanza.widget.Table tbPermintaan;
    private id.yaski.simrskhanza.widget.Table tbRekapPermintaan;

...
public final class LabKeslingPermintaanPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KegiatanUsaha = new id.yaski.simrskhanza.widget.TextBox();
        PersonalDihubungi = new id.yaski.simrskhanza.widget.TextBox();
        KontakPelanggan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        AlamatPelanggan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        WaktuDiterima = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        LokasiSampling = new id.yaski.simrskhanza.widget.TextBox();
        jLabel5 = new id.yaski.simrskhanza.widget.Label();
        DeskripsiSampling = new id.yaski.simrskhanza.widget.TextBox();
        ...
        WaktuSampling = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        JenisSampel = new id.yaski.simrskhanza.widget.TextBox();
        JmlSampel = new id.yaski.simrskhanza.widget.TextBox();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        VolumeSampel = new id.yaski.simrskhanza.widget.TextBox();
        WadahSampel = new id.yaski.simrskhanza.widget.TextBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        KondisiWadah = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        DisamplingOleh = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox AlamatPelanggan;
    private id.yaski.simrskhanza.widget.TextBox BakuMutu;
    ...
    private id.yaski.simrskhanza.widget.TextBox DeskripsiSampling;
    private id.yaski.simrskhanza.widget.TextBox DisamplingOleh;
    private javax.swing.JPanel FormInput;
    private id.yaski.simrskhanza.widget.TextBox JenisSampel;
    private id.yaski.simrskhanza.widget.TextBox JmlSampel;
    private id.yaski.simrskhanza.widget.ComboBox KategoriParameter;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.TextBox KegiatanUsaha;
    private id.yaski.simrskhanza.widget.TextBox KodePelanggan;
    private id.yaski.simrskhanza.widget.TextBox KodeSampel;
    private id.yaski.simrskhanza.widget.TextBox KondisiWadah;
    private id.yaski.simrskhanza.widget.TextBox KontakPelanggan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox LokasiSampling;
    ...
    private id.yaski.simrskhanza.widget.TextBox PersonalDihubungi;
    ...
    private id.yaski.simrskhanza.widget.TextBox VolumeSampel;
    private id.yaski.simrskhanza.widget.TextBox WadahSampel;
    private id.yaski.simrskhanza.widget.Tanggal WaktuDiterima;
    private id.yaski.simrskhanza.widget.Tanggal WaktuSampling;

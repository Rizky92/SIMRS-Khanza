...
public final class LabKeslingPenugasanPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPenugasan = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        TNoPenugasan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel10 = new id.yaski.simrskhanza.widget.Label();
        KdAnalis = new id.yaski.simrskhanza.widget.TextBox();
        NmAnalis = new id.yaski.simrskhanza.widget.TextBox();
        btnAnalis = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdAnalis;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmAnalis;
    ...
    private id.yaski.simrskhanza.widget.TextBox TNoPenugasan;
    private id.yaski.simrskhanza.widget.TextBox TNoPermintaan;
    private id.yaski.simrskhanza.widget.Tanggal TanggalPenugasan;
    private id.yaski.simrskhanza.widget.Button btnAnalis;

...
public class LabKeslingRekapPembayaran extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LTotalBayar = new id.yaski.simrskhanza.widget.Label();
        ...
        tbPembayaran = new id.yaski.simrskhanza.widget.Table();
        ...
        tbDetailPembayaran = new id.yaski.simrskhanza.widget.Table();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Label LTotalBayar;
    ...
    private id.yaski.simrskhanza.widget.Table tbDetailPembayaran;
    private id.yaski.simrskhanza.widget.Table tbPembayaran;

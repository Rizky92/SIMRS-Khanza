...
public final class LabKeslingBayarTagihanPengujianSampel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PenerimaanSampel = new id.yaski.simrskhanza.widget.TextBox();
        TitikSampel = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoBayar = new id.yaski.simrskhanza.widget.TextBox();
        jLabel6 = new id.yaski.simrskhanza.widget.Label();
        DibayarOleh = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox DibayarOleh;
    ...
    private id.yaski.simrskhanza.widget.TextBox TitikSampel;

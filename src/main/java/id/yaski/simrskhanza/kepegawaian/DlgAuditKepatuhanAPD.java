...
public final class DlgAuditKepatuhanAPD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Topi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Masker = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        SarungTangan = new id.yaski.simrskhanza.widget.ComboBox();
        Apron = new id.yaski.simrskhanza.widget.ComboBox();
        Sepatu = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Apron;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Masker;
    ...
    private id.yaski.simrskhanza.widget.ComboBox SarungTangan;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox Sepatu;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Topi;

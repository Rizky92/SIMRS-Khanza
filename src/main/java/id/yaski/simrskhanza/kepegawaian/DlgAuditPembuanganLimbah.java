...
public final class DlgAuditPembuanganLimbah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PemisahanLimbahOlehPenghasilLimbah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        LimbahInfeksiusDimasukkanKantongKuning = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        LimbahNoninfeksiusDimasukkanKantongHitam = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        LimbahTigaperempatDiikat = new id.yaski.simrskhanza.widget.ComboBox();
        LimbahSegeraDibawaKepembuanganSementara = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PembersihanTempatSampahDenganDesinfekten = new id.yaski.simrskhanza.widget.ComboBox();
        KotakSampahDalamKondisiBersih = new id.yaski.simrskhanza.widget.ComboBox();
        PembersihanPenampunganSementaraDenganDesinfekten = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox KotakSampahDalamKondisiBersih;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.ComboBox LimbahInfeksiusDimasukkanKantongKuning;
    private id.yaski.simrskhanza.widget.ComboBox LimbahNoninfeksiusDimasukkanKantongHitam;
    private id.yaski.simrskhanza.widget.ComboBox LimbahSegeraDibawaKepembuanganSementara;
    private id.yaski.simrskhanza.widget.ComboBox LimbahTigaperempatDiikat;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.TextBox NmRuang;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PembersihanPenampunganSementaraDenganDesinfekten;
    private id.yaski.simrskhanza.widget.ComboBox PembersihanTempatSampahDenganDesinfekten;
    private id.yaski.simrskhanza.widget.ComboBox PemisahanLimbahOlehPenghasilLimbah;

...
public final class DlgAuditBundlePLABSI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MelakukanHandHygiene = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Menggunakan_Apd = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        LokasiPemasangan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel15 = new id.yaski.simrskhanza.widget.Label();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        MelakukanHandHygieneSesudah = new id.yaski.simrskhanza.widget.ComboBox();
        PembersihanKulit = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        AlatYangSteril = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        SpoitDisposable = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        PerawatanDressing = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        PemberianTanggal = new id.yaski.simrskhanza.widget.ComboBox();
        SetInfus = new id.yaski.simrskhanza.widget.ComboBox();
...
if(KdRuang.getText().trim().equals("")||NmRuang.getText().trim().equals("")){
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AlatYangSteril;
    ...
    private id.yaski.simrskhanza.widget.ComboBox LokasiPemasangan;
    private id.yaski.simrskhanza.widget.ComboBox MelakukanHandHygiene;
    private id.yaski.simrskhanza.widget.ComboBox MelakukanHandHygieneSesudah;
    private id.yaski.simrskhanza.widget.ComboBox Menggunakan_Apd;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.TextBox NmRuang;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PemberianTanggal;
    private id.yaski.simrskhanza.widget.ComboBox PembersihanKulit;
    private id.yaski.simrskhanza.widget.ComboBox PerawatanDressing;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SetInfus;
    private id.yaski.simrskhanza.widget.ComboBox SpoitDisposable;

...
public final class DlgPulang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        id_pegawai = new id.yaski.simrskhanza.widget.TextBox();
        jam_datang = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox id_pegawai;
    ...
    private id.yaski.simrskhanza.widget.TextBox jam_datang;

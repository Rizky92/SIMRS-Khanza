...
public final class DlgBerkasKepegawaian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CmbKategori = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        JenjangJabatan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PanelContent = new id.yaski.simrskhanza.widget.panelisi();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox CmbKategori;
    ...
    private id.yaski.simrskhanza.widget.TextBox JenjangJabatan;
    ...
    private id.yaski.simrskhanza.widget.editorpane LoadHTML4;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML5;
    private id.yaski.simrskhanza.widget.panelisi PanelContent;

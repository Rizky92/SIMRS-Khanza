...
public final class DlgHarian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnClose = new id.yaski.simrskhanza.widget.Button();
        BtnSimpan = new id.yaski.simrskhanza.widget.Button();
        BtnBatal = new id.yaski.simrskhanza.widget.Button();
        jamdatang = new id.yaski.simrskhanza.widget.TextBox();
        jampulang = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Cari = new id.yaski.simrskhanza.widget.Button();
        ...
        Jam2 = new id.yaski.simrskhanza.widget.ComboBox();
        Menit2 = new id.yaski.simrskhanza.widget.ComboBox();
        Detik2 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Shift = new id.yaski.simrskhanza.widget.ComboBox();
        tglPulang = new id.yaski.simrskhanza.widget.Tanggal();
        Idpresensi = new id.yaski.simrskhanza.widget.TextBox();
        ...
        tglCari = new id.yaski.simrskhanza.widget.Tanggal();
        ...
        Departemen = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnClose;
    ...
    private id.yaski.simrskhanza.widget.Button Cari;
    private id.yaski.simrskhanza.widget.ComboBox Departemen;
    private id.yaski.simrskhanza.widget.ComboBox Detik;
    private id.yaski.simrskhanza.widget.ComboBox Detik2;
    private javax.swing.JDialog DlgInput;
    private id.yaski.simrskhanza.widget.TextBox Idpresensi;
    private id.yaski.simrskhanza.widget.ComboBox Jam;
    private id.yaski.simrskhanza.widget.ComboBox Jam2;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.ComboBox Menit2;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Shift;
    ...
    private id.yaski.simrskhanza.widget.TextBox jamdatang;
    private id.yaski.simrskhanza.widget.TextBox jampulang;
    ...
    private id.yaski.simrskhanza.widget.Tanggal tglCari;
    private id.yaski.simrskhanza.widget.Tanggal tglCari2;
    private id.yaski.simrskhanza.widget.Tanggal tglMasuk;
    private id.yaski.simrskhanza.widget.Tanggal tglPulang;

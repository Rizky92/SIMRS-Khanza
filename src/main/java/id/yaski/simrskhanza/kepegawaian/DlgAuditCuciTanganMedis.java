...
public final class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        SebelumMenyentuh = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        SebelumTehnik = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        SetelahTerpapar = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        SetelahKontak = new id.yaski.simrskhanza.widget.ComboBox();
        SetelahLingkungan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox SebelumMenyentuh;
    private id.yaski.simrskhanza.widget.ComboBox SebelumTehnik;
    private id.yaski.simrskhanza.widget.ComboBox SetelahKontak;
    private id.yaski.simrskhanza.widget.ComboBox SetelahLingkungan;
    private id.yaski.simrskhanza.widget.ComboBox SetelahTerpapar;

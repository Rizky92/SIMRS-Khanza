...
import id.yaski.simrskhanza.fungsi.Painter;
...
import id.yaski.simrskhanza.restore.DlgRestoreDokter;
import id.yaski.simrskhanza.simrskhanza.DlgCariSpesialis;
...
public class DlgDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnCariTTD = new id.yaski.simrskhanza.widget.Button();
        PhotoTTD = new Painter();
        BtnSimpanTTD = new id.yaski.simrskhanza.widget.Button();
        BtnHapusTTD = new id.yaski.simrskhanza.widget.Button();
        BtnKeluarTTD = new id.yaski.simrskhanza.widget.Button();
        ...
        CmbCrGd = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        CmbCrStts = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        TSpesialis = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TAlumni = new id.yaski.simrskhanza.widget.TextBox();
        KdSps = new id.yaski.simrskhanza.widget.TextBox();
        btnSpesial = new id.yaski.simrskhanza.widget.Button();
        BtnCariPegawai = new id.yaski.simrskhanza.widget.Button();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnCariPegawai;
    private id.yaski.simrskhanza.widget.Button BtnCariTTD;
    private id.yaski.simrskhanza.widget.Button BtnEdit;
    private id.yaski.simrskhanza.widget.Button BtnHapus;
    private id.yaski.simrskhanza.widget.Button BtnHapusTTD;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnKeluarTTD;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnSimpan;
    private id.yaski.simrskhanza.widget.Button BtnSimpanTTD;
    private id.yaski.simrskhanza.widget.ComboBox CMbGd;
    private id.yaski.simrskhanza.widget.CekBox ChkInput;
    private id.yaski.simrskhanza.widget.ComboBox CmbCrGd;
    private id.yaski.simrskhanza.widget.ComboBox CmbCrStts;
    ...
    private id.yaski.simrskhanza.widget.TextBox KdSps;
    ...
    private id.yaski.simrskhanza.widget.TextBox TAlumni;
    ...
    private id.yaski.simrskhanza.widget.TextBox TSpesialis;
    ...
    private id.yaski.simrskhanza.widget.Button btnSpesial;

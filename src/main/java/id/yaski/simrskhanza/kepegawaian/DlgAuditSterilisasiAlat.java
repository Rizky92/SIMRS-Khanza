...
public final class DlgAuditSterilisasiAlat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Audit1 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        Audit2 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        Audit3 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Audit4 = new id.yaski.simrskhanza.widget.ComboBox();
        Audit5 = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Audit7 = new id.yaski.simrskhanza.widget.ComboBox();
        Audit6 = new id.yaski.simrskhanza.widget.ComboBox();
        Audit8 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        Audit9 = new id.yaski.simrskhanza.widget.ComboBox();
        Audit10 = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel28 = new id.yaski.simrskhanza.widget.Label();
        Audit11 = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Audit1;
    private id.yaski.simrskhanza.widget.ComboBox Audit10;
    private id.yaski.simrskhanza.widget.ComboBox Audit11;
    private id.yaski.simrskhanza.widget.ComboBox Audit2;
    private id.yaski.simrskhanza.widget.ComboBox Audit3;
    private id.yaski.simrskhanza.widget.ComboBox Audit4;
    private id.yaski.simrskhanza.widget.ComboBox Audit5;
    private id.yaski.simrskhanza.widget.ComboBox Audit6;
    private id.yaski.simrskhanza.widget.ComboBox Audit7;
    private id.yaski.simrskhanza.widget.ComboBox Audit8;
    private id.yaski.simrskhanza.widget.ComboBox Audit9;

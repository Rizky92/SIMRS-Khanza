...
public final class SKPKriteriaPenilaian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kriteria = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Sasaran = new id.yaski.simrskhanza.widget.TextBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Kriteria;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox NmKategori;
    private id.yaski.simrskhanza.widget.TextBox Sasaran;

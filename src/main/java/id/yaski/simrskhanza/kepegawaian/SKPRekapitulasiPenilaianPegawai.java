...
public class SKPRekapitulasiPenilaianPegawai extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoPenilaian = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KdPenilai = new id.yaski.simrskhanza.widget.TextBox();
        NmPenilai = new id.yaski.simrskhanza.widget.TextBox();
        btnPenilai = new id.yaski.simrskhanza.widget.Button();
        label17 = new id.yaski.simrskhanza.widget.Label();
        KdDInilai = new id.yaski.simrskhanza.widget.TextBox();
        NmDinilai = new id.yaski.simrskhanza.widget.TextBox();
        btnDinilai = new id.yaski.simrskhanza.widget.Button();
        ...
        KodeTransaksi1 = new id.yaski.simrskhanza.widget.TextBox();
        jLabel21 = new id.yaski.simrskhanza.widget.Label();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        KodeTransaksi2 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        KodeTransaksi3 = new id.yaski.simrskhanza.widget.TextBox();
        KodeTransaksi4 = new id.yaski.simrskhanza.widget.TextBox();
        KodeTransaksi5 = new id.yaski.simrskhanza.widget.TextBox();
        ...
        RPS1 = new id.yaski.simrskhanza.widget.TextArea();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox KdDInilai;
    private id.yaski.simrskhanza.widget.TextBox KdPenilai;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi1;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi2;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi3;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi4;
    private id.yaski.simrskhanza.widget.TextBox KodeTransaksi5;
    private id.yaski.simrskhanza.widget.TextBox NmDinilai;
    private id.yaski.simrskhanza.widget.TextBox NmPenilai;
    private id.yaski.simrskhanza.widget.TextBox NoPenilaian;
    private javax.swing.JPopupMenu Popup;
    private id.yaski.simrskhanza.widget.TextArea RPS;
    private id.yaski.simrskhanza.widget.TextArea RPS1;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.Tanggal Tanggal;
    private id.yaski.simrskhanza.widget.Button btnDinilai;
    private id.yaski.simrskhanza.widget.Button btnPenilai;

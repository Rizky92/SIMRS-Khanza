...
public final class DlgAuditPenangananDarah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MenggunakanApdWaktuMembuangDarah = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        KomponenDarahTidakAdaDilantai = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        MembuangDarahPadaTempatDitentukan = new id.yaski.simrskhanza.widget.ComboBox();
        NmRuang = new id.yaski.simrskhanza.widget.TextBox();
        PembersihanArealTumbahanDarah = new id.yaski.simrskhanza.widget.ComboBox();
        ApdDibuangdiLimbahInfeksius = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        MelakukanKebersihanTanganSetelahProsedur = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox ApdDibuangdiLimbahInfeksius;
    ...
    private id.yaski.simrskhanza.widget.ComboBox KomponenDarahTidakAdaDilantai;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.ComboBox MelakukanKebersihanTanganSetelahProsedur;
    private id.yaski.simrskhanza.widget.ComboBox MembuangDarahPadaTempatDitentukan;
    private id.yaski.simrskhanza.widget.ComboBox MenggunakanApdWaktuMembuangDarah;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.TextBox NmRuang;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PembersihanArealTumbahanDarah;

...
public final class DlgAuditBundleISK extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PemasanganSesuaiIndikasi = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        HandHygiene = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        ApdYangTepat = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        PetunjukProduk = new id.yaski.simrskhanza.widget.ComboBox();
        LepasSetelahTidakDiperlukan = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        AlatSteril = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        UrineBag = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        FiksasiKateter = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox AlatSteril;
    private id.yaski.simrskhanza.widget.ComboBox ApdYangTepat;
    ...
    private id.yaski.simrskhanza.widget.ComboBox FiksasiKateter;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.ComboBox HandHygiene;
    ...
    private id.yaski.simrskhanza.widget.ComboBox LepasSetelahTidakDiperlukan;
    private id.yaski.simrskhanza.widget.ComboBox Menit;
    private id.yaski.simrskhanza.widget.TextBox NmRuang;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PemasanganSesuaiIndikasi;
    private id.yaski.simrskhanza.widget.ComboBox PetunjukProduk;
    ...
    private id.yaski.simrskhanza.widget.ComboBox UrineBag;

...
public final class DlgAuditPembuanganBendaTajam extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        SetiapInjeksiNeedleLangsungDimasukkanSafetyBox = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        SetiapPemasanganIvCanulaLangsungDimasukkanSafetyBox = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        SetiapBendaTajamJarumDimasukkanSafetyXox = new id.yaski.simrskhanza.widget.ComboBox();
        NmRuang = new id.yaski.simrskhanza.widget.TextBox();
        SafetyBoxTigaperempatDiganti = new id.yaski.simrskhanza.widget.ComboBox();
        SafetyBoxKeadaanBersih = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        SafteyBoxTertutupSetelahDigunakan = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox SafetyBoxKeadaanBersih;
    private id.yaski.simrskhanza.widget.ComboBox SafetyBoxTigaperempatDiganti;
    private id.yaski.simrskhanza.widget.ComboBox SafteyBoxTertutupSetelahDigunakan;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SetiapBendaTajamJarumDimasukkanSafetyXox;
    private id.yaski.simrskhanza.widget.ComboBox SetiapInjeksiNeedleLangsungDimasukkanSafetyBox;
    private id.yaski.simrskhanza.widget.ComboBox SetiapPemasanganIvCanulaLangsungDimasukkanSafetyBox;

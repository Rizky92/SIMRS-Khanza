...
public final class DlgAuditBundleVAP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PosisiKepala = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        PengkajianSetiapHari = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Profilaksis = new id.yaski.simrskhanza.widget.ComboBox();
        Suction = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel22 = new id.yaski.simrskhanza.widget.Label();
        OralHygiene = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel24 = new id.yaski.simrskhanza.widget.Label();
        PenggunaanApd = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel25 = new id.yaski.simrskhanza.widget.Label();
        Dvt = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox Dvt;
    ...
    private id.yaski.simrskhanza.widget.ComboBox OralHygiene;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.ComboBox PenggunaanApd;
    private id.yaski.simrskhanza.widget.ComboBox PengkajianSetiapHari;
    private id.yaski.simrskhanza.widget.ComboBox PosisiKepala;
    private id.yaski.simrskhanza.widget.ComboBox Profilaksis;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox Suction;

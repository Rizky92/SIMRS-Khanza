...
public final class DlgAuditBundleIADP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        APD = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel23 = new id.yaski.simrskhanza.widget.Label();
        SkinAntiSeptik = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        LokasiIV = new id.yaski.simrskhanza.widget.ComboBox();
        PerawatanRutin = new id.yaski.simrskhanza.widget.ComboBox();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox APD;
    ...
    private id.yaski.simrskhanza.widget.ComboBox LokasiIV;
    ...
    private id.yaski.simrskhanza.widget.ComboBox PerawatanRutin;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ComboBox SkinAntiSeptik;

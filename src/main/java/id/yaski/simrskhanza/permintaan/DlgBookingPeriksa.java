 ...
 */
package id.yaski.simrskhanza.permintaan;
...
import id.yaski.simrskhanza.kepegawaian.DlgCariDokter2;
...
public class DlgBookingPeriksa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnSimpanBalas = new id.yaski.simrskhanza.widget.Button();
        BtnBatal = new id.yaski.simrskhanza.widget.Button();
        BtnCloseBalasan = new id.yaski.simrskhanza.widget.Button();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        FormInput = new id.yaski.simrskhanza.widget.PanelBiasa();
        NoBooking = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NamaPasien = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TambahanPesan = new id.yaski.simrskhanza.widget.TextArea();
        jLabel54 = new id.yaski.simrskhanza.widget.Label();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        TanggalBooking = new id.yaski.simrskhanza.widget.TextBox();
        TanggalPeriksa = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoReg = new id.yaski.simrskhanza.widget.TextBox();
        Kuota = new id.yaski.simrskhanza.widget.TextBox();
        jLabel26 = new id.yaski.simrskhanza.widget.Label();
        Pendaftar = new id.yaski.simrskhanza.widget.TextBox();
        jLabel27 = new id.yaski.simrskhanza.widget.Label();
        jLabel28 = new id.yaski.simrskhanza.widget.Label();
        SisaKuota = new id.yaski.simrskhanza.widget.TextBox();
        jLabel29 = new id.yaski.simrskhanza.widget.Label();
        LabelStatus = new id.yaski.simrskhanza.widget.Label();
        jLabel56 = new id.yaski.simrskhanza.widget.Label();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        StatusBalas = new id.yaski.simrskhanza.widget.ComboBox();
        BalasanPesan = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnJawab = new id.yaski.simrskhanza.widget.Button();
        ...
        NoBokingDipilih = new id.yaski.simrskhanza.widget.TextBox();
        BtnPrint1 = new id.yaski.simrskhanza.widget.Button();
        scrollBalasan = new id.yaski.simrskhanza.widget.ScrollPane();
        DataBalasan = new id.yaski.simrskhanza.widget.TextArea();
    ...
    private id.yaski.simrskhanza.widget.TextBox BalasanPesan;
    ...
    private id.yaski.simrskhanza.widget.Button BtnCloseBalasan;
    private id.yaski.simrskhanza.widget.Button BtnDokter;
    private id.yaski.simrskhanza.widget.Button BtnHapus;
    private id.yaski.simrskhanza.widget.Button BtnJawab;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSimpanBalas;
    ...
    private id.yaski.simrskhanza.widget.TextArea DataBalasan;
    ...
    private id.yaski.simrskhanza.widget.TextBox Kuota;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.Label LCount1;
    private id.yaski.simrskhanza.widget.Label LabelStatus;
    private id.yaski.simrskhanza.widget.TextBox NamaPasien;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.TextBox NmPoli;
    private id.yaski.simrskhanza.widget.TextBox NoBokingDipilih;
    private id.yaski.simrskhanza.widget.TextBox NoBooking;
    private id.yaski.simrskhanza.widget.TextBox NoReg;
    ...
    private id.yaski.simrskhanza.widget.TextBox Pendaftar;
    ...
    private id.yaski.simrskhanza.widget.TextBox SisaKuota;
    private id.yaski.simrskhanza.widget.ComboBox StatusBalas;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TNo;
    private id.yaski.simrskhanza.widget.TextArea TambahanPesan;
    private id.yaski.simrskhanza.widget.TextBox TanggalBooking;
    private id.yaski.simrskhanza.widget.TextBox TanggalPeriksa;
    ...
    private id.yaski.simrskhanza.widget.ScrollPane scrollBalasan;

...
public class DlgPermintaanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        HargaKamar = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnSuratPermintaan = new id.yaski.simrskhanza.widget.Button();
        BtnSuratPRI = new id.yaski.simrskhanza.widget.Button();
        BtnPersetujuanRanap = new id.yaski.simrskhanza.widget.Button();
        BtnPernyataanMemilihDPJP = new id.yaski.simrskhanza.widget.Button();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnPernyataanMemilihDPJP;
    private id.yaski.simrskhanza.widget.Button BtnPersetujuanRanap;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSuratPRI;
    private id.yaski.simrskhanza.widget.Button BtnSuratPermintaan;
    ...
    private id.yaski.simrskhanza.widget.TextBox Poli;

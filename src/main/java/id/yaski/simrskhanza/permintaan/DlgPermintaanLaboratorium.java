...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbTarifPK = new id.yaski.simrskhanza.widget.Table();
        BtnCari1 = new id.yaski.simrskhanza.widget.Button();
        jLabel4 = new id.yaski.simrskhanza.widget.Label();
        TNoPermintaanPK = new id.yaski.simrskhanza.widget.TextBox();
        ...
        PemeriksaanPA = new id.yaski.simrskhanza.widget.TextBox();
        BtnCari3 = new id.yaski.simrskhanza.widget.Button();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        TNoPermintaanPA = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        DiperolehDengan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        LokasiPengambilan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel16 = new id.yaski.simrskhanza.widget.Label();
        Diawetkan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel17 = new id.yaski.simrskhanza.widget.Label();
        TanggalPA = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel18 = new id.yaski.simrskhanza.widget.Label();
        DilakukanPA = new id.yaski.simrskhanza.widget.TextBox();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        DiagnosaPA = new id.yaski.simrskhanza.widget.TextBox();
        TanggalBahan = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel20 = new id.yaski.simrskhanza.widget.Label();
        NomorPA = new id.yaski.simrskhanza.widget.TextBox();
        jLabel21 = new id.yaski.simrskhanza.widget.Label();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbTarifPA = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox DiagnosaPA;
    private id.yaski.simrskhanza.widget.TextBox DiagnosisKlinis;
    private id.yaski.simrskhanza.widget.TextBox Diawetkan;
    private id.yaski.simrskhanza.widget.TextBox DilakukanPA;
    private id.yaski.simrskhanza.widget.TextBox DiperolehDengan;
    ...
    private id.yaski.simrskhanza.widget.TextBox LokasiPengambilan;
    private id.yaski.simrskhanza.widget.TextBox NmPerujuk;
    private id.yaski.simrskhanza.widget.TextBox NomorPA;
    ...
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanMB;
    private id.yaski.simrskhanza.widget.TextBox PemeriksaanPA;
    ...
    private id.yaski.simrskhanza.widget.TextBox TCariMB;
    private id.yaski.simrskhanza.widget.TextBox TNoPermintaanMB;
    private id.yaski.simrskhanza.widget.TextBox TNoPermintaanPA;
    private id.yaski.simrskhanza.widget.TextBox TNoPermintaanPK;
    ...
    private id.yaski.simrskhanza.widget.Tanggal TanggalBahan;
    private id.yaski.simrskhanza.widget.Tanggal TanggalPA;
    ...
    private id.yaski.simrskhanza.widget.Table tbTarifMB;
    private id.yaski.simrskhanza.widget.Table tbTarifPA;
    private id.yaski.simrskhanza.widget.Table tbTarifPK;

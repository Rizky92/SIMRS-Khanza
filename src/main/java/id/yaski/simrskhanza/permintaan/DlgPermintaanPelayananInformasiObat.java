...
public class DlgPermintaanPelayananInformasiObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnSimpanJawaban = new id.yaski.simrskhanza.widget.Button();
        BtnBatalJawaban = new id.yaski.simrskhanza.widget.Button();
        NoPermintaanJawaban = new id.yaski.simrskhanza.widget.TextBox();
        label1 = new id.yaski.simrskhanza.widget.Label();
        KdPetugas = new id.yaski.simrskhanza.widget.TextBox();
        label8 = new id.yaski.simrskhanza.widget.Label();
        NmPetugas = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugas = new id.yaski.simrskhanza.widget.Button();
        TanggalJawab = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel42 = new id.yaski.simrskhanza.widget.Label();
        MetodeJawab = new id.yaski.simrskhanza.widget.ComboBox();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        Referensi = new id.yaski.simrskhanza.widget.TextArea();
        label2 = new id.yaski.simrskhanza.widget.Label();
        PenyampaianJawaban = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Jawaban = new id.yaski.simrskhanza.widget.TextArea();
        ...
        NoRw = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NoPermintaan = new id.yaski.simrskhanza.widget.TextBox();
        jLabel9 = new id.yaski.simrskhanza.widget.Label();
        jLabel11 = new id.yaski.simrskhanza.widget.Label();
        Penanya = new id.yaski.simrskhanza.widget.TextBox();
        KeteranganJenisPertanyaan = new id.yaski.simrskhanza.widget.TextBox();
        TanggalPermintaan = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel39 = new id.yaski.simrskhanza.widget.Label();
        Metode = new id.yaski.simrskhanza.widget.ComboBox();
        jSeparator1 = new javax.swing.JSeparator();
        jSeparator2 = new javax.swing.JSeparator();
        jLabel40 = new id.yaski.simrskhanza.widget.Label();
        StatusPenanya = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        jLabel41 = new id.yaski.simrskhanza.widget.Label();
        JenisPertanyaan = new id.yaski.simrskhanza.widget.ComboBox();
        jSeparator3 = new javax.swing.JSeparator();
        jSeparator4 = new javax.swing.JSeparator();
        jLabel30 = new id.yaski.simrskhanza.widget.Label();
        scrollPane1 = new id.yaski.simrskhanza.widget.ScrollPane();
        UraianPertanyaan = new id.yaski.simrskhanza.widget.TextArea();
        ...
        BtnJawabanApoteker = new id.yaski.simrskhanza.widget.Button();
        BtnDokumentasiPIO = new id.yaski.simrskhanza.widget.Button();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnSimpanJawaban;
    ...
    private id.yaski.simrskhanza.widget.TextArea Jawaban;
    private id.yaski.simrskhanza.widget.ComboBox JenisPertanyaan;
    private id.yaski.simrskhanza.widget.TextBox KdPetugas;
    private id.yaski.simrskhanza.widget.TextBox KeteranganJenisPertanyaan;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.editorpane LoadHTML;
    private id.yaski.simrskhanza.widget.ComboBox Metode;
    private id.yaski.simrskhanza.widget.ComboBox MetodeJawab;
    private id.yaski.simrskhanza.widget.TextBox NmPasien;
    private id.yaski.simrskhanza.widget.TextBox NmPetugas;
    private id.yaski.simrskhanza.widget.TextBox NoPermintaan;
    private id.yaski.simrskhanza.widget.TextBox NoPermintaanJawaban;
    private id.yaski.simrskhanza.widget.TextBox NoRM;
    private id.yaski.simrskhanza.widget.TextBox NoRw;
    private id.yaski.simrskhanza.widget.TextBox NoTelp;
    private id.yaski.simrskhanza.widget.PanelBiasa PanelAccor;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Penanya;
    private id.yaski.simrskhanza.widget.ComboBox PenyampaianJawaban;
    private id.yaski.simrskhanza.widget.RadioButton R1;
    private id.yaski.simrskhanza.widget.RadioButton R2;
    private id.yaski.simrskhanza.widget.TextArea Referensi;
    private id.yaski.simrskhanza.widget.ScrollPane Scroll;
    private id.yaski.simrskhanza.widget.ScrollPane ScrollMenu;
    private id.yaski.simrskhanza.widget.ComboBox StatusPenanya;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.Tanggal TanggalJawab;
    private id.yaski.simrskhanza.widget.Tanggal TanggalPermintaan;
    private id.yaski.simrskhanza.widget.TextArea UraianPertanyaan;
    ...
    private id.yaski.simrskhanza.widget.Label label8;

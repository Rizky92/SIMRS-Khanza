...
import id.yaski.simrskhanza.keuangan.DlgCariDaftarOperasi;
...
import id.yaski.simrskhanza.setting.DlgCariRuangOperasi;
...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnOperator = new id.yaski.simrskhanza.widget.Button();
        Kamar = new id.yaski.simrskhanza.widget.TextBox();
        jLabel35 = new id.yaski.simrskhanza.widget.Label();
        JamMulai = new id.yaski.simrskhanza.widget.ComboBox();
        MenitMulai = new id.yaski.simrskhanza.widget.ComboBox();
        DetikMulai = new id.yaski.simrskhanza.widget.ComboBox();
        DetikSelesai = new id.yaski.simrskhanza.widget.ComboBox();
        MenitSelesai = new id.yaski.simrskhanza.widget.ComboBox();
        JamSelesai = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        KdOperasi = new id.yaski.simrskhanza.widget.TextBox();
        NmOperasi = new id.yaski.simrskhanza.widget.TextBox();
        BtnOperasi = new id.yaski.simrskhanza.widget.Button();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        KdRuangOperasi = new id.yaski.simrskhanza.widget.TextBox();
        NmRuangOperasi = new id.yaski.simrskhanza.widget.TextBox();
        BtnRuangOperasi = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnKamarInap = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnPreOperasi = new id.yaski.simrskhanza.widget.Button();
        BtnCatatanAnastesiSedasi = new id.yaski.simrskhanza.widget.Button();
        BtnPreAnastesi = new id.yaski.simrskhanza.widget.Button();
        BtnTagihanOperasi = new id.yaski.simrskhanza.widget.Button();
        ...
        BtnPengkajianPaskaOperasi = new id.yaski.simrskhanza.widget.Button();
...
private void BtnOperatorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOperatorActionPerformed
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnCatatanAnastesiSedasi;
    ...
    private id.yaski.simrskhanza.widget.Button BtnKamarInap;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnObatBhp;
    private id.yaski.simrskhanza.widget.Button BtnOperasi;
    private id.yaski.simrskhanza.widget.Button BtnOperator;
    private id.yaski.simrskhanza.widget.Button BtnPengkajianPaskaOperasi;
    private id.yaski.simrskhanza.widget.Button BtnPenilaianPreInduksi;
    private id.yaski.simrskhanza.widget.Button BtnPermintaanLab;
    private id.yaski.simrskhanza.widget.Button BtnPreAnastesi;
    private id.yaski.simrskhanza.widget.Button BtnPreOperasi;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnRiwayatPasien;
    private id.yaski.simrskhanza.widget.Button BtnRuangOperasi;
    ...
    private id.yaski.simrskhanza.widget.Button BtnTagihanOperasi;
    ...
    private id.yaski.simrskhanza.widget.ComboBox DetikMulai;
    private id.yaski.simrskhanza.widget.ComboBox DetikSelesai;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.PanelBiasa FormMenu;
    private id.yaski.simrskhanza.widget.ComboBox JamMulai;
    private id.yaski.simrskhanza.widget.ComboBox JamSelesai;
    private id.yaski.simrskhanza.widget.TextBox Kamar;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextBox KdOperasi;
    private id.yaski.simrskhanza.widget.TextBox KdRuangOperasi;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.ComboBox MenitMulai;
    private id.yaski.simrskhanza.widget.ComboBox MenitSelesai;
    private id.yaski.simrskhanza.widget.TextBox NmDokter;
    private id.yaski.simrskhanza.widget.TextBox NmOperasi;
    private id.yaski.simrskhanza.widget.TextBox NmRuangOperasi;

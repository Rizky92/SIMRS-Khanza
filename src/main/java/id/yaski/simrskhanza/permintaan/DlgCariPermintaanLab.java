...
import id.yaski.simrskhanza.bridging.ApiADAMLABS;
import id.yaski.simrskhanza.bridging.ApiLICA;
import id.yaski.simrskhanza.bridging.ApiMEDQLAB;
import id.yaski.simrskhanza.bridging.ApiSOFTMEDIX;
import id.yaski.simrskhanza.bridging.KoneksiDBADAMLABS;
import id.yaski.simrskhanza.bridging.koneksiDBELIMS;
import id.yaski.simrskhanza.bridging.koneksiDBSLIMS;
import id.yaski.simrskhanza.bridging.koneksiDBSMARTLAB;
import id.yaski.simrskhanza.bridging.koneksiDBSysmex;
import id.yaski.simrskhanza.bridging.koneksiDBVANSLAB;
...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        JnsRegistrasi = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        BtnSampel = new id.yaski.simrskhanza.widget.Button();
        BtnHasil = new id.yaski.simrskhanza.widget.Button();
        ...
        tbLabRalan = new id.yaski.simrskhanza.widget.Table();
        scrollPane2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbLabRalan2 = new id.yaski.simrskhanza.widget.Table();
        ...
        tbLabRanap = new id.yaski.simrskhanza.widget.Table();
        scrollPane4 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbLabRanap2 = new id.yaski.simrskhanza.widget.Table();
        ...
        BtnCetakHasilLab = new id.yaski.simrskhanza.widget.Button();
        BtnBarcodePermintaan = new id.yaski.simrskhanza.widget.Button();
        BtnBarcodePermintaan2 = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLica = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLica = new id.yaski.simrskhanza.widget.Button();
        BtnKirimSysmex = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilSysmex = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLISELIMS = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLISELIMS = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLISTeras = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLISTeras = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLISMADQLAB = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLISMADQLAB = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLISSMARTLAB = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLISSMARTLAB = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLISSOFTMEDIX = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLISSOFTMEDIX = new id.yaski.simrskhanza.widget.Button();
        BtnKirimVansLab = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilVanslab = new id.yaski.simrskhanza.widget.Button();
        BtnKirimLISSLIMS = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilLISSLIMS = new id.yaski.simrskhanza.widget.Button();
        BtnKirimAdamLabs = new id.yaski.simrskhanza.widget.Button();
        BtnAmbilAdamLabs = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnAmbilAdamLabs;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLISELIMS;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLISMADQLAB;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLISSLIMS;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLISSMARTLAB;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLISSOFTMEDIX;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLISTeras;
    private id.yaski.simrskhanza.widget.Button BtnAmbilLica;
    private id.yaski.simrskhanza.widget.Button BtnAmbilSysmex;
    private id.yaski.simrskhanza.widget.Button BtnAmbilVanslab;
    private id.yaski.simrskhanza.widget.Button BtnBarcodePermintaan;
    private id.yaski.simrskhanza.widget.Button BtnBarcodePermintaan2;
    private id.yaski.simrskhanza.widget.Button BtnCari;
    private id.yaski.simrskhanza.widget.Button BtnCetakHasilLab;
    ...
    private id.yaski.simrskhanza.widget.Button BtnHasil;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnKirim;
    private id.yaski.simrskhanza.widget.Button BtnKirimAdamLabs;
    private id.yaski.simrskhanza.widget.Button BtnKirimLISELIMS;
    private id.yaski.simrskhanza.widget.Button BtnKirimLISMADQLAB;
    private id.yaski.simrskhanza.widget.Button BtnKirimLISSLIMS;
    private id.yaski.simrskhanza.widget.Button BtnKirimLISSMARTLAB;
    private id.yaski.simrskhanza.widget.Button BtnKirimLISSOFTMEDIX;
    private id.yaski.simrskhanza.widget.Button BtnKirimLISTeras;
    private id.yaski.simrskhanza.widget.Button BtnKirimLica;
    private id.yaski.simrskhanza.widget.Button BtnKirimSysmex;
    private id.yaski.simrskhanza.widget.Button BtnKirimVansLab;
    private id.yaski.simrskhanza.widget.Button BtnPrint;
    private id.yaski.simrskhanza.widget.Button BtnSampel;
    ...
    private id.yaski.simrskhanza.widget.ComboBox JnsRegistrasi;
    ...
    private id.yaski.simrskhanza.widget.Table tbLabRalan;
    private id.yaski.simrskhanza.widget.Table tbLabRalan2;
    private id.yaski.simrskhanza.widget.Table tbLabRanap;
    private id.yaski.simrskhanza.widget.Table tbLabRanap2;

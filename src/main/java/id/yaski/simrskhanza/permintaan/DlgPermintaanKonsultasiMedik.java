...
public class DlgPermintaanKonsultasiMedik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        JawabanKonsultasi = new id.yaski.simrskhanza.widget.TextArea();
        label2 = new id.yaski.simrskhanza.widget.Label();
        JawabanDiagnosaKerja = new id.yaski.simrskhanza.widget.TextBox();
        label3 = new id.yaski.simrskhanza.widget.Label();
        ...
        Permintaan = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        UraianKonsultasi = new id.yaski.simrskhanza.widget.TextArea();
        ...
        BtnDokterDIkonsuli = new id.yaski.simrskhanza.widget.Button();
        NmDokterDikonsuli = new id.yaski.simrskhanza.widget.TextBox();
        KdDokterDikonsuli = new id.yaski.simrskhanza.widget.TextBox();
        ...
        DiagnosaKerja = new id.yaski.simrskhanza.widget.TextBox();
        ...
        BtnJawabanDikonsuli = new id.yaski.simrskhanza.widget.Button();
        BtnDokumentasiKonsul = new id.yaski.simrskhanza.widget.Button();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnDokterDIkonsuli;
    private id.yaski.simrskhanza.widget.Button BtnDokumentasiKonsul;
    private id.yaski.simrskhanza.widget.Button BtnEdit;
    private id.yaski.simrskhanza.widget.Button BtnHapus;
    private id.yaski.simrskhanza.widget.Button BtnJawabanDikonsuli;
    ...
    private id.yaski.simrskhanza.widget.TextBox DiagnosaKerja;
    private id.yaski.simrskhanza.widget.PanelBiasa FormInput;
    private id.yaski.simrskhanza.widget.PanelBiasa FormMenu;
    private id.yaski.simrskhanza.widget.TextBox JawabanDiagnosaKerja;
    private id.yaski.simrskhanza.widget.TextArea JawabanKonsultasi;
    private id.yaski.simrskhanza.widget.TextBox KdDokter;
    private id.yaski.simrskhanza.widget.TextBox KdDokterDikonsuli;
    ...
    private id.yaski.simrskhanza.widget.TextBox NmDokterDikonsuli;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Permintaan;
    ...
    private id.yaski.simrskhanza.widget.TextArea UraianKonsultasi;
    ...
    private id.yaski.simrskhanza.widget.Label label3;

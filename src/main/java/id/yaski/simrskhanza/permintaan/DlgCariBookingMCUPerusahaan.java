...
public class DlgCariBookingMCUPerusahaan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnMenunggu = new id.yaski.simrskhanza.widget.Button();
        BtnSelesai = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnMenunggu;
    ...
    private id.yaski.simrskhanza.widget.Button BtnSelesai;

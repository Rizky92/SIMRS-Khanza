...
import id.yaski.simrskhanza.rekammedis.RMLayananProgramKFR;
...
public class DlgCariPermintaanLayananProgramKFR extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnLayani = new id.yaski.simrskhanza.widget.Button();
        BtnSelesaiProgram = new id.yaski.simrskhanza.widget.Button();
        BtnPerpanjangProgram = new id.yaski.simrskhanza.widget.Button();
        ...
        LCount2 = new id.yaski.simrskhanza.widget.Label();
        ...
        BtnSOAPTindakan = new id.yaski.simrskhanza.widget.Button();
        BtnDetailPermintaan = new id.yaski.simrskhanza.widget.Button();
        BtnRiwayatProgram = new id.yaski.simrskhanza.widget.Button();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnDetailPermintaan;
    private id.yaski.simrskhanza.widget.Button BtnKeluar;
    private id.yaski.simrskhanza.widget.Button BtnLayani;
    private id.yaski.simrskhanza.widget.Button BtnPerpanjangProgram;
    private id.yaski.simrskhanza.widget.Button BtnRiwayatPasien;
    private id.yaski.simrskhanza.widget.Button BtnRiwayatProgram;
    private id.yaski.simrskhanza.widget.Button BtnSOAPTindakan;
    private id.yaski.simrskhanza.widget.Button BtnSelesaiProgram;
    ...
    private id.yaski.simrskhanza.widget.Label LCount2;

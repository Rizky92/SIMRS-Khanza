...
public class UTDPenyerahanDarah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CmbCariGd = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        CmbCariResus = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Persenppn = new id.yaski.simrskhanza.widget.TextBox();
        BesarPPN = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Bayar = new id.yaski.simrskhanza.widget.TextBox();
        label20 = new id.yaski.simrskhanza.widget.Label();
        LKembali = new id.yaski.simrskhanza.widget.Label();
        ...
        tbDarah = new id.yaski.simrskhanza.widget.Table();
        ...
        nopenyerahan = new id.yaski.simrskhanza.widget.TextBox();
        label14 = new id.yaski.simrskhanza.widget.Label();
        kdptgcross = new id.yaski.simrskhanza.widget.TextBox();
        kdptgpj = new id.yaski.simrskhanza.widget.TextBox();
        label16 = new id.yaski.simrskhanza.widget.Label();
        nmptgcross = new id.yaski.simrskhanza.widget.TextBox();
        nmptgpj = new id.yaski.simrskhanza.widget.TextBox();
        btnPtgCross = new id.yaski.simrskhanza.widget.Button();
        btnPtgPJ = new id.yaski.simrskhanza.widget.Button();
        ...
        nmpengambil = new id.yaski.simrskhanza.widget.TextBox();
        label23 = new id.yaski.simrskhanza.widget.Label();
        alamatpengambil = new id.yaski.simrskhanza.widget.TextBox();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox Bayar;
    private id.yaski.simrskhanza.widget.TextBox BesarPPN;
    ...
    private id.yaski.simrskhanza.widget.ComboBox CmbCariGd;
    private id.yaski.simrskhanza.widget.ComboBox CmbCariResus;
    private id.yaski.simrskhanza.widget.TextBox Kd2;
    private id.yaski.simrskhanza.widget.Label LKembali;
    private id.yaski.simrskhanza.widget.Label LTotal;
    private id.yaski.simrskhanza.widget.TextBox Persenppn;
    ...
    private id.yaski.simrskhanza.widget.TextBox alamatpengambil;
    private id.yaski.simrskhanza.widget.Button btnPtgCross;
    private id.yaski.simrskhanza.widget.Button btnPtgPJ;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdptgcross;
    private id.yaski.simrskhanza.widget.TextBox kdptgpj;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmpengambil;
    private id.yaski.simrskhanza.widget.TextBox nmptgcross;
    private id.yaski.simrskhanza.widget.TextBox nmptgpj;
    private id.yaski.simrskhanza.widget.TextBox nopenyerahan;
    ...
    private id.yaski.simrskhanza.widget.Table tbDarah;

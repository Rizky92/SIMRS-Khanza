...
public class UTDPemisahanDarah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnCariKomponen = new id.yaski.simrskhanza.widget.Button();
        Scroll3 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbKomponen = new id.yaski.simrskhanza.widget.Table();
        btnTambahKomponen = new id.yaski.simrskhanza.widget.Button();
        Komponen = new id.yaski.simrskhanza.widget.TextBox();
        BtnAllKomponen = new id.yaski.simrskhanza.widget.Button();
        ...
        tbPemisahan = new id.yaski.simrskhanza.widget.Table();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnAllKomponen;
    ...
    private id.yaski.simrskhanza.widget.Button BtnCariKomponen;
    ...
    private id.yaski.simrskhanza.widget.TextBox Komponen;
    ...
    private id.yaski.simrskhanza.widget.Button btnTambahKomponen;
    ...
    private id.yaski.simrskhanza.widget.Table tbKomponen;
    private id.yaski.simrskhanza.widget.Table tbMedis;
    private id.yaski.simrskhanza.widget.Table tbNonMedis;
    private id.yaski.simrskhanza.widget.Table tbPemisahan;

...
public class UTDPendonor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        GDCari = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        ResusCari = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        NoId = new id.yaski.simrskhanza.widget.TextBox();
        Nama = new id.yaski.simrskhanza.widget.TextBox();
        label18 = new id.yaski.simrskhanza.widget.Label();
        label26 = new id.yaski.simrskhanza.widget.Label();
        Telp = new id.yaski.simrskhanza.widget.TextBox();
        label31 = new id.yaski.simrskhanza.widget.Label();
        KTP = new id.yaski.simrskhanza.widget.TextBox();
        ...
        GD = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Resus = new id.yaski.simrskhanza.widget.ComboBox();
...
*/
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.ComboBox GD;
    private id.yaski.simrskhanza.widget.ComboBox GDCari;
    private id.yaski.simrskhanza.widget.ComboBox JK;
    private id.yaski.simrskhanza.widget.TextBox KTP;
    ...
    private id.yaski.simrskhanza.widget.TextBox Nama;
    private id.yaski.simrskhanza.widget.TextBox NoId;
    private javax.swing.JPanel PanelInput;
    private id.yaski.simrskhanza.widget.TextBox Propinsi;
    private id.yaski.simrskhanza.widget.ComboBox Resus;
    private id.yaski.simrskhanza.widget.ComboBox ResusCari;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox Telp;

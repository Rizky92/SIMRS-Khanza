...
public final class UTDCekalDarah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoDonor = new id.yaski.simrskhanza.widget.TextBox();
        jLabel8 = new id.yaski.simrskhanza.widget.Label();
        jLabel4 = new id.yaski.simrskhanza.widget.Label();
        IDPendonor = new id.yaski.simrskhanza.widget.TextBox();
        ...
        TanggalCekal = new id.yaski.simrskhanza.widget.Tanggal();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox IDPendonor;

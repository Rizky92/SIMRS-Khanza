...
import id.yaski.simrskhanza.inventory.riwayatobat;
...
public class UTDCariPenyerahanDarah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kdkomponen = new id.yaski.simrskhanza.widget.TextBox();
        nmkomponen = new id.yaski.simrskhanza.widget.TextBox();
        ...
        btnPetugasCros = new id.yaski.simrskhanza.widget.Button();
...
*/
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button btnPetugasCros;
    ...
    private id.yaski.simrskhanza.widget.TextBox kdkomponen;
    ...
    private id.yaski.simrskhanza.widget.TextBox nmkomponen;

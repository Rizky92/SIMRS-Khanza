...
package id.yaski.simrskhanza.tranfusidarah;
...
public final class UTDDonor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TCariMedis = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NomorDonor = new id.yaski.simrskhanza.widget.TextBox();
        label36 = new id.yaski.simrskhanza.widget.Label();
        NoPendonor = new id.yaski.simrskhanza.widget.TextBox();
        ...
        Dinas = new id.yaski.simrskhanza.widget.ComboBox();
        Lahir = new id.yaski.simrskhanza.widget.TextBox();
        ...
        NomorBag = new id.yaski.simrskhanza.widget.TextBox();
        label41 = new id.yaski.simrskhanza.widget.Label();
        NomorTelp = new id.yaski.simrskhanza.widget.TextBox();
        jLabel12 = new id.yaski.simrskhanza.widget.Label();
        JenisBag = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel13 = new id.yaski.simrskhanza.widget.Label();
        JenisDonor = new id.yaski.simrskhanza.widget.ComboBox();
        jLabel14 = new id.yaski.simrskhanza.widget.Label();
        TempatAftap = new id.yaski.simrskhanza.widget.ComboBox();
        label17 = new id.yaski.simrskhanza.widget.Label();
        KodePetugasAftap = new id.yaski.simrskhanza.widget.TextBox();
        NamaPetugasAftap = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugasAftap = new id.yaski.simrskhanza.widget.Button();
        ...
        HCV = new id.yaski.simrskhanza.widget.ComboBox();
        ...
        Spilis = new id.yaski.simrskhanza.widget.ComboBox();
        label19 = new id.yaski.simrskhanza.widget.Label();
        KodePetugasUSaring = new id.yaski.simrskhanza.widget.TextBox();
        NamaPetugasUSaring = new id.yaski.simrskhanza.widget.TextBox();
        btnPetugasUSaring = new id.yaski.simrskhanza.widget.Button();
        jLabel19 = new id.yaski.simrskhanza.widget.Label();
        Malaria = new id.yaski.simrskhanza.widget.ComboBox();
        NamaPendonor = new id.yaski.simrskhanza.widget.TextBox();
        btnPendonor = new id.yaski.simrskhanza.widget.Button();
        JK = new id.yaski.simrskhanza.widget.TextBox();
        Resus = new id.yaski.simrskhanza.widget.TextBox();
        ...
        tbTranfusiDarah = new id.yaski.simrskhanza.widget.Table();
        ...
        TanggalCari1 = new id.yaski.simrskhanza.widget.Tanggal();
        jLabel21 = new id.yaski.simrskhanza.widget.Label();
        TanggalCari2 = new id.yaski.simrskhanza.widget.Tanggal();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Button BtnAll2;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Dinas;
    private id.yaski.simrskhanza.widget.TextBox GD;
    private id.yaski.simrskhanza.widget.ComboBox HBSAg;
    private id.yaski.simrskhanza.widget.ComboBox HCV;
    private id.yaski.simrskhanza.widget.ComboBox HIV;
    private id.yaski.simrskhanza.widget.TextBox JK;
    private id.yaski.simrskhanza.widget.ComboBox JenisBag;
    private id.yaski.simrskhanza.widget.ComboBox JenisDonor;
    private id.yaski.simrskhanza.widget.TextBox KodePetugasAftap;
    private id.yaski.simrskhanza.widget.TextBox KodePetugasUSaring;
    private id.yaski.simrskhanza.widget.Label LCount;
    private id.yaski.simrskhanza.widget.TextBox Lahir;
    private id.yaski.simrskhanza.widget.ComboBox Malaria;
    private id.yaski.simrskhanza.widget.TextBox NamaPendonor;
    private id.yaski.simrskhanza.widget.TextBox NamaPetugasAftap;
    private id.yaski.simrskhanza.widget.TextBox NamaPetugasUSaring;
    private id.yaski.simrskhanza.widget.TextBox NoPendonor;
    private id.yaski.simrskhanza.widget.TextBox NomorBag;
    private id.yaski.simrskhanza.widget.TextBox NomorDonor;
    private id.yaski.simrskhanza.widget.TextBox NomorTelp;
    private id.yaski.simrskhanza.widget.TextBox Resus;
    ...
    private id.yaski.simrskhanza.widget.ComboBox Spilis;
    private id.yaski.simrskhanza.widget.TextBox TCari;
    private id.yaski.simrskhanza.widget.TextBox TCariMedis;
    private id.yaski.simrskhanza.widget.TextBox TCariNonMedis;
    private javax.swing.JTabbedPane TabRawat;
    private id.yaski.simrskhanza.widget.Tanggal Tanggal;
    private id.yaski.simrskhanza.widget.Tanggal TanggalCari1;
    private id.yaski.simrskhanza.widget.Tanggal TanggalCari2;
    private id.yaski.simrskhanza.widget.ComboBox TempatAftap;
    private id.yaski.simrskhanza.widget.TextBox Tensi;
    private id.yaski.simrskhanza.widget.Button btnPendonor;
    private id.yaski.simrskhanza.widget.Button btnPetugasAftap;
    private id.yaski.simrskhanza.widget.Button btnPetugasUSaring;
    ...
    private id.yaski.simrskhanza.widget.Table tbMedis;
    private id.yaski.simrskhanza.widget.Table tbNonMedis;
    private id.yaski.simrskhanza.widget.Table tbTranfusiDarah;

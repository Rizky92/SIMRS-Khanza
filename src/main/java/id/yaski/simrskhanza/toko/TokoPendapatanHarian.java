...
public final class TokoPendapatanHarian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbPenjualan = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbPiutang = new id.yaski.simrskhanza.widget.Table();
        jPanel1 = new javax.swing.JPanel();
        panelisi5 = new id.yaski.simrskhanza.widget.panelisi();
        Total = new id.yaski.simrskhanza.widget.Label();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Label Total;
    ...
    private id.yaski.simrskhanza.widget.Table tbPenjualan;
    private id.yaski.simrskhanza.widget.Table tbPiutang;

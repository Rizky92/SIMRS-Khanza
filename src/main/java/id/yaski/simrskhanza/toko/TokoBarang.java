...
import id.yaski.simrskhanza.inventory.DlgCariSatuan;
...
import id.yaski.simrskhanza.restore.DlgRestoreTokoBarang;
...
public final class TokoBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kode_brng = new id.yaski.simrskhanza.widget.TextBox();
        nama_brng = new id.yaski.simrskhanza.widget.TextBox();
        ...
        kode_sat = new id.yaski.simrskhanza.widget.TextBox();
        nama_sat = new id.yaski.simrskhanza.widget.TextBox();
        ...
        distributor = new id.yaski.simrskhanza.widget.TextBox();
        label5 = new id.yaski.simrskhanza.widget.Label();
        grosir = new id.yaski.simrskhanza.widget.TextBox();
        label6 = new id.yaski.simrskhanza.widget.Label();
        retail = new id.yaski.simrskhanza.widget.TextBox();
  ...
  isForm();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.TextBox distributor;
    private id.yaski.simrskhanza.widget.TextBox grosir;
    ...
    private id.yaski.simrskhanza.widget.TextBox kode_brng;
    private id.yaski.simrskhanza.widget.TextBox kode_sat;
    ...
    private id.yaski.simrskhanza.widget.TextBox nama_brng;
    private id.yaski.simrskhanza.widget.TextBox nama_sat;
    ...
    private id.yaski.simrskhanza.widget.TextBox retail;

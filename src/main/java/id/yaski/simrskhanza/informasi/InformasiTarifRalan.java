...
public final class InformasiTarifRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbJnsPerawatan1 = new id.yaski.simrskhanza.widget.Table();
        Scroll2 = new id.yaski.simrskhanza.widget.ScrollPane();
        tbJnsPerawatan2 = new id.yaski.simrskhanza.widget.Table();
    ...
    */
    ...
    private id.yaski.simrskhanza.widget.Table tbJnsPerawatan1;
    private id.yaski.simrskhanza.widget.Table tbJnsPerawatan2;

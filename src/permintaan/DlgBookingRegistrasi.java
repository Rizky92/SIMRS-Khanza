...
import kepegawaian.DlgCariDokterSMC;
...
public class DlgBookingRegistrasi extends javax.swing.JDialog {
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BookingRegistrasi.html", "Laporan Daftar Booking Registrasi", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BookingRegistrasi.wps", "Laporan Daftar Booking Registrasi", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BookingRegistrasi.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BookingRegistrasi.xlsx", tbObat);
                        break;
    ...
    */
    ...
    private widget.Label JamPraktek;

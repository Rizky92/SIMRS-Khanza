            ...
            if(TabPilihRawat.getSelectedIndex()==0){
                if(TabRawatJalan.getSelectedIndex()==0){
                    if(tabMode.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("LapPermintaanLab.html", "Data Permintaan Laboratorium", tbLabRalan);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLab.wps", "Data Permintaan Laboratorium", tbLabRalan);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLab.csv", tbLabRalan);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLab.xlsx", tbLabRalan);
                                break;
                    ...
                    if(tabMode2.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("LapPermintaanLab2.html", "Data Detail Permintaan Laboratorium", tbLabRalan2);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLab2.wps", "Data Detail Permintaan Laboratorium", tbLabRalan2);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLab2.csv", tbLabRalan2);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLab2.xlsx", tbLabRalan2);
                                break;
                            case "Laporan 5 (Jasper)":
                                Sequel.queryu("delete from temporary_permintaan_lab");
                ...
                if(TabRawatInap.getSelectedIndex()==0){
                    if(tabMode3.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("LapPermintaanLab3.html", "Data Permintaan Laboratorium", tbLabRanap);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLab3.wps", "Data Permintaan Laboratorium", tbLabRanap);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLab3.csv", tbLabRanap);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLab3.xlsx", tbLabRanap);
                                break;
                            case "Laporan 5 (Jasper)":
                                Sequel.queryu("delete from temporary_permintaan_lab");
                    ...
                    if(tabMode4.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("LapPermintaanLab4.html", "Data Detail Permintaan Laboratorium", tbLabRanap2);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLab4.wps", "Data Detail Permintaan Laboratorium", tbLabRanap2);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLab4.csv", tbLabRanap2);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLab4.xlsx", tbLabRanap2);
                                break;
                            case "Laporan 5 (Jasper)":
                                Sequel.queryu("delete from temporary_permintaan_lab");

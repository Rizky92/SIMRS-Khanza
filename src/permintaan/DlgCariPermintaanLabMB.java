                    ...
                    if(tabMode.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                ...
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLabMB.wps", "Data Permintaan Laboratorium", tbLabRalan);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLabMB.csv", tbLabRalan);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLabMB.xlsx", tbLabRalan);
                                break;
                    ...
                    if(tabMode2.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                ...
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLab2MB.wps", "Data Detail Permintaan Laboratorium", tbLabRalan2);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLab2MB.csv", tbLabRalan2);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLab2MB.xlsx", tbLabRalan2);
                                break;
                            case "Laporan 5 (Jasper)":
                                Sequel.queryu("delete from temporary_permintaan_labmb");
                    ...
                    if(tabMode4.getRowCount()==0){
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                ...
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("LapPermintaanLab4MB.wps", "Data Detail Permintaan Laboratorium", tbLabRanap2);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("LapPermintaanLab4MB.csv", tbLabRanap2);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("LapPermintaanLab4MB.xlsx", tbLabRanap2);
                                break;
                            case "Laporan 5 (Jasper)":
                                Sequel.queryu("delete from temporary_permintaan_labmb");

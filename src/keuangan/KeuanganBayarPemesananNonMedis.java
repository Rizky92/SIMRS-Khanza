    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("BayarPemesananNonMedis.html", "::[ Bayar Pemesanan ]::", tbKamar); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("BayarPemesananNonMedis.wps", "::[ Bayar Pemesanan ]::", tbKamar); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("BayarPemesananNonMedis.csv", tbKamar); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("BayarPemesananNonMedis.xlsx", tbKamar); break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("FeeRujukanRontgen.html", "Rekap Fee Rujukan Rontgen", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("FeeRujukanRontgen.wps", "Rekap Fee Rujukan Rontgen", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("FeeRujukanRontgen.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("FeeRujukanRontgen.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptFeeRujukanRontgen.jasper", "report", "[ Rekap Fee Rujukan Rontgen ]", param);
                        break;
                }
            } catch (Exception e) {

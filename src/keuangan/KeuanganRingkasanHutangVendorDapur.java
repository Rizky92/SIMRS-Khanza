    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanHutangVendorDapur.html", "Ringkasan Hutang Vendor Barang Dapur", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanHutangVendorDapur.wps", "Ringkasan Hutang Vendor Barang Dapur", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanHutangVendorDapur.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RingkasanHutangVendorDapur.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptRingkasanHutangVendorDapur.jasper", "report", "::[ Ringkasan Hutang Vendor Barang Dapur ]::", param);
                        break;
                }
            } catch (Exception e) {

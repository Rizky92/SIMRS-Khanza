    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("Bubes.html", "::[ Laporan Keuangan ]::", tbDokter); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("Bubes.wps", "::[ Laporan Keuangan ]::", tbDokter); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("Bubes.csv", tbDokter); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("Bubes.xlsx", tbDokter); break;

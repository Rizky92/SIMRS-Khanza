        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PenagihanPiutangPasien.html", "Data Penagihan Piutang Pasien", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PenagihanPiutangPasien.wps", "Data Penagihan Piutang Pasien", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PenagihanPiutangPasien.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PenagihanPiutangPasien.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        i++;
                        Sequel.temporary(String.valueOf(i),"Total Tagihan :","","","","","","",Valid.SetAngka(totaltagihan),"","");
                        ...
                        Valid.reportTempSmc("rptPenagihanPiutangPasien.jasper","report","::[ Data Penagihan Piutang Pasien ]::",param);
                        break;
                }
            } catch (Exception e) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("rptPenagihanPiutangPasien.html", "::[ Data Penagihan Piutang Pasien ]::", tbDokter); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("rptPenagihanPiutangPasien.wps", "::[ Data Penagihan Piutang Pasien ]::", tbDokter); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("rptPenagihanPiutangPasien.csv", tbDokter); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("rptPenagihanPiutangPasien.xlsx", tbDokter); break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PaymentPoint.html", "Payment Point", Tabel);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PaymentPoint.wps", "Payment Point", Tabel);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PaymentPoint.csv", Tabel);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PaymentPoint.xlsx", Tabel);
                        break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ValidasiTagihanDapur.html", "Validasi Tagihan Dapur", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ValidasiTagihanDapur.wps", "Validasi Tagihan Dapur", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ValidasiTagihanDapur.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ValidasiTagihanDapur.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptValidasiTagihanDapur.jasper", "report", "::[ Data Pegajuan Titip Faktur/Tagihan Dapur ]::", param);
                        break;
                }
            } catch (Exception e) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PaketOperasi.html", "Data Paket Operasi", tbJnsPerawatan, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PaketOperasi.wps", "Data Paket Operasi", tbJnsPerawatan, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PaketOperasi.csv", tbJnsPerawatan, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PaketOperasi.xlsx", tbJnsPerawatan, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;

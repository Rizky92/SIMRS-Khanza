    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PengembalianDepositPasien.html", "Pengembalian Deposit Pasien", Tabel);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PengembalianDepositPasien.wps", "Pengembalian Deposit Pasien", Tabel);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PengembalianDepositPasien.csv", Tabel);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PengembalianDepositPasien.xlsx", Tabel);
                        break;

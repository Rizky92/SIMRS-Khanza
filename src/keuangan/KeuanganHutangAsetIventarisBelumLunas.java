    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("HutangAsetInventarisBelumLunas.html", "Hutang Aset/Inventaris Belum Lunas", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("HutangAsetInventarisBelumLunas.wps", "Hutang Aset/Inventaris Belum Lunas", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("HutangAsetInventarisBelumLunas.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("HutangAsetInventarisBelumLunas.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptHutangAsetInventaris.jasper", "report", "::[ Data Hutang Aset/Inventaris ]::", param);
                        break;
                }
            } catch (Exception e) {

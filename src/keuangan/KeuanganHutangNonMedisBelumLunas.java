    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("HutangNonMedisBelumLunas.html", "Hutang Non Medis Belum Lunas", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("HutangNonMedisBelumLunas.wps", "Hutang Non Medis Belum Lunas", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("HutangNonMedisBelumLunas.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("HutangNonMedisBelumLunas.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptHutangNonMedisBelumLunas.jasper", "report", "::[ Data Hutang Barang Non Medis ]::", param);
                        break;
                }
            } catch (Exception e) {

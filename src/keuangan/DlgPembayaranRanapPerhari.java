        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PembayaranRanapPerhari.html", "Rekap Tagihan Ranap Masuk", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PembayaranRanapPerhari.wps", "Rekap Tagihan Ranap Masuk", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PembayaranRanapPerhari.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":

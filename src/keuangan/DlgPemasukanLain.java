    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PemasukanLain.html", "Data Pemasukan Lain-Lain", tbResep);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PemasukanLain.wps", "Data Pemasukan Lain-Lain", tbResep);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PemasukanLain.csv", tbResep);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PemasukanLain.xlsx", tbResep);
                        break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RHPaketBHP.html", "Rekap Harian BHP Medis/Paket BHP", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RHPaketBHP.wps", "Rekap Harian BHP Medis/Paket BHP", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RHPaketBHP.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":

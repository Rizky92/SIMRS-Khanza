    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RekapPembayaranPerPoli.html", "Rekap Pembayaran Per Bagian/Unit", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RekapPembayaranPerPoli.wps", "Rekap Pembayaran Per Bagian/Unit", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RekapPembayaranPerPoli.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RekapPembayaranPerPoli.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptRekapPembayaranPerPoli.jasper", "report", "[ Rekap Pembayaran Per Bagian/Unit ]", param);
                        break;
                }
            } catch (Exception e) {

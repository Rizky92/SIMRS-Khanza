    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KategoriPemasukan.html", "Kategori Pemasukan Lain", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KategoriPemasukan.wps", "Kategori Pemasukan Lain", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KategoriPemasukan.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KategoriPemasukan.xlsx", tbKamar);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptKategoriPemasukanLain.jasper", "report", "::[ Kategori Pemasukan Lain ]::", param);
                        break;
                }
            } catch (Exception e) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("BayarPemesananAset.html", "::[ Bayar Pemesanan Aset/Inventaris ]::", tbKamar); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("BayarPemesananAset.wps", "::[ Bayar Pemesanan Aset/Inventaris ]::", tbKamar); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("BayarPemesananAset.csv", tbKamar); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("BayarPemesananAset.xlsx", tbKamar); break;

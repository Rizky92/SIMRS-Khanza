    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("AkunBayar.html", "Akun Bayar", tbJadwal, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("AkunBayar.wps", "Akun Bayar", tbJadwal, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("AkunBayar.csv", tbJadwal, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("AkunBayar.xlsx", tbJadwal, IntStream.rangeClosed(1, tabMode.getColumnCount() - 1).toArray());
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptAkunBayar.jasper", "report", "::[ Akun Bayar ]::", param,
                            "select akun_bayar.nama_bayar, akun_bayar.kd_rek, rekening.nm_rek, akun_bayar.ppn from akun_bayar inner join rekening on " +
                            "akun_bayar.kd_rek=rekening.kd_rek where akun_bayar.nama_bayar like ? or rekening.nm_rek like ? order by akun_bayar.nama_bayar",

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    bw.flush();
                }                String pilihan = (String) JOptionPane.showInputDialog(null, "Silahkan pilih laporan..!", "Pilihan Cetak", JOptionPane.QUESTION_MESSAGE, null, new Object[] {"Laporan 1 (HTML)", "Laporan 2 (WPS)", "Laporan 3 (CSV)", "Laporan 4 (XLSX)", "Laporan 5 (Jasper)"}, "Laporan 5 (Jasper)");                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RVPPiutang.html", "Data Piutang BPJS Sebelum RVP", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RVPPiutang.wps", "Data Piutang BPJS Sebelum RVP", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RVPPiutang.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RVPPiutang.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        i++;
                        Sequel.temporary(String.valueOf(i),"Total :","","","",
                                    Valid.SetAngka(ttlpiutang),
                                    Valid.SetAngka(ttliur),
                                    Valid.SetAngka(ttlsudahdibayar),
                                    Valid.SetAngka(ttlsisapiutang),
                                    Valid.SetAngka(ttlinacbg),
                        ...
                        Valid.reportTempSmc("rptRVPPiutang.jasper","report","::[ Data Piutang BPJS Sebelum RVP ]::",param);
                        break;
                }
            } catch (Exception e) {

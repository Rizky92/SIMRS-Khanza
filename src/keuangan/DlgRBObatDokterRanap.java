    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RBObatPerdokterRanap.html", "Rekap Obat Dokter Perpasien Ralan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RBObatPerdokterRanap.wps", "Rekap Obat Dokter Perpasien Ralan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RBObatPerdokterRanap.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ValidasiTagihanNonMedis.html", "Validasi Tagihan Non Medis", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ValidasiTagihanNonMedis.wps", "Validasi Tagihan Non Medis", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ValidasiTagihanNonMedis.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ValidasiTagihanNonMedis.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        Sequel.deleteTemporary();
                        int i = 0;
                        for (; i < tabMode.getRowCount(); i++) {
                            Sequel.temporary(String.valueOf(i + 1), tabMode.getValueAt(i, 0).toString(), tabMode.getValueAt(i, 1).toString(), tabMode.getValueAt(i, 2).toString(), tabMode.getValueAt(i, 3).toString(), tabMode.getValueAt(i, 4).toString());
                        }
                        Sequel.temporary(String.valueOf(i + 1), "TOTAL TAGIHAN :", "", "", "", LCount.getText());
                        ...
                        Valid.reportTempSmc("rptValidasiTagihanNonMedis.jasper", "report", "::[ Data Pegajuan Titip Faktur/Tagihan Non Medis ]::", param);
                        break;
                }
            } catch (Exception e) {

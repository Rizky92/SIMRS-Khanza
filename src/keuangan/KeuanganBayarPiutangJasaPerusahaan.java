    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("BayarPiutangJasaPerusahaan.html", "::[ Bayar Piutang Jasa Perusahaan ]::", tbKamar); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("BayarPiutangJasaPerusahaan.wps", "::[ Bayar Piutang Jasa Perusahaan ]::", tbKamar); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("BayarPiutangJasaPerusahaan.csv", tbKamar); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("BayarPiutangJasaPerusahaan.xlsx", tbKamar); break;

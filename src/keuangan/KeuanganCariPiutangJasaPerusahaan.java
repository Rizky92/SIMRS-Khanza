    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("rptPiutangJasaPerusahaan.html", "::[ Transaksi Piutang Jasa Perusahaan ]::", tbDokter); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("rptPiutangJasaPerusahaan.wps", "::[ Transaksi Piutang Jasa Perusahaan ]::", tbDokter); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("rptPiutangJasaPerusahaan.csv", tbDokter); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("rptPiutangJasaPerusahaan.xlsx", tbDokter); break;

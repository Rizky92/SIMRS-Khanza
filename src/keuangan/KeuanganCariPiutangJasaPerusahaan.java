        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PiutangJasaPerusahaan.html", "Transaksi Piutang Jasa Perusahaan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PiutangJasaPerusahaan.wps", "Transaksi Piutang Jasa Perusahaan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":

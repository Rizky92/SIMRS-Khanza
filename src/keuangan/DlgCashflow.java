        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Cashflow.html", "Arus Kas/Cash Flow Perusahaan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Cashflow.wps", "Arus Kas/Cash Flow Perusahaan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Cashflow.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Cashflow.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptCashFlow.jasper", "report", "::[ Arus Kas/Cash Flow Perusahaan ]::", param);
                        break;
                }
            } catch (Exception e) {

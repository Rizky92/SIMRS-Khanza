            ...
            if(kontrakun.equals("")){
                ...
                if(kontrakun.equals(kategori.Host_to_Host_Bank_Mandiri)){
                    ...
                    if(Sequel.menyimpantf2("pengeluaran_harian","?,?,?,?,?,?","Pengeluaran",6,new String[]{
                        ...
                        if (sukses) sukses = jur.simpanJurnalSMC(Nomor.getText(),"U","PENGELUARAN HARIAN"+", OLEH "+akses.getkode());
                    }else{
                        sukses=false;
                    }
                        ...
                        try {
                            ...
                            try {
                                ...
                                if(rs.next()){
                                    ...
                                    if (sukses) sukses = jur.simpanJurnalSMC(Nomor.getText(),"U","PEMBATALAN PENGELUARAN HARIAN"+", OLEH "+akses.getkode());
                                }
                            } catch (Exception e) {
                                sukses=false;
                                System.out.println("Notif : "+e);

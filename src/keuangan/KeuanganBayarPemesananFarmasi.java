        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BayarPemesananFarmasi.html", "Bayar Pemesanan", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BayarPemesananFarmasi.wps", "Bayar Pemesanan", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BayarPemesananFarmasi.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BayarPemesananFarmasi.xlsx", tbKamar);
                        break;

        ...
        try {
            ...
            if(Sequel.queryu2tf("delete from bayar_pemesanan where tgl_bayar=? and no_faktur=? and "+
                ...
                if(koderekening.equals("")){
                    ...
                    if (sukses) sukses = Sequel.insertTampJurnal(Bayar_Pemesanan_Obat, "HUTANG USAHA", "0", BesarBayar.getText());
                    if (sukses) sukses = jur.simpanJurnal(NoBukti.getText(),"U","BATAL BAYAR PELUNASAN HUTANG OBAT/BHP/ALKES NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode()); 
                }
            }else{
                sukses=false;
            }

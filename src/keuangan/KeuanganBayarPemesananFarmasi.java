                ...
                if(sisahutang>0){
                    ...
                    if(koderekening.equals("")){
                        ...
                        if(koderekening.equals(Host_to_Host_Bank_Mandiri)){
                            ...
                            jur.clear();
                            if (sukses) sukses = jur.tampung(Bayar_Pemesanan_Obat, "HUTANG USAHA", Double.parseDouble(BesarBayar.getText()), 0);
                            if (sukses) sukses = jur.tampung(koderekening, AkunBayar.getSelectedItem().toString(), 0, Double.parseDouble(BesarBayar.getText()));
                            if (sukses) sukses = jur.simpanJurnalSMC(NoBukti.getText(),"U","BAYAR PELUNASAN HUTANG OBAT/BHP/ALKES NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());
        ...
        try {
            ...
            if(Sequel.queryu2tf("delete from bayar_pemesanan where tgl_bayar=? and no_faktur=? and "+
                ...
                if(koderekening.equals("")){
                    ...
                    if (sukses) sukses = jur.tampung(Bayar_Pemesanan_Obat, "HUTANG USAHA", "0", BesarBayar.getText());
                    if (sukses) sukses = jur.simpanJurnalSMC(NoBukti.getText(),"U","BATAL BAYAR PELUNASAN HUTANG OBAT/BHP/ALKES NO.FAKTUR "+NoFaktur.getText()+", OLEH "+akses.getkode());
                }
            }else{
                sukses=false;
            }
    ...
    private void BtnSimpanMandiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanMandiriActionPerformed
        if(NoRekening.getText().trim().equals("")){
            ...
            try {
                ...
                if (sukses) sukses = jur.tampung(Bayar_Pemesanan_Obat, "HUTANG USAHA", BesarBayar.getText(), "0");

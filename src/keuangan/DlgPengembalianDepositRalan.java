 ...
 * @author perpustakaan
 */
public final class DlgPengembalianDepositRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPengembalianDepositRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengembalian Deposit Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPengembalianDepositRalan.jasper","report","::[ Pengembalian Deposit Rawat Jalan ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPengembalianDepositRalan dialog = new DlgPengembalianDepositRalan(new javax.swing.JFrame(), true);
    ...
    public void tampil(){
        ...
        try{
            ps= koneksi.prepareStatement(
                "select pengembalian_deposit_ralan.tanggal,pengembalian_deposit_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pengembalian_deposit_ralan.besar_pengembalian,pengembalian_deposit_ralan.petugas from pengembalian_deposit_ralan "+
                "inner join reg_periksa on reg_periksa.no_rawat=pengembalian_deposit_ralan.no_rawat inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "+
                "where pengembalian_deposit_ralan.tanggal between ? and ? "+(TCari.getText().equals("")?"":" and (pengembalian_deposit_ralan.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ?) ")+
                "order by pengembalian_deposit_ralan.tanggal");
            try {

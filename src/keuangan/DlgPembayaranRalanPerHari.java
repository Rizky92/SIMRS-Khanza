        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PembayaranRalanPerHari.html", "Rekap Tagihan Ralan Masuk Harian", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PembayaranRalanPerHari.wps", "Rekap Tagihan Ralan Masuk Harian", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PembayaranRalanPerHari.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("LhtBiaya.html", "Rekap Tagihan Masuk", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("LhtBiaya.wps", "Rekap Tagihan Masuk", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("LhtBiaya.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PaymentPoint2.html", "Payment Point", Tabel);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PaymentPoint2.wps", "Payment Point", Tabel);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PaymentPoint2.csv", Tabel);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PaymentPoint2.xlsx", Tabel);
                        break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PerkiraanBiayaRanap.html", "Perkiraan Biaya Rawat Inap", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PerkiraanBiayaRanap.wps", "Perkiraan Biaya Rawat Inap", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PerkiraanBiayaRanap.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KategoriPiutangJasaPerusahaan.html", "Kategori Piutang Jasa Perusahaan", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KategoriPiutangJasaPerusahaan.wps", "Kategori Piutang Jasa Perusahaan", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KategoriPiutangJasaPerusahaan.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KategoriPiutangJasaPerusahaan.xlsx", tbKamar);
                        break;

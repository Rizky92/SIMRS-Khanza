        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KeuanganNilaiPiutangPerCaraBayarPerBulan.html", "Nilai Piutang Per Cara Bayar Per Bulan", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KeuanganNilaiPiutangPerCaraBayarPerBulan.wps", "Nilai Piutang Per Cara Bayar Per Bulan", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KeuanganNilaiPiutangPerCaraBayarPerBulan.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KeuanganNilaiPiutangPerCaraBayarPerBulan.xlsx", tbDokter);
                        break;

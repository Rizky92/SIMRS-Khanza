        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BayarJmDokter.html", "Data Rekap Pembayaran Jasa Medis Dokter", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BayarJmDokter.wps", "Data Rekap Pembayaran Jasa Medis Dokter", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BayarJmDokter.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BayarJmDokter.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Sequel.temporary(String.valueOf(i),"","","TOTAL PEMBAYARAN :","","","",Valid.SetAngka(totaltagihan));
                        ...
                        Valid.reportTempSmc("rptBayarJmDokter.jasper","report","::[ Data Rekap Pembayaran Jasa Medis Dokter ]::",param);
                        break;
                }
            } catch (Exception e) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("rptBayarJmDokter.html", "::[ Data Rekap Pembayaran Jasa Medis Dokter ]::", tbDokter); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("rptBayarJmDokter.wps", "::[ Data Rekap Pembayaran Jasa Medis Dokter ]::", tbDokter); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("rptBayarJmDokter.csv", tbDokter); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("rptBayarJmDokter.xlsx", tbDokter); break;

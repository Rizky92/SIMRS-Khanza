    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ValidasiTagihanObatBHP.html", "Validasi Tagihan Obat BHP", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ValidasiTagihanObatBHP.wps", "Validasi Tagihan Obat BHP", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ValidasiTagihanObatBHP.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ValidasiTagihanObatBHP.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptValidasiTagihanObatBHP.jasper", "report", "::[ Data Pegajuan Titip Faktur/Tagihan Obat & BHP ]::", param);
                        break;
                }
            } catch (Exception e) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("BebanHutangLain.html", "::[ Data Beban Hutang Lain ]::", tbKamar); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("BebanHutangLain.wps", "::[ Data Beban Hutang Lain ]::", tbKamar); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("BebanHutangLain.csv", tbKamar); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("BebanHutangLain.xlsx", tbKamar); break;

    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
       if(NoNota.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("piutang_lainlain","?,?,?,?,?,?,?,?,?,?,'Belum Lunas'","No.Nota",10,new String[]{
                    ...
                    Sequel.insertTampJurnal(kontraakun, namakontraakun, NominalPinjam.getText(), "0");
                    Sequel.insertTampJurnal(koderekening, AkunBayar.getSelectedItem().toString(), "0", NominalPinjam.getText());
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbKamar.getSelectedRow()>-1){
            ...
            if(Sequel.queryu2tf("delete from piutang_lainlain where nota_piutang=?", 1,new String[]{
                ...
                Sequel.deleteTampJurnal();
                Sequel.insertTampJurnal(tbKamar.getValueAt(tbKamar.getSelectedRow(), 6).toString(), tbKamar.getValueAt(tbKamar.getSelectedRow(), 7).toString(), tbKamar.getValueAt(tbKamar.getSelectedRow(), 10).toString(), "0");
                Sequel.insertTampJurnal(kontraakun, namakontraakun, "0", tbKamar.getValueAt(tbKamar.getSelectedRow(), 10).toString());

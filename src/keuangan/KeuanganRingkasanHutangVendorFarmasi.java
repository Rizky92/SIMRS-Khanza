    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanHutangVendorFarmasi.html", "Ringkasan Hutang Vendor Farmasi", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanHutangVendorFarmasi.wps", "Ringkasan Hutang Vendor Farmasi", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanHutangVendorFarmasi.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RingkasanHutangVendorFarmasi.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptRingkasanHutangVendorFarmasi.jasper", "report", "::[ Ringkasan Hutang Vendor Farmasi ]::", param);
                        break;
                }
            } catch (Exception e) {

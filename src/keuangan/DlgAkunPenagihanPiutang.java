            ...
            try {
                ...
                switch (pilihan) {
                    ...
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptAkunPenagihanPiutang.jasper", "report", "::[ Akun Penagihan Piutang ]::", param, "select akun_bayar_hutang.nama_bayar, akun_bayar_hutang.kd_rek, " +
                            "rekening.nm_rek from akun_bayar_hutang inner join rekening on akun_bayar_hutang.kd_rek = rekening.kd_rek where akun_bayar_hutang.nama_bayar like ? or " +
                            "rekening.nm_rek like ? order by akun_bayar_hutang.nama_bayar", "%" + TCari.getText().trim() + "%", "%" + TCari.getText().trim() + "%");
                        break;
                }
            } catch (Exception e) {

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PiutangPeminjamanUangBelumLunas.html", "Piutang Peminjaman Uang Belum Lunas", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PiutangPeminjamanUangBelumLunas.wps", "Piutang Peminjaman Uang Belum Lunas", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PiutangPeminjamanUangBelumLunas.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":

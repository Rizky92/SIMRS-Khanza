    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("BayarPiutangPeminjamanUang.html", "Bayar Piutang Pinjaman Uang", tbKamar); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("BayarPiutangPeminjamanUang.wps", "Bayar Piutang Pinjaman Uang", tbKamar); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("BayarPiutangPeminjamanUang.csv", tbKamar); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("BayarPiutangPeminjamanUang.xlsx", tbKamar); break;

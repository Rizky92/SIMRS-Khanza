    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanHutangVendorNonMedis.html", "Ringkasan Hutang Vendor Barang Non Medis", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanHutangVendorNonMedis.wps", "Ringkasan Hutang Vendor Barang Non Medis", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanHutangVendorNonMedis.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RingkasanHutangVendorNonMedis.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Sequel.temporary(String.valueOf(i + 2), "TOTAL HUTANG :", "", LCount.getText());
                        ...
                        Valid.reportTempSmc("rptRingkasanHutangVendorNonMedis.jasper", "report", "::[ Ringkasan Hutang Vendor Barang Non Medis ]::", param);
                        break;
                }
            } catch (Exception e) {

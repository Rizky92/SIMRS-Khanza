    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("CariTagihanObatBHP.html", "Cari Tagihan Obat BHP", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("CariTagihanObatBHP.wps", "Cari Tagihan Obat BHP", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("CariTagihanObatBHP.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("CariTagihanObatBHP.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptTagihanObatBHP.jasper", "report", "::[ Data Titip Faktur/Tagihan Obat & BHP ]::", param);
                        break;
                }
            } catch (Exception e) {

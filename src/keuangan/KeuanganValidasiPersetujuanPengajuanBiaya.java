    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("ValidasiPersetujuanPengajuanBiaya.html", "Data Pengajuan Biaya Yang Disetujui", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("ValidasiPersetujuanPengajuanBiaya.wps", "Data Pengajuan Biaya Yang Disetujui", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("ValidasiPersetujuanPengajuanBiaya.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("ValidasiPersetujuanPengajuanBiaya.xlsx", tbBangsal);
                        break;

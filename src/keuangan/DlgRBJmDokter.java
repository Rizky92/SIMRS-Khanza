    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RBTindakanDokter.html", "Rekap Bulanan Tindakan Dokter", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RBTindakanDokter.wps", "Rekap Bulanan Tindakan Dokter", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                    ...
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptRBTindakanDokter.jasper", "report", "Rekap Bulanan Tindakan Dokter", param);
                        break;
                }
            } catch (Exception e) {

        ...
        if (chkRalan.isSelected()) {
            try {
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "and reg_periksa.tgl_registrasi between ? and ? and rawat_jl_dr.tarif_tindakandr > 0 and not exists(select * from bayar_jm_dokter " +
                ...
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "and reg_periksa.tgl_registrasi between ? and ? and rawat_jl_drpr.tarif_tindakandr > 0 and not exists(select * from bayar_jm_dokter " +
        ...
        if (chkRanap.isSelected()) {
            try {
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "and reg_periksa.tgl_registrasi between ? and ? and rawat_inap_dr.tarif_tindakandr > 0 and not exists(select * from bayar_jm_dokter " +
                ...
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "and reg_periksa.tgl_registrasi between ? and ? and rawat_inap_drpr.tarif_tindakandr > 0 and not exists(select * from bayar_jm_dokter " +
        ...
        if (chkOperasi.isSelected()) {
            try {
                ...
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "between ? and ? and operasi.biayaoperator1 > 0 and not exists(select * from bayar_jm_dokter join bayar_operasi_operator1 " +
                ...
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "between ? and ? and operasi.biayaoperator2 > 0 and not exists(select * from bayar_jm_dokter join bayar_operasi_operator2 " +
                ...
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "between ? and ? and operasi.biayaoperator3 > 0 and not exists(select * from bayar_jm_dokter join bayar_operasi_operator3 " +
                ...
                try (PreparedStatement ps = koneksi.prepareStatement(
                    ...
                    "between ? and ? and operasi.biayadokter_anak > 0 and not exists(select * from bayar_jm_dokter join bayar_operasi_dokter_anak " +

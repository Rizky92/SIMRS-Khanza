...
public final class DlgPembayaranRalan extends javax.swing.JDialog {
    ...
    public DlgPembayaranRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tanggal","No.Rawat/No.Bukti","No.Nota","No.RM","Nama Pasien","Poli/Unit","Perujuk",
            ...
            try {
                ...
                switch (pilihan) {
                    ...
                    case "Laporan 3 (CSV)":
                        htmlContent = new StringBuilder();
                        htmlContent.append(
                            "\"Tanggal\";\"No.Rawat/No.Bukti\";\"No.Nota\";\"No.RM\";\"Nama Pasien\";\"Poli/Unit\";\"Perujuk\";\"Registrasi\";\"Obat+Emb+Tsl\";\"Paket Tindakan\";\"Operasi\";\"Laborat\";\"Radiologi\";\"Tambahan\";\"Potongan\";\"Total\";\"Dokter\";\"Keterangan\"\n"
                        );
                        for(i=0;i<tabMode.getRowCount();i++){
                            htmlContent.append(

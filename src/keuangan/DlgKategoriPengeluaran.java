    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KategoriPengeluaran.html", "Kategori Pengeluaran Lain", tbKamar);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KategoriPengeluaran.wps", "Kategori Pengeluaran Lain", tbKamar);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KategoriPengeluaran.csv", tbKamar);
                        break;
                    case "Laporan 4 (XLSX)":

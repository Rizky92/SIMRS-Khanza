    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RingkasanPiutangPerJensBayar.html", "Ringkasan Sisa Piutang Per Jenis/Cara Bayar", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RingkasanPiutangPerJensBayar.wps", "Ringkasan Sisa Piutang Per Jenis/Cara Bayar", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RingkasanPiutangPerJensBayar.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":

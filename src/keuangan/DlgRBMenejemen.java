    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RBMenejemen.html", "Rekap Bulanan Menejemen Rumah Sakit", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RBMenejemen.wps", "Rekap Bulanan Menejemen Rumah Sakit", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RBMenejemen.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":

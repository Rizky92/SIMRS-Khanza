    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RBJasaSarana.html", "Rekap Bulanan Jasa Sarana Rumah Sakit", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RBJasaSarana.wps", "Rekap Bulanan Jasa Sarana Rumah Sakit", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RBJasaSarana.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RBJasaSarana.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportTempSmc("rptRBJasaSarana.jasper","report","Rekap Bulanan Jasa Sarana Rumah Sakit",param);
                        break;
                }
            } catch (Exception e) {

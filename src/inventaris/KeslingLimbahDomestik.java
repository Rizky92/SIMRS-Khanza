    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("LimbahDomestik.html", "Data Catatan Limbah Padat Domestik", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("LimbahDomestik.wps", "Data Catatan Limbah Padat Domestik", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("LimbahDomestik.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("LimbahDomestik.xlsx", tbObat);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptLimbahDomestik.jasper", "report", "::[ Data Catatan Limbah Padat Domestik ]::", param, "select kesling_limbah_domestik.nip, petugas.nama, " +
                            "kesling_limbah_domestik.tanggal, kesling_limbah_domestik.jumlahlimbah, kesling_limbah_domestik.tanggalangkut, kesling_limbah_domestik.keterangan from " +
                            "kesling_limbah_domestik inner join petugas on kesling_limbah_domestik.nip = petugas.nip where kesling_limbah_domestik.tanggal between ? and ? and " +
                            "(if(trim(?) = '', 1 = 1, kesling_limbah_domestik.nip like ? or petugas.nama like ? or kesling_limbah_domestik.keterangan like ?)) order by " +
                            "kesling_limbah_domestik.tanggal", Valid.getTglSmc(DTPCari1) + " 00:00:00.000", Valid.getTglSmc(DTPCari2) + " 23:59:59.999", TCari.getText().trim(),

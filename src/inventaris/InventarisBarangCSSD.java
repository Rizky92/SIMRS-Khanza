    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("BarangCSSD.html", "Barang CSSD", tbSpesialis);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("BarangCSSD.wps", "Barang CSSD", tbSpesialis);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("BarangCSSD.csv", tbSpesialis);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("BarangCSSD.xlsx", tbSpesialis);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptBarangCSSD.jasper", "report", "::[ Barang CSSD ]::", param);
                        break;
                }
            } catch (Exception e) {

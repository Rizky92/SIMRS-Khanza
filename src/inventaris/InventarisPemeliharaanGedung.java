    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PemeliharaanGedung.html", "Data Pemeliharaan Gedung", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PemeliharaanGedung.wps", "Data Pemeliharaan Gedung", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PemeliharaanGedung.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PemeliharaanGedung.xlsx", tbJnsPerawatan);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptPemeliharaanGedung.jasper", "report", "::[ Data Pemeliharaan Gedung ]::", param, "select pemeliharaan_gedung.no_pemeliharaan, " +
                            "pemeliharaan_gedung.nip, petugas.nama, pemeliharaan_gedung.uraian_kegiatan, pemeliharaan_gedung.tanggal, pemeliharaan_gedung.pelaksana, " +
                            "pemeliharaan_gedung.biaya, pemeliharaan_gedung.jenis_pemeliharaan, pemeliharaan_gedung.tindak_lanjut from pemeliharaan_gedung inner join " +
                            "petugas on pemeliharaan_gedung.nip = petugas.nip where pemeliharaan_gedung.tanggal between ? and ? and (if(trim(?) = '', 1 = 1, " +
                            "pemeliharaan_gedung.no_pemeliharaan like ? or pemeliharaan_gedung.uraian_kegiatan like ? or pemeliharaan_gedung.pelaksana like ? " +
                            "or pemeliharaan_gedung.jenis_pemeliharaan like ? or petugas.nama like ?)) order by pemeliharaan_gedung.no_pemeliharaan",
                            Valid.getTglSmc(DTPCari1), Valid.getTglSmc(DTPCari2), TCari.getText().trim(), "%" + TCari.getText().trim() + "%", "%" +

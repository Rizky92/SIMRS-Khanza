    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PemakaianAirPDAM.html", "Data Pemakaian Air PDAM", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PemakaianAirPDAM.wps", "Data Pemakaian Air PDAM", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PemakaianAirPDAM.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PemakaianAirPDAM.xlsx", tbObat);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptPemakaianAirPDAM.jasper", "report", "::[ Data Pemakaian Air PDAM ]::", param, "select kesling_pemakaian_air_pdam.nip, petugas.nama, " +
                            "kesling_pemakaian_air_pdam.tanggal, kesling_pemakaian_air_pdam.meteran, kesling_pemakaian_air_pdam.jumlahharian, kesling_pemakaian_air_pdam.keterangan " +
                            "from kesling_pemakaian_air_pdam inner join petugas on kesling_pemakaian_air_pdam.nip = petugas.nip where kesling_pemakaian_air_pdam.tanggal between ? and ? " +
                            "and (if(trim(?) = '', 1 = 1, kesling_pemakaian_air_pdam.nip like ? or petugas.nama like ? or kesling_pemakaian_air_pdam.keterangan like ?)) order by " +
                            "kesling_pemakaian_air_pdam.tanggal", Valid.getTglSmc(DTPCari1) + " 00:00:00.000", Valid.getTglSmc(DTPCari2) + " 23:59:59.999", TCari.getText().trim(),

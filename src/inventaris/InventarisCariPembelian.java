                        ...
                        if(rs.next()){
                            ...
                            if (sukses) {
                                ...
                                if(rs.getDouble("ppn")>0){
                                    if (sukses) sukses = jur.tampung(PPN_Masukan, 0, rs.getDouble("ppn"));
                                }
                                if (sukses) sukses = jur.tampung(rs.getString("kd_rek"), rs.getDouble("tagihan"), 0);
                                if (sukses) sukses = jur.simpanJurnalSMC(rs.getString("no_faktur"),"U","PEMBATALAN PENGADAAN BARANG NON MEDIS DAN PENUNJANG (LAB & RAD)"+", OLEH "+akses.getkode());
                            }
                            if(sukses==true){

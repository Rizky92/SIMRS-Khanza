...
public class InventarisCariSuratPemesananSMC extends javax.swing.JDialog {
    ...
    /**
     * Creates new form InventarisCariSuratPemesananSmc
     *
     * @param parent
     * @param modal
     */
    public InventarisCariSuratPemesananSMC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[] {
            "No.Pemesanan", "Barang", "Jml", "Harga(Rp)", "SubTotal(Rp)", "Disk(%)", "Bsr.Disk(Rp)", "Total(Rp)"
        }) {
            @Override
        ...
        int[] widths = {97, 300, 40, 90, 90, 50, 90, 95};
        ...
        kdbar.setDocument(new batasInput((byte) 20).getKata(kdbar));
    ...
    private void initComponents() {
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Cetak Surat Pemesanan Barang Aset ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Surat Pemesanan Barang Aset ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelisi4.add(kdbar);
        kdbar.setBounds(74, 10, 110, 23);

        nmbar.setEditable(false);
        nmbar.setName("nmbar"); // NOI18N
        nmbar.setPreferredSize(new java.awt.Dimension(250, 23));
        panelisi4.add(nmbar);
        nmbar.setBounds(186, 10, 280, 23);
        ...
        btnBarang.setBounds(468, 10, 28, 23);
    ...
    private void TglBeli2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TglBeli2KeyPressed
        Valid.pindah(evt, kdsup, NoFaktur);
    ...
    private void NoFakturKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoFakturKeyPressed
        Valid.pindah(evt, TglBeli1, BtnKeluar);
    ...
    private void kdbarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdbarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi("select inventaris_barang.nama_barang from inventaris_barang where inventaris_barang.kode_barang=?", nmbar, kdbar.getText());
        } else if (evt.getKeyCode() == KeyEvent.VK_PAGE_UP) {
            Sequel.cariIsi("select inventaris_barang.nama_barang from inventaris_barang where inventaris_barang.kode_barang=?", nmbar, kdbar.getText());
            kdptg.requestFocus();
        } else if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < row; i++) {
                Sequel.menyimpan("temporary", "'" + i + "','" +
                    ...
                    tabMode.getValueAt(i, 7).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','',''" + akses.getalamatip() + "'", "Data Surat Pemesanan Inventaris");
            }
            i++;
            Sequel.menyimpan("temporary", "'" + i + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Data Surat Pemesanan Inventaris");
            i++;
            Sequel.menyimpan("temporary", "'" + i + "','Jml.Total :','','','','','','','" + LTotal.getText() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','',''" + akses.getalamatip() + "'", "Data Surat Pemesanan Inventaris");
            ...
            Valid.MyReportqry("rptDataPemesananInventarisSmc.jasper", "report", "::[ Data Surat Pemesanan Barang Aset ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param);
        }
    ...
    private void ppDatangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDatangActionPerformed
        if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim().equals("")) {
            ...
            String status = tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString();
            status = status.substring(status.lastIndexOf("Status : ") + "Status : ".length());
            if (status.equals("Sudah Datang")) {
                JOptionPane.showMessageDialog(null, "Data pemesanan sudah tervalidasi..!!");
            } else {
                InventarisPemesanan aplikasi = new InventarisPemesanan(null, false);
                ...
                aplikasi.isCek();
                aplikasi.setTampilSmc(tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString());
                aplikasi.tampilSmc();
    ...
    private void ppProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppProsesActionPerformed
        if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim().equals("")) {
            ...
            Sequel.queryu("update surat_pemesanan_inventaris_smc set status='Proses Pesan' where no_pemesanan=?", tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim());
            tampil();
        }
        ...
        if (Apoteker.getText().trim().equals("")) {
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                    "select spi.tanggal, spi.no_pemesanan, spi.kode_suplier, is2.nama_suplier," +
                    " spi.nip, p.nama, spi.status, spi.total, spi.ppn, spi.meterai, spi.tagihan" +
                    " from surat_pemesanan_inventaris_smc spi" +
                    " inner join inventaris_suplier is2 on spi.kode_suplier = is2.kode_suplier" +
                    " inner join petugas p on spi.nip = p.nip" +
                    " where spi.no_pemesanan=?");
                try {
                    ...
                    if (rs.next()) {
                        ...
                        ps2 = koneksi.prepareStatement(
                            "select dspi.kode_barang, ib.nama_barang, dspi.jumlah, dspi.h_pesan," +
                            " dspi.subtotal, dspi.dis, dspi.besardis, dspi.total" +
                            " from detail_surat_pemesanan_inventaris_smc dspi" +
                            " inner join inventaris_barang ib on dspi.kode_barang = ib.kode_barang" +
                            " where dspi.no_pemesanan=?" +
                            " order by dspi.kode_barang");
                        try {
                            ps2.setString(1, rs.getString("no_pemesanan"));
                            rs2 = ps2.executeQuery();
                            while (rs2.next()) {
                                Sequel.menyimpan(
                                    "temporary", "'" + i + "','" + rs2.getString("jumlah") + "','" + rs2.getString("kode_barang") + "','" +
                                    rs2.getString("nama_barang") + "','" + Valid.SetAngka(rs2.getDouble("h_pesan")) + "','" + Valid.SetAngka(rs2.getDouble("subtotal")) + "','" +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisCariSuratPemesananSMC dialog = new InventarisCariSuratPemesananSMC(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        if (!ceksukses) {
            ...
            new SwingWorker<Void, Object[]>() {
                double tagihan = 0;
                final String nopemesanan = NoFaktur.getText().toLowerCase().trim();
                final String tgl1 = Valid.getTglSmc(TglBeli1);
                final String tgl2 = Valid.getTglSmc(TglBeli2);
                final String kodesuplier = kdsup.getText().toLowerCase().trim();
                final String kodepetugas = kdptg.getText().toLowerCase().trim();
                final String kodebarang = kdbar.getText().toLowerCase().trim();
                final String cari = TCari.getText().toLowerCase().trim();

                @Override
                protected Void doInBackground() throws Exception {
                    StringJoiner sj = new StringJoiner(" and ");
                    sj.add("sp.tanggal between ? and ?");

                    if (!nopemesanan.isBlank()) {
                        sj.add("sp.no_pemesanan like ?");
                    }

                    if (!kodesuplier.isBlank()) {
                        sj.add("sp.kode_suplier = ?");
                    }

                    if (!kodepetugas.isBlank()) {
                        sj.add("sp.nip = ?");
                    }

                    sj.add("exists(select * from detail_surat_pemesanan_inventaris_smc d inner join inventaris_barang b on d.kode_barang = b.kode_barang where d.no_pemesanan = sp.no_pemesanan " + (kodebarang.isBlank() ? "" : "and d.kode_barang = ? ") + (cari.isBlank() ? "" : "and (d.kode_barang like ? or b.nama_barang like ?)") + ")");

                    if (!cari.isBlank()) {
                        sj.add("(sp.no_pemesanan like ? or sp.kode_suplier like ? or s.nama_suplier like ? or sp.nip like ? or p.nama like ?)");
                    }

                    try (PreparedStatement ps = koneksi.prepareStatement(
                        "select sp.tanggal, sp.no_pemesanan, sp.kode_suplier, s.nama_suplier, sp.nip, p.nama, sp.status, sp.kd_rek, sp.total, sp.ppn, sp.meterai, " +
                        "sp.tagihan from surat_pemesanan_inventaris_smc sp inner join inventaris_suplier s on sp.kode_suplier = s.kode_suplier inner join petugas p " +
                        "on sp.nip = p.nip " + (sj.length() == 0 ? "" : "where " + sj.toString() + " ") + "order by sp.tanggal, sp.no_pemesanan"
                    )) {
                        int p = 0;
                        ps.setString(++p, tgl1);
                        ps.setString(++p, tgl2);
                        if (!nopemesanan.isBlank()) {
                            ps.setString(++p, "%" + nopemesanan + "%");
                        }
                        if (!kodesuplier.isBlank()) {
                            ps.setString(++p, kodesuplier);
                        }
                        if (!kodepetugas.isBlank()) {
                            ps.setString(++p, kodepetugas);
                        }
                        if (!kodebarang.isBlank()) {
                        ...
                        try (ResultSet rs = ps.executeQuery()) {
                            while (rs.next()) {
                                ...
                                try (PreparedStatement ps2 = koneksi.prepareStatement(
                                    "select d.kode_barang, b.nama_barang, d.jumlah, d.h_pesan, d.subtotal, d.dis, d.besardis, d.total " +
                                    "from detail_surat_pemesanan_inventaris_smc d inner join inventaris_barang b on d.kode_barang = b.kode_barang " +
                                    "where d.no_pemesanan = ? " + (cari.isBlank() ? "" : "and (d.kode_barang like ? or b.nama_barang like ?) ") + "order by d.kode_barang"
                                )) {
                                    int p2 = 0;
                                    ps2.setString(++p2, rs.getString("no_pemesanan"));
                                    if (!cari.isBlank()) {
                                        ps2.setString(++p2, "%" + cari + "%");
                                        ps2.setString(++p2, "%" + cari + "%");
                                    }
                                    try (ResultSet rs2 = ps2.executeQuery()) {
                                        if (rs2.next()) {
                                            ...
                                            do {
                                                publish(new Object[] {
                                                    "", (++no) + ". " + rs2.getString("kode_barang") + ", " + rs2.getString("nama_barang"), rs2.getString("jumlah"),
                                                    Valid.SetAngka(rs2.getDouble("h_pesan")), Valid.SetAngka(rs2.getDouble("subtotal")), Valid.SetAngka(rs2.getDouble("dis")),
                                                    Valid.SetAngka(rs2.getDouble("besardis")), Valid.SetAngka(rs2.getDouble("total"))
                                                });
                                            } while (rs2.next());
                                        }
                                    }
                                }
                                publish(new Object[] {"Supplier", ": " + rs.getString("kode_suplier") + ", " + rs.getString("nama_suplier"), "", "", "", "Total", ":", Valid.SetAngka(rs.getDouble("total"))});
                                publish(new Object[] {"Petugas", ": " + rs.getString("nip") + ", " + rs.getString("nama"), "", "", "", "Meterai", ":", Valid.SetAngka(rs.getDouble("meterai"))});
                                publish(new Object[] {"", "", "", "", "", "PPN", ":", Valid.SetAngka(rs.getDouble("ppn"))});
                                publish(new Object[] {"", "", "", "", "", "Tagihan", ":", Valid.SetAngka(rs.getDouble("tagihan"))});
                                publish(new Object[] {"", "", "", "", "", "", "", ""});
                ...
                protected void done() {
                    ...
                    InventarisCariSuratPemesananSMC.this.setCursor(Cursor.getDefaultCursor());
                    ceksukses = false;
                }
    ...
    public void isCek() {
        BtnPrint.setEnabled(akses.getsurat_pemesanan_inventaris_smc());
        ppHapus.setEnabled(akses.getsurat_pemesanan_inventaris_smc());
        ppDatang.setEnabled(akses.getpenerimaan_aset_inventaris());
        ppProses.setEnabled(akses.getsurat_pemesanan_inventaris_smc());
        ppSuratPemesanan.setEnabled(akses.getsurat_pemesanan_inventaris_smc());
    }

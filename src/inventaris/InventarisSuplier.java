    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Suplier.html", "Data Suplier", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Suplier.wps", "Data Suplier", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Suplier.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Suplier.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptSuplier.jasper", "report", "::[ Data Suplier ]::", param, "select inventaris_suplier.kode_suplier, inventaris_suplier.nama_suplier, " +
                            "inventaris_suplier.alamat, inventaris_suplier.kota, inventaris_suplier.no_telp, inventaris_suplier.nama_bank, inventaris_suplier.rekening from " +
                            "inventaris_suplier where (if(trim(?) = '', 1 = 1, inventaris_suplier.kode_suplier like ? or inventaris_suplier.nama_suplier like ? or " +
                            "inventaris_suplier.alamat like ? or inventaris_suplier.kota like ? or inventaris_suplier.nama_bank like ? or inventaris_suplier.no_telp like ?)) " +
                            "order by inventaris_suplier.kode_suplier", TCari.getText().trim(), "%" + TCari.getText().trim() + "%", "%" + TCari.getText().trim() + "%",

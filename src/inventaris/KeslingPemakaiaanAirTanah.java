    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PemakaianAirTanah.html", "Data Pemakaian Air Tanah", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PemakaianAirTanah.wps", "Data Pemakaian Air Tanah", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PemakaianAirTanah.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PemakaianAirTanah.xlsx", tbObat);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptPemakaianAirTanah.jasper", "report", "::[ Data Pemakaian Air Tanah ]::", param, "select kesling_pemakaian_air_tanah.nip, petugas.nama, " +
                            "kesling_pemakaian_air_tanah.tanggal, kesling_pemakaian_air_tanah.meteran, kesling_pemakaian_air_tanah.jumlahharian, kesling_pemakaian_air_tanah.keterangan " +
                            "from kesling_pemakaian_air_tanah inner join petugas on kesling_pemakaian_air_tanah.nip = petugas.nip where kesling_pemakaian_air_tanah.tanggal between ? and ? " +
                            "and (if(trim(?) = '', 1 = 1, kesling_pemakaian_air_tanah.nip like ? or petugas.nama like ? or kesling_pemakaian_air_tanah.keterangan like ?)) order by " +
                            "kesling_pemakaian_air_tanah.tanggal", Valid.getTglSmc(DTPCari1) + " 00:00:00.000", Valid.getTglSmc(DTPCari2) + " 23:59:59.999", TCari.getText().trim(),

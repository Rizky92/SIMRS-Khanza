    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("RekapPengajuanInventarisDepartemen.html", "Laporan Rekap Pengajuan Aset/Inventaris Per Departemen", tbBangsal);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("RekapPengajuanInventarisDepartemen.wps", "Laporan Rekap Pengajuan Aset/Inventaris Per Departemen", tbBangsal);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("RekapPengajuanInventarisDepartemen.csv", tbBangsal);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("RekapPengajuanInventarisDepartemen.xlsx", tbBangsal);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        for (int i = 0; i < tabMode.getRowCount(); i++) {
                            if (!tbBangsal.getValueAt(i, 0).toString().contains(">>")) {
                                Sequel.temporary(String.valueOf(i + 1), (String) tabMode.getValueAt(i, 0), (String) tabMode.getValueAt(i, 1), (String) tabMode.getValueAt(i, 2),
                                    ...
                                    (String) tabMode.getValueAt(i, 11), (String) tabMode.getValueAt(i, 12), (String) tabMode.getValueAt(i, 13), (String) tabMode.getValueAt(i, 14));
                            }
                        }
                        Valid.reportTempSmc("rptRekapPengajuanInventarisDepartemen.jasper", "report", "::[ Laporan Rekap Pengajuan Aset/Inventaris Per Departemen ]::", param);
                        break;
                }
            } catch (Exception e) {

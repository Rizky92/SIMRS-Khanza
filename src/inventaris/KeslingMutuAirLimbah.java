    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MutuAirLimbah.html", "Data Mutu Air Limbah", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MutuAirLimbah.wps", "Data Mutu Air Limbah", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("MutuAirLimbah.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("MutuAirLimbah.xlsx", tbObat);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptMutuAirLimbah.jasper", "report", "::[ Data Mutu Air Limbah ]::", param, "select kesling_mutu_air_limbah.nip, petugas.nama, kesling_mutu_air_limbah.tanggal, " +
                            "kesling_mutu_air_limbah.meteran, kesling_mutu_air_limbah.jumlahharian, kesling_mutu_air_limbah.ph, kesling_mutu_air_limbah.suhu, kesling_mutu_air_limbah.tds, " +
                            "kesling_mutu_air_limbah.ec, kesling_mutu_air_limbah.salt from kesling_mutu_air_limbah inner join petugas on kesling_mutu_air_limbah.nip = petugas.nip where " +
                            "kesling_mutu_air_limbah.tanggal between ? and ? and (if(trim(?) = '', 1 = 1, kesling_mutu_air_limbah.nip like ? or petugas.nama like ?))", Valid.getTglSmc(DTPCari1) +
                            " 00:00:00.000", Valid.getTglSmc(DTPCari2) + " 23:59:59.999", TCari.getText().trim(), "%" + TCari.getText().trim() + "%", "%" + TCari.getText().trim() + "%");
                        break;
                }
            } catch (Exception e) {

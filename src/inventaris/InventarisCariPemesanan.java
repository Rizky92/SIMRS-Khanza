    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PembelianAset.html", "Transaksi Penerimaan Barang Aset/Inventaris", tbDokter, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PembelianAset.wps", "Transaksi Penerimaan Barang Aset/Inventaris", tbDokter, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PembelianAset.csv", tbDokter, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PembelianAset.xlsx", tbDokter, 0, 1, 2, 3, 4, 5, 6, 7, 8);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        for (; i < tabMode.getRowCount(); i++) {
                            Sequel.temporary(String.valueOf(i + 1), (String) tabMode.getValueAt(i, 0), (String) tabMode.getValueAt(i, 1), (String) tabMode.getValueAt(i, 2),
                                ...
                                (String) tabMode.getValueAt(i, 7), (String) tabMode.getValueAt(i, 8));
                        }
                        Sequel.temporary(String.valueOf(++i));
                        Sequel.temporary(String.valueOf(++i), "Jumlah Total :", "", "", "", "", "", "", "", LTotal.getText());
                        ...
                        Valid.reportTempSmc("rptPemesananAset.jasper", "report", "::[ Transaksi Penerimaan Barang Aset/Inventaris ]::", param);
                        break;
                }
            } catch (Exception e) {

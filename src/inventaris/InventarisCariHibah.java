                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            if (sukses) {
                                jur.clear();
                                if (sukses) sukses = jur.tampung(rs.getString("kd_rek_aset"), 0, rs.getDouble("totalhibah"));
                                if (sukses) sukses = jur.tampung(Kontra_Hibah_Aset, rs.getDouble("totalhibah"), 0);
                                if (sukses) sukses = jur.simpanJurnalSMC(rs.getString("no_hibah"),"U","PEMBATALAN HIBAH ASET/INVENTARIS "+", OLEH "+akses.getkode());
                            }
                            if(sukses==true){

           ...
           try {
               ...
               try {
                  ...
                  if(rs.next()){
                      ...
                      if (!Sequel.insertTampJurnal(rs.getString("kd_rek_aset"), "JENIS ASET/INVENTARIS", 0, rs.getDouble("totalhibah"))) {
                        sukses = false;
                      }
                      if (!Sequel.insertTampJurnal(Kontra_Hibah_Aset, "PENDAPATAN HIBAH", rs.getDouble("totalhibah"), 0)) {
                        sukses = false;
                      }
                      if (sukses) {

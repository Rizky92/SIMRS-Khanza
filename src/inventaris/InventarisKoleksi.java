    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("rptInv.html", "Data Inventaris Barang", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("rptInv.wps", "Data Inventaris Barang", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("rptInv.csv", tbJnsPerawatan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("rptInv.xlsx", tbJnsPerawatan);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptInv.jasper", "report", "::[ Data Inventaris Barang ]::", param);
                        break;
                }
            } catch (Exception e) {

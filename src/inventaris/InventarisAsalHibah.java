    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("AsalHibah.html", "Data Pemberi Hibah/Asal Hibah", tbDokter);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("AsalHibah.wps", "Data Pemberi Hibah/Asal Hibah", tbDokter);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("AsalHibah.csv", tbDokter);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("AsalHibah.xlsx", tbDokter);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptAsalHibah.jasper", "report", "::[ Data Pemberi Hibah/Asal Hibah ]::", param, "select pemberihibah.kode_pemberi, pemberihibah.nama_pemberi, " +
                            "pemberihibah.alamat, pemberihibah.kota, pemberihibah.no_telp from pemberihibah where (if(trim(?) = '', 1 = 1, pemberihibah.kode_pemberi like ? or " +
                            "pemberihibah.nama_pemberi like ? or pemberihibah.alamat like ? or pemberihibah.kota like ? or pemberihibah.no_telp like ?)) order by pemberihibah.kode_pemberi",

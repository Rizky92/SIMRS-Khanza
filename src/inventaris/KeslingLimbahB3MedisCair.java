    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("LimbahB3MedisCair.html", "Data Limbah Cair B3 Medis Keluar TPS", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("LimbahB3MedisCair.wps", "Data Limbah Cair B3 Medis Keluar TPS", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("LimbahB3MedisCair.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("LimbahB3MedisCair.xlsx", tbObat);
                        break;
                    case "Laporan 5 (Jasper)":
                        ...
                        Valid.reportSmc("rptLimbahB3MedisCair.jasper", "report", "::[ Data Limbah Cair B3 Medis Keluar TPS ]::", param, "select kesling_limbah_b3medis_cair.nip, petugas.nama, " +
                            "kesling_limbah_b3medis_cair.tanggal, kesling_limbah_b3medis_cair.jmllimbah, kesling_limbah_b3medis_cair.tujuan_penyerahan, kesling_limbah_b3medis_cair.bukti_dokumen, " +
                            "kesling_limbah_b3medis_cair.sisa_di_tps, kesling_limbah_b3medis_cair.keterangan from kesling_limbah_b3medis_cair inner join petugas on " +
                            "kesling_limbah_b3medis_cair.nip = petugas.nip where kesling_limbah_b3medis_cair.tanggal between ? and ? and (if(trim(?) = '', 1 = 1, " +
                            "kesling_limbah_b3medis_cair.nip like ? or petugas.nama like ? or kesling_limbah_b3medis_cair.bukti_dokumen like ?)) order by " +
                            "kesling_limbah_b3medis_cair.tanggal", Valid.getTglSmc(DTPCari1) + " 00:00:00.000", Valid.getTglSmc(DTPCari2) + " 23:59:59.999",

        ...
        if(TabModePasien.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("Dpjp.html", "Data Diagnosa Pasien", tbPasien);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("Dpjp.wps", "Data Diagnosa Pasien", tbPasien);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("Dpjp.csv", tbPasien);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("Dpjp.xlsx", tbPasien);
                        break;

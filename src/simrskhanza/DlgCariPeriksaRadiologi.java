...
//                            System.out.println("nomor urut " + nomorurut);
    ...
    public void RadPdfKlaimBPJSKompilasi(String NomorRawat, String NoRekamMedis)
    {
        ...
        try {
            ps2 = koneksi.prepareStatement(
                "select permintaan_radiologi.noorder, periksa_radiologi.no_rawat, permintaan_radiologi.tgl_permintaan, " +
                "permintaan_radiologi.jam_permintaan, permintaan_radiologi.tgl_sampel, permintaan_radiologi.jam_sampel, " +
                "permintaan_radiologi.tgl_hasil, permintaan_radiologi.jam_hasil, periksa_radiologi.kd_dokter, " +
                "permintaan_radiologi.diagnosa_klinis, periksa_radiologi.kd_jenis_prw, jns_perawatan_radiologi.nm_perawatan, " +
                "hasil_radiologi.hasil, reg_periksa.no_rkm_medis from permintaan_radiologi " +
                "join periksa_radiologi on permintaan_radiologi.no_rawat = periksa_radiologi.no_rawat " +
                "join jns_perawatan_radiologi on periksa_radiologi.kd_jenis_prw = jns_perawatan_radiologi.kd_jenis_prw " +
                "join hasil_radiologi on periksa_radiologi.no_rawat = hasil_radiologi.no_rawat " +
                "join reg_periksa on hasil_radiologi.no_rawat = reg_periksa.no_rawat " +
                "and periksa_radiologi.no_rawat = reg_periksa.no_rawat " +
                "and permintaan_radiologi.no_rawat = reg_periksa.no_rawat " +
                "where periksa_radiologi.no_rawat = ? " +
                "group by permintaan_radiologi.noorder, periksa_radiologi.no_rawat"
            );
            try {

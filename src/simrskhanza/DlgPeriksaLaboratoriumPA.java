...
public final class DlgPeriksaLaboratoriumPA extends javax.swing.JDialog {
    ...
    private String noorder="",kelas="",kamar,namakamar,cara_bayar_lab="Yes",kelas_lab="Yes",pilihan="",status="",diagnosa="",finger="";
    private double ttl=0,item=0;
    private boolean sukses=false;
    private final boolean VALIDASIULANGHASILPERMINTAANLABPA = koneksiDB.VALIDASIULANGHASILPERMINTAAN("labpa"), AKTIFKANBILLINGPARSIAL = koneksiDB.AKTIFKANBILLINGPARSIAL();

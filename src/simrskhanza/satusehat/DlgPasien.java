...
public class DlgPasien extends javax.swing.JDialog {
                ...
                if(propinsiref.getTable().getSelectedRow()!= -1){   
                    ...
                    switch (pilih) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Propinsi2.setText(propinsiref.getTable().getValueAt(propinsiref.getTable().getSelectedRow(),2).toString().toUpperCase());
                            break;
                        default:
                            break;
                    }
                ...
                if(kabupatenref.getTable().getSelectedRow()!= -1){   
                    ...
                    switch (pilih) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Kabupaten2.setText(kabupatenref.getTable().getValueAt(kabupatenref.getTable().getSelectedRow(),2).toString().toUpperCase());
                            break;
                        default:
                            break;
                    }
                ...
                if(kecamatanref.getTable().getSelectedRow()!= -1){   
                    ...
                    switch (pilih) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Kecamatan2.setText(kecamatanref.getTable().getValueAt(kecamatanref.getTable().getSelectedRow(),2).toString().toUpperCase());
                            break;
                        default:
                            break;
                    }
                ...
                if(kelurahanref.getTable().getSelectedRow()!= -1){    
                    ...
                    switch (pilih) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Kelurahan2.setText(kelurahanref.getTable().getValueAt(kelurahanref.getTable().getSelectedRow(),2).toString().toUpperCase());
                            break;
                        default:
                            break;
                    }
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2026" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2026" }));
        ...
        CekIHS.setBackground(new java.awt.Color(242, 242, 242));
        CekIHS.setLabel("Cek IHS");
        CekIHS.setName("CekIHS"); // NOI18N
        CekIHS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CekIHSActionPerformed(evt);
            }
        });
        FormInput.add(CekIHS);
        CekIHS.setBounds(880, 130, 80, 24);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNo.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                ...
                // Cek IHS setelah data tersimpan; kalau belum terdaftar
                // sekalian didaftarkan. NIK dibaca SEKARANG karena
                // emptTeks() di bawah mengosongkan formulir.
...
/**
 * Buka picker referensi wilayah Kemendagri (isi cache/*.iyem) untuk satu tingkat.
 *
 * Tombol klip dulunya membuka daftar dari tabel lokal yang boleh diketik bebas; itulah yang
 * melahirkan baris master seperti "KJAWA TENGAH" dan "PROPINSIJAWA TENGAH". Picker referensi
 * menyaring berjenjang memakai kode induknya, jadi nama yang terpilih pasti sah dan cocok
 * dengan induknya - syarat supaya alamat pasien bisa dipetakan ke SATUSEHAT.
 *
 * @param tingkat   1=propinsi, 2=kabupaten, 3=kecamatan, 4=kelurahan
 * @param sasaran   kolom tujuan: 1=data pasien, 2=penanggung jawab, 3=kolom alamat kedua
 * @param namaInduk nama wilayah induk yang sedang terpilih di kelompok kolom itu
 */
private void bukaReferensiWilayah(int tingkat, int sasaran, String namaInduk) {
    akses.setform("DlgPasien");
    String kodeInduk = "", sebutanInduk = "";
    switch (tingkat) {
        case 2:  kodeInduk = KdProp.getText().trim(); sebutanInduk = "propinsi";  break;
        case 3:  kodeInduk = KdKab.getText().trim();  sebutanInduk = "kabupaten"; break;
        case 4:  kodeInduk = KdKec.getText().trim();  sebutanInduk = "kecamatan"; break;
        default: break;
    }
    String induk = (namaInduk == null) ? "" : namaInduk.trim();
    // Tanpa kode induk daftar tidak bisa disaring dan petugas melihat seluruh Indonesia -
    // persis keadaan yang bikin salah pilih wilayah yang namanya kembar.
    if (tingkat > 1 && (kodeInduk.equals("") || induk.equals("") || induk.equalsIgnoreCase(sebutanInduk))) {
        JOptionPane.showMessageDialog(null, "Silahkan pilih " + sebutanInduk + " dulu..!!");
        return;
    }
    pilih = sasaran;
    javax.swing.JDialog dialog;
    switch (tingkat) {
        case 2:  kabupatenref.setPropinsi(kodeInduk, induk); dialog = kabupatenref; break;
        case 3:  kecamatanref.setPropinsi(kodeInduk, induk); dialog = kecamatanref; break;
        case 4:  kelurahanref.setPropinsi(kodeInduk, induk); dialog = kelurahanref; break;
        default: dialog = propinsiref; break;
    }
...
private void BtnKelurahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKelurahanActionPerformed
        bukaReferensiWilayah(4, 1, Kecamatan.getText());
...
private void BtnKecamatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKecamatanActionPerformed
        bukaReferensiWilayah(3, 1, Kabupaten.getText());
...
private void BtnKabupatenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKabupatenActionPerformed
        bukaReferensiWilayah(2, 1, Propinsi.getText());
...
private void BtnSeek8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek8ActionPerformed
        bukaReferensiWilayah(4, 3, Kecamatan2.getText());
...
private void BtnSeek9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek9ActionPerformed
        bukaReferensiWilayah(3, 3, Kabupaten2.getText());
...
private void BtnSeek10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek10ActionPerformed
        bukaReferensiWilayah(2, 3, Propinsi2.getText());
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void BtnKecamatanPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKecamatanPjActionPerformed
        bukaReferensiWilayah(3, 2, KabupatenPj.getText());
    ...
    private void BtnKabupatenPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKabupatenPjActionPerformed
        bukaReferensiWilayah(2, 2, PropinsiPj.getText());
    ...
    private void BtnKelurahanPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKelurahanPjActionPerformed
        bukaReferensiWilayah(4, 2, KecamatanPj.getText());
    ...
    private void CekIHSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CekIHSActionPerformed
        ...
        // Pesan dibedakan supaya petugas tahu tindak lanjutnya: pasien belum terdaftar di
        // SATUSEHAT (perlu registrasi) itu lain urusan dengan server sedang tidak bisa dihubungi.
        if(hasil.ada()){
        ...
        // Hanya "benar-benar belum terdaftar" yang boleh didaftarkan. NIK yang sudah dipakai
        // Patient provisional dilewati supaya tidak jadi data ganda.
        ...
        // Ditanya dulu, tidak otomatis: Patient yang terlanjur dibuat di SATUSEHAT tidak bisa
        // dihapus dari sini, jadi keputusannya ada di petugas.
    ...
    }//GEN-LAST:event_CekIHSActionPerformed

    /**
     * Cek IHS pasien ke SATUSEHAT sesudah data tersimpan; bila belum terdaftar, sekalian
     * didaftarkan.
     *
     * Dijalankan di thread terpisah dan TIDAK memunculkan dialog apa pun: loket pendaftaran tidak
     * boleh tertahan panggilan jaringan, dan kegagalan di sini bukan alasan menggagalkan
     * penyimpanan data pasien. Pasien yang gagal tetap bisa diproses lewat tombol Cek IHS, atau
     * ikut terkirim saat bundle SATUSEHAT dijalankan.
     *
     * Pendaftaran hanya berjalan bila server menjawab "tidak ditemukan". Gangguan jaringan tidak
     * pernah memicu pembuatan Patient baru - pengamannya ada di
     * {@link SatuSehatCekNIK#cekIHSAtauBuat(String)}.
     */
    private void cekAtauBuatIhsLatar(final String nik) {
        ...
        Thread pekerja = new Thread(new Runnable() {
            ...
            public void run() {
                SatuSehatCekNIK.HasilIHS hasil;
                try {
                    hasil = new SatuSehatCekNIK().cekIHSAtauBuat(bersih);
                } catch (Throwable e) {
                    System.out.println("Notifikasi IHS pasien " + bersih + " : " + e);
                    tampilkanHasilIhs(null, SatuSehatCekNIK.ringkasError(e));
                    return;
                }
                System.out.println("IHS pasien " + bersih + " : " + hasil.status + " - " + hasil.pesan);
                tampilkanHasilIhs(hasil, null);
            }
        }, "ihs-pasien-" + bersih);
    ...
    /**
     * Tampilkan hasil proses IHS ke petugas, berhasil maupun gagal, lengkap dengan sebabnya.
     *
     * Dibuka lewat invokeLater karena pemanggilnya thread latar, sedangkan komponen Swing hanya
     * boleh disentuh dari Event Dispatch Thread. Dialognya muncul sesudah formulir dikosongkan —
     * itu memang konsekuensi prosesnya berjalan di latar supaya loket tidak tertahan jaringan.
     */
    private void tampilkanHasilIhs(final SatuSehatCekNIK.HasilIHS hasil, final String galat) {
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                if (hasil == null) {
                    JOptionPane.showMessageDialog(null,
                            "Gagal memproses IHS pasien.\n\nSebabnya:\n" + galat,
                            "IHS Satu Sehat", JOptionPane.ERROR_MESSAGE);
                } else if (hasil.ada()) {
                    JOptionPane.showMessageDialog(null, ringkasanIHS(hasil),
                            "IHS Satu Sehat", JOptionPane.INFORMATION_MESSAGE);
                } else if (hasil.status.equals(SatuSehatCekNIK.IHS_GAGAL)) {
                    JOptionPane.showMessageDialog(null, hasil.pesan,
                            "IHS Satu Sehat", JOptionPane.ERROR_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(null, hasil.pesan,
                            "IHS Satu Sehat", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
    }
    ...
    /**
     * Ringkasan data pasien dari SATUSEHAT untuk ditampilkan ke petugas. Hanya field yang
     * benar-benar dikirim server yang dibaris-kan; field kosong dilewati supaya tidak
     * terbaca seolah datanya ada tapi kosong.
     */
    private String ringkasanIHS(SatuSehatCekNIK.HasilIHS hasil){
        ...
        if(!hasil.nikServer.equals("")){
            // SATUSEHAT membalikkan NIK bertopeng "################"; ditampilkan apa adanya
            // supaya petugas tidak menyangka NIK-nya tidak cocok.
    ...
    private java.awt.Button CekIHS;

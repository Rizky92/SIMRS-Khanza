        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PasienMati.html", "Data Pasien Meninggal", tbMati);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PasienMati.wps", "Data Pasien Meninggal", tbMati);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PasienMati.csv", tbMati);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PasienMati.xlsx", tbMati);
                        break;

                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        Sequel.temporaryLab(String.valueOf(++i), rs2.getString("nm_perawatan"), rs3.getString("diagnosa_klinik"), rs3.getString("makroskopik"), rs3.getString("mikroskopik"), rs3.getString("kesimpulan"));
                                    }
                                } catch (Exception e) {
            ...
            try {
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        Sequel.temporaryLab(String.valueOf(++i), "", "Total Biaya Pemeriksaan Lab", Valid.SetAngka(ttl));
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                try {
                                    ...
                                    rs3=ps3.executeQuery();
                                    while(rs3.next()){
                                        Sequel.temporaryLab(String.valueOf(++i), rs2.getString("nm_perawatan"), rs3.getString("diagnosa_klinik"), rs3.getString("makroskopik"), rs3.getString("mikroskopik"), rs3.getString("kesimpulan"), rs3.getString("kesan"));
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif ps3 : "+e);
                                } finally{
            ...
            case 0:
                if(tabMode.getRowCount()==0){
                    ...
                    "Laporan 1 (HTML)", "Laporan 2 (WPS)", "Laporan 3 (CSV)", "Laporan 4 (XLSX)", "Laporan 5 (Jasper)"
                        ...
                        switch (pilihan) {
                            case "Laporan 1 (HTML)":
                                Valid.exportHtmlSmc("DataLabPA.html", "Data Pemeriksaan Laboratorium", tbDokter);
                                break;
                            case "Laporan 2 (WPS)":
                                Valid.exportWPSSmc("DataLabPA.wps", "Data Pemeriksaan Laboratorium", tbDokter);
                                break;
                            case "Laporan 3 (CSV)":
                                Valid.exportCSVSmc("DataLabPA.csv", tbDokter);
                                break;
                            case "Laporan 4 (XLSX)":
                                Valid.exportXlsxSmc("DataLabPA.xlsx", tbDokter);
                                break;

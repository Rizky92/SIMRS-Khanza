                ...
                switch (pilihan) {
                    ...
                    case "Laporan 5 (Jasper)":
                        ...
                        if(TCari.getText().trim().equals("")){
                            Valid.Myreportqry("rptBangsal.jasper","report","::[ Data Kamar ]::","select * from order by kd_bangsal",param);
                        }else if(! TCari.getText().trim().equals("")){
                            Valid.Myreportqry("rptBangsal.jasper","report","::[ Data Kamar ]::","select * from where kd_bangsal like '%"+TCari.getText().trim()+"%' "+

            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(sukses==true){
                    if(status.equals("Ranap")){
                        ...
                        if(ttlpendapatan>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(Suspen_Piutang_Operasi_Ranap, "Suspen Piutang Operasi Ranap", ttlpendapatan, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Operasi_Ranap, "Pendapatan Operasi Rawat Inap", 0, ttlpendapatan);
                        }
                        if(ttljmdokter>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Medik_Dokter_Operasi_Ranap, "Beban Jasa Medik Dokter Operasi Ranap", ttljmdokter, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Dokter_Operasi_Ranap, "Utang Jasa Medik Dokter Operasi Ranap", 0, ttljmdokter);
                        }
                        if(ttljmpetugas>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Medik_Paramedis_Operasi_Ranap, "Beban Jasa Medik Petugas Operasi Ranap", ttljmpetugas, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Paramedis_Operasi_Ranap, "Utang Jasa Medik Petugas Operasi Ranap", 0, ttljmpetugas);
                        }
                        if(ttlbhp>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(HPP_Obat_Operasi_Ranap, "HPP Persediaan Operasi Rawat Inap", ttlbhp, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Persediaan_Obat_Kamar_Operasi_Ranap, "Persediaan BHP Operasi Ranap", 0, ttlbhp);
                        }
                        ...
                        Sequel.deleteTampJurnal();
                        if(ttlpendapatan>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(Suspen_Piutang_Operasi_Ralan, "Suspen Piutang Operasi Ralan", ttlpendapatan, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Operasi_Ralan, "Pendapatan Operasi Rawat Jalan", 0, ttlpendapatan);
                        }
                        if(ttljmdokter>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Medik_Dokter_Operasi_Ralan, "Beban Jasa Medik Dokter Operasi Ralan", ttljmdokter, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Dokter_Operasi_Ralan, "Utang Jasa Medik Dokter Operasi Ralan", 0, ttljmdokter);
                        }
                        if(ttljmpetugas>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(Beban_Jasa_Medik_Paramedis_Operasi_Ralan, "Beban Jasa Medik Petugas Operasi Ralan", ttljmpetugas, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Utang_Jasa_Medik_Paramedis_Operasi_Ralan, "Utang Jasa Medik Petugas Operasi Ralan", 0, ttljmpetugas);
                        }
                        if(ttlbhp>0){
                            if (sukses) sukses = Sequel.insertTampJurnal(HPP_Obat_Operasi_Ralan, "HPP Persediaan Operasi Rawat Jalan", ttlbhp, 0);
                            if (sukses) sukses = Sequel.insertTampJurnal(Persediaan_Obat_Kamar_Operasi_Ralan, "Persediaan BHP Operasi Ralan", 0, ttlbhp);
                        }

           ...
           // BtnBatal.requestFocus();
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("UTDPemisahanKomponen.html", "Data Pemisahan Komponen Darah", tbPemisahan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("UTDPemisahanKomponen.wps", "Data Pemisahan Komponen Darah", tbPemisahan);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("UTDPemisahanKomponen.csv", tbPemisahan);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("UTDPemisahanKomponen.xlsx", tbPemisahan);
                        break;

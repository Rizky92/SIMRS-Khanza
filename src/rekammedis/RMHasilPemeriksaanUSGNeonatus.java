    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataHasilPemeriksaanUSGNeonatus.html", "DATA HASIL PEMERIKSAAN USG NEONATUS", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataHasilPemeriksaanUSGNeonatus.wps", "DATA HASIL PEMERIKSAAN USG NEONATUS", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataHasilPemeriksaanUSGNeonatus.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataHasilPemeriksaanUSGNeonatus.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {

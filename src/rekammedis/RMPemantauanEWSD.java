    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataPemantauanPEWSDewasa.html","Data Pemantauan PEWS Dewasa",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataPemantauanPEWSDewasa.wps","Data Pemantauan PEWS Dewasa",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataPemantauanPEWSDewasa.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataPemantauanPEWSDewasa.xlsx",tbObat); break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataCatatanKeperawatanRanap.html","Data Catatan Keperawatan Rawat Inap",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataCatatanKeperawatanRanap.wps","Data Catatan Keperawatan Rawat Inap",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataCatatanKeperawatanRanap.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataCatatanKeperawatanRanap.xlsx",tbObat); break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("LanjutanRisikoJatuhPsikiatri.html", "Data Pengkajian Lanjutan Risiko Jatuh Psikiatri", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("LanjutanRisikoJatuhPsikiatri.wps", "Data Pengkajian Lanjutan Risiko Jatuh Psikiatri", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("LanjutanRisikoJatuhPsikiatri.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("LanjutanRisikoJatuhPsikiatri.xlsx", tbObat);
                        break;

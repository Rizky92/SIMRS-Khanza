    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("SkriningRalan.html","Data Skrining Rawat Jalan",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("SkriningRalan.wps","Data Skrining Rawat Jalan",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("SkriningRalan.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("SkriningRalan.xlsx",tbObat); break;

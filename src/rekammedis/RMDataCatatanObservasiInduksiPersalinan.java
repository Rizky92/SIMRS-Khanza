    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataCatatanObservasiInduksiPersalinan.html","Data Catatan Observasi Induksi Persalinan",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataCatatanObservasiInduksiPersalinan.wps","Data Catatan Observasi Induksi Persalinan",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataCatatanObservasiInduksiPersalinan.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataCatatanObservasiInduksiPersalinan.xlsx",tbObat); break;

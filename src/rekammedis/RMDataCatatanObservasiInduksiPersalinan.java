        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataCatatanObservasiInduksiPersalinan.html", "Data Catatan Observasi Induksi Persalinan", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataCatatanObservasiInduksiPersalinan.wps", "Data Catatan Observasi Induksi Persalinan", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataCatatanObservasiInduksiPersalinan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataCatatanObservasiInduksiPersalinan.xlsx", tbObat);
                        break;

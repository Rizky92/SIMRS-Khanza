    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("LanjutanRisikoJatuhLansia.html","Data Pengkajian Lanjutan Risiko Jatuh Lansia",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("LanjutanRisikoJatuhLansia.wps","Data Pengkajian Lanjutan Risiko Jatuh Lansia",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("LanjutanRisikoJatuhLansia.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("LanjutanRisikoJatuhLansia.xlsx",tbObat); break;

        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("LanjutanRisikoJatuhLansia.html", "Data Pengkajian Lanjutan Risiko Jatuh Lansia", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("LanjutanRisikoJatuhLansia.wps", "Data Pengkajian Lanjutan Risiko Jatuh Lansia", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("LanjutanRisikoJatuhLansia.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("LanjutanRisikoJatuhLansia.xlsx", tbObat);
                        break;

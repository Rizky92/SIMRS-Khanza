    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("StewardScorePascaAnestesi.html","Data Monitoring Steward Score Pasca Anestesi",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("StewardScorePascaAnestesi.wps","Data Monitoring Steward Score Pasca Anestesi",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("StewardScorePascaAnestesi.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("StewardScorePascaAnestesi.xlsx",tbObat); break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataCatatanObservasiVentilator.html","Data Catatan Observasi Ventilator",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataCatatanObservasiVentilator.wps","Data Catatan Observasi Ventilator",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataCatatanObservasiVentilator.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataCatatanObservasiVentilator.xlsx",tbObat); break;

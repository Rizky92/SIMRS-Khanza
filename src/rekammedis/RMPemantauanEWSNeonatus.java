    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataPemantauanEWSNeonatus.html","Data Pemantauan EWS Neonatus",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataPemantauanEWSNeonatus.wps","Data Pemantauan EWS Neonatus",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataPemantauanEWSNeonatus.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataPemantauanEWSNeonatus.xlsx",tbObat); break;

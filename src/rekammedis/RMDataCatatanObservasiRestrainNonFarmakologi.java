    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataCatatanObservasiRestrainNonFarmakologi.html","Data Catatan Observasi Restrain Nonfarmakologi",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataCatatanObservasiRestrainNonFarmakologi.wps","Data Catatan Observasi Restrain Nonfarmakologi",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataCatatanObservasiRestrainNonFarmakologi.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataCatatanObservasiRestrainNonFarmakologi.xlsx",tbObat); break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataCatatanObservasiRanapPostPartum.html","Data Catatan Observasi Rawat Inap Post Partum",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataCatatanObservasiRanapPostPartum.wps","Data Catatan Observasi Rawat Inap Post Partum",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataCatatanObservasiRanapPostPartum.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataCatatanObservasiRanapPostPartum.xlsx",tbObat); break;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("DataPemantauanPEWS.html","Data Pemantauan PEWS",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("DataPemantauanPEWS.wps","Data Pemantauan PEWS",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("DataPemantauanPEWS.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("DataPemantauanPEWS.xlsx",tbObat); break;

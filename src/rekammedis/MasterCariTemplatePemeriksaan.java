                ...
                if(Sequel.menyimpantf2("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                    ...
                    if(TabModeTindakan.getRowCount()>0){
                        ...
                        if(sukses==true){
                            ...
                            if(ttlmenejemen>0){
                                if (sukses) sukses = jur.tampung(Beban_Jasa_Menejemen_Tindakan_Ralan, "Beban Jasa Manajemen Tindakan Ralan", ttlmenejemen, 0);
                                if (sukses) sukses = jur.tampung(Utang_Jasa_Menejemen_Tindakan_Ralan, "Utang Jasa Manajemen Tindakan Ralan", 0, ttlmenejemen);
                            }
                            if (sukses) sukses = jur.simpanJurnalSMC(noperawatan,"U","TINDAKAN RAWAT JALAN PASIEN "+noperawatan+" DIPOSTING OLEH "+akses.getkode());
                        }
                    }
                }else{
                    sukses=false;

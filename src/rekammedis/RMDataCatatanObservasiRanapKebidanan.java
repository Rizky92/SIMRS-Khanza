        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataCatatanObservasiRanapKebidanan.html", "Data Catatan Observasi Rawat Inap Kebidanan", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataCatatanObservasiRanapKebidanan.wps", "Data Catatan Observasi Rawat Inap Kebidanan", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataCatatanObservasiRanapKebidanan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataCatatanObservasiRanapKebidanan.xlsx", tbObat);
                        break;

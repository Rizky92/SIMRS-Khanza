        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PenilaianRisikoDekubitas.html", "Data Pengkajian Risiko Dekubitus", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PenilaianRisikoDekubitas.wps", "Data Pengkajian Risiko Dekubitus", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PenilaianRisikoDekubitas.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PenilaianRisikoDekubitas.xlsx", tbObat);
                        break;

...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        AyamYa = new widget.RadioButton();
        AyamTidak = new widget.RadioButton();
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(new File("file2.css")))) {
                    ...
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataAsuhanGiziPasien.html", "Data Asuhan Gizi Pasien", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataAsuhanGiziPasien.wps", "Data Asuhan Gizi Pasien", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataAsuhanGiziPasien.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataAsuhanGiziPasien.xlsx", tbObat);
                        break;
    ...
    */
    ...
    private widget.RadioButton AyamTidak;
    private widget.RadioButton AyamYa;

    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("LanjutanRisikoJatuhAnak.html","Data Pengkajian Lanjutan Risiko Jatuh Anak",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("LanjutanRisikoJatuhAnak.wps","Data Pengkajian Lanjutan Risiko Jatuh Anak",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("LanjutanRisikoJatuhAnak.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("LanjutanRisikoJatuhAnak.xlsx",tbObat); break;

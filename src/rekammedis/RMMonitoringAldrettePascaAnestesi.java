    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)": Valid.exportHtmlSmc("SkorMonitoringAldrette.html","Data Skor Monitoring Aldrette Pasca Anestesi",tbObat); break;
                    case "Laporan 2 (WPS)": Valid.exportWPSSmc("SkorMonitoringAldrette.wps","Data Skor Monitoring Aldrette Pasca Anestesi",tbObat); break;
                    case "Laporan 3 (CSV)": Valid.exportCSVSmc("SkorMonitoringAldrette.csv",tbObat); break;
                    case "Laporan 4 (XLSX)": Valid.exportXlsxSmc("SkorMonitoringAldrette.xlsx",tbObat); break;

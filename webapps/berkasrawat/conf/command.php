...
function cekUser()
{
    if (isset($_SESSION['ses_admin_berkas_rawat'])) {
        return true;
    } elseif (isset($_SESSION['ses_vedika'])) {
        return true;
    } else {
        return false;
    }
...
function actionPages()
{
    ...
    if(cekSessiAdmin()) {
        switch ($aksi) {
            case 'HomeAdmin': include_once('index.php');
                break;
            case 'List': include_once('pages/list.php');
                break;
            case 'ListNonHapus': include_once('pages/listnonhapus.php');
                break;
            case 'Detail': include_once('pages/detail.php');
                break;
            case 'DetailNonHapus': include_once('pages/detailnonhapus.php');
                break;
            case 'Detail2': include_once('pages/detail2.php');
                break;
            case 'Detail2NonHapus': include_once('pages/detail2nonhapus.php');
                break;
            case 'MasterBerkas': include_once('pages/master.php');
                break;
            default: include_once('index.php');
        }
    } elseif(cekSessiVedika()) {
        switch ($aksi) {
            case 'HomeAdmin': include_once('homevedika.php');
                break;
            case 'ListVedika': include_once('pages/listvedika.php');
                break;
            default: include_once('homevedika.php');
        }
    } elseif (cekSesiBillingVedika()) {

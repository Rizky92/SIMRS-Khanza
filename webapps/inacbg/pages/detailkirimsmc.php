...
<div id="post">
    ...
    <?php elseif ((isset($_GET['action']) ? validTeks($_GET['action']) : null) === 'cetak'): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <?php if ((isset($_GET['grouper']) ? validTeks($_GET['grouper']) : null) === 'idrg'): ?>

        <?php elseif ((isset($_GET['grouper']) ? validTeks($_GET['grouper']) : null) === 'inacbg_stage1'): ?>

        <?php elseif ((isset($_GET['grouper']) ? validTeks($_GET['grouper']) : null) === 'inacbg_stage2'): ?>
                    ...
                    if (isset($BtnSimpan)) {
                        ...
                        if ((int) round($validasi) === 0) {
                            if ($corona == 'PasienCorona') {
                                ...
                                //         $tarif_poli_eks, $nm_dokter, getKelasRS(), "71", "COVID-19", "#", $codernik,

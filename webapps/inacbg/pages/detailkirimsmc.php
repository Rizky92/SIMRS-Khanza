            ...
            <div style="width: 100%; height: 90%; overflow: auto;">
                <table width="100%" align="center">
                    ...
                    <tr class="head">
                        ...
                        <td>:</td>
                        <td width="57%">
                            <select name="kelas_rawat" class="text3" style="font-family: Tahoma">
                    ...
                    <tr class="head">
                        ...
                        <td width="57%">
                            ...
                            ?>
                            <input name="diagnosa" class="text inputbox" style="font-family: Tahoma" type="text" value="<?= $penyakit ?>" size="60" maxlength="100">
                        </td>
                    </tr>
                    <tr class="head">
                        ...
                        <td width="57%">
                            ...
                            ?>
                            <input name="procedure" type="text" class="text inputbox" style="font-family: Tahoma" value="<?= $prosedur; ?>" size="60" maxlength="100">
                        </td>
                    </tr>
                    <?php

...
ALTER TABLE `detail_nota_jalan` ADD COLUMN IF NOT EXISTS `keterangan` varchar(20) NULL DEFAULT NULL AFTER `besar_bayar`;

ALTER TABLE `detail_nota_inap` ADD COLUMN IF NOT EXISTS `keterangan` varchar(20) NULL DEFAULT NULL AFTER `besar_bayar`;

...
CREATE TABLE IF NOT EXISTS `penilaian_tindakan_invasif_non_bedah` (
  ...
  `antiplatelet` varchar(10) DEFAULT NULL,
  `lama_antiplatelet` varchar(50) DEFAULT NULL,
  `beta_blocker` varchar(10) DEFAULT NULL,
  `lama_beta_blocker` varchar(50) DEFAULT NULL,
  `simarc` varchar(10) DEFAULT NULL,
  ...
  `penilaian_nyeri_durasi` varchar(5) NOT NULL,
  ...
  `skrining_jatuh` enum('Resiko Rendah', 'Resiko Sedang', 'Resiko Tinggi') NOT NULL,

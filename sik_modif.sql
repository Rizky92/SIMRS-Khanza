...
-- ------------------------------------------------------------------------
-- Form Pengkajian Keperawatan Tindakan Invasif Non Bedah (SMC)
-- ------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rm_pengkajian_invasif_non_bedah` (
  `id`                        INT(11) NOT NULL AUTO_INCREMENT,
  `no_rawat`                  VARCHAR(20) NOT NULL,
  `tgl_pengkajian`            DATE NOT NULL,
  `jam_pasien_datang`         TIME DEFAULT NULL,
  `jam_pengkajian`            TIME DEFAULT NULL,
  `diagnosa_medis`            VARCHAR(255) DEFAULT NULL,
  `tujuan_tindakan`           VARCHAR(500) DEFAULT NULL,
  `tujuan_lainlain`           VARCHAR(255) DEFAULT NULL,
  `status_fungsional`         VARCHAR(255) DEFAULT NULL,
  `keluhan_utama`             TEXT DEFAULT NULL,
  `status_psikologi`          VARCHAR(100) DEFAULT NULL,
  `riwayat_penyakit`          VARCHAR(500) DEFAULT NULL,
  `riwayat_penyakit_lain`     VARCHAR(255) DEFAULT NULL,
  `sistem_pernapasan`         VARCHAR(100) DEFAULT NULL,
  `muntah_darah`              TINYINT(1) DEFAULT NULL,
  `bab`                       VARCHAR(50) DEFAULT NULL,
  `urine_24jam`               VARCHAR(50) DEFAULT NULL,
  `obat_antiplatelet`         TINYINT(1) DEFAULT NULL,
  `obat_antiplatelet_lama`    VARCHAR(100) DEFAULT NULL,
  `obat_betablocker`          TINYINT(1) DEFAULT NULL,
  `obat_betablocker_lama`     VARCHAR(100) DEFAULT NULL,
  `obat_simarc`               TINYINT(1) DEFAULT NULL,
  `obat_simarc_lama`          VARCHAR(100) DEFAULT NULL,
  `alergi`                    TINYINT(1) DEFAULT NULL,
  `alergi_keterangan`         VARCHAR(255) DEFAULT NULL,
  `td_sistolik`               VARCHAR(10) DEFAULT NULL,
  `td_diastolik`              VARCHAR(10) DEFAULT NULL,
  `nadi`                      VARCHAR(10) DEFAULT NULL,
  `saturasi`                  VARCHAR(10) DEFAULT NULL,
  `pernapasan`                VARCHAR(10) DEFAULT NULL,
  `suhu`                      VARCHAR(10) DEFAULT NULL,
  `tes_allen_kanan`           VARCHAR(20) DEFAULT NULL,
  `tes_allen_kiri`            VARCHAR(20) DEFAULT NULL,
  `dorsalis_pedis_kanan`      VARCHAR(20) DEFAULT NULL,
  `dorsalis_pedis_kiri`       VARCHAR(20) DEFAULT NULL,
  `berat_badan`               DECIMAL(5,2) DEFAULT NULL,
  `tinggi_badan`              DECIMAL(5,2) DEFAULT NULL,
  `nyeri`                     TINYINT(1) DEFAULT NULL,
  `nyeri_lokasi`              VARCHAR(100) DEFAULT NULL,
  `nyeri_skala`               VARCHAR(20) DEFAULT NULL,
  `nyeri_lama`                VARCHAR(50) DEFAULT NULL,
  `nyeri_pencetus`            VARCHAR(100) DEFAULT NULL,
  `nyeri_kualitas`            VARCHAR(100) DEFAULT NULL,
  `nyeri_penjalaran`          VARCHAR(100) DEFAULT NULL,
  `kebutuhan_edukasi`         VARCHAR(500) DEFAULT NULL,
  `edukasi_lainlain`          VARCHAR(255) DEFAULT NULL,
  `lab_hb`                    VARCHAR(20) DEFAULT NULL,
  `lab_ht`                    VARCHAR(20) DEFAULT NULL,
  `lab_leukosit`              VARCHAR(20) DEFAULT NULL,
  `lab_na`                    VARCHAR(20) DEFAULT NULL,
  `lab_ur`                    VARCHAR(20) DEFAULT NULL,
  `lab_cr`                    VARCHAR(20) DEFAULT NULL,
  `lab_hbsag`                 VARCHAR(20) DEFAULT NULL,
  `lab_k`                     VARCHAR(20) DEFAULT NULL,
  `lab_anti_hcv`              VARCHAR(50) DEFAULT NULL,
  `lab_pt_ir`                 VARCHAR(20) DEFAULT NULL,
  `lab_pt_aptt`               VARCHAR(20) DEFAULT NULL,
  `lab_gds`                   VARCHAR(20) DEFAULT NULL,
  `skrining_skor`             VARCHAR(20) DEFAULT NULL,
  `skrining_risiko`           VARCHAR(20) DEFAULT NULL,
  `echo_ada`                  TINYINT(1) DEFAULT NULL,
  `echo_kesan`                VARCHAR(255) DEFAULT NULL,
  `masalah_keperawatan`       VARCHAR(500) DEFAULT NULL,
  `masalah_lainlain`          VARCHAR(255) DEFAULT NULL,
  `rencana_tindakan`          VARCHAR(500) DEFAULT NULL,
  ...
  INDEX `idx_tgl_pengkajian` (`tgl_pengkajian`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=Dynamic;

ALTER TABLE `user`
  ADD COLUMN IF NOT EXISTS `pengkajian_invasif_non_bedah` enum('true','false') DEFAULT NULL
  AFTER `penilaian_pre_induksi`;

CREATE TABLE IF NOT EXISTS `rm_penilaian_tindakan_invasif_non_bedah` (
  `no_rawat` varchar(17) NOT NULL,
  ...
  `hematokrit` varchar(10) DEFAULT NULL,
  `hemoglobin` varchar(10) DEFAULT NULL,
  `leukosit` varchar(10) DEFAULT NULL,
  `pt_ir` varchar(10) DEFAULT NULL,
  `kalium` varchar(10) DEFAULT NULL,
  `natrium` varchar(10) DEFAULT NULL,
  `hitung_jenis` varchar(10) DEFAULT NULL,
  `hbsag` varchar(10) DEFAULT NULL,
  `anti_hcv` varchar(10) DEFAULT NULL,
  `gds` varchar(10) DEFAULT NULL,
  `pt_aptt` varchar(10) DEFAULT NULL,
  `kreatinin` varchar(10) DEFAULT NULL,
  `status_psiko` varchar(50) DEFAULT NULL,
  `ket_psiko` varchar(200) DEFAULT NULL,
  `status_psiko2` varchar(50) DEFAULT NULL,
  `ket_lama_da` varchar(100) DEFAULT NULL,
  `status_psiko3` varchar(50) DEFAULT NULL,
  `ket_lama_bb` varchar(100) DEFAULT NULL,
  `status_psiko4` varchar(50) DEFAULT NULL,
  `ket_lama_simarc` varchar(100) DEFAULT NULL,
  ...
  `radialis_kanan` varchar(10) DEFAULT NULL,
  `radialis_kiri` varchar(10) DEFAULT NULL,
  `pedis_kanan` varchar(10) DEFAULT NULL,
  `pedis_kiri` varchar(10) DEFAULT NULL,
  `nyeri` varchar(50) DEFAULT NULL,
  `skala_nyeri` varchar(10) DEFAULT NULL,
  `durasi` varchar(50) DEFAULT NULL,
  `lokasi` varchar(100) DEFAULT NULL,
  `pencetus` varchar(100) DEFAULT NULL,
  `kualitas` varchar(100) DEFAULT NULL,
  `penjalaran` varchar(100) DEFAULT NULL,
  `hasil_echo` text DEFAULT NULL,
  `skrining_jatuh` varchar(50) DEFAULT NULL,
  `skor_resiko_jatuh` varchar(10) DEFAULT NULL,
  `rpd2` text DEFAULT NULL,
